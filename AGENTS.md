...
- 专业结论来源约束：产品/系统设计、游戏视觉/交互、runtime、WASM、agent、viewer、QA、LiveOps/community 等专业分析、实现、验证、评审或对外口径，必须来自对应专业角色 slice；TPM 只能合流和标注证据来源。
...
3. `game_visual_interaction_designer`: `.agents/roles/game_visual_interaction_designer.md`
4. `runtime_engineer`: `.agents/roles/runtime_engineer.md`
5. `wasm_platform_engineer`: `.agents/roles/wasm_platform_engineer.md`
6. `agent_engineer`: `.agents/roles/agent_engineer.md`
7. `viewer_engineer`: `.agents/roles/viewer_engineer.md`
8. `qa_engineer`: `.agents/roles/qa_engineer.md`
9. `liveops_community`: `.agents/roles/liveops_community.md`
