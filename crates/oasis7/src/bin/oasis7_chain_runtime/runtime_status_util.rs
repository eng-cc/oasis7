...
pub(super) fn print_runtime_ready_summary(
    ...
    println!(
        concat!(
            ...
            "- first_claim_approval_submit: http://{}:{}/v1/chain/agent-claim/approval-request/submit\n",
            "- first_claim_approval_requests: http://{}:{}/v1/chain/agent-claim/approval-requests\n",
            "- first_claim_approval_approve: http://{}:{}/v1/chain/agent-claim/approval-request/approve\n",
            "- first_claim_approval_reject: http://{}:{}/v1/chain/agent-claim/approval-request/reject\n",
