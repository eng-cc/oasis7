...
const M4_BUILTIN_IDENTITY_MANIFEST: &str =
    include_str!("world/artifacts/m4_builtin_modules.identity.json");
...
#[cfg(test)]
pub(crate) fn m4_builtin_manifest_hash_tokens(module_id: &str) -> Option<Vec<String>> {
