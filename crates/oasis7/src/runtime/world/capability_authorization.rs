...
struct CapabilityAuthorizationRootBody<'a> {
    ...
    revocation: &'a super::super::capability_authorization::CapabilityRevocationState,
...
fn validate_budget_account(account: &CapabilityBudgetAccount) -> Result<(), WorldError> {
