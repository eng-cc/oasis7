...
pub use auth::{
    ...
    sign_hosted_prompt_control_strong_auth_grant, sign_power_survival_quote_auth_proof,
...
pub use protocol::{
    ...
    PlaybackControl, PlayerAuthProof, PlayerAuthScheme, PowerSurvivalQuotePreflight,
    ...
    PromptControlOperation, PromptControlRollbackRequest, RefineQuotePreflight, RefineQuoteRequest,
