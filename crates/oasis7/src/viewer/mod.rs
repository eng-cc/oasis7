...
pub use auth::{
    ...
    sign_social_contact_quote_auth_proof, sign_war_declaration_quote_auth_proof,
    ...
    verify_social_contact_quote_auth_proof, verify_war_declaration_quote_auth_proof,
};
#[cfg(not(target_arch = "wasm32"))]
