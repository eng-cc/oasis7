...
pub use auth::{
    ...
    sign_declare_social_edge_quote_auth_proof, sign_fragment_refill_preview_auth_proof,
    sign_gameplay_action_auth_proof, sign_governance_vote_quote_auth_proof,
