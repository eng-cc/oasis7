...
pub use auth::{
    ...
    sign_hosted_prompt_control_strong_auth_grant, sign_product_validation_quote_auth_proof,
...
pub use protocol::{
    ...
    CollectDataRequest, ControlCompletionAck, ControlCompletionStatus, GameplayActionAck,
    GameplayActionError, GameplayActionRequest, HostedStrongAuthGrant, LiveControl,
    PlaybackControl, PlayerAuthProof, PlayerAuthScheme, ProductValidationQuotePreflight,
    ...
    RefineQuotePreflight, RefineQuoteRequest, VIEWER_PROTOCOL_VERSION, ViewerControl,
