...
pub use auth::{
    ...
    verify_refine_quote_auth_proof, verify_schedule_recipe_quote_auth_proof,
...
pub use protocol::{
    ...
    PowerSurvivalRecoveryAction, ProductValidationQuotePreflight, ProductValidationQuoteRequest,
    PromptControlAck, PromptControlApplyRequest, PromptControlCommand, PromptControlError,
    PromptControlOperation, PromptControlRollbackRequest, PublishSocialFactQuotePreflight,
    PublishSocialFactQuoteRequest, PublishSocialFactQuoteStake, RefineQuotePreflight,
    RefineQuoteRequest, ScheduleRecipeQuotePreflight, ScheduleRecipeQuoteRequest,
