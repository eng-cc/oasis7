...
#[derive(Clone)]
struct ProviderLookupFailureDht;
...
struct ProviderLookupFailureConnectedPeerTrapNetwork {
...
impl ProviderLookupFailureConnectedPeerTrapNetwork {
    ...
    fn connected_peer_provider_attempts(&self) -> usize {
        *self
...
#[derive(Clone, Default)]
struct ProviderRouteFailureGenericTrapNetwork {
...
struct MalformedProviderResponseNetwork;
