...
try {
  ...
  for (const [name, width, height] of [["desktop", 1440, 900], ["narrow", 390, 844]]) {
    ...
    summary.viewports[name] = { width, height, statePath, envPath, framePath, consolePath, fullPng, cropPng, targetCenter, safeMargin: frame.safeMargin, stats, cropStats };
  }
