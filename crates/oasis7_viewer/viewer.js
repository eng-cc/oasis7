...
function PixelWorldCanvasRenderer(props) {
  ...
  return (() => {
    ...
    insert(_el$0, () => tr$1(props.locale(), "Canvas 显示当前世界；相邻 HUD、焦点栏和命令抽屉提供当前 Agent、阻塞、回执与命令路径。", "The canvas shows the current world; adjacent HUD, focus rail, and command drawer expose the current agent, blocker, receipt, and command path."));
    ...
    createRenderEffect(() => setAttribute(_el$9, "aria-label", tr$1(props.locale(), "交互式世界 Canvas", "Interactive world canvas")));
    return _el$8;
  })();
}
            ...
            children: (owned) => createComponent(EventCard, {
              ...
              get children() {
                return [(() => {
                  var _el$12 = _tmpl$7();
                  insert(_el$12, (() => {
                    var _c$2 = memo(() => !!releaseActionAvailable());
                    return () => _c$2() ? tr(locale(), "Release 已作为正式可用动作发布；可以从可用动作列表执行。", "Release is published as a canonical available action; execute it from the available actions list.") : tr(locale(), "维护方式是保持控制权与 upkeep 健康；release 只作为状态指导，直到正式动作发布。", "Maintain by keeping control and upkeep healthy; release stays guidance-only until a canonical action is published.");
                  })());
                  return _el$12;
                })(), createComponent(Show, {
                  get when() {
...
function WorldStageHero() {
  ...
  return (() => {
    var _el$87 = _tmpl$27(), _el$88 = _el$87.firstChild, _el$89 = _el$88.firstChild, _el$90 = _el$89.firstChild, _el$91 = _el$90.firstChild, _el$92 = _el$90.nextSibling, _el$93 = _el$92.nextSibling, _el$94 = _el$88.nextSibling, _el$95 = _el$94.firstChild, _el$96 = _el$95.firstChild, _el$97 = _el$96.nextSibling, _el$98 = _el$97.nextSibling, _el$99 = _el$95.nextSibling, _el$100 = _el$99.firstChild, _el$101 = _el$100.nextSibling, _el$102 = _el$101.nextSibling, _el$103 = _el$99.nextSibling, _el$104 = _el$103.firstChild, _el$105 = _el$104.nextSibling;
    insert(_el$91, () => tr(locale(), "工业世界指挥桌", "Industrial World Command Desk"));
    insert(_el$90, createComponent(InlineHelpTip, {
      get locale() {
        return locale();
      },
    ...
    insert(_el$92, () => gameplaySummary()?.goalTitle || tr(locale(), "进入世界，先看局势，再做动作", "Read the world first, then act."));
    insert(_el$93, () => gameplaySummary()?.nextStepHint || gameplaySummary()?.objective || tr(locale(), "这张入口页优先保留世界、目标和关键动作；高级诊断与治理能力按需展开。", "This entry keeps the world, objective, and primary actions in front. Advanced diagnostics and governance stay on demand."));
    insert(_el$88, createComponent(ViewerEntryMenu, {}), null);
    ...
    insert(_el$96, () => tr(locale(), "局势", "Situation"));
    insert(_el$97, stageLabel);
    insert(_el$98, () => gameplayProgressLabel(gameplaySummary()?.progressPercent, locale()));
    insert(_el$100, () => tr(locale(), "已接受意图", "Accepted Intent"));
    insert(_el$101, acceptedIntentTitle);
    insert(_el$102, acceptedIntentDetail);
    insert(_el$104, () => tr(locale(), "下一步", "Next Step"));
    insert(_el$105, nextStepCopy);
    insert(_el$87, createComponent(Show, {
      get when() {
      ...
      get children() {
        return createComponent(CalloutCard, {
          ...
          get children() {
            var _el$106 = _tmpl$7();
            insert(_el$106, () => tr(locale(), "首屏优先展示世界与目标；只有连接异常时，才把连接状态抬到这里提示你。", "This entry keeps the world and target first, and only elevates connection status when it needs attention."));
            return _el$106;
          }
        });
      }
    }), null);
    createRenderEffect(() => className(_el$97, gameplayStageToneClass(gameplaySummary()?.stageStatus)));
    return _el$87;
  })();
}
function MobileJumpRail() {
  const locale = () => uiLocale();
  return (() => {
    var _el$108 = _tmpl$28(), _el$109 = _el$108.firstChild, _el$110 = _el$109.nextSibling, _el$111 = _el$110.nextSibling, _el$112 = _el$111.nextSibling;
    insert(_el$109, () => tr(locale(), "世界", "World"));
    insert(_el$110, () => tr(locale(), "目标", "Targets"));
    insert(_el$111, () => tr(locale(), "指挥", "Command"));
    insert(_el$112, () => tr(locale(), "诊断", "Diagnostics"));
    createRenderEffect(() => setAttribute(_el$108, "aria-label", tr(locale(), "主入口分区导航", "Primary entry section navigation")));
    return _el$108;
  })();
}
function TargetsPanel() {
  ...
  const selectedLabel = () => state.selectedKind && state.selectedId ? `${state.selectedKind}:${state.selectedId}` : null;
  return (() => {
    var _el$113 = _tmpl$29(), _el$114 = _el$113.firstChild, _el$115 = _el$114.firstChild, _el$116 = _el$115.nextSibling, _el$117 = _el$114.nextSibling, _el$118 = _el$117.firstChild, _el$119 = _el$118.nextSibling, _el$120 = _el$117.nextSibling, _el$121 = _el$120.firstChild, _el$122 = _el$121.nextSibling;
    ...
    insert(_el$113, createComponent(EmptyState, {
      get children() {
    ...
    insert(_el$115, () => tr(locale(), "筛选目标", "Filter targets"));
    _el$116.$$input = (event) => setSelectedSearch(event.currentTarget.value);
    insert(_el$118, () => tr(locale(), "行动体", "Agents"));
    insert(_el$119, createComponent(Show, {
      ...
      get children() {
        return createComponent(For, {
          ...
          children: (agent) => (() => {
            var _el$124 = _tmpl$30(), _el$125 = _el$124.firstChild, _el$126 = _el$125.nextSibling;
            _el$124.$$click = () => applySelection({
              kind: "agent",
              id: agent.id
            });
            insert(_el$125, () => agent.id);
            insert(_el$126, () => `${tr(locale(), "地点", "location")}=${agent.location_id} · ${tr(locale(), "资源", "resources")}=${renderResourceSummary(agent.resources)}`);
            createRenderEffect((_p$) => {
              var _v$13 = agent.id, _v$14 = state.selectedKind === "agent" && state.selectedId === agent.id;
              _v$13 !== _p$.e && setAttribute(_el$124, "data-select-id", _p$.e = _v$13);
              _v$14 !== _p$.t && setAttribute(_el$124, "data-selected", _p$.t = _v$14);
              return _p$;
            }, {
              e: void 0,
              t: void 0
    ...
    insert(_el$121, () => tr(locale(), "地点", "Locations"));
    insert(_el$122, createComponent(Show, {
      ...
      get children() {
        return createComponent(For, {
          ...
          children: (location) => (() => {
            var _el$127 = _tmpl$31(), _el$128 = _el$127.firstChild, _el$129 = _el$128.nextSibling;
            _el$127.$$click = () => applySelection({
              kind: "location",
              id: location.id
            });
            insert(_el$128, () => location.name || location.id);
            insert(_el$129, () => `id=${location.id} · ${tr(locale(), "半径", "radius")}=${formatPhysicalDistanceCm(location.profile?.radius_cm, locale()) || "-"} · ${tr(locale(), "资源", "resources")}=${renderResourceSummary(location.resources)}`);
            createRenderEffect((_p$) => {
              var _v$15 = location.id, _v$16 = state.selectedKind === "location" && state.selectedId === location.id;
              _v$15 !== _p$.e && setAttribute(_el$127, "data-select-id", _p$.e = _v$15);
              _v$16 !== _p$.t && setAttribute(_el$127, "data-selected", _p$.t = _v$16);
              return _p$;
            }, {
              e: void 0,
              t: void 0
    ...
    createRenderEffect(() => setAttribute(_el$116, "placeholder", tr(locale(), "搜索行动体或地点", "Search agents or locations")));
    createRenderEffect(() => _el$116.value = getSelectedSearch());
    return _el$113;
  })();
}
function WorldSummaryPanel() {
  ...
  return (() => {
    var _el$130 = _tmpl$34(), _el$134 = _el$130.firstChild, _el$135 = _el$134.firstChild, _el$136 = _el$135.firstChild, _el$137 = _el$136.firstChild, _el$138 = _el$137.nextSibling, _el$139 = _el$136.nextSibling, _el$140 = _el$135.nextSibling, _el$141 = _el$140.firstChild, _el$142 = _el$141.nextSibling, _el$143 = _el$142.nextSibling, _el$151 = _el$143.nextSibling, _el$152 = _el$151.nextSibling, _el$153 = _el$152.firstChild, _el$154 = _el$153.nextSibling;
    insert(_el$130, createComponent(PanelSection, {
      get title() {
        ...
        return createComponent(Show, {
          ...
          children: (gameplay) => [(() => {
            ...
            get children() {
              return [(() => {
                var _el$156 = _tmpl$7();
                insert(_el$156, () => gameplay().acceptedIntentSummary);
                return _el$156;
              })(), (() => {
                var _el$157 = _tmpl$4();
                insert(_el$157, () => gameplay().acceptedIntentDetail);
                return _el$157;
              })(), createComponent(Show, {
                get when() {
                ...
                get children() {
                  return [(() => {
                    ...
                    var _el$159 = _tmpl$4();
                    insert(_el$159, () => gameplay().resumeAnchor);
                    return _el$159;
                  })()];
                }
              })];
            ...
            get children() {
              return [(() => {
                ...
                var _el$161 = _tmpl$7();
                insert(_el$161, () => gameplay().executionSummary || tr(locale(), "等待目标执行状态更新。", "Waiting for goal execution state updates."));
                return _el$161;
              })(), createComponent(Show, {
                get when() {
                ...
                get children() {
                  var _el$163 = _tmpl$4();
                  insert(_el$163, () => gameplay().executionCauseDetail);
                  return _el$163;
                }
              })];
            }
            ...
            get children() {
              return [createComponent(Show, {
                ...
                get children() {
                  var _el$164 = _tmpl$4();
                  insert(_el$164, () => gameplay().progressDetail);
                  return _el$164;
                }
              }), createComponent(Show, {
                get when() {
                ...
                get children() {
                  return [(() => {
                    ...
                    var _el$166 = _tmpl$4();
                    insert(_el$166, () => gameplay().narrativeBlockerDetail || tr(locale(), "当前玩法被阻塞，需要显式恢复。", "Gameplay is blocked and needs explicit recovery."));
                    return _el$166;
                  })()];
                }
              }), createComponent(Show, {
                ...
                get children() {
                  var _el$167 = _tmpl$4();
                  insert(_el$167, () => gameplay().blockerSupplementalDetail);
                  return _el$167;
                }
              }), (() => {
                ...
                var _el$169 = _tmpl$7();
                insert(_el$169, () => gameplay().narrativeNextStep || tr(locale(), "等待下一次运行时指引更新。", "Wait for the next runtime guidance update."));
                return _el$169;
              })(), createComponent(Show, {
                get when() {
                ...
                get children() {
                  var _el$170 = _tmpl$4();
                  insert(_el$170, () => gameplay().branchHint);
                  return _el$170;
                }
              }), createComponent(Show, {
                get when() {
            ...
            get children() {
              var _el$172 = _tmpl$8();
              insert(_el$172, createComponent(MetricCard, {
                get label() {
            ...
            children: (feedback) => createComponent(EventCard, {
              ...
              get children() {
                return [(() => {
                  var _el$178 = _tmpl$7();
                  insert(_el$178, () => feedback().effect || feedback().reason || tr(locale(), "最新回执已更新，但还没有新的世界级后果。", "The latest feedback is in, but there is no new world-level consequence yet."));
                  return _el$178;
                })(), createComponent(Show, {
                  get when() {
                  ...
                  get children() {
                    var _el$179 = _tmpl$4();
                    insert(_el$179, () => feedback().reason);
                    return _el$179;
                  }
                }), createComponent(Show, {
                  get when() {
            ...
            children: (action) => createComponent(CalloutCard, {
              ...
              get children() {
                return [(() => {
                  var _el$181 = _tmpl$7();
                  insert(_el$181, () => action().label || action().actionId || tr(locale(), "当前存在一条更合适的推进动作。", "One action is currently the best next move."));
                  return _el$181;
                })(), (() => {
                  var _el$182 = _tmpl$4();
                  insert(_el$182, () => gameplayActionDetail(action(), gameplay(), locale()));
                  return _el$182;
                })(), (() => {
                  var _el$183 = _tmpl$37(), _el$184 = _el$183.firstChild;
                  _el$184.$$click = () => renderGameplayAction(action());
                  insert(_el$184, () => gameplayActionButtonLabel(action(), locale()));
                  createRenderEffect(() => _el$184.disabled = Boolean(action().disabledReason));
                  return _el$183;
                })()];
              }
            })
            ...
            insert(_el$174, () => tr(locale(), "可用玩法动作", "Available Gameplay Actions"));
                ...
                return createComponent(For, {
                  ...
                  children: (action) => createComponent(EventCard, {
                    ...
                    get children() {
                      return [(() => {
                        var _el$185 = _tmpl$4();
                        insert(_el$185, () => gameplayActionDetail(action, gameplay(), locale()));
                        return _el$185;
                      })(), createComponent(Show, {
                        get when() {
                        ...
                        get children() {
                          var _el$186 = _tmpl$37(), _el$187 = _el$186.firstChild;
                          _el$187.$$click = () => renderGameplayAction(action);
                          insert(_el$187, () => gameplayActionButtonLabel(action, locale()));
                          createRenderEffect(() => _el$187.disabled = Boolean(action.disabledReason));
                          return _el$186;
                        }
                      }), createComponent(Show, {
                        get when() {
                        ...
                        get children() {
                          var _el$188 = _tmpl$37(), _el$189 = _el$188.firstChild;
                          _el$189.$$click = () => renderGameplayAction(action);
                          insert(_el$189, () => gameplayActionButtonLabel(action, locale()));
                          createRenderEffect(() => _el$189.disabled = Boolean(action.disabledReason));
                          return _el$188;
                        }
                      })];
                    }
            ...
            get children() {
              return [(() => {
                var _el$176 = _tmpl$7();
                insert(_el$176, () => gameplay().assetGovernanceHandoff);
                return _el$176;
              })(), (() => {
                var _el$177 = _tmpl$4();
                insert(_el$177, () => tr(locale(), "资产 / 治理相关能力请走单独 lane；这张主入口页面只保留正式玩法所需的最小动作面。", "Asset and governance actions stay on their dedicated lane; this primary entry only keeps the minimum surface needed for formal gameplay."));
                return _el$177;
              })()];
            }
          })]
        ...
        return createComponent(PanelSection, {
          ...
          get children() {
            return [(() => {
              ...
              get children() {
                var _el$132 = _tmpl$32(), _el$133 = _el$132.firstChild;
                _el$133.$$click = () => {
                  void logoutHostedPlayerSession();
                };
                insert(_el$133, () => tr(locale(), "释放玩家会话", "Release Player Session"));
                return _el$132;
              }
            })];
          }
    ...
    insert(_el$137, () => tr(locale(), "运行诊断", "Runtime Diagnostics"));
    insert(_el$138, () => tr(locale(), "执行通道、认证/会话、托管矩阵与最近事件都收在这里，避免它们继续抢占主玩法首屏。", "Execution lanes, auth/session truth, hosted matrix, and recent events live here so they no longer dominate the primary gameplay viewport."));
    ...
    insert(_el$143, createComponent(Show, {
      ...
      get children() {
        var _el$144 = _tmpl$33();
        _el$144.$$click = () => {
          void logoutHostedPlayerSession();
        };
        insert(_el$144, () => tr(locale(), "释放玩家会话", "Release Player Session"));
        return _el$144;
      }
    }));
    ...
    insert(_el$151, createComponent(MetricCard, {
      get label() {
    ...
    insert(_el$153, () => tr(locale(), "最近事件", "Recent Events"));
...
function InteractionPanel() {
  ...
  return (() => {
    var _el$195 = _tmpl$48(), _el$196 = _el$195.firstChild, _el$198 = _el$196.nextSibling;
    insert(_el$196, createComponent(Badge, {
      "class": "badge badge--accent",
      get children() {
    ...
    insert(_el$195, createComponent(EmptyState, {
      get children() {
        return assetLaneDetail();
      }
    }), null);
    insert(_el$195, createComponent(PanelSection, {
      get title() {
      ...
      get children() {
        return [(() => {
          var _el$199 = _tmpl$38(), _el$200 = _el$199.firstChild, _el$201 = _el$200.nextSibling;
          insert(_el$200, () => tr(locale(), "消息", "Message"));
          _el$201.$$input = (event) => {
            state.chatDraft.message = String(event.currentTarget.value || "");
            state.chatDraft.dirty = true;
          };
          createRenderEffect((_p$) => {
            ...
            _v$17 !== _p$.e && setAttribute(_el$201, "placeholder", _p$.e = _v$17);
            _v$18 !== _p$.t && (_el$201.disabled = _p$.t = _v$18);
            return _p$;
          }, {
            e: void 0,
            t: void 0
          });
          createRenderEffect(() => _el$201.value = state.chatDraft.message);
          return _el$199;
        })(), (() => {
          var _el$202 = _tmpl$39(), _el$203 = _el$202.firstChild;
          _el$203.$$click = () => sendAgentChat(agentId(), state.chatDraft.message);
          insert(_el$203, () => tr(locale(), "发送聊天", "Send Chat"));
          createRenderEffect(() => _el$203.disabled = !chatCapability().enabled);
          return _el$202;
        })(), createComponent(Show, {
          get when() {
            return chatFeedback();
          ...
          var _el$204 = _tmpl$9(), _el$205 = _el$204.firstChild, _el$206 = _el$205.nextSibling;
          insert(_el$205, () => tr(locale(), "消息流", "Message Flow"));
              ...
              return createComponent(For, {
                ...
                children: (entry) => createComponent(EventCard, {
                  ...
                  get children() {
                    return [(() => {
                      var _el$235 = _tmpl$7();
                      insert(_el$235, () => chatEntryMessage(entry, locale()));
                      return _el$235;
    ...
    insert(_el$195, createComponent(PanelSection, {
      ...
      get children() {
        return [(() => {
          ...
          var _el$208 = _tmpl$40(), _el$209 = _el$208.firstChild;
          _el$209.$$click = () => togglePromptOverridesVisible();
          insert(_el$209, promptSettingsButtonLabel);
          return _el$208;
        })()];
      }
    }), null);
      ...
      get children() {
        return createComponent(PanelSection, {
          ...
          get children() {
            return [(() => {
              var _el$210 = _tmpl$4();
              insert(_el$210, () => promptVersionState().summary);
              return _el$210;
            })(), (() => {
              var _el$211 = _tmpl$4();
              insert(_el$211, () => promptVersionState().detail);
              return _el$211;
            })(), createComponent(Show, {
              get when() {
              ...
              get children() {
                var _el$212 = _tmpl$41(), _el$213 = _el$212.firstChild, _el$214 = _el$213.nextSibling;
                insert(_el$213, () => tr(locale(), "后端审批码", "Backend Approval Code"));
                _el$214.$$input = (event) => {
                  state.strongAuth.approvalCode = String(event.currentTarget.value || "");
                };
                createRenderEffect(() => _el$214.value = state.strongAuth.approvalCode || "");
                return _el$212;
              }
            }), (() => {
              var _el$215 = _tmpl$42(), _el$216 = _el$215.firstChild, _el$217 = _el$216.nextSibling;
              insert(_el$216, () => tr(locale(), "系统提示词覆盖", "System Prompt Override"));
              _el$217.$$input = (event) => {
                state.promptDraft.systemPrompt = String(event.currentTarget.value || "");
                state.promptDraft.dirty = true;
              };
              createRenderEffect(() => _el$217.disabled = !promptCapability().enabled);
              createRenderEffect(() => _el$217.value = state.promptDraft.systemPrompt);
              return _el$215;
            })(), (() => {
              var _el$218 = _tmpl$43(), _el$219 = _el$218.firstChild, _el$220 = _el$219.nextSibling;
              insert(_el$219, () => tr(locale(), "短期目标覆盖", "Short-Term Goal Override"));
              _el$220.$$input = (event) => {
                state.promptDraft.shortTermGoal = String(event.currentTarget.value || "");
                state.promptDraft.dirty = true;
              };
              createRenderEffect(() => _el$220.disabled = !promptCapability().enabled);
              createRenderEffect(() => _el$220.value = state.promptDraft.shortTermGoal);
              return _el$218;
            })(), (() => {
              var _el$221 = _tmpl$44(), _el$222 = _el$221.firstChild, _el$223 = _el$222.nextSibling;
              insert(_el$222, () => tr(locale(), "长期目标覆盖", "Long-Term Goal Override"));
              _el$223.$$input = (event) => {
                state.promptDraft.longTermGoal = String(event.currentTarget.value || "");
                state.promptDraft.dirty = true;
              };
              createRenderEffect(() => _el$223.disabled = !promptCapability().enabled);
              createRenderEffect(() => _el$223.value = state.promptDraft.longTermGoal);
              return _el$221;
            })(), (() => {
              var _el$224 = _tmpl$45(), _el$225 = _el$224.firstChild, _el$226 = _el$225.nextSibling;
              _el$225.$$click = () => sendPromptControl("preview", null);
              insert(_el$225, () => tr(locale(), "预览提示词", "Preview Prompt"));
              _el$226.$$click = () => sendPromptControl("apply", null);
              insert(_el$226, () => tr(locale(), "应用提示词", "Apply Prompt"));
              createRenderEffect((_p$) => {
                var _v$19 = !promptCapability().enabled, _v$20 = !promptCapability().enabled;
                _v$19 !== _p$.e && (_el$225.disabled = _p$.e = _v$19);
                _v$20 !== _p$.t && (_el$226.disabled = _p$.t = _v$20);
                return _p$;
              }, {
                e: void 0,
                t: void 0
              ...
              var _el$227 = _tmpl$46(), _el$228 = _el$227.firstChild, _el$229 = _el$228.firstChild, _el$230 = _el$229.nextSibling, _el$231 = _el$228.nextSibling;
              insert(_el$229, () => tr(locale(), "下一次回滚目标版本", "Next Rollback Target Version"));
              _el$230.$$input = (event) => {
              ...
              insert(_el$231, () => tr(locale(), "回滚提示词", "Rollback Prompt"));
              createRenderEffect((_p$) => {
                var _v$21 = !promptCapability().enabled, _v$22 = !promptCapability().enabled;
                _v$21 !== _p$.e && (_el$230.disabled = _p$.e = _v$21);
                _v$22 !== _p$.t && (_el$231.disabled = _p$.t = _v$22);
                return _p$;
              }, {
                e: void 0,
                t: void 0
              });
              createRenderEffect(() => _el$230.value = Number(state.promptDraft.rollbackTargetVersion || 0));
              return _el$227;
            })(), createComponent(Show, {
              get when() {
    ...
    insert(_el$195, createComponent(PanelSection, {
      ...
      get children() {
        return [(() => {
          ...
          var _el$233 = _tmpl$47(), _el$234 = _el$233.firstChild;
          insert(_el$234, () => tr(locale(), "主代币转账（这里暂未开放）", "Main Token Transfer (Not Exposed Here Yet)"));
          return _el$233;
        })()];
      }
    }), null);
...
function DetailsPanel() {
  ...
  return (() => {
    var _el$236 = _tmpl$50(), _el$237 = _el$236.firstChild, _el$238 = _el$237.nextSibling, _el$239 = _el$238.firstChild, _el$240 = _el$239.nextSibling, _el$241 = _el$240.nextSibling;
    ...
    insert(_el$236, createComponent(InteractionPanel, {}), _el$238);
    ...
    insert(_el$239, () => tr(locale(), "世界规模", "World Scale"));
    ...
    insert(_el$241, worldMetaSummary);
    ...
    insert(_el$236, createComponent(Show, {
      ...
      get children() {
        var _el$242 = _tmpl$49(), _el$243 = _el$242.firstChild, _el$244 = _el$243.nextSibling;
        insert(_el$243, () => tr(locale(), "最近错误", "Last Error"));
        insert(_el$244, () => state.lastError);
        return _el$242;
      }
    }), null);
    return _el$236;
...
function AppShell() {
  ...
  return [createComponent(MobileJumpRail, {}), createComponent(HostedLoginGate, {}), (() => {
    var _el$245 = _tmpl$51(), _el$246 = _el$245.firstChild, _el$247 = _el$246.firstChild, _el$248 = _el$247.nextSibling, _el$249 = _el$248.nextSibling, _el$250 = _el$246.nextSibling;
    insert(_el$247, () => tr(locale(), "导航", "Navigate"));
    insert(_el$248, () => tr(locale(), "目标", "Targets"));
    insert(_el$249, () => tr(locale(), "先锁定对象，再进入世界舞台或右侧指挥面板。", "Lock onto a target first, then move into the stage or command surface."));
    insert(_el$250, createComponent(TargetsPanel, {}));
    return _el$245;
  })(), (() => {
    var _el$251 = _tmpl$52(), _el$252 = _el$251.firstChild, _el$253 = _el$252.firstChild;
    insert(_el$253, createComponent(WorldStageHero, {}), null);
    insert(_el$253, createComponent(PixelWorldHost, {
      get locale() {
        return locale();
      }
    }), null);
    insert(_el$253, createComponent(WorldSummaryPanel, {}), null);
    return _el$251;
  })(), (() => {
    var _el$254 = _tmpl$53(), _el$255 = _el$254.firstChild, _el$256 = _el$255.firstChild, _el$257 = _el$256.nextSibling, _el$258 = _el$257.nextSibling, _el$259 = _el$255.nextSibling;
    insert(_el$256, () => tr(locale(), "指挥与核查", "Command and Inspect"));
    insert(_el$257, () => tr(locale(), "交互与明细", "Interact and Inspect"));
    insert(_el$258, () => tr(locale(), "只有锁定目标后才进入这里。聊天优先，提示词与对象核查继续后置。", "Enter this column only after locking a target. Chat comes first; prompt controls and raw inspection stay behind it."));
    insert(_el$259, createComponent(DetailsPanel, {}));
    return _el$254;
  })()];
}
