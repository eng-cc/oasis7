...
function PixelWorldHost(props) {
  ...
  return (() => {
    var _el$149 = _tmpl$40$1(), _el$195 = _el$149.firstChild, _el$196 = _el$195.firstChild;
    ...
    insert(_el$149, createComponent(Show, {
      ...
      get children() {
        var _el$155 = _tmpl$34$1(), _el$156 = _el$155.firstChild, _el$157 = _el$156.firstChild, _el$158 = _el$156.nextSibling, _el$159 = _el$158.firstChild;
        insert(_el$157, () => tr$1(locale(), "Renderer 未接管", "Renderer Not Attached"));
        insert(_el$159, () => tr$1(locale(), "嵌入式 renderer 未接管；页面先使用 host fallback，正式玩法摘要、目标和明细主链继续可用。", "The embedded renderer is not attached; the page is using host fallback first. Formal gameplay summary, targets, and details remain available."));
        insert(_el$158, createComponent(Show, {
          get when() {
            return rendererFatal();
          },
          get children() {
            var _el$160 = _tmpl$29$1();
            insert(_el$160, () => `${rendererFatal().code}: ${rendererFatal().message}`);
            return _el$160;
          }
        }), null);
        return _el$155;
    ...
    insert(_el$149, createComponent(Show, {
      ...
      get children() {
        var _el$161 = _tmpl$35$1();
        insert(_el$161, createComponent(PixelWorldActionReceipt, {
    ...
    insert(_el$149, createComponent(Show, {
      ...
      get children() {
        var _el$162 = _tmpl$36$1(), _el$163 = _el$162.firstChild, _el$164 = _el$163.nextSibling;
        _el$162.addEventListener("toggle", (event) => setPersistentCommandDrawerOpen(event.currentTarget.open));
        insert(_el$163, () => tr$1(locale(), "命令与目标", "Command and Target"));
        insert(_el$164, createComponent(PixelWorldFocusCommandSurface, {
          locale
        }));
        createRenderEffect(() => _el$162.open = commandDrawerOpen());
        return _el$162;
      }
    }), _el$195);
    insert(_el$149, createComponent(Show, {
      ...
      get children() {
        var _el$165 = _tmpl$37$1(), _el$166 = _el$165.firstChild, _el$167 = _el$166.nextSibling, _el$168 = _el$167.firstChild, _el$169 = _el$168.nextSibling, _el$170 = _el$169.nextSibling, _el$171 = _el$170.nextSibling, _el$172 = _el$171.nextSibling, _el$173 = _el$172.nextSibling, _el$174 = _el$173.nextSibling, _el$175 = _el$174.nextSibling, _el$176 = _el$175.nextSibling, _el$180 = _el$176.nextSibling, _el$181 = _el$180.nextSibling, _el$182 = _el$181.nextSibling, _el$183 = _el$182.nextSibling;
        insert(_el$166, () => tr$1(locale(), "Renderer 诊断", "Renderer Diagnostics"));
        insert(_el$168, () => `locations=${visualState().locations.length}`);
        insert(_el$169, () => `fragments=${visualState().fragmentTerrain.length}`);
        insert(_el$170, () => `agents=${visualState().agents.length}`);
        insert(_el$171, () => `links=${visualState().links.length}`);
        insert(_el$172, () => `hotspots=${arrayField(renderState(), "visual_hotspots", "visualHotspots").length}`);
        insert(_el$173, () => `derived_positions=${visualState().agents.filter((agent) => agent.position_source === "location_derived").length}`);
        insert(_el$174, () => visualState().worldBounds ? "world_bounds=ready" : "world_bounds=missing");
        insert(_el$175, () => `renderer=${rendererStatus()}`);
        insert(_el$176, () => `runtime=${runtimeSource()}`);
        insert(_el$167, createComponent(Show, {
          ...
          get children() {
            ...
            insert(_el$177, () => `zoom=${cameraState().zoom.toFixed(2)}`);
            return _el$177;
          }
        }), _el$180);
        insert(_el$167, createComponent(Show, {
          ...
          get children() {
            ...
            insert(_el$178, () => `pan=${cameraState().pan_x_px},${cameraState().pan_y_px}`);
            return _el$178;
          }
        }), _el$180);
        insert(_el$167, createComponent(Show, {
          ...
          get children() {
            var _el$179 = _tmpl$24$1();
            insert(_el$179, () => `hover=${hoverSelection().kind}/${hoverSelection().id}`);
            return _el$179;
          }
        }), _el$180);
        _el$180.$$click = requestReadyMode;
        insert(_el$180, () => tr$1(locale(), "重新挂载嵌入式 Renderer", "Reattach Embedded Renderer"));
        _el$181.$$click = simulateFatal;
        insert(_el$181, () => tr$1(locale(), "模拟 Renderer Fatal", "Simulate Renderer Fatal"));
        _el$182.$$click = setFallbackMode;
        insert(_el$182, () => tr$1(locale(), "切回 Host Fallback", "Back To Host Fallback"));
        insert(_el$183, () => tr$1(locale(), "当前世界舞台优先依赖 wasm bridge、嵌入式 canvas、轻量拖拽缩放和事件回传。若 wasm bridge 缺失或启动失败，页面会显式退回 host fallback，而不是继续保留一套 JS renderer。", "The world stage now depends on the wasm bridge, embedded canvas, light pan-zoom interaction, and event callbacks. If the wasm bridge is missing or fails to boot, the page falls back explicitly instead of keeping a second JS renderer."));
        return _el$165;
      }
    }), _el$195);
    insert(_el$149, createComponent(Show, {
      ...
      get children() {
        var _el$184 = _tmpl$38$1(), _el$185 = _el$184.firstChild, _el$186 = _el$185.nextSibling, _el$187 = _el$186.firstChild, _el$188 = _el$187.firstChild, _el$189 = _el$188.nextSibling, _el$190 = _el$189.nextSibling, _el$192 = _el$187.nextSibling, _el$193 = _el$192.firstChild, _el$194 = _el$193.nextSibling;
        _el$184.addEventListener("toggle", (event) => setPersistentDiagnosticsDrawerOpen(event.currentTarget.open));
        insert(_el$185, () => tr$1(locale(), "沉浸诊断", "Focus Diagnostics"));
        insert(_el$188, () => `renderer=${rendererStatus()}`);
        insert(_el$189, () => `runtime=${runtimeSource()}`);
        insert(_el$190, () => `derived_positions=${renderState().agents.filter((agent) => agent.position_source === "location_derived").length}`);
        insert(_el$187, createComponent(Show, {
          get when() {
            return rendererFatal();
          },
          get children() {
            var _el$191 = _tmpl$13$1();
            insert(_el$191, () => rendererFatal().code);
            return _el$191;
          }
        }), null);
        _el$193.$$click = requestReadyMode;
        insert(_el$193, () => tr$1(locale(), "重新挂载嵌入式 Renderer", "Reattach Embedded Renderer"));
        _el$194.$$click = setFallbackMode;
        insert(_el$194, () => tr$1(locale(), "切回 Host Fallback", "Back To Host Fallback"));
        createRenderEffect(() => _el$184.open = diagnosticsDrawerOpen());
        return _el$184;
      }
    }), _el$195);
    _el$195.addEventListener("toggle", (event) => setRenderDtoOpen(event.currentTarget.open));
    insert(_el$196, () => tr$1(locale(), "展开 Render DTO", "Expand Render DTO"));
    insert(_el$195, createComponent(Show, {
      get when() {
        return renderDtoOpen();
      },
      get children() {
        var _el$197 = _tmpl$39$1(), _el$198 = _el$197.firstChild;
        insert(_el$198, () => JSON.stringify(renderState(), null, 2));
        return _el$197;
      }
    }), null);
    createRenderEffect((_p$) => {
...
function InlineHelpTip(props) {
  ...
  return (() => {
    ...
    createRenderEffect((_p$) => {
      var _v$ = isOpen() ? "true" : "false", _v$2 = props.label ?? tr(locale(), "打开比例说明", "Open scale guidance"), _v$3 = props.id, _v$4 = isOpen() ? "true" : "false", _v$5 = props.id, _v$6 = props.id, _v$7 = isOpen() ? "false" : "true";
      _v$ !== _p$.e && setAttribute(_el$19, "data-open", _p$.e = _v$);
      _v$2 !== _p$.t && setAttribute(_el$20, "aria-label", _p$.t = _v$2);
      _v$3 !== _p$.a && setAttribute(_el$20, "aria-describedby", _p$.a = _v$3);
      _v$4 !== _p$.o && setAttribute(_el$20, "aria-expanded", _p$.o = _v$4);
      _v$5 !== _p$.i && setAttribute(_el$20, "aria-controls", _p$.i = _v$5);
      _v$6 !== _p$.n && setAttribute(_el$21, "id", _p$.n = _v$6);
      _v$7 !== _p$.s && setAttribute(_el$21, "aria-hidden", _p$.s = _v$7);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
function HostedLoginForm(props) {
  ...
  return (() => {
    ...
    insert(_el$50, createComponent(Show, {
      ...
      get children() {
        return [(() => {
          ...
          createRenderEffect((_p$) => {
            var _v$8 = props.codeId ?? "hosted-login-code", _v$9 = props.codeId ?? "hosted-login-code";
            _v$8 !== _p$.e && setAttribute(_el$59, "for", _p$.e = _v$8);
            _v$9 !== _p$.t && setAttribute(_el$60, "id", _p$.t = _v$9);
            return _p$;
          }, {
            e: void 0,
            t: void 0
    ...
    createRenderEffect((_p$) => {
      var _v$0 = props.handleId ?? "hosted-login-handle", _v$1 = props.handleId ?? "hosted-login-handle", _v$10 = state.hostedLogin.startInFlight;
      _v$0 !== _p$.e && setAttribute(_el$53, "for", _p$.e = _v$0);
      _v$1 !== _p$.t && setAttribute(_el$54, "id", _p$.t = _v$1);
      _v$10 !== _p$.a && (_el$56.disabled = _p$.a = _v$10);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
function ViewerEntryMenu() {
  ...
  return (() => {
    ...
    createRenderEffect((_p$) => {
      var _v$11 = locale() === "zh", _v$12 = locale() === "en";
      _v$11 !== _p$.e && (_el$83.disabled = _p$.e = _v$11);
      _v$12 !== _p$.t && (_el$84.disabled = _p$.t = _v$12);
      return _p$;
    }, {
      e: void 0,
      t: void 0
    ...
    insert(_el$97, createComponent(Show, {
      ...
      get children() {
        return createComponent(CalloutCard, {
          ...
          get children() {
            var _el$116 = _tmpl$7();
            insert(_el$116, () => tr(locale(), "首屏优先展示世界与目标；只有连接异常时，才把连接状态抬到这里提示你。", "This entry keeps the world and target first, and only elevates connection status when it needs attention."));
            return _el$116;
          }
        });
      }
    }), null);
    createRenderEffect(() => className(_el$107, gameplayStageToneClass(gameplaySummary()?.stageStatus)));
    return _el$97;
  })();
}
function MobileJumpRail() {
  const locale = () => uiLocale();
  return (() => {
    var _el$118 = _tmpl$31(), _el$119 = _el$118.firstChild, _el$120 = _el$119.nextSibling, _el$121 = _el$120.nextSibling, _el$122 = _el$121.nextSibling;
    insert(_el$119, () => tr(locale(), "世界", "World"));
    insert(_el$120, () => tr(locale(), "目标", "Targets"));
    insert(_el$121, () => tr(locale(), "指挥", "Command"));
    insert(_el$122, () => tr(locale(), "诊断", "Diagnostics"));
    createRenderEffect(() => setAttribute(_el$118, "aria-label", tr(locale(), "主入口分区导航", "Primary entry section navigation")));
    return _el$118;
  })();
}
function TargetsPanel() {
  ...
  const selectedLabel = () => state.selectedKind && state.selectedId ? `${state.selectedKind}:${state.selectedId}` : null;
  return (() => {
    var _el$123 = _tmpl$32(), _el$124 = _el$123.firstChild, _el$125 = _el$124.firstChild, _el$126 = _el$125.nextSibling, _el$127 = _el$124.nextSibling, _el$128 = _el$127.firstChild, _el$129 = _el$128.nextSibling, _el$130 = _el$127.nextSibling, _el$131 = _el$130.firstChild, _el$132 = _el$131.nextSibling;
    ...
    insert(_el$123, createComponent(EmptyState, {
      get children() {
    ...
    insert(_el$125, () => tr(locale(), "筛选目标", "Filter targets"));
    _el$126.$$input = (event) => setSelectedSearch(event.currentTarget.value);
    insert(_el$128, () => tr(locale(), "行动体", "Agents"));
    insert(_el$129, createComponent(Show, {
      get when() {
      ...
      get children() {
        return createComponent(For, {
          ...
          children: (agent) => (() => {
            var _el$134 = _tmpl$33(), _el$135 = _el$134.firstChild, _el$136 = _el$135.nextSibling;
            _el$134.$$click = () => applySelection({
              kind: "agent",
              id: agent.id
            });
            insert(_el$135, () => agent.id);
            insert(_el$136, () => `${tr(locale(), "地点", "location")}=${agent.location_id} · ${tr(locale(), "资源", "resources")}=${renderResourceSummary(agent.resources)}`);
            createRenderEffect((_p$) => {
              var _v$13 = agent.id, _v$14 = state.selectedKind === "agent" && state.selectedId === agent.id;
              _v$13 !== _p$.e && setAttribute(_el$134, "data-select-id", _p$.e = _v$13);
              _v$14 !== _p$.t && setAttribute(_el$134, "data-selected", _p$.t = _v$14);
              return _p$;
            }, {
              e: void 0,
              t: void 0
    ...
    insert(_el$131, () => tr(locale(), "地点", "Locations"));
    insert(_el$132, createComponent(Show, {
      get when() {
      ...
      get children() {
        return createComponent(For, {
          ...
          children: (location) => (() => {
            var _el$137 = _tmpl$34(), _el$138 = _el$137.firstChild, _el$139 = _el$138.nextSibling;
            _el$137.$$click = () => applySelection({
              kind: "location",
              id: location.id
            });
            insert(_el$138, () => location.name || location.id);
            insert(_el$139, () => `id=${location.id} · ${tr(locale(), "半径", "radius")}=${formatPhysicalDistanceCm(location.profile?.radius_cm, locale()) || "-"} · ${tr(locale(), "资源", "resources")}=${renderResourceSummary(location.resources)}`);
            createRenderEffect((_p$) => {
              var _v$15 = location.id, _v$16 = state.selectedKind === "location" && state.selectedId === location.id;
              _v$15 !== _p$.e && setAttribute(_el$137, "data-select-id", _p$.e = _v$15);
              _v$16 !== _p$.t && setAttribute(_el$137, "data-selected", _p$.t = _v$16);
              return _p$;
            }, {
              e: void 0,
              t: void 0
    ...
    createRenderEffect(() => setAttribute(_el$126, "placeholder", tr(locale(), "搜索行动体或地点", "Search agents or locations")));
    createRenderEffect(() => _el$126.value = getSelectedSearch());
    return _el$123;
  })();
}
function WorldSummaryPanel() {
  ...
  return (() => {
    var _el$140 = _tmpl$37(), _el$144 = _el$140.firstChild, _el$145 = _el$144.firstChild, _el$146 = _el$145.firstChild, _el$147 = _el$146.firstChild, _el$148 = _el$147.nextSibling, _el$149 = _el$146.nextSibling, _el$150 = _el$145.nextSibling, _el$151 = _el$150.firstChild, _el$152 = _el$151.nextSibling, _el$153 = _el$152.nextSibling, _el$161 = _el$153.nextSibling, _el$162 = _el$161.nextSibling, _el$163 = _el$162.firstChild, _el$164 = _el$163.nextSibling;
    insert(_el$140, createComponent(PanelSection, {
      get title() {
        ...
        return createComponent(Show, {
          ...
          children: (gameplay) => [(() => {
            ...
            get children() {
              return [(() => {
                var _el$166 = _tmpl$7();
                insert(_el$166, () => gameplay().acceptedIntentSummary);
                return _el$166;
              })(), (() => {
                var _el$167 = _tmpl$4();
                insert(_el$167, () => gameplay().acceptedIntentDetail);
                return _el$167;
              })(), createComponent(Show, {
                get when() {
                ...
                get children() {
                  return [(() => {
                    ...
                    var _el$169 = _tmpl$4();
                    insert(_el$169, () => gameplay().resumeAnchor);
                    return _el$169;
                  })()];
                }
              })];
            ...
            get children() {
              return [(() => {
                ...
                var _el$171 = _tmpl$7();
                insert(_el$171, () => gameplay().executionSummary || tr(locale(), "等待目标执行状态更新。", "Waiting for goal execution state updates."));
                return _el$171;
              })(), createComponent(Show, {
                get when() {
                ...
                get children() {
                  var _el$173 = _tmpl$4();
                  insert(_el$173, () => gameplay().executionCauseDetail);
                  return _el$173;
                }
              })];
            }
            ...
            get children() {
              return [createComponent(Show, {
                ...
                get children() {
                  var _el$174 = _tmpl$4();
                  insert(_el$174, () => gameplay().progressDetail);
                  return _el$174;
                }
              }), createComponent(Show, {
                get when() {
                ...
                get children() {
                  return [(() => {
                    ...
                    var _el$176 = _tmpl$4();
                    insert(_el$176, () => gameplay().narrativeBlockerDetail || tr(locale(), "当前玩法被阻塞，需要显式恢复。", "Gameplay is blocked and needs explicit recovery."));
                    return _el$176;
                  })()];
                }
              }), createComponent(Show, {
                ...
                get children() {
                  var _el$177 = _tmpl$4();
                  insert(_el$177, () => gameplay().blockerSupplementalDetail);
                  return _el$177;
                }
              }), (() => {
                ...
                var _el$179 = _tmpl$7();
                insert(_el$179, () => gameplay().narrativeNextStep || tr(locale(), "等待下一次运行时指引更新。", "Wait for the next runtime guidance update."));
                return _el$179;
              })(), createComponent(Show, {
                get when() {
                ...
                get children() {
                  var _el$180 = _tmpl$4();
                  insert(_el$180, () => gameplay().branchHint);
                  return _el$180;
                }
              }), createComponent(Show, {
                get when() {
            ...
            get children() {
              var _el$182 = _tmpl$8();
              insert(_el$182, createComponent(MetricCard, {
                get label() {
            ...
            children: (feedback) => createComponent(EventCard, {
              ...
              get children() {
                return [(() => {
                  var _el$188 = _tmpl$7();
                  insert(_el$188, () => feedback().effect || feedback().reason || tr(locale(), "最新回执已更新，但还没有新的世界级后果。", "The latest feedback is in, but there is no new world-level consequence yet."));
                  return _el$188;
                })(), createComponent(Show, {
                  get when() {
                  ...
                  get children() {
                    var _el$189 = _tmpl$4();
                    insert(_el$189, () => feedback().reason);
                    return _el$189;
                  }
                }), createComponent(Show, {
                  get when() {
            ...
            children: (action) => createComponent(CalloutCard, {
              ...
              get children() {
                return [(() => {
                  var _el$191 = _tmpl$7();
                  insert(_el$191, () => action().label || action().actionId || tr(locale(), "当前存在一条更合适的推进动作。", "One action is currently the best next move."));
                  return _el$191;
                })(), (() => {
                  var _el$192 = _tmpl$4();
                  insert(_el$192, () => gameplayActionDetail(action(), gameplay(), locale()));
                  return _el$192;
                })(), (() => {
                  var _el$193 = _tmpl$28(), _el$194 = _el$193.firstChild;
                  _el$194.$$click = () => renderGameplayAction(action());
                  insert(_el$194, () => gameplayActionButtonLabel(action(), locale()));
                  createRenderEffect(() => _el$194.disabled = Boolean(action().disabledReason));
                  return _el$193;
                })()];
              }
            })
            ...
            var _el$183 = _tmpl$39(), _el$184 = _el$183.firstChild, _el$185 = _el$184.nextSibling;
            insert(_el$184, () => tr(locale(), "可用玩法动作", "Available Gameplay Actions"));
                    ...
                    get children() {
                      return [(() => {
                        ...
                        get children() {
                          ...
                          createRenderEffect(() => _el$199.disabled = Boolean(action.disabledReason));
                          return _el$198;
                        }
                      })];
                    }
            ...
            get children() {
              return [(() => {
                var _el$186 = _tmpl$7();
                insert(_el$186, () => gameplay().assetGovernanceHandoff);
                return _el$186;
              })(), (() => {
                var _el$187 = _tmpl$4();
                insert(_el$187, () => tr(locale(), "资产 / 治理相关能力请走单独 lane；这张主入口页面只保留正式玩法所需的最小动作面。", "Asset and governance actions stay on their dedicated lane; this primary entry only keeps the minimum surface needed for formal gameplay."));
                return _el$187;
              })()];
            }
          })]
        ...
        return createComponent(PanelSection, {
          ...
          get children() {
            return [(() => {
              ...
              get children() {
                var _el$142 = _tmpl$35(), _el$143 = _el$142.firstChild;
                _el$143.$$click = () => {
                  void logoutHostedPlayerSession();
                };
                insert(_el$143, () => tr(locale(), "释放玩家会话", "Release Player Session"));
                return _el$142;
              }
            })];
          }
    ...
    insert(_el$147, () => tr(locale(), "运行诊断", "Runtime Diagnostics"));
    insert(_el$148, () => tr(locale(), "执行通道、认证/会话、托管矩阵与最近事件都收在这里，避免它们继续抢占主玩法首屏。", "Execution lanes, auth/session truth, hosted matrix, and recent events live here so they no longer dominate the primary gameplay viewport."));
    ...
    insert(_el$150, createComponent(PanelSection, {
      get title() {
    ...
    insert(_el$153, createComponent(Show, {
      ...
      get children() {
        ...
        insert(_el$154, () => tr(locale(), "释放玩家会话", "Release Player Session"));
        return _el$154;
      }
    }));
    ...
    insert(_el$150, createComponent(Show, {
      ...
      get children() {
        var _el$157 = _tmpl$6();
        insert(_el$157, createComponent(Badge, {
          "class": "badge badge--warn",
          get children() {
    ...
    insert(_el$150, createComponent(PanelSection, {
      ...
      get children() {
        return [createComponent(EmptyState, {
          ...
          var _el$158 = _tmpl$1();
          insert(_el$158, createComponent(For, {
            get each() {
    ...
    insert(_el$161, createComponent(MetricCard, {
      get label() {
    ...
    insert(_el$163, () => tr(locale(), "最近事件", "Recent Events"));
...
function InteractionPanel() {
  ...
  return (() => {
    var _el$205 = _tmpl$50(), _el$206 = _el$205.firstChild, _el$208 = _el$206.nextSibling;
    ...
    insert(_el$205, createComponent(EmptyState, {
      get children() {
        return assetLaneDetail();
      }
    }), null);
    insert(_el$205, createComponent(PanelSection, {
      get title() {
      ...
      get children() {
        return [(() => {
          var _el$209 = _tmpl$40(), _el$210 = _el$209.firstChild, _el$211 = _el$210.nextSibling;
          insert(_el$210, () => tr(locale(), "消息", "Message"));
          _el$211.$$input = (event) => {
            state.chatDraft.message = String(event.currentTarget.value || "");
            state.chatDraft.dirty = true;
          };
          createRenderEffect((_p$) => {
            ...
            _v$17 !== _p$.e && setAttribute(_el$211, "placeholder", _p$.e = _v$17);
            _v$18 !== _p$.t && (_el$211.disabled = _p$.t = _v$18);
            return _p$;
          }, {
            e: void 0,
            t: void 0
          });
          createRenderEffect(() => _el$211.value = state.chatDraft.message);
          return _el$209;
        })(), (() => {
          var _el$212 = _tmpl$41(), _el$213 = _el$212.firstChild;
          _el$213.$$click = () => sendAgentChat(agentId(), state.chatDraft.message);
          insert(_el$213, () => tr(locale(), "发送聊天", "Send Chat"));
          createRenderEffect(() => _el$213.disabled = !chatCapability().enabled);
          return _el$212;
        })(), createComponent(Show, {
          get when() {
            return chatFeedback();
          ...
          var _el$214 = _tmpl$9(), _el$215 = _el$214.firstChild, _el$216 = _el$215.nextSibling;
          insert(_el$215, () => tr(locale(), "消息流", "Message Flow"));
              ...
              return createComponent(For, {
                ...
                children: (entry) => createComponent(EventCard, {
                  ...
                  get children() {
                    return [(() => {
                      var _el$245 = _tmpl$7();
                      insert(_el$245, () => chatEntryMessage(entry, locale()));
                      return _el$245;
    ...
    insert(_el$205, createComponent(PanelSection, {
      ...
      get children() {
        return [(() => {
          ...
          var _el$218 = _tmpl$42(), _el$219 = _el$218.firstChild;
          _el$219.$$click = () => togglePromptOverridesVisible();
          insert(_el$219, promptSettingsButtonLabel);
          return _el$218;
        })()];
      }
    }), null);
      ...
      get children() {
        return createComponent(PanelSection, {
          ...
          get children() {
            return [(() => {
              var _el$220 = _tmpl$4();
              insert(_el$220, () => promptVersionState().summary);
              return _el$220;
            })(), (() => {
              var _el$221 = _tmpl$4();
              insert(_el$221, () => promptVersionState().detail);
              return _el$221;
            })(), createComponent(Show, {
              get when() {
              ...
              get children() {
                var _el$222 = _tmpl$43(), _el$223 = _el$222.firstChild, _el$224 = _el$223.nextSibling;
                insert(_el$223, () => tr(locale(), "后端审批码", "Backend Approval Code"));
                _el$224.$$input = (event) => {
                  state.strongAuth.approvalCode = String(event.currentTarget.value || "");
                };
                createRenderEffect(() => _el$224.value = state.strongAuth.approvalCode || "");
                return _el$222;
              }
            }), (() => {
              var _el$225 = _tmpl$44(), _el$226 = _el$225.firstChild, _el$227 = _el$226.nextSibling;
              insert(_el$226, () => tr(locale(), "系统提示词覆盖", "System Prompt Override"));
              _el$227.$$input = (event) => {
                state.promptDraft.systemPrompt = String(event.currentTarget.value || "");
                state.promptDraft.dirty = true;
              };
              createRenderEffect(() => _el$227.disabled = !promptCapability().enabled);
              createRenderEffect(() => _el$227.value = state.promptDraft.systemPrompt);
              return _el$225;
            })(), (() => {
              var _el$228 = _tmpl$45(), _el$229 = _el$228.firstChild, _el$230 = _el$229.nextSibling;
              insert(_el$229, () => tr(locale(), "短期目标覆盖", "Short-Term Goal Override"));
              _el$230.$$input = (event) => {
              ...
              createRenderEffect(() => _el$230.value = state.promptDraft.shortTermGoal);
              return _el$228;
            })(), (() => {
              var _el$231 = _tmpl$46(), _el$232 = _el$231.firstChild, _el$233 = _el$232.nextSibling;
              insert(_el$232, () => tr(locale(), "长期目标覆盖", "Long-Term Goal Override"));
              _el$233.$$input = (event) => {
              ...
              createRenderEffect(() => _el$233.value = state.promptDraft.longTermGoal);
              return _el$231;
            })(), (() => {
              var _el$234 = _tmpl$47(), _el$235 = _el$234.firstChild, _el$236 = _el$235.nextSibling;
              _el$235.$$click = () => sendPromptControl("preview", null);
              insert(_el$235, () => tr(locale(), "预览提示词", "Preview Prompt"));
              _el$236.$$click = () => sendPromptControl("apply", null);
              insert(_el$236, () => tr(locale(), "应用提示词", "Apply Prompt"));
              createRenderEffect((_p$) => {
                var _v$19 = !promptCapability().enabled, _v$20 = !promptCapability().enabled;
                _v$19 !== _p$.e && (_el$235.disabled = _p$.e = _v$19);
                _v$20 !== _p$.t && (_el$236.disabled = _p$.t = _v$20);
                return _p$;
              }, {
                e: void 0,
                t: void 0
              ...
              var _el$237 = _tmpl$48(), _el$238 = _el$237.firstChild, _el$239 = _el$238.firstChild, _el$240 = _el$239.nextSibling, _el$241 = _el$238.nextSibling;
              insert(_el$239, () => tr(locale(), "下一次回滚目标版本", "Next Rollback Target Version"));
              _el$240.$$input = (event) => {
              ...
              insert(_el$241, () => tr(locale(), "回滚提示词", "Rollback Prompt"));
              createRenderEffect((_p$) => {
                var _v$21 = !promptCapability().enabled, _v$22 = !promptCapability().enabled;
                _v$21 !== _p$.e && (_el$240.disabled = _p$.e = _v$21);
                _v$22 !== _p$.t && (_el$241.disabled = _p$.t = _v$22);
                return _p$;
              }, {
                e: void 0,
                t: void 0
              });
              createRenderEffect(() => _el$240.value = Number(state.promptDraft.rollbackTargetVersion || 0));
              return _el$237;
            })(), createComponent(Show, {
              get when() {
    ...
    insert(_el$205, createComponent(PanelSection, {
      ...
      get children() {
        return [(() => {
          ...
          var _el$243 = _tmpl$49(), _el$244 = _el$243.firstChild;
          insert(_el$244, () => tr(locale(), "主代币转账（这里暂未开放）", "Main Token Transfer (Not Exposed Here Yet)"));
          return _el$243;
        })()];
      }
    }), null);
...
function DetailsPanel() {
  ...
  return (() => {
    var _el$246 = _tmpl$52(), _el$247 = _el$246.firstChild, _el$248 = _el$247.nextSibling, _el$249 = _el$248.firstChild, _el$250 = _el$249.nextSibling, _el$251 = _el$250.nextSibling;
    ...
    insert(_el$246, createComponent(InteractionPanel, {}), _el$248);
    ...
    insert(_el$249, () => tr(locale(), "世界规模", "World Scale"));
    ...
    insert(_el$251, worldMetaSummary);
    ...
    insert(_el$246, createComponent(Show, {
      ...
      get children() {
        var _el$252 = _tmpl$51(), _el$253 = _el$252.firstChild, _el$254 = _el$253.nextSibling;
        insert(_el$253, () => tr(locale(), "最近错误", "Last Error"));
        insert(_el$254, () => state.lastError);
        return _el$252;
      }
    }), null);
    return _el$246;
...
function AppShell() {
  ...
  return [createComponent(MobileJumpRail, {}), createComponent(HostedLoginGate, {}), (() => {
    var _el$255 = _tmpl$53(), _el$256 = _el$255.firstChild, _el$257 = _el$256.firstChild, _el$258 = _el$257.nextSibling, _el$259 = _el$258.nextSibling, _el$260 = _el$256.nextSibling;
    insert(_el$257, () => tr(locale(), "导航", "Navigate"));
    insert(_el$258, () => tr(locale(), "目标", "Targets"));
    insert(_el$259, () => tr(locale(), "先锁定对象，再进入世界舞台或右侧指挥面板。", "Lock onto a target first, then move into the stage or command surface."));
    insert(_el$260, createComponent(TargetsPanel, {}));
    return _el$255;
  })(), (() => {
    var _el$261 = _tmpl$54(), _el$262 = _el$261.firstChild, _el$263 = _el$262.firstChild;
    insert(_el$263, createComponent(WorldStageHero, {}), null);
    insert(_el$263, createComponent(PixelWorldHost, {
      get locale() {
        return locale();
      }
    }), null);
    insert(_el$263, createComponent(WorldSummaryPanel, {}), null);
    return _el$261;
  })(), (() => {
    var _el$264 = _tmpl$55(), _el$265 = _el$264.firstChild, _el$266 = _el$265.firstChild, _el$267 = _el$266.nextSibling, _el$268 = _el$267.nextSibling, _el$269 = _el$265.nextSibling;
    insert(_el$266, () => tr(locale(), "指挥与核查", "Command and Inspect"));
    insert(_el$267, () => tr(locale(), "交互与明细", "Interact and Inspect"));
    insert(_el$268, () => tr(locale(), "只有锁定目标后才进入这里。聊天优先，提示词与对象核查继续后置。", "Enter this column only after locking a target. Chat comes first; prompt controls and raw inspection stay behind it."));
    insert(_el$269, createComponent(DetailsPanel, {}));
    return _el$264;
  })()];
}
