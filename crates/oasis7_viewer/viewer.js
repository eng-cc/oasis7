...
function createWorldFeedTransport({ getSocket, getState: getState2, render: render2, requestSnapshot, sendJson: sendJson2 }) {
  ...
  function handleWorldFeed(feed) {
    ...
    const requestedCursor = previous?.requestCursor == null ? "" : String(previous.requestCursor);
    if (responseGeneration === generation && !consumed.requiresSnapshotReload && ["ready", "replay", "empty"].includes(status) && returnedCursor && returnedCursor !== requestedCursor && continuationTimer == null) {
      continuationTimer = window.setTimeout(() => {
        continuationTimer = null;
        if (responseGeneration !== generation) {
          return;
        }
        const latest = getState2().worldFeed;
        if (latest?.requestInFlight || latest?.snapshotReloadRequired || !["ready", "replay", "empty"].includes(latest?.status) || !latest?.cursor) {
          return;
        }
        requestWorldFeed2({ cursor: latest.cursor, limit: latest.requestLimit || 50 });
      }, 0);
    }
  }
  ...
  function refreshAfterWorldActivity() {
    const state2 = getState2();
    const cursor = state2.worldFeed?.cursor;
    const socket2 = getSocket();
    if (!cursor || !socket2 || socket2.readyState !== WebSocket.OPEN || state2.worldFeed?.requestInFlight || state2.worldFeed?.snapshotReloadRequired || !["ready", "replay", "empty"].includes(state2.worldFeed?.status)) {
      return false;
    }
    return requestWorldFeed2({ cursor });
  }
...
function handleViewerMessage(message) {
  ...
  switch (message?.type) {
    ...
    case "event": {
      ...
      state.tick = state.logicalTime;
      worldFeedTransport.refreshAfterWorldActivity();
      break;
    }
    case "metrics":
...
function renderDetails() {
  ...
  elements.rightPanel.innerHTML = `
    <div class="stack">
      ...
      ${state.selectedObject ? `<pre class="json">${escapeHtml(JSON.stringify(state.selectedObject, null, 2))}</pre>` : '<div class="empty">Select an agent or location from Targets first.</div>'}
      <div>
...
var _tmpl$$o = /* @__PURE__ */ template(`<div class="stack stack--compact"data-testid=first-chat-unlock-preview>`), _tmpl$2$o = /* @__PURE__ */ template(`<div class=first-chat-unlock-preview__field><div class=metric__label></div><div>`);
const ZH_VALUE_MAP = {
  chat_purpose: {
  ...
  return (() => {
    ...
    insert(_el$, createComponent(For, {
      ...
      children: ([field, label]) => (() => {
        var _el$2 = _tmpl$2$o(), _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling;
...
function probePixelWorldWebgl2Surface(canvas) {
  try {
...
var _tmpl$$n = /* @__PURE__ */ template(`<div class=pixel-world-canvas__grid>`), _tmpl$2$n = /* @__PURE__ */ template(`<div class="pixel-world-canvas__terrain-band pixel-world-canvas__terrain-band--one">`), _tmpl$3$l = /* @__PURE__ */ template(`<div class="pixel-world-canvas__terrain-band pixel-world-canvas__terrain-band--two">`), _tmpl$4$h = /* @__PURE__ */ template(`<div class=pixel-world-fragment-terrain>`), _tmpl$5$g = /* @__PURE__ */ template(`<div class=pixel-world-route>`), _tmpl$6$a = /* @__PURE__ */ template(`<div class="pixel-world-route-waypoint pixel-world-route-waypoint--mid">`), _tmpl$7$6 = /* @__PURE__ */ template(`<div class="pixel-world-route-waypoint pixel-world-route-waypoint--target">`), _tmpl$8$3 = /* @__PURE__ */ template(`<div class=pixel-world-hotspot><span>`), _tmpl$9$3 = /* @__PURE__ */ template(`<button class="pixel-world-entity pixel-world-entity--location"data-pixel-world-location-marker=true><span>`), _tmpl$0$2 = /* @__PURE__ */ template(`<button class="pixel-world-entity pixel-world-entity--agent"data-pixel-world-agent-marker=true><span>`), _tmpl$1$1 = /* @__PURE__ */ template(`<button type=button class="pixel-world-entity pixel-world-entity--agent pixel-world-entity--canvas-hit-target"data-pixel-world-agent-marker=true><span>`), _tmpl$10$1 = /* @__PURE__ */ template(`<div class="pixel-world-canvas__callout pixel-world-canvas__callout--goal">`), _tmpl$11$1 = /* @__PURE__ */ template(`<div class="pixel-world-canvas__callout pixel-world-canvas__callout--blocker">`), _tmpl$12$1 = /* @__PURE__ */ template(`<div class=pixel-world-canvas__hotspot-tooltip data-hotspot-tooltip role=status>`), _tmpl$13$1 = /* @__PURE__ */ template(`<div class=pixel-world-canvas__selection>`), _tmpl$14$1 = /* @__PURE__ */ template(`<div class="pixel-world-canvas pixel-world-canvas--rendered"><canvas id=pixel-world-embedded-runtime-canvas class=pixel-world-canvas__surface tabindex=0 role=img aria-describedby=pixel-world-canvas-accessible-summary width=960 height=540></canvas><div id=pixel-world-canvas-accessible-summary class=sr-only></div><div class=pixel-world-canvas__overlay>`), _tmpl$15$1 = /* @__PURE__ */ template(`<div class=pixel-world-action-receipt__detail>`), _tmpl$16$1 = /* @__PURE__ */ template(`<span>`), _tmpl$17$1 = /* @__PURE__ */ template(`<div class=pixel-world-action-receipt__meta><span>`), _tmpl$18$1 = /* @__PURE__ */ template(`<div data-viewer-overlay=receipt><div class=pixel-world-action-receipt__label></div><div class=pixel-world-action-receipt__body><div class=pixel-world-action-receipt__title></div><div class=pixel-world-action-receipt__summary>`), _tmpl$19$1 = /* @__PURE__ */ template(`<span class=pixel-world-command-cell__blocker-chip>`), _tmpl$20$1 = /* @__PURE__ */ template(`<div class=pixel-world-command-cell__detail>`), _tmpl$21$1 = /* @__PURE__ */ template(`<div class=pixel-world-command-strip data-viewer-overlay=next-move><div class="pixel-world-command-cell pixel-world-command-cell--objective"><div class=pixel-world-command-cell__label></div><div class=pixel-world-command-cell__value></div><div class=pixel-world-command-cell__detail></div></div><div class="pixel-world-command-cell pixel-world-command-cell--next"><div class=pixel-world-command-cell__header><div class=pixel-world-command-cell__label></div></div><div class=pixel-world-command-cell__value></div><a class=pixel-world-command-cell__action></a></div><div class="pixel-world-command-cell pixel-world-command-cell--leverage"><div class=pixel-world-command-cell__label></div><div class=pixel-world-command-cell__value></div><div class=pixel-world-command-cell__detail>`), _tmpl$22$1 = /* @__PURE__ */ template(`<span class="badge badge--accent">`), _tmpl$23$1 = /* @__PURE__ */ template(`<div class="pixel-world-readout badge-row"><span></span><span class="badge badge--accent">`), _tmpl$24$1 = /* @__PURE__ */ template(`<div class="pixel-world-focus-hud__cell pixel-world-focus-hud__cell--tick"data-hud-priority=telemetry><span></span><strong></strong><em>`), _tmpl$25$1 = /* @__PURE__ */ template(`<div class=pixel-world-focus-hud data-focus-hud=true><div class=pixel-world-focus-hud__identity><div class=pixel-world-focus-hud__eyebrow></div><div class=pixel-world-focus-hud__title></div></div><div class="pixel-world-focus-hud__cell pixel-world-focus-hud__cell--prompt"><span></span><strong></strong><em></em></div><div class="pixel-world-focus-hud__cell pixel-world-focus-hud__cell--mission"><span></span><strong></strong><em></em></div><div class="pixel-world-focus-hud__cell pixel-world-focus-hud__cell--blocker"><span></span><strong></strong></div><div class="pixel-world-focus-hud__cell pixel-world-focus-hud__cell--receipt"hidden><span></span><strong></strong><em></em></div><div class=pixel-world-focus-controls><button type=button class="pixel-world-focus-control pixel-world-focus-control--primary"></button><button id=viewer-focus-exit type=button class="pixel-world-focus-control pixel-world-focus-control--quiet"></button><details class=pixel-world-focus-more-controls><summary></summary><button type=button class="pixel-world-focus-control pixel-world-focus-control--secondary"></button><button type=button class="pixel-world-focus-control pixel-world-focus-control--secondary">`), _tmpl$26$1 = /* @__PURE__ */ template(`<span class="badge badge--warn">`), _tmpl$27$1 = /* @__PURE__ */ template(`<div class=pixel-world-focus-cinematic data-focus-cinematic=true><div class=pixel-world-focus-cinematic__eyebrow></div><div class=pixel-world-focus-cinematic__title></div><div class=pixel-world-focus-cinematic__body></div><div class=badge-row><span class="badge badge--accent">`), _tmpl$28$1 = /* @__PURE__ */ template(`<div class="pixel-world-focus-rail__item pixel-world-focus-rail__item--blocker"data-focus-priority=blocker><span></span><strong>`), _tmpl$29$1 = /* @__PURE__ */ template(`<div class=pixel-world-focus-rail__item><span></span><strong></strong><em>`), _tmpl$30$1 = /* @__PURE__ */ template(`<div class=pixel-world-focus-rail__item><span></span><strong>`), _tmpl$31$1 = /* @__PURE__ */ template(`<div class=pixel-world-focus-rail data-focus-rail=true><div class=pixel-world-focus-rail__label>`), _tmpl$32$1 = /* @__PURE__ */ template(`<span class=sr-only>`), _tmpl$33$1 = /* @__PURE__ */ template(`<em>`), _tmpl$34$1 = /* @__PURE__ */ template(`<div class="pixel-world-focus-minimap__node pixel-world-focus-minimap__node--selected"data-selected=true><span></span><strong></strong><em>`), _tmpl$35$1 = /* @__PURE__ */ template(`<div class=pixel-world-focus-minimap data-focus-minimap=true><div class=pixel-world-focus-minimap__label></div><div class=pixel-world-focus-minimap__grid></div><div class=pixel-world-focus-minimap__route></div><div class="pixel-world-focus-minimap__node pixel-world-focus-minimap__node--target"><span></span><strong></strong></div><div class="pixel-world-focus-minimap__node pixel-world-focus-minimap__node--agent"><span></span><strong></strong></div><div class=pixel-world-focus-minimap__meta><span></span><span></span><span></span><span>`), _tmpl$36$1 = /* @__PURE__ */ template(`<pre class=json>`), _tmpl$37$1 = /* @__PURE__ */ template(`<details class=diagnostic><summary>`), _tmpl$38$1 = /* @__PURE__ */ template(`<span class=badge>`), _tmpl$39$1 = /* @__PURE__ */ template(`<div class=badge-row><span class="badge badge--accent"></span><span class=badge></span><span>`), _tmpl$40$1 = /* @__PURE__ */ template(`<div class=pixel-world-focus-command-tray><div class="pixel-world-focus-command-chip pixel-world-focus-command-chip--target"><span></span><strong></strong><em></em></div><div class="pixel-world-focus-command-chip pixel-world-focus-command-chip--blocker"><span></span><strong></strong></div><div class="pixel-world-focus-command-chip pixel-world-focus-command-chip--receipt"><span></span><strong></strong></div><button type=button class="pixel-world-focus-command-chip pixel-world-focus-command-chip--primary"data-chat-send=1>`), _tmpl$41$1 = /* @__PURE__ */ template(`<div class=empty>`), _tmpl$42$1 = /* @__PURE__ */ template(`<div class="panel panel--nested"><div class=panel__header><div class="stack stack--compact"><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></div></div><div class="panel__body stack"><div class=field><label for=agent-chat-message></label><textarea id=agent-chat-message rows=2></textarea></div><div class=toolbar><button type=button data-chat-send=1></button></div><div><div class="panel__title panel__title--spaced"></div><div class=event-list>`), _tmpl$43$1 = /* @__PURE__ */ template(`<div id=viewer-command-console class="pixel-world-focus-command-surface stack">`), _tmpl$44$1 = /* @__PURE__ */ template(`<div class=feedback-detail>`), _tmpl$45$1 = /* @__PURE__ */ template(`<div class=feedback-card><div class=badge-row><span></span></div><div class=feedback-summary>`), _tmpl$46$1 = /* @__PURE__ */ template(`<div><div class=event-card__title><span></span></div><div class=event-card__meta></div><div class=feedback-summary>`), _tmpl$47$1 = /* @__PURE__ */ template(`<div class=pixel-world-host__summary><div class=pixel-world-host__summary-copy><div class=pixel-world-host__headline></div><div class=feedback-detail>`), _tmpl$48$1 = /* @__PURE__ */ template(`<div class="empty pixel-world-render-unavailable"data-viewer-overlay=renderer-unavailable>`), _tmpl$49$1 = /* @__PURE__ */ template(`<div class=pixel-world-focus-receipt>`), _tmpl$50$1 = /* @__PURE__ */ template(`<details id=viewer-focus-command-drawer class="pixel-world-focus-drawer pixel-world-focus-drawer--command"><summary></summary><div class=pixel-world-focus-drawer__body>`), _tmpl$51$1 = /* @__PURE__ */ template(`<div class=feedback-detail data-renderer-fatal>`), _tmpl$52$1 = /* @__PURE__ */ template(`<details class="diagnostic pixel-world-render-diagnostics"><summary></summary><div class="pixel-world-host__toolbar badge-row"><span class="badge badge--accent"></span><span class="badge badge--accent"></span><span class="badge badge--accent"></span><span class=badge></span><span class=badge></span><span class=badge></span><span class=badge></span><span class=badge></span><span class=badge></span><button type=button></button><button type=button></button><div class=feedback-detail>`), _tmpl$53$1 = /* @__PURE__ */ template(`<details id=viewer-focus-diagnostics-drawer class="pixel-world-focus-drawer pixel-world-focus-drawer--diagnostics"><summary></summary><div class=pixel-world-focus-drawer__body><div class=badge-row><span class=badge></span><span class=badge></span><span class=badge></span></div><div class="toolbar toolbar--spaced"><button type=button>`), _tmpl$54$1 = /* @__PURE__ */ template(`<div class="stack flow-top"><pre class=json>`), _tmpl$55$1 = /* @__PURE__ */ template(`<div data-viewer-overlay=world-hud><div class=pixel-world-focus-entry data-viewer-overlay=cinematic-entry><div id=pixel-world-focus-entry-hint class=pixel-world-focus-entry__hint></div><button type=button class=pixel-world-focus-entry__button aria-pressed=false></button></div><details class=diagnostic><summary>`), _tmpl$56$1 = /* @__PURE__ */ template(`<div>`), _tmpl$57$1 = /* @__PURE__ */ template(`<button type=button class=pixel-world-render-unavailable__retry>`);
...
function PixelWorldHostVisualLayer(props) {
  ...
  return [_tmpl$$n(), _tmpl$2$n(), _tmpl$3$l(), createComponent(For, {
    get each() {
    ...
    children: (location, index) => (() => {
      var _el$0 = _tmpl$9$3(), _el$1 = _el$0.firstChild;
...
function createPixelWorldHostAdapter({
  ...
  return {
    ...
    simulateFatal(message) {
      onFatal?.(typeof message === "object" ? message : {
...
function pixelWorldGameplayActionKey(action2) {
  if (!action2) return "";
  const actionId = String(action2.actionId || action2.action_id || action2.protocolAction || action2.protocol_action || action2.executeKind || "").trim().toLowerCase();
  const targetAgentId = String(action2.targetAgentId || action2.target_agent_id || action2.actorAgentId || action2.actor_agent_id || "").trim().toLowerCase();
  return `${actionId}::${targetAgentId}`;
}
function pixelWorldGameplayActionMatches(action2, feedback) {
  if (!action2 || !feedback || feedback.kind !== "gameplay_action") return false;
  const actionId = String(action2.actionId || action2.action_id || action2.protocolAction || action2.protocol_action || action2.executeKind || "").trim().toLowerCase();
  const feedbackAction = String(feedback.action || "").trim().toLowerCase();
  const targetAgentId = String(action2.targetAgentId || action2.target_agent_id || action2.actorAgentId || action2.actor_agent_id || "").trim().toLowerCase();
  const feedbackAgentId = String(feedback.agentId || feedback.targetAgentId || "").trim().toLowerCase();
  return Boolean(actionId && feedbackAction && feedbackAction.includes(actionId) && (!targetAgentId || !feedbackAgentId || targetAgentId === feedbackAgentId));
}
function pixelWorldNextMoveDisabledReason(action2, gameplay, locale) {
  if (!action2) return null;
  if (action2.disabledReason) return action2.disabledReason;
  const feedback = snapshotSemanticFeedback(state.lastGameplayActionFeedback) || gameplay?.recentFeedback;
  const feedbackStage = String(feedback?.stage || "").trim().toLowerCase();
  if (pixelWorldGameplayActionMatches(action2, feedback) && PIXEL_WORLD_PENDING_GAMEPLAY_STAGES.has(feedbackStage)) return tr$1(locale, "动作已提交，正在等待世界确认。", "Action submitted; waiting for world confirmation.");
  const actionId = String(action2.actionId || action2.action_id || "").trim().toLowerCase();
  const protocolAction = String(action2.protocolAction || action2.protocol_action || "").trim().toLowerCase();
  const targetAgentId = String(action2.targetAgentId || action2.target_agent_id || "").trim();
  const boundAgentId = String(state.auth.boundAgentId || "").trim();
  if (targetAgentId && actionId !== "claim_first_agent" && !["request_snapshot", "live_control.step", "live_control.play"].includes(protocolAction)) {
    if (!boundAgentId) return tr$1(locale, "当前账号尚未绑定 Agent，不能执行共享快照动作。", "The current account has no bound Agent for this shared-snapshot action.");
    if (targetAgentId !== boundAgentId) return tr$1(locale, `这个动作目标是 ${targetAgentId}，但当前账号绑定的是 ${boundAgentId}。`, `This action targets ${targetAgentId}, but the current account is bound to ${boundAgentId}.`);
  }
  return null;
}
function pixelWorldNextMovePending(action2, gameplay) {
  if (!action2) return false;
  const feedback = snapshotSemanticFeedback(state.lastGameplayActionFeedback) || gameplay?.recentFeedback;
  const feedbackStage = String(feedback?.stage || "").trim().toLowerCase();
  const key = pixelWorldGameplayActionKey(action2);
  return Boolean(key && state.gameplayActionPending?.actionKey === key || pixelWorldGameplayActionMatches(action2, feedback) && PIXEL_WORLD_BUSY_GAMEPLAY_STAGES.has(feedbackStage));
}
function resolvePixelWorldDirectNextMoveAction(gameplay, executeKind) {
  ...
  return actions.find((action2) => action2?.executeKind === executeKind && !action2?.disabledReason) || actions.find((action2) => String(action2?.actionId || action2?.action_id || "") === executeKind && !action2?.disabledReason) || null;
}
function PixelWorldCommercialHud(props) {
  ...
  const directNextMoveAction = () => resolvePixelWorldDirectNextMoveAction(buildGameplaySummary(props.locale()), surface().next_action.execute_kind) || (surface().next_action.execute_kind === "gameplay_action" ? buildGameplaySummary(props.locale()).availableActions.find((action2) => DIRECT_PIXEL_WORLD_NEXT_MOVE_KINDS.has(action2?.actionId) && action2?.label === surface().next_action.label && !action2?.disabledReason) : null);
  const gameplay = () => buildGameplaySummary(props.locale());
  ...
  return createComponent(Show, {
    ...
    get children() {
      return [(() => {
        ...
        createRenderEffect((_p$) => {
          var _v$42 = surface().active_agent_id || "", _v$43 = surface().player_leverage.state, _v$44 = nextMoveRoute(), _v$45 = surface().next_action.execute_kind || "none", _v$46 = surface().blocker.label ? "true" : "false", _v$47 = nextMoveHref(), _v$48 = `${tr$1(props.locale(), "下一步", "Next Move")}: ${surface().next_action.label}`, _v$49 = nextMoveDisabledReason() ? "true" : void 0, _v$50 = nextMovePending() ? "true" : "false", _v$51 = nextMoveDisabledReason() ? -1 : void 0;
          _v$42 !== _p$.e && setAttribute(_el$31, "data-active-agent", _p$.e = _v$42);
          _v$43 !== _p$.t && setAttribute(_el$31, "data-leverage-state", _p$.t = _v$43);
          _v$44 !== _p$.a && setAttribute(_el$36, "data-next-move-route", _p$.a = _v$44);
          _v$45 !== _p$.o && setAttribute(_el$36, "data-execute-kind", _p$.o = _v$45);
          _v$46 !== _p$.i && setAttribute(_el$36, "data-blocker-present", _p$.i = _v$46);
          _v$47 !== _p$.n && setAttribute(_el$42, "href", _p$.n = _v$47);
          _v$48 !== _p$.s && setAttribute(_el$42, "aria-label", _p$.s = _v$48);
          _v$49 !== _p$.h && setAttribute(_el$42, "aria-disabled", _p$.h = _v$49);
          _v$50 !== _p$.r && setAttribute(_el$42, "aria-busy", _p$.r = _v$50);
          _v$51 !== _p$.d && setAttribute(_el$42, "tabindex", _p$.d = _v$51);
          return _p$;
        }, {
          e: void 0,
          t: void 0,
        ...
        get children() {
          return createComponent(PixelWorldActionReceipt, {
        ...
        var _el$47 = _tmpl$23$1(), _el$48 = _el$47.firstChild, _el$50 = _el$48.nextSibling;
        insert(_el$48, () => readoutStatus().label);
        insert(_el$47, createComponent(Show, {
          get when() {
            return memo(() => surface().world_read.tick !== null)() && surface().world_read.tick !== void 0;
          },
          get children() {
            var _el$49 = _tmpl$22$1();
            insert(_el$49, () => `tick=${surface().world_read.tick}`);
            createRenderEffect(() => setAttribute(_el$49, "data-world-tick", String(surface().world_read.tick)));
            return _el$49;
          }
        }), _el$50);
        insert(_el$50, () => `agents=${surface().world_read.agents}`);
        createRenderEffect(() => className(_el$48, readoutStatus().className));
        return _el$47;
      })()];
    }
  });
...
function PixelWorldFocusHud(props) {
  ...
  return createComponent(Show, {
    ...
    get children() {
      var _el$51 = _tmpl$25$1(), _el$52 = _el$51.firstChild, _el$53 = _el$52.firstChild, _el$54 = _el$53.nextSibling, _el$55 = _el$52.nextSibling, _el$56 = _el$55.firstChild, _el$57 = _el$56.nextSibling, _el$58 = _el$57.nextSibling, _el$59 = _el$55.nextSibling, _el$60 = _el$59.firstChild, _el$61 = _el$60.nextSibling, _el$62 = _el$61.nextSibling, _el$67 = _el$59.nextSibling, _el$68 = _el$67.firstChild, _el$69 = _el$68.nextSibling, _el$70 = _el$67.nextSibling, _el$71 = _el$70.firstChild, _el$72 = _el$71.nextSibling, _el$73 = _el$72.nextSibling, _el$74 = _el$70.nextSibling, _el$75 = _el$74.firstChild, _el$76 = _el$75.nextSibling, _el$77 = _el$76.nextSibling, _el$78 = _el$77.firstChild, _el$79 = _el$78.nextSibling, _el$80 = _el$79.nextSibling;
      insert(_el$53, () => tr$1(props.locale(), "电影视图", "Cinematic View"));
      insert(_el$54, () => tr$1(props.locale(), "世界指挥棋盘", "World Command Board"));
      insert(_el$56, () => tr$1(props.locale(), "当前目标", "Current Objective"));
      insert(_el$57, () => surface().objective.title);
      insert(_el$58, () => surface().next_action.label);
      insert(_el$60, () => tr$1(props.locale(), "任务进度", "Mission Progress"));
      insert(_el$61, (() => {
      ...
      insert(_el$62, () => surface().next_action.detail || surface().objective.detail);
      insert(_el$51, createComponent(Show, {
        get when() {
          return memo(() => surface().world_read.tick !== null)() && surface().world_read.tick !== void 0;
        },
        get children() {
          var _el$63 = _tmpl$24$1(), _el$64 = _el$63.firstChild, _el$65 = _el$64.nextSibling, _el$66 = _el$65.nextSibling;
          insert(_el$64, () => tr$1(props.locale(), "世界 Tick", "World Tick"));
          insert(_el$65, () => surface().world_read.tick);
          insert(_el$66, () => `tick=${surface().world_read.tick}`);
          createRenderEffect(() => setAttribute(_el$63, "data-world-tick", String(surface().world_read.tick)));
          return _el$63;
        }
      }), _el$67);
      insert(_el$68, () => tr$1(props.locale(), "阻塞", "Blocker"));
      insert(_el$69, () => surface().blocker.label || tr$1(props.locale(), "暂无阻塞", "No blocker"));
      insert(_el$71, () => tr$1(props.locale(), "回执", "Receipt"));
      insert(_el$72, () => surface().action_receipt.title);
      insert(_el$73, () => receiptConfidenceLabel(surface().action_receipt.confidence, props.locale()));
      ...
      createRenderEffect((_p$) => {
        ...
        _v$52 !== _p$.e && setAttribute(_el$67, "data-blocker-present", _p$.e = _v$52);
        _v$53 !== _p$.t && setAttribute(_el$67, "data-hud-priority", _p$.t = _v$53);
        _v$54 !== _p$.a && setAttribute(_el$70, "data-receipt-confidence", _p$.a = _v$54);
        _v$55 !== _p$.o && setAttribute(_el$70, "data-hud-priority", _p$.o = _v$55);
        _v$56 !== _p$.i && setAttribute(_el$74, "aria-label", _p$.i = _v$56);
        return _p$;
      }, {
        e: void 0,
        t: void 0,
...
function PixelWorldFocusRail(props) {
  ...
  return createComponent(Show, {
    ...
    get children() {
      var _el$88 = _tmpl$31$1(), _el$89 = _el$88.firstChild;
      ...
      insert(_el$88, createComponent(Show, {
        ...
        get children() {
          var _el$93 = _tmpl$29$1(), _el$94 = _el$93.firstChild, _el$95 = _el$94.nextSibling, _el$96 = _el$95.nextSibling;
          insert(_el$94, () => tr$1(props.locale(), "Agent", "Agent"));
          insert(_el$95, activeAgentName);
          insert(_el$96, () => `id=${activeAgent()}`);
          return _el$93;
        }
      }), null);
      insert(_el$88, createComponent(Show, {
        ...
        get children() {
          var _el$97 = _tmpl$29$1(), _el$98 = _el$97.firstChild, _el$99 = _el$98.nextSibling, _el$100 = _el$99.nextSibling;
          insert(_el$98, () => tr$1(props.locale(), "选中", "Selected"));
          insert(_el$99, selectedName);
      ...
      insert(_el$88, createComponent(Show, {
        ...
        get children() {
          var _el$101 = _tmpl$30$1(), _el$102 = _el$101.firstChild, _el$103 = _el$102.nextSibling;
...
function PixelWorldFocusMinimapCard(props) {
  ...
  return createComponent(Show, {
    ...
    get children() {
      var _el$104 = _tmpl$35$1(), _el$105 = _el$104.firstChild, _el$107 = _el$105.nextSibling, _el$108 = _el$107.nextSibling, _el$109 = _el$108.nextSibling, _el$110 = _el$109.firstChild, _el$111 = _el$110.nextSibling, _el$112 = _el$109.nextSibling, _el$113 = _el$112.firstChild, _el$114 = _el$113.nextSibling, _el$120 = _el$112.nextSibling, _el$121 = _el$120.firstChild, _el$122 = _el$121.nextSibling, _el$123 = _el$122.nextSibling, _el$124 = _el$123.nextSibling;
      ...
      insert(_el$114, (() => {
        var _c$6 = memo(() => !!activeAgent());
        return () => _c$6() ? activeAgentName() : tr$1(props.locale(), "待分配", "Unassigned");
      })());
      insert(_el$112, createComponent(Show, {
        ...
        get children() {
          var _el$115 = _tmpl$33$1();
          insert(_el$115, () => `id=${activeAgent()}`);
          return _el$115;
        }
      }), null);
      insert(_el$104, createComponent(Show, {
        ...
        get children() {
          var _el$116 = _tmpl$34$1(), _el$117 = _el$116.firstChild, _el$118 = _el$117.nextSibling, _el$119 = _el$118.nextSibling;
          insert(_el$117, () => tr$1(props.locale(), "选中", "Selected"));
          insert(_el$118, selectedName);
          insert(_el$119, () => `${selected().kind}/${selected().id}`);
          return _el$116;
        }
      }), _el$120);
      insert(_el$121, () => `agents=${props.renderState().agents.length}`);
      insert(_el$122, () => `targets=${props.renderState().locations.length}`);
      ...
      createRenderEffect((_p$) => {
        ...
        _v$57 !== _p$.e && setAttribute(_el$108, "data-routes", _p$.e = _v$57);
...
function PixelRawDiagnostics(props) {
  ...
  return (() => {
    var _el$125 = _tmpl$37$1(), _el$126 = _el$125.firstChild;
    _el$125.addEventListener("toggle", (event) => setOpen(event.currentTarget.open));
    insert(_el$126, () => tr$1(locale(), "原始诊断", "Raw diagnostics"));
    insert(_el$125, createComponent(Show, {
      get when() {
        return open();
      },
      get children() {
        var _el$127 = _tmpl$36$1();
        insert(_el$127, () => JSON.stringify(value2(), null, 2));
        return _el$127;
      }
    }), null);
    return _el$125;
...
function PixelWorldFocusCommandSurface(props) {
  ...
  return (() => {
    ...
    insert(_el$128, createComponent(Show, {
      ...
      get fallback() {
        return (() => {
          var _el$162 = _tmpl$41$1();
          insert(_el$162, () => tr$1(locale(), "先选中一个行动体，才能在电影视图里直接下指令。", "Select an agent to issue direct commands in Cinematic View."));
          return _el$162;
        })();
      },
      get children() {
        return [(() => {
          var _el$129 = _tmpl$39$1(), _el$130 = _el$129.firstChild, _el$131 = _el$130.nextSibling, _el$133 = _el$131.nextSibling;
          ...
          insert(_el$129, createComponent(Show, {
            ...
            get children() {
              var _el$132 = _tmpl$38$1();
              insert(_el$132, () => `boundPlayer=${binding().playerId}`);
              return _el$132;
            }
          }), _el$133);
          insert(_el$133, (() => {
            var _c$7 = memo(() => !!chatCapability().enabled);
            return () => _c$7() ? tr$1(locale(), "聊天可用", "Chat Ready") : tr$1(locale(), "聊天受限", "Chat Limited");
          })());
          createRenderEffect(() => className(_el$133, chatCapability().enabled ? "badge badge--good" : "badge badge--warn"));
          return _el$129;
        })(), (() => {
          var _el$134 = _tmpl$40$1(), _el$135 = _el$134.firstChild, _el$136 = _el$135.firstChild, _el$137 = _el$136.nextSibling, _el$138 = _el$137.nextSibling, _el$139 = _el$135.nextSibling, _el$140 = _el$139.firstChild, _el$141 = _el$140.nextSibling, _el$142 = _el$139.nextSibling, _el$143 = _el$142.firstChild, _el$144 = _el$143.nextSibling, _el$145 = _el$142.nextSibling;
          ...
          get children() {
            var _el$146 = _tmpl$41$1();
            insert(_el$146, () => chatCapability().reason);
            return _el$146;
          }
        }), (() => {
          var _el$147 = _tmpl$42$1(), _el$148 = _el$147.firstChild, _el$149 = _el$148.firstChild, _el$150 = _el$149.firstChild, _el$151 = _el$150.nextSibling, _el$152 = _el$151.nextSibling, _el$153 = _el$148.nextSibling, _el$154 = _el$153.firstChild, _el$155 = _el$154.firstChild, _el$156 = _el$155.nextSibling, _el$157 = _el$154.nextSibling, _el$158 = _el$157.firstChild, _el$159 = _el$157.nextSibling, _el$160 = _el$159.firstChild, _el$161 = _el$160.nextSibling;
          insert(_el$150, () => tr$1(locale(), "指挥面板", "Command Surface"));
          insert(_el$151, () => tr$1(locale(), "行动体聊天", "Agent Chat"));
          insert(_el$152, () => tr$1(locale(), "给当前目标发消息并读取反馈。", "Message the current target and read feedback."));
          insert(_el$155, () => tr$1(locale(), "消息", "Message"));
          _el$156.$$input = (event) => {
            state.chatDraft.message = String(event.currentTarget.value || "");
            state.chatDraft.dirty = true;
          };
          _el$158.$$click = () => sendAgentChat(agentId(), state.chatDraft.message);
          insert(_el$158, () => tr$1(locale(), "发送聊天", "Send Chat"));
          insert(_el$153, createComponent(Show, {
            ...
            get fallback() {
              return (() => {
                var _el$163 = _tmpl$41$1();
                insert(_el$163, () => tr$1(locale(), "还没有聊天反馈。", "No chat feedback yet."));
                return _el$163;
              })();
            },
            children: (feedback) => (() => {
              var _el$164 = _tmpl$45$1(), _el$165 = _el$164.firstChild, _el$166 = _el$165.firstChild, _el$168 = _el$165.nextSibling;
              insert(_el$166, () => chatFeedbackDisplay().label);
              insert(_el$165, createComponent(Show, {
                ...
                get children() {
                  ...
                  insert(_el$167, () => `code=${chatFeedbackDisplay().code}`);
                  return _el$167;
                }
              }), null);
              insert(_el$168, () => chatFeedbackDisplay().summary);
              insert(_el$164, createComponent(Show, {
                get when() {
                  return chatFeedbackDisplay().detail;
                },
                get children() {
                  var _el$169 = _tmpl$44$1();
                  insert(_el$169, () => chatFeedbackDisplay().detail);
                  return _el$169;
                }
              }), null);
              ...
              createRenderEffect(() => className(_el$166, chatFeedbackDisplay().badgeClass));
              return _el$164;
            })()
          }), _el$159);
          insert(_el$160, () => tr$1(locale(), "消息流", "Message Flow"));
          insert(_el$161, createComponent(Show, {
            ...
            get fallback() {
              return (() => {
                var _el$170 = _tmpl$41$1();
                insert(_el$170, () => tr$1(locale(), "这个行动体还没有聊天历史。", "No chat history for this agent yet."));
                return _el$170;
              })();
            },
            get children() {
              return createComponent(For, {
                ...
                children: (entry) => (() => {
                  var _el$171 = _tmpl$46$1(), _el$172 = _el$171.firstChild, _el$173 = _el$172.firstChild, _el$174 = _el$172.nextSibling, _el$175 = _el$174.nextSibling;
                  insert(_el$173, () => chatEntryTitle$1(entry, locale()));
                  insert(_el$174, () => chatEntryMeta$1(entry, locale()));
                  insert(_el$175, () => entry.message || tr$1(locale(), "没有消息正文。", "No message body."));
                  insert(_el$171, createComponent(PixelRawDiagnostics, {
                    locale,
                    value: entry
                  }), null);
                  createRenderEffect(() => className(_el$171, chatEntryCardClass$1(entry)));
                  return _el$171;
                })()
              });
            }
          ...
          createRenderEffect(() => _el$156.value = state.chatDraft.message);
          return _el$147;
        })()];
      }
    }));
...
function PixelWorldHost(props) {
  ...
  return (() => {
    var _el$176 = _tmpl$55$1(), _el$181 = _el$176.firstChild, _el$182 = _el$181.firstChild, _el$183 = _el$182.nextSibling, _el$220 = _el$181.nextSibling, _el$221 = _el$220.firstChild;
    setAttribute(_el$176, "data-visual-fixture", visualFixtureName || "");
    insert(_el$176, createComponent(Show, {
      get when() {
        return !focusMode() || !maximized();
      },
      get children() {
        var _el$177 = _tmpl$47$1(), _el$178 = _el$177.firstChild, _el$179 = _el$178.firstChild, _el$180 = _el$179.nextSibling;
        insert(_el$179, () => tr$1(locale(), "世界指挥棋盘", "World Command Board"));
        insert(_el$180, () => renderState()?.commercial_surface?.objective?.detail || tr$1(locale(), "等待 Rust bridge 生成世界显示状态。", "Waiting for the Rust bridge to derive the world display state."));
        return _el$177;
      }
    }), _el$181);
    insert(_el$182, () => tr$1(locale(), "拖动、缩放并检查世界", "Pan, zoom, and inspect the world"));
    addEventListener(_el$183, "click", focusController.enterFocusMode);
    insert(_el$183, (() => {
      var _c$8 = memo(() => rendererStatus() === "unavailable");
      return () => _c$8() ? tr$1(locale(), "电影视图（当前不可用）", "Cinematic View (unavailable)") : tr$1(locale(), "电影视图", "Cinematic View");
    })());
    insert(_el$176, createComponent(Show, {
      get when() {
    ...
    insert(_el$176, createComponent(Show, {
      ...
      get children() {
        var _el$184 = _tmpl$48$1();
        insert(_el$184, (() => {
          var _c$9 = memo(() => rendererStatus() === "unavailable");
          return () => _c$9() ? [(() => {
            var _el$224 = _tmpl$56$1();
            insert(_el$224, () => tr$1(locale(), "此浏览器中的图形不可用", "Graphics unavailable in this browser"));
            return _el$224;
          })(), (() => {
            var _el$225 = _tmpl$57$1();
            _el$225.$$click = requestReadyMode;
            insert(_el$225, () => tr$1(locale(), "重试 Renderer", "Retry Renderer"));
            return _el$225;
    ...
    insert(_el$176, createComponent(Show, {
      ...
      get children() {
        ...
        insert(_el$185, createComponent(PixelWorldActionReceipt, {
    ...
    insert(_el$176, createComponent(Show, {
      ...
      get children() {
        var _el$186 = _tmpl$50$1(), _el$187 = _el$186.firstChild, _el$188 = _el$187.nextSibling;
        _el$186.addEventListener("toggle", (event) => {
        ...
        insert(_el$187, () => tr$1(locale(), "命令与目标", "Command and Target"));
        insert(_el$188, createComponent(PixelWorldFocusCommandSurface, {
          locale
        }));
        createRenderEffect(() => _el$186.open = commandDrawerOpen());
        return _el$186;
      }
    }), _el$220);
    insert(_el$176, createComponent(Show, {
      ...
      get children() {
        var _el$189 = _tmpl$52$1(), _el$190 = _el$189.firstChild, _el$191 = _el$190.nextSibling, _el$192 = _el$191.firstChild, _el$193 = _el$192.nextSibling, _el$194 = _el$193.nextSibling, _el$196 = _el$194.nextSibling, _el$197 = _el$196.nextSibling, _el$198 = _el$197.nextSibling, _el$199 = _el$198.nextSibling, _el$200 = _el$199.nextSibling, _el$201 = _el$200.nextSibling, _el$205 = _el$201.nextSibling, _el$206 = _el$205.nextSibling, _el$207 = _el$206.nextSibling;
        insert(_el$190, () => tr$1(locale(), "Renderer 诊断", "Renderer Diagnostics"));
        insert(_el$192, () => `locations=${visualState().locations.length}`);
        insert(_el$193, () => `fragments=${visualState().fragmentTerrain.length}`);
        insert(_el$194, () => `agents=${visualState().agents.length}`);
        insert(_el$191, createComponent(Show, {
          get when() {
            return memo(() => renderState()?.world_tick !== null)() && renderState()?.world_tick !== void 0;
          },
          get children() {
            var _el$195 = _tmpl$22$1();
            insert(_el$195, () => `tick=${renderState()?.world_tick}`);
            createRenderEffect(() => setAttribute(_el$195, "data-world-tick", String(renderState()?.world_tick)));
            return _el$195;
          }
        }), _el$196);
        insert(_el$196, () => `links=${visualState().links.length}`);
        insert(_el$197, () => `hotspots=${arrayField(renderState(), "visual_hotspots", "visualHotspots").length}`);
        insert(_el$198, () => `derived_positions=${visualState().agents.filter((agent) => agent.position_source === "location_derived").length}`);
        insert(_el$199, () => visualState().worldBounds ? "world_bounds=ready" : "world_bounds=missing");
        insert(_el$200, () => `renderer=${rendererStatus()}`);
        insert(_el$201, () => `runtime=${runtimeSource()}`);
        insert(_el$191, createComponent(Show, {
          get when() {
            return cameraState();
          },
          get children() {
            var _el$202 = _tmpl$38$1();
            insert(_el$202, () => `zoom=${cameraState().zoom.toFixed(2)}`);
            return _el$202;
          }
        }), _el$205);
        insert(_el$191, createComponent(Show, {
          ...
          get children() {
            var _el$203 = _tmpl$38$1();
            insert(_el$203, () => `pan=${cameraState().pan_x_px},${cameraState().pan_y_px}`);
            return _el$203;
          }
        }), _el$205);
        insert(_el$191, createComponent(Show, {
          ...
          get children() {
            var _el$204 = _tmpl$38$1();
            insert(_el$204, () => `hover=${hoverSelection().kind}/${hoverSelection().id}`);
            return _el$204;
          }
        }), _el$205);
        _el$205.$$click = requestReadyMode;
        insert(_el$205, () => tr$1(locale(), "重新挂载嵌入式 Renderer", "Reattach Embedded Renderer"));
        _el$206.$$click = simulateFatal;
        insert(_el$206, () => tr$1(locale(), "模拟 Renderer Fatal", "Simulate Renderer Fatal"));
        insert(_el$207, () => tr$1(locale(), "当前世界舞台只依赖 wasm/Rust bridge、嵌入式 canvas、轻量拖拽缩放和事件回传。", "The world stage depends only on the wasm/Rust bridge, embedded canvas, light pan-zoom interaction, and event callbacks."));
        insert(_el$191, createComponent(Show, {
          get when() {
            return memo(() => rendererStatus() === "unavailable")() && rendererFatal();
          },
          get children() {
            var _el$208 = _tmpl$51$1();
            insert(_el$208, () => `${rendererFatal().code}: ${rendererFatal().message}`);
            return _el$208;
          }
        }), null);
        createRenderEffect(() => setAttribute(_el$189, "data-renderer-state", rendererStatus()));
        return _el$189;
      }
    }), _el$220);
    insert(_el$176, createComponent(Show, {
      ...
      get children() {
        var _el$209 = _tmpl$53$1(), _el$210 = _el$209.firstChild, _el$211 = _el$210.nextSibling, _el$212 = _el$211.firstChild, _el$214 = _el$212.firstChild, _el$215 = _el$214.nextSibling, _el$216 = _el$215.nextSibling, _el$218 = _el$212.nextSibling, _el$219 = _el$218.firstChild;
        _el$209.addEventListener("toggle", (event) => {
          const open = event.currentTarget.open;
          if (open) {
        ...
        insert(_el$210, () => tr$1(locale(), "电影视图诊断", "Cinematic Diagnostics"));
        insert(_el$212, createComponent(Show, {
          get when() {
            return memo(() => renderState().world_tick !== null)() && renderState().world_tick !== void 0;
          },
          get children() {
            var _el$213 = _tmpl$22$1();
            insert(_el$213, () => `tick=${renderState().world_tick}`);
            createRenderEffect(() => setAttribute(_el$213, "data-world-tick", String(renderState().world_tick)));
            return _el$213;
          }
        }), _el$214);
        insert(_el$214, () => `renderer=${rendererStatus()}`);
        insert(_el$215, () => `runtime=${runtimeSource()}`);
        insert(_el$216, () => `derived_positions=${renderState().agents.filter((agent) => agent.position_source === "location_derived").length}`);
        insert(_el$212, createComponent(Show, {
          get when() {
            return rendererFatal();
          },
          get children() {
            var _el$217 = _tmpl$26$1();
            insert(_el$217, () => rendererFatal().code);
            return _el$217;
          }
        }), null);
        _el$219.$$click = requestReadyMode;
        insert(_el$219, () => tr$1(locale(), "重新挂载嵌入式 Renderer", "Reattach Embedded Renderer"));
        createRenderEffect(() => _el$209.open = diagnosticsDrawerOpen());
        return _el$209;
      }
    }), _el$220);
    _el$220.addEventListener("toggle", (event) => setRenderDtoOpen(event.currentTarget.open));
    insert(_el$221, () => tr$1(locale(), "展开 Render DTO", "Expand Render DTO"));
    insert(_el$220, createComponent(Show, {
      get when() {
        return renderDtoOpen();
      },
      get children() {
        var _el$222 = _tmpl$54$1(), _el$223 = _el$222.firstChild;
        insert(_el$223, () => JSON.stringify(renderState(), null, 2));
        return _el$222;
      }
    }), null);
    createRenderEffect((_p$) => {
...
var _tmpl$$m = /* @__PURE__ */ template(`<span class=badge>`), _tmpl$2$m = /* @__PURE__ */ template(`<div class="feedback-detail world-feed__notice">`), _tmpl$3$k = /* @__PURE__ */ template(`<div class="toolbar world-feed__recovery"><button type=button data-world-feed-action=reload-authoritative-snapshot>`), _tmpl$4$g = /* @__PURE__ */ template(`<div class="toolbar world-feed__recovery"><button type=button data-world-feed-action=retry-world-feed>`), _tmpl$5$f = /* @__PURE__ */ template(`<div class="event-list world-feed__events"data-world-feed-events=true>`), _tmpl$6$9 = /* @__PURE__ */ template(`<details id=viewer-world-feed class="panel panel--world-feed"data-viewer-overlay=feed data-viewer-surface=world-feed aria-live=polite><summary class="panel__header panel__header--stack world-feed__summary"><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></summary><div class="panel__body world-feed__body"><div class=world-feed__status-row><span>`), _tmpl$7$5 = /* @__PURE__ */ template(`<div class=world-feed__empty data-world-feed-empty=true>`), _tmpl$8$2 = /* @__PURE__ */ template(`<a class=world-feed__receipt-link href=#viewer-action-receipt>`), _tmpl$9$2 = /* @__PURE__ */ template(`<article class="event-card world-feed__event"><div class=event-card__header><div class=event-card__title></div><span class=badge></span></div><div class=event-card__meta>`);
...
function WorldFeedPanel(props) {
  ...
  return (() => {
    var _el$ = _tmpl$6$9(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling, _el$5 = _el$4.nextSibling, _el$6 = _el$2.nextSibling, _el$7 = _el$6.firstChild, _el$8 = _el$7.firstChild;
    ...
    insert(_el$6, createComponent(Show, {
      ...
      get children() {
        var _el$10 = _tmpl$3$k(), _el$11 = _el$10.firstChild;
    ...
    insert(_el$6, createComponent(Show, {
      ...
      get children() {
        var _el$12 = _tmpl$4$g(), _el$13 = _el$12.firstChild;
    ...
    insert(_el$6, createComponent(Show, {
      ...
      get children() {
        ...
        insert(_el$14, createComponent(For, {
          ...
          children: (event) => (() => {
            var _el$16 = _tmpl$9$2(), _el$17 = _el$16.firstChild, _el$18 = _el$17.firstChild, _el$19 = _el$18.nextSibling, _el$20 = _el$17.nextSibling;
            ...
            insert(_el$16, createComponent(Show, {
              ...
              get children() {
                var _el$21 = _tmpl$8$2();
                insert(_el$21, () => tr2(locale(), `查看明确回执 ${event.receipt_ref}`, `View explicit receipt ${event.receipt_ref}`));
                createRenderEffect(() => setAttribute(_el$21, "data-world-feed-receipt-ref", event.receipt_ref));
                return _el$21;
              }
            }), null);
            createRenderEffect(() => setAttribute(_el$16, "data-world-feed-event", event.event_seq));
            return _el$16;
          })()
        }));
        return _el$14;
...
var _tmpl$$l = /* @__PURE__ */ template(`<nav class=mobile-rail><a class=mobile-rail__link href=#viewer-stage-panel></a><a class=mobile-rail__link href=#viewer-targets-panel></a><a class=mobile-rail__link href=#viewer-details-panel>`), _tmpl$2$l = /* @__PURE__ */ template(`<nav class=secondary-viewer-nav><button type=button class=secondary-viewer-nav__more aria-controls=viewer-diagnostics-panel>`);
...
function MobileJumpRail(props) {
  ...
  return (() => {
    var _el$ = _tmpl$$l(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.nextSibling;
...
function SecondaryViewerNavigation(props) {
  ...
  return (() => {
    var _el$5 = _tmpl$2$l(), _el$6 = _el$5.firstChild;
...
delegateEvents(["click"]);
var _tmpl$$k = /* @__PURE__ */ template(`<section id=viewer-director-panel class="panel director-surface"data-viewer-surface=director data-director-mode=active tabindex=-1 aria-labelledby=viewer-director-title><div class="panel__header panel__header--stack"><div class=panel__eyebrow></div><div class=panel__title id=viewer-director-title></div><div class=panel__meta-copy></div><button id=viewer-director-exit type=button class=panel__route-close></button></div><div class="panel__body stack"><div class=badge-row><span class="badge badge--good">server_validated</span><span class=badge></span><span class=badge></span></div><div class=director-density-grid><div class=hero-focus-card><div class=hero-focus-card__label></div><div class="hero-focus-card__value hero-focus-card__value--body"></div></div><div class=hero-focus-card><div class=hero-focus-card__label></div><div class="hero-focus-card__value hero-focus-card__value--body"></div></div><div class=hero-focus-card><div class=hero-focus-card__label></div><div class="hero-focus-card__value hero-focus-card__value--body"></div></div><div class=hero-focus-card><div class=hero-focus-card__label></div><div class="hero-focus-card__value hero-focus-card__value--body"></div></div></div><div class=badge-row><span class=badge></span><span class=badge></span><span class=badge></span></div><div class=feedback-detail></div><div class=director-density-list>`), _tmpl$2$k = /* @__PURE__ */ template(`<div class=director-density-list__row><span></span><span class="badge badge--diagnostic">`), _tmpl$3$j = /* @__PURE__ */ template(`<div class=director-entry-card><div class=panel__title></div><div class=feedback-detail></div><div class=toolbar><button id=viewer-director-entry type=button class="button button--secondary">`);
  ...
  return createComponent(Show, {
    ...
    get children() {
      ...
      insert(_el$28, createComponent(For, {
        ...
        children: (label) => (() => {
          var _el$29 = _tmpl$2$k(), _el$30 = _el$29.firstChild, _el$31 = _el$30.nextSibling;
          insert(_el$30, label);
...
function DirectorEntryCard(props) {
  ...
  return (() => {
    var _el$32 = _tmpl$3$j(), _el$33 = _el$32.firstChild, _el$34 = _el$33.nextSibling, _el$35 = _el$34.nextSibling, _el$36 = _el$35.firstChild;
...
function MicroDepotFacilitiesPanel(props) {
  ...
  return createComponent(Show, {
    ...
    get children() {
      var _el$ = _tmpl$$j(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild, _el$5 = _el$4.nextSibling, _el$6 = _el$5.nextSibling, _el$7 = _el$2.nextSibling;
  ...
  return createComponent(Show, {
    ...
    get children() {
      ...
      insert(_el$4, createComponent(For, {
        ...
        children: (option) => (() => {
          var _el$5 = _tmpl$3$h(), _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$8 = _el$6.nextSibling, _el$9 = _el$8.firstChild;
...
var _tmpl$$h = /* @__PURE__ */ template(`<div class=fallback-tradeoff__detail><dt></dt><dd>`), _tmpl$2$h = /* @__PURE__ */ template(`<aside class="event-card fallback-tradeoff__handoff"data-testid=viewer-no-safe-fallback-handoff><div class=event-card__title><h4></h4><span class="badge badge--warn"></span></div><dl class=fallback-tradeoff__details>`), _tmpl$3$g = /* @__PURE__ */ template(`<section class=fallback-tradeoff aria-labelledby=fallback-tradeoff-heading data-testid=viewer-fallback-tradeoff><div class=fallback-tradeoff__heading><h3 id=fallback-tradeoff-heading></h3><span></span></div><div class=summary-grid role=list>`), _tmpl$4$e = /* @__PURE__ */ template(`<span class="badge badge--accent">`), _tmpl$5$d = /* @__PURE__ */ template(`<article data-testid=viewer-fallback-tradeoff-option role=listitem><div class=event-card__title><h4></h4><div class=badge-row><span></span></div></div><dl class=fallback-tradeoff__details>`);
...
function FallbackTradeoffPanel(props) {
  ...
  return createComponent(Show, {
    ...
    get children() {
      var _el$4 = _tmpl$3$g(), _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.nextSibling, _el$8 = _el$5.nextSibling;
      ...
      insert(_el$8, createComponent(For, {
        ...
        children: (option) => (() => {
          var _el$12 = _tmpl$5$d(), _el$13 = _el$12.firstChild, _el$14 = _el$13.firstChild, _el$15 = _el$14.nextSibling, _el$16 = _el$15.firstChild, _el$18 = _el$13.nextSibling;
      ...
      insert(_el$4, createComponent(Show, {
        ...
        get children() {
          var _el$9 = _tmpl$2$h(), _el$0 = _el$9.firstChild, _el$1 = _el$0.firstChild, _el$10 = _el$1.nextSibling, _el$11 = _el$0.nextSibling;
...
var _tmpl$$g = /* @__PURE__ */ template(`<div class=metric><div class=metric__label></div><div class=metric__value>`), _tmpl$2$g = /* @__PURE__ */ template(`<section class=event-card data-testid=wait-resolution-quote><div class=event-card__title><h3></h3><span></span></div><div class=feedback-summary></div><div class=summary-grid>`);
...
function WaitResolutionQuoteCard(props) {
  ...
  return (() => {
    var _el$4 = _tmpl$2$g(), _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.nextSibling, _el$8 = _el$5.nextSibling, _el$9 = _el$8.nextSibling;
...
var _tmpl$$f = /* @__PURE__ */ template(`<div class=metric><div class=metric__label></div><div class=metric__value>`), _tmpl$2$f = /* @__PURE__ */ template(`<section class="panel panel--nested"data-testid=product-validation-quote data-quote-kind=preflight><div class=panel__header><div class="stack stack--compact"><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></div></div><div class="panel__body stack"><div class=badge-row><span class="badge badge--accent"></span><span class=badge></span><span class=badge></span><span></span></div><div class=summary-grid></div><div class=feedback-summary data-testid=product-validation-quote-recommended-action>`), _tmpl$3$f = /* @__PURE__ */ template(`<div class="feedback-summary feedback-summary--warn"data-testid=product-validation-quote-advisory>`), _tmpl$4$d = /* @__PURE__ */ template(`<div class=feedback-detail>`), _tmpl$5$c = /* @__PURE__ */ template(`<section class="panel panel--nested"data-testid=product-validation-quote-panel data-quote-kind=preflight><div class=panel__header><div class="stack stack--compact"><div class=panel__eyebrow></div><div class=panel__title></div></div></div><div class="panel__body stack"><form class="stack stack--compact"data-testid=product-validation-quote-request-form><label><span></span><input></label><label><span></span><input type=number min=1 step=1 inputmode=numeric></label><button type=submit class="button button--secondary">`), _tmpl$6$7 = /* @__PURE__ */ template(`<div class="feedback-summary feedback-summary--error"role=alert>`), _tmpl$7$3 = /* @__PURE__ */ template(`<div class=feedback-summary role=status>`);
function raw(value2) {
...
function ProductValidationQuoteCard(props) {
  ...
  return (() => {
    var _el$4 = _tmpl$2$f(), _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$8 = _el$7.nextSibling, _el$9 = _el$8.nextSibling, _el$0 = _el$5.nextSibling, _el$1 = _el$0.firstChild, _el$10 = _el$1.firstChild, _el$11 = _el$10.nextSibling, _el$12 = _el$11.nextSibling, _el$13 = _el$12.nextSibling, _el$14 = _el$1.nextSibling, _el$15 = _el$14.nextSibling;
...
function ProductValidationQuotePanel(props) {
  ...
  return (() => {
    var _el$19 = _tmpl$5$c(), _el$20 = _el$19.firstChild, _el$21 = _el$20.firstChild, _el$22 = _el$21.firstChild, _el$23 = _el$22.nextSibling, _el$24 = _el$20.nextSibling, _el$25 = _el$24.firstChild, _el$26 = _el$25.firstChild, _el$27 = _el$26.firstChild, _el$28 = _el$27.nextSibling, _el$29 = _el$26.nextSibling, _el$30 = _el$29.firstChild, _el$31 = _el$30.nextSibling, _el$32 = _el$29.nextSibling;
...
var _tmpl$$e = /* @__PURE__ */ template(`<div class=metric><div class=metric__label></div><div class=metric__value>`), _tmpl$2$e = /* @__PURE__ */ template(`<section class="panel panel--nested"data-testid=power-survival-quote data-quote-kind=preflight><div class=panel__header><div class="stack stack--compact"><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></div></div><div class="panel__body stack"><div class=badge-row><span class="badge badge--accent"></span><span class=badge></span><span class=badge></span><span class=badge></span></div><div class=summary-grid></div><div class=feedback-summary data-testid=power-survival-shutdown-avoidance></div><div class=feedback-summary data-testid=power-survival-recommendation>`), _tmpl$3$e = /* @__PURE__ */ template(`<section id=viewer-power-survival-quote-panel class="panel panel--nested"data-testid=power-survival-quote-panel data-quote-kind=preflight><div class=panel__header><div class="stack stack--compact"><div class=panel__eyebrow></div><div class=panel__title></div></div></div><div class="panel__body stack"><form class="stack stack--compact"data-testid=power-survival-quote-request-form><label><span></span><input></label><label><span></span><input type=number min=1 step=1 inputmode=numeric></label><label><span></span><input type=number min=0 step=1 inputmode=numeric></label><button type=submit class="button button--secondary">`), _tmpl$4$c = /* @__PURE__ */ template(`<div class="feedback-summary feedback-summary--error"role=alert>`), _tmpl$5$b = /* @__PURE__ */ template(`<div class=feedback-summary role=status>`), _tmpl$6$6 = /* @__PURE__ */ template(`<div class="feedback-summary feedback-summary--warn"role=status data-testid=power-survival-quote-stale>`);
...
function PowerSurvivalQuoteCard(props) {
  ...
  const tr2 = props.tr;
  return (() => {
    var _el$4 = _tmpl$2$e(), _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$8 = _el$7.nextSibling, _el$9 = _el$8.nextSibling, _el$0 = _el$5.nextSibling, _el$1 = _el$0.firstChild, _el$10 = _el$1.firstChild, _el$11 = _el$10.nextSibling, _el$12 = _el$11.nextSibling, _el$13 = _el$12.nextSibling, _el$14 = _el$1.nextSibling, _el$15 = _el$14.nextSibling, _el$16 = _el$15.nextSibling;
    insert(_el$7, () => tr2(locale(), "提交前估价", "Before You Commit"));
...
function PowerSurvivalQuotePanel(props) {
  ...
  return (() => {
    var _el$17 = _tmpl$3$e(), _el$18 = _el$17.firstChild, _el$19 = _el$18.firstChild, _el$20 = _el$19.firstChild, _el$21 = _el$20.nextSibling, _el$22 = _el$18.nextSibling, _el$23 = _el$22.firstChild, _el$24 = _el$23.firstChild, _el$25 = _el$24.firstChild, _el$26 = _el$25.nextSibling, _el$27 = _el$24.nextSibling, _el$28 = _el$27.firstChild, _el$29 = _el$28.nextSibling, _el$30 = _el$27.nextSibling, _el$31 = _el$30.firstChild, _el$32 = _el$31.nextSibling, _el$33 = _el$30.nextSibling;
...
delegateEvents(["input"]);
var _tmpl$$d = /* @__PURE__ */ template(`<div class=metric><div class=metric__label></div><div class=metric__value>`), _tmpl$2$d = /* @__PURE__ */ template(`<section class="panel panel--nested"data-testid=power-sale-quote data-quote-kind=preflight><div class=panel__header><div class="stack stack--compact"><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></div></div><div class="panel__body stack"><div class=badge-row><span class="badge badge--accent"></span><span class=badge></span><span class=badge></span><span class=badge></span></div><div class=summary-grid></div><div data-testid=power-sale-production-risk></div><div class=feedback-summary data-testid=power-sale-rationale></div><div class=feedback-summary data-testid=power-sale-recommendation>`), _tmpl$3$d = /* @__PURE__ */ template(`<section id=viewer-power-sale-quote-panel class="panel panel--nested"data-testid=power-sale-quote-panel data-quote-kind=preflight><div class=panel__header><div class="stack stack--compact"><div class=panel__eyebrow></div><div class=panel__title></div></div></div><div class="panel__body stack"><form class="stack stack--compact"data-testid=power-sale-quote-request-form><label><span></span><input></label><label><span></span><input type=number min=1 step=1 inputmode=numeric></label><label><span></span><input type=number min=0 step=1 inputmode=numeric></label><button type=submit class="button button--secondary">`), _tmpl$4$b = /* @__PURE__ */ template(`<div class="feedback-summary feedback-summary--error"role=alert>`), _tmpl$5$a = /* @__PURE__ */ template(`<div class=feedback-summary role=status>`), _tmpl$6$5 = /* @__PURE__ */ template(`<div class="feedback-summary feedback-summary--warn"role=status>`);
...
function PowerSaleQuotePanel(props) {
  ...
  return (() => {
    var _el$18 = _tmpl$3$d(), _el$19 = _el$18.firstChild, _el$20 = _el$19.firstChild, _el$21 = _el$20.firstChild, _el$22 = _el$21.nextSibling, _el$23 = _el$19.nextSibling, _el$24 = _el$23.firstChild, _el$25 = _el$24.firstChild, _el$26 = _el$25.firstChild, _el$27 = _el$26.nextSibling, _el$28 = _el$25.nextSibling, _el$29 = _el$28.firstChild, _el$30 = _el$29.nextSibling, _el$31 = _el$28.nextSibling, _el$32 = _el$31.firstChild, _el$33 = _el$32.nextSibling, _el$34 = _el$31.nextSibling;
...
delegateEvents(["input"]);
var _tmpl$$c = /* @__PURE__ */ template(`<div class=metric><div class=metric__label></div><div class=metric__value>`), _tmpl$2$c = /* @__PURE__ */ template(`<section class="panel panel--nested"data-testid=fragment-refill-preview-panel data-quote-kind=preflight><div class=panel__header><div class="stack stack--compact"><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></div></div><div class="panel__body stack"><form class="stack stack--compact"data-testid=fragment-refill-preview-request-form><label><span></span><input type=number step=1 inputmode=numeric></label><label><span></span><input type=number step=1 inputmode=numeric></label><label><span></span><input type=number step=1 inputmode=numeric></label><button type=submit class="button button--secondary">`), _tmpl$3$c = /* @__PURE__ */ template(`<div class="feedback-summary feedback-summary--error"role=alert>`), _tmpl$4$a = /* @__PURE__ */ template(`<div class=feedback-summary role=status>`), _tmpl$5$9 = /* @__PURE__ */ template(`<div class="feedback-summary feedback-summary--warn"role=status data-testid=fragment-refill-preview-stale>`), _tmpl$6$4 = /* @__PURE__ */ template(`<div class=stack data-testid=fragment-refill-preview-card><div class=badge-row><span class="badge badge--accent"></span><span class=badge></span></div><div class=summary-grid></div><div class=feedback-summary></div><div class=feedback-detail>`), _tmpl$7$2 = /* @__PURE__ */ template(`<div class=feedback-detail>`);
...
function FragmentRefillPreviewPanel(props) {
  ...
  return (() => {
    var _el$4 = _tmpl$2$c(), _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$8 = _el$7.nextSibling, _el$9 = _el$8.nextSibling, _el$0 = _el$5.nextSibling, _el$1 = _el$0.firstChild, _el$10 = _el$1.firstChild, _el$11 = _el$10.firstChild, _el$12 = _el$11.nextSibling, _el$13 = _el$10.nextSibling, _el$14 = _el$13.firstChild, _el$15 = _el$14.nextSibling, _el$16 = _el$13.nextSibling, _el$17 = _el$16.firstChild, _el$18 = _el$17.nextSibling, _el$19 = _el$16.nextSibling;
    ...
    insert(_el$0, (() => {
      ...
      return () => _c$5() ? (() => {
        var _el$23 = _tmpl$6$4(), _el$24 = _el$23.firstChild, _el$25 = _el$24.firstChild, _el$26 = _el$25.nextSibling, _el$27 = _el$24.nextSibling, _el$28 = _el$27.nextSibling, _el$29 = _el$28.nextSibling;
...
function RefineQuotePreflightPanel(props) {
  ...
  return (() => {
    var _el$18 = _tmpl$4$9(), _el$19 = _el$18.firstChild, _el$20 = _el$19.firstChild, _el$21 = _el$20.firstChild, _el$22 = _el$21.nextSibling, _el$23 = _el$22.nextSibling, _el$24 = _el$19.nextSibling, _el$25 = _el$24.firstChild, _el$26 = _el$25.firstChild, _el$27 = _el$26.firstChild, _el$28 = _el$27.nextSibling, _el$29 = _el$26.nextSibling;
...
delegateEvents(["input"]);
var _tmpl$$a = /* @__PURE__ */ template(`<div class=metric><div class=metric__label></div><div class=metric__value>`), _tmpl$2$a = /* @__PURE__ */ template(`<section class="panel panel--nested"data-testid=market-quote-decision data-quote-kind=preflight><div class=panel__header><div class="stack stack--compact"><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></div></div><div class="panel__body stack"><div data-testid=market-quote-recommendation></div><div class=summary-grid></div><div class=feedback-detail data-testid=market-quote-rationale></div><div class=feedback-detail data-testid=market-quote-next-action></div><div class="feedback-summary feedback-summary--warn"data-testid=market-quote-conditional>`), _tmpl$3$a = /* @__PURE__ */ template(`<div class=feedback-detail data-testid=market-quote-contribution><strong>`), _tmpl$4$8 = /* @__PURE__ */ template(`<section class="panel panel--nested"data-testid=market-quote-decision-panel><div class=panel__header><div class=panel__title></div></div><div class="panel__body stack"><form class="stack stack--compact"data-testid=market-quote-decision-request-form><label><span></span><input></label><label><span></span><input type=number min=1 step=1></label><button class="button button--secondary"type=submit>`), _tmpl$5$7 = /* @__PURE__ */ template(`<div class="feedback-summary feedback-summary--error"role=alert>`);
...
function MarketQuoteDecisionCard(props) {
  ...
  const tr2 = props.tr;
  return (() => {
    var _el$4 = _tmpl$2$a(), _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$8 = _el$7.nextSibling, _el$9 = _el$8.nextSibling, _el$0 = _el$5.nextSibling, _el$1 = _el$0.firstChild, _el$10 = _el$1.nextSibling, _el$11 = _el$10.nextSibling, _el$12 = _el$11.nextSibling, _el$13 = _el$12.nextSibling;
    insert(_el$7, () => tr2(locale(), "提交前估价", "Before You Commit"));
    ...
    insert(_el$0, createComponent(For, {
      ...
      children: (item) => (() => {
        var _el$14 = _tmpl$3$a(), _el$15 = _el$14.firstChild;
...
function MarketQuoteDecisionPanel(props) {
  ...
  return (() => {
    var _el$16 = _tmpl$4$8(), _el$17 = _el$16.firstChild, _el$18 = _el$17.firstChild, _el$19 = _el$17.nextSibling, _el$20 = _el$19.firstChild, _el$21 = _el$20.firstChild, _el$22 = _el$21.firstChild, _el$23 = _el$22.nextSibling, _el$24 = _el$21.nextSibling, _el$25 = _el$24.firstChild, _el$26 = _el$25.nextSibling, _el$27 = _el$24.nextSibling;
...
var _tmpl$$9 = /* @__PURE__ */ template(`<div class=metric><div class=metric__label></div><div class=metric__value>`), _tmpl$2$9 = /* @__PURE__ */ template(`<section class="panel panel--nested"id=war-quote-card data-testid=war-declaration-quote data-quote-kind=preflight data-submission-allowed=false><div class=panel__header><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></div><div class="panel__body stack"><div id=war-quote-status role=status></div><div id=war-quote-blocker data-testid=war-declaration-blocker></div><div class=summary-grid></div><div class=feedback-summary data-testid=war-declaration-mobilization-electricity></div><div class=feedback-summary data-testid=war-declaration-mobilization-data></div><div id=war-quote-risk class="feedback-summary feedback-summary--warn"data-testid=war-declaration-risk></div><div id=war-quote-recommendation class=feedback-summary data-testid=war-declaration-recommendation></div><div class=feedback-detail></div><button id=war-quote-declare class="button button--secondary"type=button disabled data-testid=war-declaration-submit-disabled>`), _tmpl$3$9 = /* @__PURE__ */ template(`<section class="panel panel--nested"id=war-declaration-quote-panel data-testid=war-declaration-quote-panel><div class=panel__header><div class=panel__title></div></div><div class="panel__body stack"><form class="stack stack--compact"data-testid=war-declaration-quote-request-form><label><span></span><input></label><label><span></span><input></label><label><span></span><input type=number min=1 max=10></label><button id=war-quote-refresh class="button button--secondary"type=submit>`), _tmpl$4$7 = /* @__PURE__ */ template(`<div id=war-quote-unavailable role=alert class="feedback-summary feedback-summary--warn"data-testid=war-declaration-unavailable>`), _tmpl$5$6 = /* @__PURE__ */ template(`<div id=war-quote-stale role=status class="feedback-summary feedback-summary--warn"data-testid=war-declaration-quote-stale>`);
...
function WarDeclarationQuotePanel(props) {
  ...
  return (() => {
    var _el$17 = _tmpl$3$9(), _el$18 = _el$17.firstChild, _el$19 = _el$18.firstChild, _el$20 = _el$18.nextSibling, _el$21 = _el$20.firstChild, _el$22 = _el$21.firstChild, _el$23 = _el$22.firstChild, _el$24 = _el$23.nextSibling, _el$25 = _el$22.nextSibling, _el$26 = _el$25.firstChild, _el$27 = _el$26.nextSibling, _el$28 = _el$25.nextSibling, _el$29 = _el$28.firstChild, _el$30 = _el$29.nextSibling, _el$31 = _el$28.nextSibling;
...
delegateEvents(["input"]);
var _tmpl$$8 = /* @__PURE__ */ template(`<div class=metric><div class=metric__label></div><div class=metric__value>`), _tmpl$2$8 = /* @__PURE__ */ template(`<section class="panel panel--nested"data-testid=governance-vote-quote data-quote-kind=preflight data-submission-allowed=false><div class=panel__header><div class="stack stack--compact"><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></div></div><div class="panel__body stack"><div class=summary-grid></div><div class=feedback-summary></div><div class="feedback-summary feedback-summary--warn"></div><div class=feedback-summary><span>`), _tmpl$3$8 = /* @__PURE__ */ template(`<section class="panel panel--nested"data-testid=governance-vote-quote-panel><div class=panel__header><div class="stack stack--compact"><div class=panel__title></div></div></div><div class="panel__body stack"><form class="stack stack--compact"><label><span></span><input></label><label><span></span><input></label><label><span></span><input type=number min=1></label><button class="button button--secondary"type=submit>`), _tmpl$4$6 = /* @__PURE__ */ template(`<div role=alert class="feedback-summary feedback-summary--warn">`);
...
function GovernanceVoteQuoteCard(props) {
  const q = () => props.quote || {};
  return (() => {
    var _el$4 = _tmpl$2$8(), _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$8 = _el$7.nextSibling, _el$9 = _el$8.nextSibling, _el$0 = _el$5.nextSibling, _el$1 = _el$0.firstChild, _el$10 = _el$1.nextSibling, _el$11 = _el$10.nextSibling, _el$12 = _el$11.nextSibling, _el$13 = _el$12.firstChild;
...
function GovernanceVoteQuotePanel(props) {
  ...
  return (() => {
    var _el$14 = _tmpl$3$8(), _el$15 = _el$14.firstChild, _el$16 = _el$15.firstChild, _el$17 = _el$16.firstChild, _el$18 = _el$15.nextSibling, _el$19 = _el$18.firstChild, _el$20 = _el$19.firstChild, _el$21 = _el$20.firstChild, _el$22 = _el$21.nextSibling, _el$23 = _el$20.nextSibling, _el$24 = _el$23.firstChild, _el$25 = _el$24.nextSibling, _el$26 = _el$23.nextSibling, _el$27 = _el$26.firstChild, _el$28 = _el$27.nextSibling, _el$29 = _el$26.nextSibling;
...
delegateEvents(["input"]);
var _tmpl$$7 = /* @__PURE__ */ template(`<div class=metric><div class=metric__label></div><div class=metric__value>`), _tmpl$2$7 = /* @__PURE__ */ template(`<section class="panel panel--nested"data-testid=schedule-recipe-quote data-quote-kind=preflight><div class=panel__header><div class="stack stack--compact"><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></div></div><div class="panel__body stack"><div class=badge-row><span class="badge badge--accent"></span><span class=badge></span><span class=badge></span><span class=badge></span></div><div data-testid=schedule-recipe-quote-risk></div><div data-testid=schedule-recipe-quote-recommendation></div><div class=summary-grid></div><div class=feedback-summary></div><div class=feedback-summary>`), _tmpl$3$7 = /* @__PURE__ */ template(`<section id=viewer-schedule-recipe-quote-panel class="panel panel--nested"data-testid=schedule-recipe-quote-panel data-quote-kind=preflight><div class=panel__header><div class="stack stack--compact"><div class=panel__eyebrow></div><div class=panel__title></div></div></div><div class="panel__body stack"><form class="stack stack--compact"data-testid=schedule-recipe-quote-request-form><label><span></span><input></label><label><span></span><input></label><label><span></span><input type=number min=1 step=1 inputmode=numeric></label><button type=submit class="button button--secondary">`), _tmpl$4$5 = /* @__PURE__ */ template(`<div class="feedback-summary feedback-summary--error"role=alert>`), _tmpl$5$5 = /* @__PURE__ */ template(`<div class=feedback-summary role=status>`);
...
function ScheduleRecipeQuoteCard(props) {
  ...
  const tr2 = props.tr;
  return (() => {
    var _el$4 = _tmpl$2$7(), _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$8 = _el$7.nextSibling, _el$9 = _el$8.nextSibling, _el$0 = _el$5.nextSibling, _el$1 = _el$0.firstChild, _el$10 = _el$1.firstChild, _el$11 = _el$10.nextSibling, _el$12 = _el$11.nextSibling, _el$13 = _el$12.nextSibling, _el$14 = _el$1.nextSibling, _el$15 = _el$14.nextSibling, _el$16 = _el$15.nextSibling, _el$17 = _el$16.nextSibling, _el$18 = _el$17.nextSibling;
    insert(_el$7, () => tr2(locale(), "提交前估价", "Before You Commit"));
...
function ScheduleRecipeQuotePanel(props) {
  ...
  return (() => {
    var _el$19 = _tmpl$3$7(), _el$20 = _el$19.firstChild, _el$21 = _el$20.firstChild, _el$22 = _el$21.firstChild, _el$23 = _el$22.nextSibling, _el$24 = _el$20.nextSibling, _el$25 = _el$24.firstChild, _el$26 = _el$25.firstChild, _el$27 = _el$26.firstChild, _el$28 = _el$27.nextSibling, _el$29 = _el$26.nextSibling, _el$30 = _el$29.firstChild, _el$31 = _el$30.nextSibling, _el$32 = _el$29.nextSibling, _el$33 = _el$32.firstChild, _el$34 = _el$33.nextSibling, _el$35 = _el$32.nextSibling;
    insert(_el$22, () => tr2(locale(), "提交前估价", "Before You Commit"));
...
delegateEvents(["input"]);
var _tmpl$$6 = /* @__PURE__ */ template(`<div class=metric><div class=metric__label></div><div class=metric__value>`), _tmpl$2$6 = /* @__PURE__ */ template(`<section class="panel panel--nested"data-testid=transfer-material-quote data-quote-kind=preflight><div class=panel__header><div class="stack stack--compact"><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></div></div><div class="panel__body stack"><div class=badge-row><span class="badge badge--accent"></span><span class=badge></span><span class=badge></span></div><div data-testid=transfer-material-quote-recommendation></div><div class=summary-grid></div><div class=feedback-summary></div><div class=feedback-summary>`), _tmpl$3$6 = /* @__PURE__ */ template(`<section id=viewer-transfer-material-quote-panel class="panel panel--nested"data-testid=transfer-material-quote-panel data-quote-kind=preflight><div class=panel__header><div class="stack stack--compact"><div class=panel__eyebrow></div><div class=panel__title></div></div></div><div class="panel__body stack"><form class="stack stack--compact"data-testid=transfer-material-quote-request-form><label><span></span><input></label><label><span></span><input></label><label><span></span><input></label><label><span></span><input type=number min=1 step=1 inputmode=numeric></label><label><span></span><input type=number min=0 step=1 inputmode=numeric></label><label><span></span><select><option value></option><option value=standard></option><option value=urgent></option></select></label><button type=submit class="button button--secondary">`), _tmpl$4$4 = /* @__PURE__ */ template(`<div class="feedback-summary feedback-summary--error"role=alert>`), _tmpl$5$4 = /* @__PURE__ */ template(`<div class=feedback-summary role=status>`);
...
function TransferMaterialQuoteCard(props) {
  ...
  return (() => {
    var _el$4 = _tmpl$2$6(), _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$8 = _el$7.nextSibling, _el$9 = _el$8.nextSibling, _el$0 = _el$5.nextSibling, _el$1 = _el$0.firstChild, _el$10 = _el$1.firstChild, _el$11 = _el$10.nextSibling, _el$12 = _el$11.nextSibling, _el$13 = _el$1.nextSibling, _el$14 = _el$13.nextSibling, _el$15 = _el$14.nextSibling, _el$16 = _el$15.nextSibling;
    insert(_el$7, () => tr2(locale(), "提交前估价", "Before You Commit"));
...
function TransferMaterialQuotePanel(props) {
  ...
  return (() => {
    var _el$17 = _tmpl$3$6(), _el$18 = _el$17.firstChild, _el$19 = _el$18.firstChild, _el$20 = _el$19.firstChild, _el$21 = _el$20.nextSibling, _el$22 = _el$18.nextSibling, _el$23 = _el$22.firstChild, _el$24 = _el$23.firstChild, _el$25 = _el$24.firstChild, _el$26 = _el$25.nextSibling, _el$27 = _el$24.nextSibling, _el$28 = _el$27.firstChild, _el$29 = _el$28.nextSibling, _el$30 = _el$27.nextSibling, _el$31 = _el$30.firstChild, _el$32 = _el$31.nextSibling, _el$33 = _el$30.nextSibling, _el$34 = _el$33.firstChild, _el$35 = _el$34.nextSibling, _el$36 = _el$33.nextSibling, _el$37 = _el$36.firstChild, _el$38 = _el$37.nextSibling, _el$39 = _el$36.nextSibling, _el$40 = _el$39.firstChild, _el$41 = _el$40.nextSibling, _el$42 = _el$41.firstChild, _el$43 = _el$42.nextSibling, _el$44 = _el$43.nextSibling, _el$45 = _el$39.nextSibling;
    insert(_el$20, () => tr2(locale(), "提交前估价", "Before You Commit"));
...
function AgentClaimChoiceCard(props) {
  ...
  return [createComponent(Show, {
    ...
    get children() {
      var _el$2 = _tmpl$3$4(), _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild;
...
var _tmpl$$3 = /* @__PURE__ */ template(`<div class=feedback-detail><div class=metric__label>`), _tmpl$2$3 = /* @__PURE__ */ template(`<div class="feedback-detail first-delivery-preview"><div class=metric__label>`), _tmpl$3$3 = /* @__PURE__ */ template(`<div>`);
...
var _tmpl$$2 = /* @__PURE__ */ template(`<div class=agent-activity__field><span class=metric__label></span><span>`), _tmpl$2$2 = /* @__PURE__ */ template(`<div class=agent-activity__field><span class=metric__label></span><span> <span class=entity-id>(<!>)`), _tmpl$3$2 = /* @__PURE__ */ template(`<div class=agent-activity><div class="agent-activity__heading metric__label"></div><div class=agent-activity__state>`);
...
function titleCaseIdentifier(value2) {
  ...
  return text2.replace(/\b\w/g, (letter) => letter.toUpperCase());
}
function humanizedActivityValue(value2) {
  const text2 = textValue$1(value2);
  if (!text2) {
    return "";
  }
  return /[_-]/.test(text2) ? titleCaseIdentifier(text2) : text2;
}
...
function describeAgentActivity(activity, locale = "en") {
  ...
  const target = textValue$1(activity.target);
  const targetLabel = humanizedActivityValue(target);
  const reason = humanizedActivityValue(activity.reason);
  const statusLabel2 = activityCopy(locale, status);
  return {
    kind: status,
    label: (status === "executing" || status === "waiting") && operation ? `${statusLabel2} ${operation}` : statusLabel2,
    operation,
    target,
    targetLabel,
    reason
...
function AgentActivitySurface(props) {
  ...
  return (() => {
    var _el$ = _tmpl$3$2(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling;
    ...
    insert(_el$, createComponent(Show, {
      get when() {
        return memo(() => !!(model().kind !== "unavailable" && model().kind !== "idle"))() && model().target;
      },
      get children() {
        var _el$7 = _tmpl$2$2(), _el$8 = _el$7.firstChild, _el$9 = _el$8.nextSibling, _el$0 = _el$9.firstChild, _el$1 = _el$0.nextSibling, _el$10 = _el$1.firstChild, _el$12 = _el$10.nextSibling;
        _el$12.nextSibling;
        insert(_el$8, () => activityCopy(locale(), "target"));
        insert(_el$9, () => model().targetLabel, _el$0);
        insert(_el$1, () => model().target, _el$12);
        createRenderEffect(() => setAttribute(_el$9, "title", model().targetLabel));
        return _el$7;
      }
    }), null);
    insert(_el$, createComponent(Show, {
      ...
      get children() {
        var _el$13 = _tmpl$$2(), _el$14 = _el$13.firstChild, _el$15 = _el$14.nextSibling;
        insert(_el$14, () => activityCopy(locale(), "reason"));
        insert(_el$15, () => model().reason);
        return _el$13;
      }
    }), null);
...
const ALLOWED_CONTROL_STATES = /* @__PURE__ */ new Set(["controllable", "read_only", "control_lost", "unavailable"]);
const ALLOWED_FRESHNESS = /* @__PURE__ */ new Set(["current", "stale", "reconnecting", "unknown", "conflict", "unavailable"]);
...
function AgentIntentSurface(props) {
  ...
  return (() => {
    ...
    insert(_el$, createComponent(Show, {
      get when() {
        return ["control_lost", "read_only", "unavailable"].includes(model().kind);
      },
      get children() {
        var _el$3 = _tmpl$$1();
        insert(_el$3, () => model().label);
    ...
    insert(_el$, createComponent(Show, {
      ...
      get children() {
        return [(() => {
          ...
          get children() {
            var _el$8 = _tmpl$5$1(), _el$9 = _el$8.firstChild, _el$0 = _el$9.nextSibling;
            insert(_el$9, () => intentCopy(locale(), "reason"));
            insert(_el$0, () => model().reasonLabel, null);
            insert(_el$0, (() => {
          ...
          get children() {
            ...
            insert(_el$10, () => intentCopy(locale(), "nextStep"));
            insert(_el$11, () => model().nextStep);
            return _el$1;
          }
        })];
      }
    }), null);
    createRenderEffect(() => setAttribute(_el$, "data-agent-intent-state", model().kind));
    return _el$;
  })();
}
...
function ViewerEntryMenu() {
  ...
  return (() => {
    var _el$92 = _tmpl$28(), _el$93 = _el$92.firstChild, _el$94 = _el$93.nextSibling, _el$95 = _el$94.firstChild, _el$96 = _el$95.firstChild, _el$97 = _el$96.nextSibling, _el$98 = _el$95.nextSibling, _el$99 = _el$98.firstChild, _el$100 = _el$99.nextSibling, _el$101 = _el$98.nextSibling, _el$102 = _el$101.nextSibling;
    ...
    createRenderEffect((_p$) => {
      var _v$20 = locale() === "zh", _v$21 = locale() === "en";
      _v$20 !== _p$.e && (_el$99.disabled = _p$.e = _v$20);
      _v$21 !== _p$.t && (_el$100.disabled = _p$.t = _v$21);
      return _p$;
    }, {
      e: void 0,
      t: void 0
      ...
      get children() {
        return createComponent(Show, {
          ...
          children: (starterAction) => (() => {
            var _el$118 = _tmpl$31(), _el$119 = _el$118.firstChild;
            _el$119.$$click = () => renderGameplayAction(starterAction());
            insert(_el$119, () => gameplayActionDisplayLabel(starterAction(), locale()));
            createRenderEffect((_p$) => {
              var _v$22 = gameplayActionButtonClass(starterAction()), _v$23 = gameplayActionButtonBusyAttrs(starterAction()), _v$24 = gameplayActionButtonDisabled(starterAction(), gameplay(), locale());
              _v$22 !== _p$.e && className(_el$119, _p$.e = _v$22);
              _v$23 !== _p$.t && setAttribute(_el$119, "aria-busy", _p$.t = _v$23);
              _v$24 !== _p$.a && (_el$119.disabled = _p$.a = _v$24);
              return _p$;
            }, {
              e: void 0,
              t: void 0,
    ...
    children: () => (() => {
      ...
      insert(_el$127, createComponent(Show, {
        ...
        children: (nextAction) => (() => {
          ...
          createRenderEffect((_p$) => {
            var _v$25 = gameplayActionButtonClass(nextAction()), _v$26 = gameplayActionButtonBusyAttrs(nextAction()), _v$27 = gameplayActionButtonDisabled(nextAction(), gameplay(), locale());
            _v$25 !== _p$.e && className(_el$141, _p$.e = _v$25);
            _v$26 !== _p$.t && setAttribute(_el$141, "aria-busy", _p$.t = _v$26);
            _v$27 !== _p$.a && (_el$141.disabled = _p$.a = _v$27);
            return _p$;
          }, {
            e: void 0,
            t: void 0,
  ...
  return createComponent(CalloutCard, {
    ...
    get children() {
      return [(() => {
        ...
        var _el$152 = _tmpl$31(), _el$153 = _el$152.firstChild;
        _el$153.$$click = () => {
        ...
        createRenderEffect((_p$) => {
          var _v$28 = gameplayActionButtonClass(claimAction()), _v$29 = gameplayActionButtonBusyAttrs(claimAction()), _v$30 = Boolean(disabledReason()) || gameplayActionPendingFor(claimAction());
          _v$28 !== _p$.e && className(_el$153, _p$.e = _v$28);
          _v$29 !== _p$.t && setAttribute(_el$153, "aria-busy", _p$.t = _v$29);
          _v$30 !== _p$.a && (_el$153.disabled = _p$.a = _v$30);
          return _p$;
        }, {
          e: void 0,
          t: void 0,
...
function WorldStageHero() {
  ...
  const selectionHint = () => state.selectedKind && state.selectedId ? tr(locale(), "指挥面板会围绕这个对象展开。", "The command surface now follows this target.") : tr(locale(), "先从 Targets 锁定一个行动体或地点，再进入指挥面板。", "Lock onto an agent or location in Targets before entering the command surface.");
  ...
  return (() => {
    ...
    insert(_el$155, createComponent(Show, {
      ...
      children: (selected) => (() => {
        var _el$183 = _tmpl$38();
        insert(_el$183, createComponent(Badge, {
      ...
      children: (action2) => createComponent(CalloutCard, {
        ...
        get children() {
          return [(() => {
            ...
            createRenderEffect((_p$) => {
              var _v$34 = tr(locale(), "下一步动作", "Next Move action"), _v$35 = gameplayActionTestId(action2(), "recommended"), _v$36 = gameplayActionButtonClass(action2()), _v$37 = gameplayActionButtonBusyAttrs(action2()), _v$38 = gameplayActionButtonDisabled(action2(), gameplaySummary(), locale()), _v$39 = gameplayActionDisabledReason(action2(), gameplaySummary(), locale()) ? gameplayActionBlockedReasonId(action2()) : void 0;
              _v$34 !== _p$.e && setAttribute(_el$186, "aria-label", _p$.e = _v$34);
              _v$35 !== _p$.t && setAttribute(_el$187, "data-testid", _p$.t = _v$35);
              _v$36 !== _p$.a && className(_el$187, _p$.a = _v$36);
              _v$37 !== _p$.o && setAttribute(_el$187, "aria-busy", _p$.o = _v$37);
              _v$38 !== _p$.i && (_el$187.disabled = _p$.i = _v$38);
              _v$39 !== _p$.n && setAttribute(_el$187, "aria-describedby", _p$.n = _v$39);
              return _p$;
            }, {
              e: void 0,
              t: void 0,
    ...
    addEventListener(_el$180, "click", focusViewerAnchor);
    insert(_el$180, () => tr(locale(), "选择目标", "Select Target"));
    addEventListener(_el$181, "click", focusViewerAnchor);
    insert(_el$181, () => tr(locale(), "进入指挥", "Command"));
    insert(_el$155, createComponent(Show, {
      get when() {
      ...
      get children() {
        return createComponent(CalloutCard, {
          ...
          get children() {
            var _el$182 = _tmpl$9();
            insert(_el$182, () => tr(locale(), "首屏优先展示世界与目标；只有连接异常时，才把连接状态抬到这里提示你。", "This entry keeps the world and target first, and only elevates connection status when it needs attention."));
            return _el$182;
          }
        });
      }
    ...
    createRenderEffect((_p$) => {
      var _v$31 = gameplaySummary()?.blockerKind || "ready", _v$32 = gameplayStageToneClass(gameplaySummary()?.stageStatus), _v$33 = tr(locale(), "移动端快速入口", "Mobile quick actions");
      _v$31 !== _p$.e && setAttribute(_el$155, "data-stage-state", _p$.e = _v$31);
      _v$32 !== _p$.t && className(_el$165, _p$.t = _v$32);
      _v$33 !== _p$.a && setAttribute(_el$179, "aria-label", _p$.a = _v$33);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
      ...
      children: (action2) => createComponent(CalloutCard, {
        ...
        get children() {
          return [(() => {
            ...
            createRenderEffect((_p$) => {
              var _v$40 = gameplayActionButtonClass(action2()), _v$41 = gameplayActionButtonBusyAttrs(action2()), _v$42 = gameplayActionButtonDisabled(action2(), gameplaySummary(), locale());
              _v$40 !== _p$.e && className(_el$201, _p$.e = _v$40);
              _v$41 !== _p$.t && setAttribute(_el$201, "aria-busy", _p$.t = _v$41);
              _v$42 !== _p$.a && (_el$201.disabled = _p$.a = _v$42);
              return _p$;
            }, {
              e: void 0,
              t: void 0,
        ...
        return createComponent(For, {
          ...
          children: (agent, index) => {
            ...
            return (() => {
              ...
              createRenderEffect((_p$) => {
                var _v$43 = index() === 0 ? "viewer-playthrough-select-agent" : `viewer-select-agent-${agent.id}`, _v$44 = agent.id, _v$45 = status().kind, _v$46 = isSelectedTarget("agent", agent.id), _v$47 = isSelectedTarget("agent", agent.id) ? "true" : "false";
                _v$43 !== _p$.e && setAttribute(_el$202, "data-testid", _p$.e = _v$43);
                _v$44 !== _p$.t && setAttribute(_el$202, "data-select-id", _p$.t = _v$44);
                _v$45 !== _p$.a && setAttribute(_el$202, "data-agent-session-status", _p$.a = _v$45);
                _v$46 !== _p$.o && setAttribute(_el$202, "data-selected", _p$.o = _v$46);
                _v$47 !== _p$.i && setAttribute(_el$202, "aria-pressed", _p$.i = _v$47);
                return _p$;
              }, {
                e: void 0,
                t: void 0,
      ...
      get children() {
        return createComponent(For, {
          ...
          children: (location) => (() => {
            ...
            createRenderEffect((_p$) => {
              var _v$48 = `viewer-select-location-${location.id}`, _v$49 = location.id, _v$50 = isSelectedTarget("location", location.id), _v$51 = isSelectedTarget("location", location.id) ? "true" : "false";
              _v$48 !== _p$.e && setAttribute(_el$211, "data-testid", _p$.e = _v$48);
              _v$49 !== _p$.t && setAttribute(_el$211, "data-select-id", _p$.t = _v$49);
              _v$50 !== _p$.a && setAttribute(_el$211, "data-selected", _p$.a = _v$50);
              _v$51 !== _p$.o && setAttribute(_el$211, "aria-pressed", _p$.o = _v$51);
              return _p$;
            }, {
              e: void 0,
              t: void 0,
...
function WorldSummaryPanel(props = {}) {
  ...
  return (() => {
    ...
    insert(_el$222, createComponent(PanelSection, {
      ...
      get meta() {
        return tr(locale(), "先看目标、阻塞和下一步，再决定是否进入指挥面板。", "Read the goal, blocker, and next step first, then decide whether to enter the command surface.");
      },
      get children() {
        return createComponent(Show, {
          get when() {
                      ...
                      get children() {
                        return [createComponent(Show, {
                          ...
                          get children() {
                            ...
                            createRenderEffect((_p$) => {
                              var _v$52 = gameplayActionTestId(action2), _v$53 = action2.label || action2.actionId || void 0, _v$54 = gameplayActionButtonClass(action2), _v$55 = gameplayActionButtonBusyAttrs(action2), _v$56 = gameplayActionButtonDisabled(action2, gameplay(), locale()), _v$57 = disabledReason() ? blockedReasonId : void 0;
                              _v$52 !== _p$.e && setAttribute(_el$292, "data-testid", _p$.e = _v$52);
                              _v$53 !== _p$.t && setAttribute(_el$292, "aria-label", _p$.t = _v$53);
                              _v$54 !== _p$.a && className(_el$292, _p$.a = _v$54);
                              _v$55 !== _p$.o && setAttribute(_el$292, "aria-busy", _p$.o = _v$55);
                              _v$56 !== _p$.i && (_el$292.disabled = _p$.i = _v$56);
                              _v$57 !== _p$.n && setAttribute(_el$292, "aria-describedby", _p$.n = _v$57);
                              return _p$;
                            }, {
                              e: void 0,
                              t: void 0,
                          ...
                          get children() {
                            ...
                            createRenderEffect((_p$) => {
                              var _v$58 = gameplayActionTestId(action2), _v$59 = action2.label || action2.actionId || void 0, _v$60 = gameplayActionButtonClass(action2), _v$61 = gameplayActionButtonBusyAttrs(action2), _v$62 = gameplayActionButtonDisabled(action2, gameplay(), locale()), _v$63 = disabledReason() ? blockedReasonId : void 0;
                              _v$58 !== _p$.e && setAttribute(_el$294, "data-testid", _p$.e = _v$58);
                              _v$59 !== _p$.t && setAttribute(_el$294, "aria-label", _p$.t = _v$59);
                              _v$60 !== _p$.a && className(_el$294, _p$.a = _v$60);
                              _v$61 !== _p$.o && setAttribute(_el$294, "aria-busy", _p$.o = _v$61);
                              _v$62 !== _p$.i && (_el$294.disabled = _p$.i = _v$62);
                              _v$63 !== _p$.n && setAttribute(_el$294, "aria-describedby", _p$.n = _v$63);
                              return _p$;
                            }, {
                              e: void 0,
                              t: void 0,
...
function InteractionPanel() {
  ...
  const selectedAgentLabel = () => {
    const selected = state.snapshot?.model?.agents?.[agentId()];
  ...
  return createComponent(Show, {
    ...
    get children() {
      ...
      insert(_el$301, createComponent(AgentActivitySurface, {
        get activity() {
          return selectedAgentActivity();
        },
        get locale() {
          return locale();
        }
      }), _el$304);
      insert(_el$301, createComponent(AgentIntentSurface, {
        get intent() {
          return selectedAgentIntent();
        },
        get locale() {
          return locale();
        },
      ...
      insert(_el$301, createComponent(Show, {
        ...
        children: (action2) => (() => {
          var _el$347 = _tmpl$31(), _el$348 = _el$347.firstChild;
          _el$348.$$click = () => renderGameplayAction(action2());
          insert(_el$348, () => gameplayActionDisplayLabel(action2(), locale()));
          createRenderEffect((_p$) => {
            var _v$72 = gameplayActionButtonClass(action2()), _v$73 = gameplayActionButtonBusyAttrs(action2()), _v$74 = gameplayActionButtonDisabled(action2(), gameplaySummary(), locale());
            _v$72 !== _p$.e && className(_el$348, _p$.e = _v$72);
            _v$73 !== _p$.t && setAttribute(_el$348, "aria-busy", _p$.t = _v$73);
            _v$74 !== _p$.a && (_el$348.disabled = _p$.a = _v$74);
            return _p$;
          }, {
            e: void 0,
            t: void 0,
      ...
      insert(_el$301, createComponent(PanelSection, {
        ...
        get children() {
          return [(() => {
            ...
            createRenderEffect((_p$) => {
              var _v$64 = tr(locale(), "给当前选中的行动体发一条消息", "Send a message to the selected agent"), _v$65 = !chatControlsEnabled();
              _v$64 !== _p$.e && setAttribute(_el$309, "placeholder", _p$.e = _v$64);
              _v$65 !== _p$.t && (_el$309.disabled = _p$.t = _v$65);
              return _p$;
            }, {
              e: void 0,
              t: void 0
      ...
      insert(_el$315, createComponent(Show, {
        get when() {
          ...
          return createComponent(PanelSection, {
            ...
            get children() {
              return [(() => {
                ...
                createRenderEffect((_p$) => {
                  var _v$66 = !promptControlsEnabled(), _v$67 = !promptControlsEnabled();
                  _v$66 !== _p$.e && (_el$335.disabled = _p$.e = _v$66);
                  _v$67 !== _p$.t && (_el$336.disabled = _p$.t = _v$67);
                  return _p$;
                }, {
                  e: void 0,
                  t: void 0
                ...
                createRenderEffect((_p$) => {
                  var _v$68 = !promptControlsEnabled(), _v$69 = !promptControlsEnabled();
                  _v$68 !== _p$.e && (_el$340.disabled = _p$.e = _v$68);
                  _v$69 !== _p$.t && (_el$341.disabled = _p$.t = _v$69);
                  return _p$;
                }, {
                  e: void 0,
                  t: void 0
      ...
      createRenderEffect((_p$) => {
        var _v$70 = agentId(), _v$71 = String(chatHistory().length);
        _v$70 !== _p$.e && setAttribute(_el$301, "data-command-agent", _p$.e = _v$70);
        _v$71 !== _p$.t && setAttribute(_el$301, "data-command-chat-history", _p$.t = _v$71);
        return _p$;
      }, {
        e: void 0,
        t: void 0
    ...
    insert(_el$350, createComponent(Show, {
      ...
      get fallback() {
        return memo(() => gameplaySummary()?.blockerKind === "runtime_snapshot_empty_entities")() ? createComponent(EmptyEntityRecoveryCard, {
          ...
          get children() {
            return tr(locale(), "请先从 Targets 选择一个行动体或地点。", "Select an agent or location from Targets first.");
          }
        });
      },
...
function AppShell() {
  ...
  return (() => {
    ...
    createRenderEffect((_p$) => {
      var _v$75 = starterOcGateOpen() ? "true" : void 0, _v$76 = starterOcGateOpen() ? true : void 0, _v$77 = starterOcGateOpen() ? "true" : void 0, _v$78 = starterOcGateOpen() ? true : void 0, _v$79 = starterOcGateOpen() ? "true" : void 0, _v$80 = starterOcGateOpen() ? true : void 0;
      _v$75 !== _p$.e && setAttribute(_el$360, "aria-hidden", _p$.e = _v$75);
      _v$76 !== _p$.t && (_el$360.inert = _p$.t = _v$76);
      _v$77 !== _p$.a && setAttribute(_el$367, "aria-hidden", _p$.a = _v$77);
      _v$78 !== _p$.o && (_el$367.inert = _p$.o = _v$78);
      _v$79 !== _p$.i && setAttribute(_el$370, "aria-hidden", _p$.i = _v$79);
      _v$80 !== _p$.n && (_el$370.inert = _p$.n = _v$80);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
function shouldBypassAutoMountForTestApi() {
  ...
  const value2 = String(params.get("test_api") || "").trim().toLowerCase();
  const autoMount = String(params.get("auto_mount") || "").trim().toLowerCase();
  const testApi = value2 === "1" || value2 === "true" || value2 === "yes" || value2 === "on";
