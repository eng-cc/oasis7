...
var _tmpl$ = /* @__PURE__ */ template(`<span>`), _tmpl$2 = /* @__PURE__ */ template(`<div>`), _tmpl$3 = /* @__PURE__ */ template(`<pre class=json>`), _tmpl$4 = /* @__PURE__ */ template(`<div class=feedback-detail>`), _tmpl$5 = /* @__PURE__ */ template(`<details class=diagnostic><summary></summary><div class="stack flow-top">`), _tmpl$6 = /* @__PURE__ */ template(`<div class=badge-row>`), _tmpl$7 = /* @__PURE__ */ template(`<div class=feedback-summary>`), _tmpl$8 = /* @__PURE__ */ template(`<div class=summary-grid>`), _tmpl$9 = /* @__PURE__ */ template(`<div><div class="panel__title panel__title--spaced"></div><div class=event-list>`), _tmpl$0 = /* @__PURE__ */ template(`<div class=action-grid>`), _tmpl$1 = /* @__PURE__ */ template(`<div class=event-list>`), _tmpl$10 = /* @__PURE__ */ template(`<div class=inline-help-tip><button type=button class=inline-help-tip__button>?</button><div class=inline-help-tip__panel><div class=inline-help-tip__title></div><div class=inline-help-tip__body>`), _tmpl$11 = /* @__PURE__ */ template(`<div class=feedback-card><div class=badge-row></div><div class=feedback-summary>`), _tmpl$12 = /* @__PURE__ */ template(`<div class="feedback-detail flow-top--tight">`), _tmpl$13 = /* @__PURE__ */ template(`<div class="badge-row badge-row--tight">`), _tmpl$14 = /* @__PURE__ */ template(`<div class=metric><div class=metric__label></div><div class=metric__value>`), _tmpl$15 = /* @__PURE__ */ template(`<div class=event-card__meta>`), _tmpl$16 = /* @__PURE__ */ template(`<div><div class=event-card__title><span>`), _tmpl$17 = /* @__PURE__ */ template(`<div class=panel__eyebrow>`), _tmpl$18 = /* @__PURE__ */ template(`<div class=panel__meta-copy>`), _tmpl$19 = /* @__PURE__ */ template(`<div><div class=panel__header><div class="stack stack--compact"><div class=panel__title></div></div></div><div class="panel__body stack">`), _tmpl$20 = /* @__PURE__ */ template(`<div><div class=callout__header><div class=callout__title></div></div><div class=callout__body>`), _tmpl$21 = /* @__PURE__ */ template(`<div class=field><label></label><input type=text autocomplete=off>`), _tmpl$22 = /* @__PURE__ */ template(`<div class=toolbar><button data-auth-action=complete-login>`), _tmpl$23 = /* @__PURE__ */ template(`<div class=stack>`), _tmpl$24 = /* @__PURE__ */ template(`<div class=stack><div class=control-grid><div class=field><label></label><input type=email autocomplete=email></div></div><div class=toolbar><button data-auth-action=start-login>`), _tmpl$25 = /* @__PURE__ */ template(`<div class=auth-gate role=dialog aria-modal=true aria-labelledby=hosted-login-gate-title tabindex=-1><div class=auth-gate__dialog><div class=auth-gate__header><div><div class=panel__eyebrow></div><h1 id=hosted-login-gate-title class=auth-gate__title></h1></div></div><div class=feedback-summary>`), _tmpl$26 = /* @__PURE__ */ template(`<details class=entry-menu><summary class=entry-menu__toggle></summary><div class="entry-menu__panel stack"><div><div class="panel__title panel__title--spaced"></div><div class=feedback-detail></div></div><div class=toolbar><button data-locale=zh>中文</button><button data-locale=en>English</button></div><div class=badge-row></div><div class=feedback-detail>`), _tmpl$27 = /* @__PURE__ */ template(`<div class=control-grid><div class=field><label for=agent-claim-target></label><select id=agent-claim-target>`), _tmpl$28 = /* @__PURE__ */ template(`<div class=toolbar><button>`), _tmpl$29 = /* @__PURE__ */ template(`<option>`), _tmpl$30 = /* @__PURE__ */ template(`<div class=stage-hero><div class=stage-hero__topline><div class="stack stack--hero"><div class=stage-hero__eyebrow-row><div class=stage-hero__eyebrow></div></div><div class=stage-hero__title></div><div class=stage-hero__lede></div></div></div><div class=hero-focus-grid><div class=hero-focus-card><div class=hero-focus-card__label></div><div></div><div class=hero-focus-card__detail></div></div><div class=hero-focus-card><div class=hero-focus-card__label></div><div class="hero-focus-card__value hero-focus-card__value--body"></div><div class=hero-focus-card__detail></div></div><div class=hero-focus-card><div class=hero-focus-card__label></div><div class="hero-focus-card__value hero-focus-card__value--body"></div></div></div><div class=stage-hero__mobile-shortcuts><a class=mobile-rail__link href=#viewer-targets-panel></a><a class=mobile-rail__link href=#viewer-details-panel>`), _tmpl$31 = /* @__PURE__ */ template(`<nav class=mobile-rail><a class=mobile-rail__link href=#viewer-stage-panel></a><a class=mobile-rail__link href=#viewer-targets-panel></a><a class=mobile-rail__link href=#viewer-details-panel></a><a class="mobile-rail__link mobile-rail__link--diagnostics"href=#viewer-diagnostics-panel>`), _tmpl$32 = /* @__PURE__ */ template(`<div class=stack><div class=field><label for=entity-search></label><input id=entity-search type=search></div><div><div class="panel__title panel__title--spaced"></div><div class=list></div></div><div><div class="panel__title panel__title--spaced"></div><div class=list>`), _tmpl$33 = /* @__PURE__ */ template(`<button class=list-item data-select-kind=agent><div class=list-item__title></div><div class=list-item__meta>`), _tmpl$34 = /* @__PURE__ */ template(`<button class=list-item data-select-kind=location><div class=list-item__title></div><div class=list-item__meta>`), _tmpl$35 = /* @__PURE__ */ template(`<div class=toolbar><button data-auth-action=logout>`), _tmpl$36 = /* @__PURE__ */ template(`<button data-auth-action=logout>`), _tmpl$37 = /* @__PURE__ */ template(`<div class=stack><details id=viewer-diagnostics-panel class="panel diagnostic-surface"data-viewer-surface=diagnostics><summary class="panel__header diagnostic-surface__summary"><div class=diagnostic-surface__title><div class=panel__title></div><div class=diagnostic-surface__meta></div></div><div class=badge-row></div></summary><div class="panel__body stack"><div class=badge-row></div><div class=badge-row></div><div class=toolbar></div><div class=summary-grid></div><div><div class="panel__title panel__title--spaced"></div><div class=event-list>`), _tmpl$38 = /* @__PURE__ */ template(`<div class="badge-row badge-row--spaced">`), _tmpl$39 = /* @__PURE__ */ template(`<div><div class="panel__title panel__title--spaced"></div><div class=action-grid>`), _tmpl$40 = /* @__PURE__ */ template(`<div class=field><label for=agent-chat-message></label><textarea id=agent-chat-message rows=4>`), _tmpl$41 = /* @__PURE__ */ template(`<div class=toolbar><button data-chat-send=1>`), _tmpl$42 = /* @__PURE__ */ template(`<div class=toolbar><button data-prompt-visibility-toggle=1>`), _tmpl$43 = /* @__PURE__ */ template(`<div class=field><label for=strong-auth-approval-code></label><input id=strong-auth-approval-code type=password autocomplete=off>`), _tmpl$44 = /* @__PURE__ */ template(`<div class=field><label for=prompt-system></label><textarea id=prompt-system rows=4>`), _tmpl$45 = /* @__PURE__ */ template(`<div class=field><label for=prompt-short></label><textarea id=prompt-short rows=3>`), _tmpl$46 = /* @__PURE__ */ template(`<div class=field><label for=prompt-long></label><textarea id=prompt-long rows=3>`), _tmpl$47 = /* @__PURE__ */ template(`<div class=toolbar><button data-prompt-action=preview></button><button data-prompt-action=apply>`), _tmpl$48 = /* @__PURE__ */ template(`<div class=toolbar><div class="field field--inline-flex"><label for=prompt-rollback-version></label><input id=prompt-rollback-version type=number min=0 step=1></div><button data-prompt-action=rollback>`), _tmpl$49 = /* @__PURE__ */ template(`<div class=toolbar><button disabled>`), _tmpl$50 = /* @__PURE__ */ template(`<div class=stack><div class=badge-row></div><div class=badge-row>`), _tmpl$51 = /* @__PURE__ */ template(`<div><div class="panel__title panel__title--spaced panel__title--danger"></div><pre class=json>`), _tmpl$52 = /* @__PURE__ */ template(`<div class=stack><div class=badge-row></div><div><div class="panel__title panel__title--spaced"></div><div class=badge-row></div><div class="feedback-detail flow-top">`), _tmpl$53 = /* @__PURE__ */ template(`<section class="panel panel--targets"id=viewer-targets-panel data-viewer-surface=targets><div class="panel__header panel__header--stack"><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></div><div class=panel__body>`), _tmpl$54 = /* @__PURE__ */ template(`<section class="panel panel--stage"id=viewer-stage-panel data-viewer-surface=stage><div class="panel__body panel__body--stage"><div class=stack>`), _tmpl$55 = /* @__PURE__ */ template(`<section class="panel panel--details"id=viewer-details-panel data-viewer-surface=command><div class="panel__header panel__header--stack"><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></div><div class=panel__body>`);
function uiLocale() {
...
function ClaimAgentChoiceCard(props) {
  ...
  return createComponent(PanelSection, {
    ...
    get children() {
      return [(() => {
        var _el$8 = _tmpl$6();
        insert(_el$8, createComponent(Badge, {
          get ["class"]() {
        ...
        get children() {
          var _el$1 = _tmpl$9(), _el$10 = _el$1.firstChild, _el$11 = _el$10.nextSibling;
          insert(_el$10, () => tr(locale(), "已占用 Agent", "Owned Claims"));
            ...
            children: (owned) => createComponent(EventCard, {
              ...
              get children() {
                return [(() => {
                  ...
                  get children() {
                    var _el$13 = _tmpl$4();
                    insert(_el$13, () => claimOwnedDetail(owned));
                    return _el$13;
                  }
                })];
              }
          ...
          get children() {
            return [createComponent(Show, {
              ...
              get fallback() {
                return (() => {
                  var _el$17 = _tmpl$7();
                  insert(_el$17, () => tr(locale(), "当前没有匹配的已发布动作；不要把这个分支当成可执行按钮。", "No matching published action yet; do not treat this branch as an executable button."));
                  return _el$17;
                })();
              },
              get children() {
              ...
              var _el$16 = _tmpl$4();
              insert(_el$16, () => props.gameplay?.nextStepHint || tr(locale(), "选择前先确认对应动作已经正式发布。", "Confirm the matching action is published before committing."));
              return _el$16;
            })()];
          }
        })
...
function InlineHelpTip(props) {
  ...
  return (() => {
    var _el$19 = _tmpl$10(), _el$20 = _el$19.firstChild, _el$21 = _el$20.nextSibling, _el$22 = _el$21.firstChild, _el$23 = _el$22.nextSibling;
    var _ref$ = rootRef;
    typeof _ref$ === "function" ? use(_ref$, _el$19) : rootRef = _el$19;
    _el$20.$$click = () => setIsOpen((value) => !value);
    insert(_el$22, () => props.title ?? tr(locale(), "比例说明", "Scale Guidance"));
    ...
    createRenderEffect((_p$) => {
      ...
      _v$3 !== _p$.e && setAttribute(_el$19, "data-open", _p$.e = _v$3);
      _v$4 !== _p$.t && setAttribute(_el$20, "aria-label", _p$.t = _v$4);
      _v$5 !== _p$.a && setAttribute(_el$20, "aria-describedby", _p$.a = _v$5);
      _v$6 !== _p$.o && setAttribute(_el$20, "aria-expanded", _p$.o = _v$6);
      _v$7 !== _p$.i && setAttribute(_el$20, "aria-controls", _p$.i = _v$7);
      _v$8 !== _p$.n && setAttribute(_el$21, "id", _p$.n = _v$8);
      _v$9 !== _p$.s && setAttribute(_el$21, "aria-hidden", _p$.s = _v$9);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
function FeedbackCard(props) {
  return (() => {
    var _el$25 = _tmpl$11(), _el$26 = _el$25.firstChild, _el$27 = _el$26.nextSibling;
    insert(_el$26, createComponent(Badge, {
      get ["class"]() {
    ...
    insert(_el$27, () => props.display.summary);
    insert(_el$25, createComponent(Show, {
      ...
      get children() {
        var _el$28 = _tmpl$4();
        insert(_el$28, () => props.display.detail);
        return _el$28;
      }
    }), null);
    insert(_el$25, createComponent(Show, {
...
function MetricCard(props) {
  return (() => {
    var _el$29 = _tmpl$14(), _el$30 = _el$29.firstChild, _el$31 = _el$30.nextSibling;
    insert(_el$30, () => props.label);
    insert(_el$31, () => props.value);
...
function EventCard(props) {
  return (() => {
    var _el$34 = _tmpl$16(), _el$35 = _el$34.firstChild, _el$36 = _el$35.firstChild;
    ...
    insert(_el$35, createComponent(Show, {
      ...
      get children() {
        var _el$37 = _tmpl$();
        insert(_el$37, () => props.badge);
        createRenderEffect(() => className(_el$37, props.badgeClass ?? "badge"));
        return _el$37;
      }
    }), null);
    insert(_el$34, createComponent(Show, {
      ...
      get children() {
        var _el$38 = _tmpl$15();
        insert(_el$38, () => props.meta);
        return _el$38;
      }
    }), null);
    insert(_el$34, () => props.children, null);
    createRenderEffect(() => className(_el$34, props.class ?? "event-card"));
    return _el$34;
  })();
}
function PanelSection(props) {
  return (() => {
    var _el$39 = _tmpl$19(), _el$40 = _el$39.firstChild, _el$41 = _el$40.firstChild, _el$43 = _el$41.firstChild, _el$45 = _el$40.nextSibling;
    insert(_el$41, createComponent(Show, {
      ...
      get children() {
        var _el$42 = _tmpl$17();
        insert(_el$42, () => props.eyebrow);
        return _el$42;
      }
    }), _el$43);
    insert(_el$43, () => props.title);
    insert(_el$41, createComponent(Show, {
      get when() {
        return props.meta;
      },
      get children() {
        var _el$44 = _tmpl$18();
        insert(_el$44, () => props.meta);
        return _el$44;
      }
    }), null);
    insert(_el$45, () => props.children);
    createRenderEffect(() => className(_el$39, `panel panel--nested ${props.class ?? ""}`));
    return _el$39;
  })();
}
function CalloutCard(props) {
  return (() => {
    var _el$46 = _tmpl$20(), _el$47 = _el$46.firstChild, _el$48 = _el$47.firstChild, _el$49 = _el$47.nextSibling;
    insert(_el$48, () => props.title);
    ...
    createRenderEffect(() => className(_el$46, `callout ${props.variant === "warn" ? "callout--warn" : ""}`));
    return _el$46;
  })();
}
function HostedLoginForm(props) {
  ...
  return (() => {
    var _el$50 = _tmpl$24(), _el$51 = _el$50.firstChild, _el$52 = _el$51.firstChild, _el$53 = _el$52.firstChild, _el$54 = _el$53.nextSibling, _el$55 = _el$51.nextSibling, _el$56 = _el$55.firstChild;
    insert(_el$53, () => tr(locale(), "邮箱", "Email"));
    _el$54.$$input = (event) => {
    ...
    insert(_el$56, () => tr(locale(), "请求登录验证码", "Request Login Code"));
    insert(_el$50, createComponent(Show, {
      ...
      get children() {
        return [(() => {
          ...
          var _el$58 = _tmpl$21(), _el$59 = _el$58.firstChild, _el$60 = _el$59.nextSibling;
          insert(_el$59, () => tr(locale(), "验证码", "Verification Code"));
          _el$60.$$input = (event) => {
          ...
          createRenderEffect((_p$) => {
            ...
            _v$0 !== _p$.e && setAttribute(_el$59, "for", _p$.e = _v$0);
            _v$1 !== _p$.t && setAttribute(_el$60, "id", _p$.t = _v$1);
            return _p$;
          }, {
            e: void 0,
            t: void 0
          });
          createRenderEffect(() => _el$60.value = state.hostedLogin.code);
          return _el$58;
        })(), (() => {
          var _el$61 = _tmpl$22(), _el$62 = _el$61.firstChild;
          _el$62.$$click = () => {
            void completeHostedAccountLogin();
          };
          insert(_el$62, () => tr(locale(), "登录并领取玩家会话", "Sign In and Acquire Player Session"));
          createRenderEffect(() => _el$62.disabled = state.hostedLogin.completeInFlight || state.auth.issueInFlight);
          return _el$61;
        })()];
      }
    }), null);
    insert(_el$50, createComponent(Show, {
      ...
      get children() {
        var _el$63 = _tmpl$23();
        insert(_el$63, createComponent(EmptyState, {
          get children() {
            return state.hostedLogin.error;
          }
        }), null);
    ...
    createRenderEffect((_p$) => {
      ...
      _v$10 !== _p$.e && setAttribute(_el$53, "for", _p$.e = _v$10);
      _v$11 !== _p$.t && setAttribute(_el$54, "id", _p$.t = _v$11);
      _v$12 !== _p$.a && (_el$56.disabled = _p$.a = _v$12);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
    ...
    createRenderEffect(() => _el$54.value = state.hostedLogin.handle);
    return _el$50;
  })();
}
...
function HostedLoginGate() {
  ...
  return createComponent(Show, {
    ...
    get children() {
      var _el$65 = _tmpl$25(), _el$66 = _el$65.firstChild, _el$67 = _el$66.firstChild, _el$68 = _el$67.firstChild, _el$69 = _el$68.firstChild, _el$70 = _el$69.nextSibling, _el$71 = _el$67.nextSibling;
      _el$65.$$keydown = trapDialogFocus;
      var _ref$2 = dialogRef;
      typeof _ref$2 === "function" ? use(_ref$2, _el$65) : dialogRef = _el$65;
      insert(_el$69, () => tr(locale(), "标准用户流程", "Standard User Flow"));
      insert(_el$70, () => tr(locale(), "登录邮箱后进入游戏", "Sign In With Email"));
      insert(_el$67, createComponent(Badge, {
        "class": "badge badge--warn",
        children: "auth=missing"
      }), null);
      insert(_el$71, () => tr(locale(), "当前是托管公开加入模式。先领取玩家会话，再进入聊天、玩法动作和后续授权。", "This is hosted public join. Acquire a player session first, then continue to chat, gameplay actions, and later authorization."));
      insert(_el$66, createComponent(HostedLoginForm, {
        get locale() {
          return locale();
        },
...
function EmptyEntityRecoveryCard(props) {
  ...
  return createComponent(CalloutCard, {
    ...
    get children() {
      return [(() => {
        var _el$72 = _tmpl$7();
        insert(_el$72, () => gameplay()?.blockerDetail || tr(locale(), "运行时已发布玩法摘要，但当前快照还没有可选行动体或地点。", "Runtime published gameplay summary, but the current snapshot still has no selectable agents or locations."));
        return _el$72;
      })(), createComponent(Show, {
        get when() {
        ...
        get children() {
          var _el$73 = _tmpl$4();
          insert(_el$73, () => gameplay().nextStepHint);
          return _el$73;
        }
      }), createComponent(Show, {
        get when() {
        ...
        var _el$75 = _tmpl$4();
        insert(_el$75, () => tr(locale(), "如果中间栏仍保留“刷新快照”动作，先从那里重拉一次；如果数量仍然是 0，就需要修复或重启运行时世界引导流程。", "If the middle column still exposes a refresh action, pull a fresh snapshot there first. If the counts stay at 0, repair or restart the runtime world bootstrap."));
        return _el$75;
      })()];
    }
  });
...
function ViewerEntryMenu() {
  ...
  return (() => {
    var _el$76 = _tmpl$26(), _el$77 = _el$76.firstChild, _el$78 = _el$77.nextSibling, _el$79 = _el$78.firstChild, _el$80 = _el$79.firstChild, _el$81 = _el$80.nextSibling, _el$82 = _el$79.nextSibling, _el$83 = _el$82.firstChild, _el$84 = _el$83.nextSibling, _el$85 = _el$82.nextSibling, _el$86 = _el$85.nextSibling;
    insert(_el$77, () => tr(locale(), "入口", "Entry"));
    insert(_el$80, () => tr(locale(), "语言与观察器入口", "Language and Viewer Entry"));
    insert(_el$81, () => tr(locale(), "主玩法继续留在当前页面；这里只保留语言切换。", "Primary gameplay stays on this page. This menu only keeps locale switching."));
    _el$83.$$click = () => setViewerLocale("zh");
    _el$84.$$click = () => setViewerLocale("en");
    insert(_el$85, createComponent(Badge, {
      get children() {
        return `locale=${localeCode(locale())}`;
      }
    }));
    insert(_el$86, () => viewerEntryUrls().softwareSafeUrl);
    createRenderEffect((_p$) => {
      var _v$13 = locale() === "zh", _v$14 = locale() === "en";
      _v$13 !== _p$.e && (_el$83.disabled = _p$.e = _v$13);
      _v$14 !== _p$.t && (_el$84.disabled = _p$.t = _v$14);
      return _p$;
    }, {
      e: void 0,
      t: void 0
...
function AgentClaimPanel(props) {
  ...
  return createComponent(CalloutCard, {
    ...
    get children() {
      return [(() => {
        var _el$87 = _tmpl$7();
        insert(_el$87, () => agentClaim()?.objective || tr(locale(), "选择一个未被占用的 Agent，并用当前玩家会话提交认领。", "Pick an unclaimed agent and submit the claim with the current player session."));
        return _el$87;
      })(), (() => {
        var _el$88 = _tmpl$4();
        insert(_el$88, () => agentClaim()?.progress_detail || tr(locale(), "首次 slot-1 认领可以使用专用 starter claim 额度补足前置费用。", "The first slot-1 claim can use the dedicated starter claim allowance for upfront costs."));
        return _el$88;
      })(), (() => {
        var _el$89 = _tmpl$6();
        ...
        var _el$90 = _tmpl$27(), _el$91 = _el$90.firstChild, _el$92 = _el$91.firstChild, _el$93 = _el$92.nextSibling;
        insert(_el$92, () => tr(locale(), "目标 Agent", "Target Agent"));
        _el$93.$$input = (event) => setSelectedTargetId(event.currentTarget.value);
        insert(_el$93, createComponent(For, {
          ...
          children: (target) => (() => {
            var _el$96 = _tmpl$29();
            insert(_el$96, () => `${target.name}${target.isClaimer ? ` (${tr(locale(), "当前绑定", "current binding")})` : ""}`);
            createRenderEffect(() => _el$96.value = target.id);
            return _el$96;
          })()
        }));
        createRenderEffect(() => _el$93.value = selectedTarget());
        return _el$90;
      })(), (() => {
        var _el$94 = _tmpl$28(), _el$95 = _el$94.firstChild;
        _el$95.$$click = () => {
        ...
        insert(_el$95, () => tr(locale(), "认领 Agent", "Claim Agent"));
        createRenderEffect(() => _el$95.disabled = Boolean(disabledReason()));
        return _el$94;
      })()];
    }
  });
...
function WorldStageHero() {
  ...
  return (() => {
    var _el$97 = _tmpl$30(), _el$98 = _el$97.firstChild, _el$99 = _el$98.firstChild, _el$100 = _el$99.firstChild, _el$101 = _el$100.firstChild, _el$102 = _el$100.nextSibling, _el$103 = _el$102.nextSibling, _el$104 = _el$98.nextSibling, _el$105 = _el$104.firstChild, _el$106 = _el$105.firstChild, _el$107 = _el$106.nextSibling, _el$108 = _el$107.nextSibling, _el$109 = _el$105.nextSibling, _el$110 = _el$109.firstChild, _el$111 = _el$110.nextSibling, _el$112 = _el$111.nextSibling, _el$113 = _el$109.nextSibling, _el$114 = _el$113.firstChild, _el$115 = _el$114.nextSibling, _el$116 = _el$104.nextSibling, _el$117 = _el$116.firstChild, _el$118 = _el$117.nextSibling;
    insert(_el$101, () => tr(locale(), "工业世界指挥桌", "Industrial World Command Desk"));
    insert(_el$100, createComponent(InlineHelpTip, {
      get locale() {
        return locale();
      },
    ...
    insert(_el$102, () => gameplaySummary()?.goalTitle || tr(locale(), "进入世界，先看局势，再做动作", "Read the world first, then act."));
    insert(_el$103, () => gameplaySummary()?.nextStepHint || gameplaySummary()?.objective || tr(locale(), "这张入口页优先保留世界、目标和关键动作；高级诊断与治理能力按需展开。", "This entry keeps the world, objective, and primary actions in front. Advanced diagnostics and governance stay on demand."));
    insert(_el$98, createComponent(ViewerEntryMenu, {}), null);
    ...
    insert(_el$106, () => tr(locale(), "局势", "Situation"));
    insert(_el$107, stageLabel);
    insert(_el$108, () => gameplayProgressLabel(gameplaySummary()?.progressPercent, locale()));
    insert(_el$110, () => tr(locale(), "已接受意图", "Accepted Intent"));
    insert(_el$111, acceptedIntentTitle);
    insert(_el$112, acceptedIntentDetail);
    insert(_el$114, () => tr(locale(), "下一步", "Next Step"));
    insert(_el$115, nextStepCopy);
    insert(_el$117, () => tr(locale(), "选择目标", "Select Target"));
    insert(_el$118, () => tr(locale(), "进入指挥", "Command"));
    insert(_el$97, createComponent(Show, {
      get when() {
      ...
      get children() {
        return createComponent(CalloutCard, {
          ...
          get children() {
            var _el$119 = _tmpl$7();
            insert(_el$119, () => tr(locale(), "首屏优先展示世界与目标；只有连接异常时，才把连接状态抬到这里提示你。", "This entry keeps the world and target first, and only elevates connection status when it needs attention."));
            return _el$119;
          }
        });
      }
    ...
    createRenderEffect((_p$) => {
      ...
      _v$15 !== _p$.e && className(_el$107, _p$.e = _v$15);
      _v$16 !== _p$.t && setAttribute(_el$116, "aria-label", _p$.t = _v$16);
      return _p$;
    }, {
      e: void 0,
      t: void 0
...
function MobileJumpRail() {
  const locale = () => uiLocale();
  return (() => {
    var _el$121 = _tmpl$31(), _el$122 = _el$121.firstChild, _el$123 = _el$122.nextSibling, _el$124 = _el$123.nextSibling, _el$125 = _el$124.nextSibling;
    insert(_el$122, () => tr(locale(), "世界", "World"));
    insert(_el$123, () => tr(locale(), "目标", "Targets"));
    insert(_el$124, () => tr(locale(), "指挥", "Command"));
    insert(_el$125, () => tr(locale(), "诊断", "Diagnostics"));
    createRenderEffect(() => setAttribute(_el$121, "aria-label", tr(locale(), "主入口分区导航", "Primary entry section navigation")));
    return _el$121;
  })();
}
function TargetsPanel() {
  ...
  const selectedLabel = () => state.selectedKind && state.selectedId ? `${state.selectedKind}:${state.selectedId}` : null;
  return (() => {
    var _el$126 = _tmpl$32(), _el$127 = _el$126.firstChild, _el$128 = _el$127.firstChild, _el$129 = _el$128.nextSibling, _el$130 = _el$127.nextSibling, _el$131 = _el$130.firstChild, _el$132 = _el$131.nextSibling, _el$133 = _el$130.nextSibling, _el$134 = _el$133.firstChild, _el$135 = _el$134.nextSibling;
    insert(_el$126, createComponent(Show, {
      get when() {
        return selectedLabel();
      },
    ...
    insert(_el$126, createComponent(EmptyState, {
      get children() {
    ...
    insert(_el$128, () => tr(locale(), "筛选目标", "Filter targets"));
    _el$129.$$input = (event) => setSelectedSearch(event.currentTarget.value);
    insert(_el$131, () => tr(locale(), "行动体", "Agents"));
    insert(_el$132, createComponent(Show, {
      ...
      get children() {
        return createComponent(For, {
          ...
          children: (agent) => (() => {
            var _el$137 = _tmpl$33(), _el$138 = _el$137.firstChild, _el$139 = _el$138.nextSibling;
            _el$137.$$click = () => applySelection({
              kind: "agent",
              id: agent.id
            });
            insert(_el$138, () => agent.id);
            insert(_el$139, () => `${tr(locale(), "地点", "location")}=${agent.location_id} · ${tr(locale(), "资源", "resources")}=${renderResourceSummary(agent.resources)}`);
            createRenderEffect((_p$) => {
              var _v$17 = agent.id, _v$18 = state.selectedKind === "agent" && state.selectedId === agent.id;
              _v$17 !== _p$.e && setAttribute(_el$137, "data-select-id", _p$.e = _v$17);
              _v$18 !== _p$.t && setAttribute(_el$137, "data-selected", _p$.t = _v$18);
              return _p$;
            }, {
              e: void 0,
              t: void 0
    ...
    insert(_el$134, () => tr(locale(), "地点", "Locations"));
    insert(_el$135, createComponent(Show, {
      ...
      get children() {
        return createComponent(For, {
          ...
          children: (location) => (() => {
            var _el$140 = _tmpl$34(), _el$141 = _el$140.firstChild, _el$142 = _el$141.nextSibling;
            _el$140.$$click = () => applySelection({
              kind: "location",
              id: location.id
            });
            insert(_el$141, () => location.name || location.id);
            insert(_el$142, () => `id=${location.id} · ${tr(locale(), "半径", "radius")}=${formatPhysicalDistanceCm(location.profile?.radius_cm, locale()) || "-"} · ${tr(locale(), "资源", "resources")}=${renderResourceSummary(location.resources)}`);
            createRenderEffect((_p$) => {
              var _v$19 = location.id, _v$20 = state.selectedKind === "location" && state.selectedId === location.id;
              _v$19 !== _p$.e && setAttribute(_el$140, "data-select-id", _p$.e = _v$19);
              _v$20 !== _p$.t && setAttribute(_el$140, "data-selected", _p$.t = _v$20);
              return _p$;
            }, {
              e: void 0,
              t: void 0
    ...
    createRenderEffect(() => setAttribute(_el$129, "placeholder", tr(locale(), "搜索行动体或地点", "Search agents or locations")));
    createRenderEffect(() => _el$129.value = getSelectedSearch());
    return _el$126;
  })();
}
function WorldSummaryPanel() {
  ...
  return (() => {
    var _el$143 = _tmpl$37(), _el$147 = _el$143.firstChild, _el$148 = _el$147.firstChild, _el$149 = _el$148.firstChild, _el$150 = _el$149.firstChild, _el$151 = _el$150.nextSibling, _el$152 = _el$149.nextSibling, _el$153 = _el$148.nextSibling, _el$154 = _el$153.firstChild, _el$155 = _el$154.nextSibling, _el$156 = _el$155.nextSibling, _el$164 = _el$156.nextSibling, _el$165 = _el$164.nextSibling, _el$166 = _el$165.firstChild, _el$167 = _el$166.nextSibling;
        ...
        return createComponent(Show, {
          ...
          children: (gameplay) => [(() => {
            ...
            get children() {
              return [(() => {
                var _el$169 = _tmpl$7();
                insert(_el$169, () => gameplay().acceptedIntentSummary);
                return _el$169;
              })(), (() => {
                var _el$170 = _tmpl$4();
                insert(_el$170, () => gameplay().acceptedIntentDetail);
                return _el$170;
              })(), createComponent(Show, {
                get when() {
                ...
                get children() {
                  return [(() => {
                    ...
                    var _el$172 = _tmpl$4();
                    insert(_el$172, () => gameplay().resumeAnchor);
                    return _el$172;
                  })()];
                }
              })];
            ...
            get children() {
              return [(() => {
                var _el$173 = _tmpl$6();
                insert(_el$173, createComponent(For, {
                  get each() {
                ...
                var _el$174 = _tmpl$7();
                insert(_el$174, () => gameplay().executionSummary || tr(locale(), "等待目标执行状态更新。", "Waiting for goal execution state updates."));
                return _el$174;
              })(), createComponent(Show, {
                get when() {
                ...
                get children() {
                  var _el$176 = _tmpl$4();
                  insert(_el$176, () => gameplay().executionCauseDetail);
                  return _el$176;
                }
              })];
            }
            ...
            get children() {
              return [createComponent(Show, {
                ...
                get children() {
                  var _el$177 = _tmpl$4();
                  insert(_el$177, () => gameplay().progressDetail);
                  return _el$177;
                }
              }), createComponent(Show, {
                get when() {
                ...
                get children() {
                  return [(() => {
                    ...
                    var _el$179 = _tmpl$4();
                    insert(_el$179, () => gameplay().narrativeBlockerDetail || tr(locale(), "当前玩法被阻塞，需要显式恢复。", "Gameplay is blocked and needs explicit recovery."));
                    return _el$179;
                  })()];
                }
              }), createComponent(Show, {
                ...
                get children() {
                  var _el$180 = _tmpl$4();
                  insert(_el$180, () => gameplay().blockerSupplementalDetail);
                  return _el$180;
                }
              }), (() => {
                var _el$181 = _tmpl$38();
                ...
                var _el$182 = _tmpl$7();
                insert(_el$182, () => gameplay().narrativeNextStep || tr(locale(), "等待下一次运行时指引更新。", "Wait for the next runtime guidance update."));
                return _el$182;
              })(), createComponent(Show, {
                get when() {
                ...
                get children() {
                  var _el$183 = _tmpl$4();
                  insert(_el$183, () => gameplay().branchHint);
                  return _el$183;
                }
              }), createComponent(Show, {
                get when() {
            ...
            get children() {
              var _el$185 = _tmpl$8();
              insert(_el$185, createComponent(MetricCard, {
                get label() {
            ...
            children: (feedback) => createComponent(EventCard, {
              ...
              get children() {
                return [(() => {
                  var _el$191 = _tmpl$7();
                  insert(_el$191, () => feedback().effect || feedback().reason || tr(locale(), "最新回执已更新，但还没有新的世界级后果。", "The latest feedback is in, but there is no new world-level consequence yet."));
                  return _el$191;
                })(), createComponent(Show, {
                  get when() {
                  ...
                  get children() {
                    var _el$192 = _tmpl$4();
                    insert(_el$192, () => feedback().reason);
                    return _el$192;
                  }
                }), createComponent(Show, {
                  get when() {
            ...
            children: (action) => createComponent(CalloutCard, {
              ...
              get children() {
                return [(() => {
                  var _el$194 = _tmpl$7();
                  insert(_el$194, () => action().label || action().actionId || tr(locale(), "当前存在一条更合适的推进动作。", "One action is currently the best next move."));
                  return _el$194;
                })(), (() => {
                  var _el$195 = _tmpl$4();
                  insert(_el$195, () => gameplayActionDetail(action(), gameplay(), locale()));
                  return _el$195;
                })(), (() => {
                  var _el$196 = _tmpl$28(), _el$197 = _el$196.firstChild;
                  _el$197.$$click = () => renderGameplayAction(action());
                  insert(_el$197, () => gameplayActionButtonLabel(action(), locale()));
                  createRenderEffect(() => _el$197.disabled = Boolean(action().disabledReason));
                  return _el$196;
                })()];
              }
            })
            ...
            var _el$186 = _tmpl$39(), _el$187 = _el$186.firstChild, _el$188 = _el$187.nextSibling;
            insert(_el$187, () => tr(locale(), "可用玩法动作", "Available Gameplay Actions"));
                ...
                return createComponent(For, {
                  ...
                  children: (action) => createComponent(EventCard, {
                    ...
                    get children() {
                      return [(() => {
                        var _el$198 = _tmpl$4();
                        insert(_el$198, () => gameplayActionDetail(action, gameplay(), locale()));
                        return _el$198;
                      })(), createComponent(Show, {
                        get when() {
                        ...
                        get children() {
                          var _el$199 = _tmpl$28(), _el$200 = _el$199.firstChild;
                          _el$200.$$click = () => renderGameplayAction(action);
                          insert(_el$200, () => gameplayActionButtonLabel(action, locale()));
                          createRenderEffect(() => _el$200.disabled = Boolean(action.disabledReason));
                          return _el$199;
                        }
                      }), createComponent(Show, {
                        get when() {
                        ...
                        get children() {
                          var _el$201 = _tmpl$28(), _el$202 = _el$201.firstChild;
                          _el$202.$$click = () => renderGameplayAction(action);
                          insert(_el$202, () => gameplayActionButtonLabel(action, locale()));
                          createRenderEffect(() => _el$202.disabled = Boolean(action.disabledReason));
                          return _el$201;
                        }
                      })];
                    }
            ...
            get children() {
              return [(() => {
                var _el$189 = _tmpl$7();
                insert(_el$189, () => gameplay().assetGovernanceHandoff);
                return _el$189;
              })(), (() => {
                var _el$190 = _tmpl$4();
                insert(_el$190, () => tr(locale(), "资产 / 治理相关能力请走单独 lane；这张主入口页面只保留正式玩法所需的最小动作面。", "Asset and governance actions stay on their dedicated lane; this primary entry only keeps the minimum surface needed for formal gameplay."));
                return _el$190;
              })()];
            }
          })]
        ...
        return createComponent(PanelSection, {
          ...
          get children() {
            return [(() => {
              ...
              get children() {
                var _el$145 = _tmpl$35(), _el$146 = _el$145.firstChild;
                _el$146.$$click = () => {
                  void logoutHostedPlayerSession();
                };
                insert(_el$146, () => tr(locale(), "释放玩家会话", "Release Player Session"));
                return _el$145;
              }
            })];
          }
    ...
    insert(_el$150, () => tr(locale(), "运行诊断", "Runtime Diagnostics"));
    insert(_el$151, () => tr(locale(), "执行通道、认证/会话、托管矩阵与最近事件都收在这里，避免它们继续抢占主玩法首屏。", "Execution lanes, auth/session truth, hosted matrix, and recent events live here so they no longer dominate the primary gameplay viewport."));
    ...
    insert(_el$153, createComponent(PanelSection, {
      get title() {
      ...
      get children() {
        return createComponent(Show, {
          ...
          children: (debug) => [(() => {
            var _el$203 = _tmpl$6();
            insert(_el$203, createComponent(Badge, {
              "class": "badge badge--accent",
    ...
    insert(_el$156, createComponent(Show, {
      ...
      get children() {
        var _el$157 = _tmpl$36();
        _el$157.$$click = () => {
          void logoutHostedPlayerSession();
        };
        insert(_el$157, () => tr(locale(), "释放玩家会话", "Release Player Session"));
        return _el$157;
      }
    }));
    ...
    insert(_el$164, createComponent(MetricCard, {
      get label() {
    ...
    insert(_el$166, () => tr(locale(), "最近事件", "Recent Events"));
...
function InteractionPanel() {
  ...
  return (() => {
    var _el$208 = _tmpl$50(), _el$209 = _el$208.firstChild, _el$211 = _el$209.nextSibling;
    ...
    insert(_el$208, createComponent(EmptyState, {
      get children() {
        return assetLaneDetail();
      }
    }), null);
    insert(_el$208, createComponent(PanelSection, {
      get title() {
      ...
      get children() {
        return [(() => {
          var _el$212 = _tmpl$40(), _el$213 = _el$212.firstChild, _el$214 = _el$213.nextSibling;
          insert(_el$213, () => tr(locale(), "消息", "Message"));
          _el$214.$$input = (event) => {
            state.chatDraft.message = String(event.currentTarget.value || "");
            state.chatDraft.dirty = true;
          };
          createRenderEffect((_p$) => {
            ...
            _v$21 !== _p$.e && setAttribute(_el$214, "placeholder", _p$.e = _v$21);
            _v$22 !== _p$.t && (_el$214.disabled = _p$.t = _v$22);
            return _p$;
          }, {
            e: void 0,
            t: void 0
          });
          createRenderEffect(() => _el$214.value = state.chatDraft.message);
          return _el$212;
        })(), (() => {
          var _el$215 = _tmpl$41(), _el$216 = _el$215.firstChild;
          _el$216.$$click = () => sendAgentChat(agentId(), state.chatDraft.message);
          insert(_el$216, () => tr(locale(), "发送聊天", "Send Chat"));
          createRenderEffect(() => _el$216.disabled = !chatCapability().enabled);
          return _el$215;
        })(), createComponent(Show, {
          get when() {
            return chatFeedback();
          ...
          var _el$217 = _tmpl$9(), _el$218 = _el$217.firstChild, _el$219 = _el$218.nextSibling;
          insert(_el$218, () => tr(locale(), "消息流", "Message Flow"));
              ...
              return createComponent(For, {
                ...
                children: (entry) => createComponent(EventCard, {
                  ...
                  get children() {
                    return [(() => {
                      var _el$248 = _tmpl$7();
                      insert(_el$248, () => chatEntryMessage(entry, locale()));
                      return _el$248;
    ...
    insert(_el$208, createComponent(PanelSection, {
      ...
      get children() {
        return [(() => {
          ...
          var _el$221 = _tmpl$42(), _el$222 = _el$221.firstChild;
          _el$222.$$click = () => togglePromptOverridesVisible();
          insert(_el$222, promptSettingsButtonLabel);
          return _el$221;
        })()];
      }
    }), null);
      ...
      get children() {
        return createComponent(PanelSection, {
          ...
          get children() {
            return [(() => {
              var _el$223 = _tmpl$4();
              insert(_el$223, () => promptVersionState().summary);
              return _el$223;
            })(), (() => {
              var _el$224 = _tmpl$4();
              insert(_el$224, () => promptVersionState().detail);
              return _el$224;
            })(), createComponent(Show, {
              get when() {
              ...
              get children() {
                var _el$225 = _tmpl$43(), _el$226 = _el$225.firstChild, _el$227 = _el$226.nextSibling;
                insert(_el$226, () => tr(locale(), "后端审批码", "Backend Approval Code"));
                _el$227.$$input = (event) => {
                  state.strongAuth.approvalCode = String(event.currentTarget.value || "");
                };
                createRenderEffect(() => _el$227.value = state.strongAuth.approvalCode || "");
                return _el$225;
              }
            }), (() => {
              var _el$228 = _tmpl$44(), _el$229 = _el$228.firstChild, _el$230 = _el$229.nextSibling;
              insert(_el$229, () => tr(locale(), "系统提示词覆盖", "System Prompt Override"));
              _el$230.$$input = (event) => {
                state.promptDraft.systemPrompt = String(event.currentTarget.value || "");
                state.promptDraft.dirty = true;
              };
              createRenderEffect(() => _el$230.disabled = !promptCapability().enabled);
              createRenderEffect(() => _el$230.value = state.promptDraft.systemPrompt);
              return _el$228;
            })(), (() => {
              var _el$231 = _tmpl$45(), _el$232 = _el$231.firstChild, _el$233 = _el$232.nextSibling;
              insert(_el$232, () => tr(locale(), "短期目标覆盖", "Short-Term Goal Override"));
              _el$233.$$input = (event) => {
                state.promptDraft.shortTermGoal = String(event.currentTarget.value || "");
                state.promptDraft.dirty = true;
              };
              createRenderEffect(() => _el$233.disabled = !promptCapability().enabled);
              createRenderEffect(() => _el$233.value = state.promptDraft.shortTermGoal);
              return _el$231;
            })(), (() => {
              var _el$234 = _tmpl$46(), _el$235 = _el$234.firstChild, _el$236 = _el$235.nextSibling;
              insert(_el$235, () => tr(locale(), "长期目标覆盖", "Long-Term Goal Override"));
              _el$236.$$input = (event) => {
                state.promptDraft.longTermGoal = String(event.currentTarget.value || "");
                state.promptDraft.dirty = true;
              };
              createRenderEffect(() => _el$236.disabled = !promptCapability().enabled);
              createRenderEffect(() => _el$236.value = state.promptDraft.longTermGoal);
              return _el$234;
            })(), (() => {
              var _el$237 = _tmpl$47(), _el$238 = _el$237.firstChild, _el$239 = _el$238.nextSibling;
              _el$238.$$click = () => sendPromptControl("preview", null);
              insert(_el$238, () => tr(locale(), "预览提示词", "Preview Prompt"));
              _el$239.$$click = () => sendPromptControl("apply", null);
              insert(_el$239, () => tr(locale(), "应用提示词", "Apply Prompt"));
              createRenderEffect((_p$) => {
                var _v$23 = !promptCapability().enabled, _v$24 = !promptCapability().enabled;
                _v$23 !== _p$.e && (_el$238.disabled = _p$.e = _v$23);
                _v$24 !== _p$.t && (_el$239.disabled = _p$.t = _v$24);
                return _p$;
              }, {
                e: void 0,
                t: void 0
              ...
              var _el$240 = _tmpl$48(), _el$241 = _el$240.firstChild, _el$242 = _el$241.firstChild, _el$243 = _el$242.nextSibling, _el$244 = _el$241.nextSibling;
              insert(_el$242, () => tr(locale(), "下一次回滚目标版本", "Next Rollback Target Version"));
              _el$243.$$input = (event) => {
              ...
              insert(_el$244, () => tr(locale(), "回滚提示词", "Rollback Prompt"));
              createRenderEffect((_p$) => {
                var _v$25 = !promptCapability().enabled, _v$26 = !promptCapability().enabled;
                _v$25 !== _p$.e && (_el$243.disabled = _p$.e = _v$25);
                _v$26 !== _p$.t && (_el$244.disabled = _p$.t = _v$26);
                return _p$;
              }, {
                e: void 0,
                t: void 0
              });
              createRenderEffect(() => _el$243.value = Number(state.promptDraft.rollbackTargetVersion || 0));
              return _el$240;
            })(), createComponent(Show, {
              get when() {
    ...
    insert(_el$208, createComponent(PanelSection, {
      ...
      get children() {
        return [(() => {
          var _el$245 = _tmpl$6();
          insert(_el$245, createComponent(Badge, {
            get ["class"]() {
              return mainTokenTransferCapability().enabled ? "badge badge--good" : "badge badge--warn";
            },
            get children() {
          ...
          var _el$246 = _tmpl$49(), _el$247 = _el$246.firstChild;
          insert(_el$247, () => tr(locale(), "主代币转账（这里暂未开放）", "Main Token Transfer (Not Exposed Here Yet)"));
          return _el$246;
        })()];
      }
    }), null);
...
function DetailsPanel() {
  ...
  return (() => {
    var _el$249 = _tmpl$52(), _el$250 = _el$249.firstChild, _el$251 = _el$250.nextSibling, _el$252 = _el$251.firstChild, _el$253 = _el$252.nextSibling, _el$254 = _el$253.nextSibling;
    ...
    insert(_el$249, createComponent(InteractionPanel, {}), _el$251);
    ...
    insert(_el$252, () => tr(locale(), "世界规模", "World Scale"));
    ...
    insert(_el$254, worldMetaSummary);
    ...
    insert(_el$249, createComponent(Show, {
      ...
      get children() {
        var _el$255 = _tmpl$51(), _el$256 = _el$255.firstChild, _el$257 = _el$256.nextSibling;
        insert(_el$256, () => tr(locale(), "最近错误", "Last Error"));
        insert(_el$257, () => state.lastError);
        return _el$255;
      }
    }), null);
    return _el$249;
...
function AppShell() {
  ...
  return [createComponent(MobileJumpRail, {}), createComponent(HostedLoginGate, {}), (() => {
    var _el$258 = _tmpl$53(), _el$259 = _el$258.firstChild, _el$260 = _el$259.firstChild, _el$261 = _el$260.nextSibling, _el$262 = _el$261.nextSibling, _el$263 = _el$259.nextSibling;
    insert(_el$260, () => tr(locale(), "导航", "Navigate"));
    insert(_el$261, () => tr(locale(), "目标", "Targets"));
    insert(_el$262, () => tr(locale(), "先锁定对象，再进入世界舞台或右侧指挥面板。", "Lock onto a target first, then move into the stage or command surface."));
    insert(_el$263, createComponent(TargetsPanel, {}));
    return _el$258;
  })(), (() => {
    var _el$264 = _tmpl$54(), _el$265 = _el$264.firstChild, _el$266 = _el$265.firstChild;
    insert(_el$266, createComponent(WorldStageHero, {}), null);
    insert(_el$266, createComponent(PixelWorldHost, {
      get locale() {
        return locale();
      }
    }), null);
    insert(_el$266, createComponent(WorldSummaryPanel, {}), null);
    return _el$264;
  })(), (() => {
    ...
    insert(_el$269, () => tr(locale(), "指挥与核查", "Command and Inspect"));
    insert(_el$270, () => tr(locale(), "交互与明细", "Interact and Inspect"));
    insert(_el$271, () => tr(locale(), "只有锁定目标后才进入这里。聊天优先，提示词与对象核查继续后置。", "Enter this column only after locking a target. Chat comes first; prompt controls and raw inspection stay behind it."));
    insert(_el$272, createComponent(DetailsPanel, {}));
    return _el$267;
  })()];
}
