...
function PixelWorldFocusMinimapCard(props) {
  ...
  return createComponent(Show, {
    ...
    get children() {
      var _el$86 = _tmpl$21$1(), _el$87 = _el$86.firstChild, _el$88 = _el$87.nextSibling, _el$89 = _el$88.nextSibling, _el$90 = _el$89.nextSibling, _el$91 = _el$90.firstChild, _el$92 = _el$91.nextSibling, _el$93 = _el$90.nextSibling, _el$94 = _el$93.firstChild, _el$95 = _el$94.nextSibling, _el$102 = _el$93.nextSibling, _el$103 = _el$102.firstChild, _el$104 = _el$103.nextSibling, _el$105 = _el$104.nextSibling, _el$106 = _el$105.nextSibling;
      insert(_el$87, () => tr$1(props.locale(), "任务地图", "Mission Map"));
      insert(_el$91, () => tr$1(props.locale(), "目标", "Target"));
      insert(_el$92, () => surface().next_action.label);
      insert(_el$94, () => tr$1(props.locale(), "Agent", "Agent"));
      insert(_el$95, () => activeAgent() || tr$1(props.locale(), "待分配", "Unassigned"));
      insert(_el$86, createComponent(Show, {
        get when() {
          return primaryLocation();
        },
        get children() {
          var _el$96 = _tmpl$19$1(), _el$97 = _el$96.firstChild, _el$98 = _el$97.nextSibling;
          insert(_el$97, () => tr$1(props.locale(), "锚点", "Anchor"));
          insert(_el$98, () => primaryLocation().label || primaryLocation().id);
          return _el$96;
        }
      }), _el$102);
      insert(_el$86, createComponent(Show, {
        ...
        get children() {
          var _el$99 = _tmpl$20$1(), _el$100 = _el$99.firstChild, _el$101 = _el$100.nextSibling;
          insert(_el$100, () => tr$1(props.locale(), "选中", "Selected"));
          insert(_el$101, () => `${selected().kind}/${selected().id}`);
          return _el$99;
        }
      }), _el$102);
      insert(_el$103, () => `agents=${props.renderState().agents.length}`);
      insert(_el$104, () => `targets=${props.renderState().locations.length}`);
      insert(_el$105, () => `routes=${props.renderState().links.length}`);
      insert(_el$106, () => `fragments=${props.renderState().fragment_terrain.length}`);
      createRenderEffect((_p$) => {
        ...
        _v$21 !== _p$.t && setAttribute(_el$89, "data-routes", _p$.t = _v$21);
        _v$22 !== _p$.a && setAttribute(_el$102, "aria-label", _p$.a = _v$22);
        return _p$;
      }, {
        e: void 0,
        t: void 0,
...
function PixelRawDiagnostics(props) {
  ...
  return (() => {
    var _el$107 = _tmpl$23$1(), _el$108 = _el$107.firstChild;
    _el$107.addEventListener("toggle", (event) => setOpen(event.currentTarget.open));
    insert(_el$108, () => tr$1(locale(), "原始诊断", "Raw diagnostics"));
    insert(_el$107, createComponent(Show, {
      get when() {
        return open();
      },
      get children() {
        var _el$109 = _tmpl$22$1();
        insert(_el$109, () => JSON.stringify(value(), null, 2));
        return _el$109;
      }
    }), null);
    return _el$107;
...
function PixelWorldFocusCommandSurface(props) {
  ...
  return (() => {
    ...
    insert(_el$110, createComponent(Show, {
      ...
      get fallback() {
        return (() => {
          var _el$132 = _tmpl$26$1();
          insert(_el$132, () => tr$1(locale(), "先选中一个行动体，才能在沉浸模式里直接下指令。", "Select an agent to issue direct commands in World Focus."));
          return _el$132;
        })();
      },
      get children() {
        return [(() => {
          var _el$111 = _tmpl$25$1(), _el$112 = _el$111.firstChild, _el$113 = _el$112.nextSibling, _el$115 = _el$113.nextSibling;
          insert(_el$112, () => tr$1(locale(), "当前交互目标", "Current Target"));
          insert(_el$113, () => `agent=${agentId()}`);
          insert(_el$111, createComponent(Show, {
            get when() {
              return binding()?.playerId;
            },
            get children() {
              var _el$114 = _tmpl$24$1();
              insert(_el$114, () => `boundPlayer=${binding().playerId}`);
              return _el$114;
            }
          }), _el$115);
          insert(_el$115, (() => {
          ...
          createRenderEffect(() => className(_el$115, chatCapability().enabled ? "badge badge--good" : "badge badge--warn"));
          return _el$111;
          ...
          get children() {
            var _el$116 = _tmpl$26$1();
            insert(_el$116, () => chatCapability().reason);
            return _el$116;
          }
        }), (() => {
          var _el$117 = _tmpl$27$1(), _el$118 = _el$117.firstChild, _el$119 = _el$118.firstChild, _el$120 = _el$119.firstChild, _el$121 = _el$120.nextSibling, _el$122 = _el$121.nextSibling, _el$123 = _el$118.nextSibling, _el$124 = _el$123.firstChild, _el$125 = _el$124.firstChild, _el$126 = _el$125.nextSibling, _el$127 = _el$124.nextSibling, _el$128 = _el$127.firstChild, _el$129 = _el$127.nextSibling, _el$130 = _el$129.firstChild, _el$131 = _el$130.nextSibling;
          insert(_el$120, () => tr$1(locale(), "指挥面板", "Command Surface"));
          insert(_el$121, () => tr$1(locale(), "行动体聊天", "Agent Chat"));
          insert(_el$122, () => tr$1(locale(), "沉浸态保持世界视图在前，但这里可以直接给当前目标发消息并读取反馈。", "World Focus keeps the world view in front, while this surface sends messages to the current target and reads feedback directly."));
          insert(_el$125, () => tr$1(locale(), "消息", "Message"));
          _el$126.$$input = (event) => {
          ...
          insert(_el$123, createComponent(Show, {
            ...
            get fallback() {
              return (() => {
                var _el$133 = _tmpl$26$1();
                insert(_el$133, () => tr$1(locale(), "还没有聊天反馈。", "No chat feedback yet."));
                return _el$133;
              })();
            },
            children: (feedback) => (() => {
              var _el$134 = _tmpl$30$1(), _el$135 = _el$134.firstChild, _el$136 = _el$135.firstChild, _el$138 = _el$135.nextSibling;
              insert(_el$136, () => chatFeedbackDisplay().label);
              insert(_el$135, createComponent(Show, {
                get when() {
                  return chatFeedbackDisplay().code;
                },
                get children() {
                  var _el$137 = _tmpl$24$1();
                  insert(_el$137, () => `code=${chatFeedbackDisplay().code}`);
                  return _el$137;
                }
              }), null);
              insert(_el$138, () => chatFeedbackDisplay().summary);
              insert(_el$134, createComponent(Show, {
                ...
                get children() {
                  ...
                  insert(_el$139, () => chatFeedbackDisplay().detail);
                  return _el$139;
                }
              }), null);
              insert(_el$134, createComponent(PixelRawDiagnostics, {
                locale,
                value: feedback
              }), null);
              createRenderEffect(() => className(_el$136, chatFeedbackDisplay().badgeClass));
              return _el$134;
            })()
          }), _el$129);
          insert(_el$130, () => tr$1(locale(), "消息流", "Message Flow"));
          insert(_el$131, createComponent(Show, {
            ...
            get fallback() {
              return (() => {
                ...
                insert(_el$140, () => tr$1(locale(), "这个行动体还没有聊天历史。", "No chat history for this agent yet."));
                return _el$140;
              })();
            },
            get children() {
              return createComponent(For, {
                ...
                children: (entry) => (() => {
                  var _el$141 = _tmpl$31$1(), _el$142 = _el$141.firstChild, _el$143 = _el$142.firstChild, _el$144 = _el$142.nextSibling, _el$145 = _el$144.nextSibling;
                  insert(_el$143, () => chatEntryTitle$1(entry, locale()));
                  insert(_el$144, () => chatEntryMeta$1(entry, locale()));
                  insert(_el$145, () => entry.message || tr$1(locale(), "没有消息正文。", "No message body."));
                  insert(_el$141, createComponent(PixelRawDiagnostics, {
                    locale,
                    value: entry
                  }), null);
                  return _el$141;
          ...
          createRenderEffect((_p$) => {
            ...
            _v$23 !== _p$.e && setAttribute(_el$126, "placeholder", _p$.e = _v$23);
            _v$24 !== _p$.t && (_el$126.disabled = _p$.t = _v$24);
            _v$25 !== _p$.a && (_el$128.disabled = _p$.a = _v$25);
            return _p$;
          }, {
            e: void 0,
            t: void 0,
          ...
          createRenderEffect(() => _el$126.value = state.chatDraft.message);
          return _el$117;
        })()];
      }
    }));
...
function PixelWorldCanvasPlaceholder(props) {
  const visualState = () => pixelWorldVisualState(props.renderState());
  return (() => {
    var _el$146 = _tmpl$32$1(), _el$148 = _el$146.firstChild;
    insert(_el$146, createComponent(PixelWorldHostVisualLayer, {
      enabled: true,
      get locale() {
        return props.locale;
      },
    ...
    insert(_el$146, createComponent(Show, {
      ...
      get children() {
        var _el$147 = _tmpl$8$1();
        insert(_el$147, () => `${tr$1(props.locale(), "已选中", "Selected")}: ${visualState().selection.kind}/${visualState().selection.id}`);
        return _el$147;
      }
    }), _el$148);
    insert(_el$148, createComponent(Show, {
      ...
      get children() {
        var _el$149 = _tmpl$6$1();
        insert(_el$149, () => `${tr$1(props.locale(), "目标", "Goal")}: ${visualState().goalHighlight.title}`);
        return _el$149;
      }
    }), null);
    insert(_el$148, createComponent(Show, {
      ...
      get children() {
        var _el$150 = _tmpl$7$1();
        insert(_el$150, () => `${tr$1(props.locale(), "阻塞", "Blocker")}: ${visualState().blockerHighlight.kind}`);
        return _el$150;
      }
    }), null);
    createRenderEffect(() => setAttribute(_el$146, "data-renderer-ready", props.ready() ? "true" : "false"));
    return _el$146;
  })();
}
function PixelWorldHost(props) {
  ...
  return (() => {
    var _el$151 = _tmpl$40$1(), _el$197 = _el$151.firstChild, _el$198 = _el$197.firstChild;
    insert(_el$151, createComponent(Show, {
      get when() {
        return !focusMode() || !maximized();
      },
      get children() {
        var _el$152 = _tmpl$33$1(), _el$153 = _el$152.firstChild, _el$154 = _el$153.nextSibling, _el$155 = _el$154.nextSibling, _el$156 = _el$155.firstChild;
        insert(_el$153, () => tr$1(locale(), "世界指挥棋盘", "World Command Board"));
        insert(_el$154, () => renderState().commercial_surface?.objective?.detail);
        _el$156.$$click = enterFocusMode;
        insert(_el$156, () => tr$1(locale(), "进入沉浸模式", "Enter World Focus"));
        createRenderEffect(() => setAttribute(_el$156, "aria-pressed", focusMode() ? "true" : "false"));
        return _el$152;
      }
    }), _el$197);
    insert(_el$151, createComponent(Show, {
    ...
    insert(_el$151, createComponent(PixelWorldCommercialHud, {
      locale,
      renderState
    }), _el$197);
    insert(_el$151, createComponent(Show, {
    ...
    insert(_el$151, createComponent(Show, {
      ...
      get children() {
        var _el$157 = _tmpl$34$1(), _el$158 = _el$157.firstChild, _el$159 = _el$158.firstChild, _el$160 = _el$158.nextSibling, _el$161 = _el$160.firstChild;
        insert(_el$159, () => tr$1(locale(), "Renderer 未接管", "Renderer Not Attached"));
        insert(_el$161, () => tr$1(locale(), "嵌入式 renderer 未接管；页面先使用 host fallback，正式玩法摘要、目标和明细主链继续可用。", "The embedded renderer is not attached; the page is using host fallback first. Formal gameplay summary, targets, and details remain available."));
        insert(_el$160, createComponent(Show, {
          get when() {
            return rendererFatal();
          },
          get children() {
            var _el$162 = _tmpl$29$1();
            insert(_el$162, () => `${rendererFatal().code}: ${rendererFatal().message}`);
            return _el$162;
          }
        }), null);
        return _el$157;
    ...
    insert(_el$151, createComponent(Show, {
      ...
      get children() {
        ...
        insert(_el$163, createComponent(PixelWorldActionReceipt, {
    ...
    insert(_el$151, createComponent(Show, {
      ...
      get children() {
        var _el$164 = _tmpl$36$1(), _el$165 = _el$164.firstChild, _el$166 = _el$165.nextSibling;
        _el$164.addEventListener("toggle", (event) => setPersistentCommandDrawerOpen(event.currentTarget.open));
        insert(_el$165, () => tr$1(locale(), "命令与目标", "Command and Target"));
        insert(_el$166, createComponent(PixelWorldFocusCommandSurface, {
          locale
        }));
        createRenderEffect(() => _el$164.open = commandDrawerOpen());
        return _el$164;
      }
    }), _el$197);
    insert(_el$151, createComponent(Show, {
      ...
      get children() {
        var _el$167 = _tmpl$37$1(), _el$168 = _el$167.firstChild, _el$169 = _el$168.nextSibling, _el$170 = _el$169.firstChild, _el$171 = _el$170.nextSibling, _el$172 = _el$171.nextSibling, _el$173 = _el$172.nextSibling, _el$174 = _el$173.nextSibling, _el$175 = _el$174.nextSibling, _el$176 = _el$175.nextSibling, _el$177 = _el$176.nextSibling, _el$178 = _el$177.nextSibling, _el$182 = _el$178.nextSibling, _el$183 = _el$182.nextSibling, _el$184 = _el$183.nextSibling, _el$185 = _el$184.nextSibling;
        insert(_el$168, () => tr$1(locale(), "Renderer 诊断", "Renderer Diagnostics"));
        insert(_el$170, () => `locations=${visualState().locations.length}`);
        insert(_el$171, () => `fragments=${visualState().fragmentTerrain.length}`);
        insert(_el$172, () => `agents=${visualState().agents.length}`);
        insert(_el$173, () => `links=${visualState().links.length}`);
        insert(_el$174, () => `hotspots=${arrayField(renderState(), "visual_hotspots", "visualHotspots").length}`);
        insert(_el$175, () => `derived_positions=${visualState().agents.filter((agent) => agent.position_source === "location_derived").length}`);
        insert(_el$176, () => visualState().worldBounds ? "world_bounds=ready" : "world_bounds=missing");
        insert(_el$177, () => `renderer=${rendererStatus()}`);
        insert(_el$178, () => `runtime=${runtimeSource()}`);
        insert(_el$169, createComponent(Show, {
          ...
          get children() {
            ...
            insert(_el$179, () => `zoom=${cameraState().zoom.toFixed(2)}`);
            return _el$179;
          }
        }), _el$182);
        insert(_el$169, createComponent(Show, {
          ...
          get children() {
            var _el$180 = _tmpl$24$1();
            insert(_el$180, () => `pan=${cameraState().pan_x_px},${cameraState().pan_y_px}`);
            return _el$180;
          }
        }), _el$182);
        insert(_el$169, createComponent(Show, {
          ...
          get children() {
            var _el$181 = _tmpl$24$1();
            insert(_el$181, () => `hover=${hoverSelection().kind}/${hoverSelection().id}`);
            return _el$181;
          }
        }), _el$182);
        _el$182.$$click = requestReadyMode;
        insert(_el$182, () => tr$1(locale(), "重新挂载嵌入式 Renderer", "Reattach Embedded Renderer"));
        _el$183.$$click = simulateFatal;
        insert(_el$183, () => tr$1(locale(), "模拟 Renderer Fatal", "Simulate Renderer Fatal"));
        _el$184.$$click = setFallbackMode;
        insert(_el$184, () => tr$1(locale(), "切回 Host Fallback", "Back To Host Fallback"));
        insert(_el$185, () => tr$1(locale(), "当前世界舞台优先依赖 wasm bridge、嵌入式 canvas、轻量拖拽缩放和事件回传。若 wasm bridge 缺失或启动失败，页面会显式退回 host fallback，而不是继续保留一套 JS renderer。", "The world stage now depends on the wasm bridge, embedded canvas, light pan-zoom interaction, and event callbacks. If the wasm bridge is missing or fails to boot, the page falls back explicitly instead of keeping a second JS renderer."));
        return _el$167;
      }
    }), _el$197);
    insert(_el$151, createComponent(Show, {
      ...
      get children() {
        var _el$186 = _tmpl$38$1(), _el$187 = _el$186.firstChild, _el$188 = _el$187.nextSibling, _el$189 = _el$188.firstChild, _el$190 = _el$189.firstChild, _el$191 = _el$190.nextSibling, _el$192 = _el$191.nextSibling, _el$194 = _el$189.nextSibling, _el$195 = _el$194.firstChild, _el$196 = _el$195.nextSibling;
        _el$186.addEventListener("toggle", (event) => setPersistentDiagnosticsDrawerOpen(event.currentTarget.open));
        insert(_el$187, () => tr$1(locale(), "沉浸诊断", "Focus Diagnostics"));
        insert(_el$190, () => `renderer=${rendererStatus()}`);
        insert(_el$191, () => `runtime=${runtimeSource()}`);
        insert(_el$192, () => `derived_positions=${renderState().agents.filter((agent) => agent.position_source === "location_derived").length}`);
        insert(_el$189, createComponent(Show, {
          ...
          get children() {
            ...
            insert(_el$193, () => rendererFatal().code);
            return _el$193;
          }
        }), null);
        _el$195.$$click = requestReadyMode;
        insert(_el$195, () => tr$1(locale(), "重新挂载嵌入式 Renderer", "Reattach Embedded Renderer"));
        _el$196.$$click = setFallbackMode;
        insert(_el$196, () => tr$1(locale(), "切回 Host Fallback", "Back To Host Fallback"));
        createRenderEffect(() => _el$186.open = diagnosticsDrawerOpen());
        return _el$186;
      }
    }), _el$197);
    _el$197.addEventListener("toggle", (event) => setRenderDtoOpen(event.currentTarget.open));
    insert(_el$198, () => tr$1(locale(), "展开 Render DTO", "Expand Render DTO"));
    insert(_el$197, createComponent(Show, {
      get when() {
        return renderDtoOpen();
      },
      get children() {
        var _el$199 = _tmpl$39$1(), _el$200 = _el$199.firstChild;
        insert(_el$200, () => JSON.stringify(renderState(), null, 2));
        return _el$199;
      }
    }), null);
    createRenderEffect((_p$) => {
      ...
      _v$26 !== _p$.e && className(_el$151, _p$.e = _v$26);
      _v$27 !== _p$.t && setAttribute(_el$151, "data-world-focus", _p$.t = _v$27);
      _v$28 !== _p$.a && setAttribute(_el$151, "data-world-focus-maximized", _p$.a = _v$28);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
  ...
  return createComponent(CalloutCard, {
    ...
    get children() {
      return [(() => {
        ...
        get when() {
          return quote()?.blocked_reason;
        },
        get children() {
          var _el$90 = _tmpl$4();
          insert(_el$90, () => quote().blocked_reason);
          return _el$90;
        }
      }), (() => {
        var _el$91 = _tmpl$27(), _el$92 = _el$91.firstChild, _el$93 = _el$92.firstChild, _el$94 = _el$93.nextSibling;
        insert(_el$93, () => tr(locale(), "目标 Agent", "Target Agent"));
        _el$94.$$input = (event) => setSelectedTargetId(event.currentTarget.value);
        insert(_el$94, createComponent(For, {
          ...
          children: (target) => (() => {
            var _el$98 = _tmpl$29();
            insert(_el$98, () => `${target.name}${target.isClaimer ? ` (${tr(locale(), "当前绑定", "current binding")})` : ""}`);
            createRenderEffect(() => _el$98.value = target.id);
            return _el$98;
          })()
        }));
        createRenderEffect(() => _el$94.value = selectedTarget());
        return _el$91;
      })(), (() => {
        var _el$95 = _tmpl$28(), _el$96 = _el$95.firstChild;
        _el$96.$$click = () => {
        ...
        insert(_el$96, () => tr(locale(), "认领 Agent", "Claim Agent"));
        createRenderEffect(() => _el$96.disabled = Boolean(disabledReason()));
        return _el$95;
      })(), createComponent(Show, {
        get when() {
...
function WorldStageHero() {
  ...
  return (() => {
    var _el$99 = _tmpl$30(), _el$100 = _el$99.firstChild, _el$101 = _el$100.firstChild, _el$102 = _el$101.firstChild, _el$103 = _el$102.firstChild, _el$104 = _el$102.nextSibling, _el$105 = _el$104.nextSibling, _el$106 = _el$100.nextSibling, _el$107 = _el$106.firstChild, _el$108 = _el$107.firstChild, _el$109 = _el$108.nextSibling, _el$110 = _el$109.nextSibling, _el$111 = _el$107.nextSibling, _el$112 = _el$111.firstChild, _el$113 = _el$112.nextSibling, _el$114 = _el$113.nextSibling, _el$115 = _el$111.nextSibling, _el$116 = _el$115.firstChild, _el$117 = _el$116.nextSibling;
    insert(_el$103, () => tr(locale(), "工业世界指挥桌", "Industrial World Command Desk"));
    insert(_el$102, createComponent(InlineHelpTip, {
      get locale() {
        return locale();
      },
    ...
    insert(_el$104, () => gameplaySummary()?.goalTitle || tr(locale(), "进入世界，先看局势，再做动作", "Read the world first, then act."));
    insert(_el$105, () => gameplaySummary()?.nextStepHint || gameplaySummary()?.objective || tr(locale(), "这张入口页优先保留世界、目标和关键动作；高级诊断与治理能力按需展开。", "This entry keeps the world, objective, and primary actions in front. Advanced diagnostics and governance stay on demand."));
    insert(_el$100, createComponent(ViewerEntryMenu, {}), null);
    ...
    insert(_el$108, () => tr(locale(), "局势", "Situation"));
    insert(_el$109, stageLabel);
    insert(_el$110, () => gameplayProgressLabel(gameplaySummary()?.progressPercent, locale()));
    insert(_el$112, () => tr(locale(), "已接受意图", "Accepted Intent"));
    insert(_el$113, acceptedIntentTitle);
    insert(_el$114, acceptedIntentDetail);
    insert(_el$116, () => tr(locale(), "下一步", "Next Step"));
    insert(_el$117, nextStepCopy);
    insert(_el$99, createComponent(Show, {
      get when() {
      ...
      get children() {
        return createComponent(CalloutCard, {
          ...
          get children() {
            var _el$118 = _tmpl$7();
            insert(_el$118, () => tr(locale(), "首屏优先展示世界与目标；只有连接异常时，才把连接状态抬到这里提示你。", "This entry keeps the world and target first, and only elevates connection status when it needs attention."));
            return _el$118;
          }
        });
      }
    }), null);
    createRenderEffect(() => className(_el$109, gameplayStageToneClass(gameplaySummary()?.stageStatus)));
    return _el$99;
  })();
}
function MobileJumpRail() {
  const locale = () => uiLocale();
  return (() => {
    var _el$120 = _tmpl$31(), _el$121 = _el$120.firstChild, _el$122 = _el$121.nextSibling, _el$123 = _el$122.nextSibling, _el$124 = _el$123.nextSibling;
    insert(_el$121, () => tr(locale(), "世界", "World"));
    insert(_el$122, () => tr(locale(), "目标", "Targets"));
    insert(_el$123, () => tr(locale(), "指挥", "Command"));
    insert(_el$124, () => tr(locale(), "诊断", "Diagnostics"));
    createRenderEffect(() => setAttribute(_el$120, "aria-label", tr(locale(), "主入口分区导航", "Primary entry section navigation")));
    return _el$120;
  })();
}
function TargetsPanel() {
  ...
  const selectedLabel = () => state.selectedKind && state.selectedId ? `${state.selectedKind}:${state.selectedId}` : null;
  return (() => {
    var _el$125 = _tmpl$32(), _el$126 = _el$125.firstChild, _el$127 = _el$126.firstChild, _el$128 = _el$127.nextSibling, _el$129 = _el$126.nextSibling, _el$130 = _el$129.firstChild, _el$131 = _el$130.nextSibling, _el$132 = _el$129.nextSibling, _el$133 = _el$132.firstChild, _el$134 = _el$133.nextSibling;
    ...
    insert(_el$125, createComponent(EmptyState, {
      get children() {
    ...
    insert(_el$127, () => tr(locale(), "筛选目标", "Filter targets"));
    _el$128.$$input = (event) => setSelectedSearch(event.currentTarget.value);
    insert(_el$130, () => tr(locale(), "行动体", "Agents"));
    insert(_el$131, createComponent(Show, {
      get when() {
      ...
      get children() {
        return createComponent(For, {
          ...
          children: (agent) => (() => {
            var _el$136 = _tmpl$33(), _el$137 = _el$136.firstChild, _el$138 = _el$137.nextSibling;
            _el$136.$$click = () => applySelection({
              kind: "agent",
              id: agent.id
            });
            insert(_el$137, () => agent.id);
            insert(_el$138, () => `${tr(locale(), "地点", "location")}=${agent.location_id} · ${tr(locale(), "资源", "resources")}=${renderResourceSummary(agent.resources)}`);
            createRenderEffect((_p$) => {
              var _v$13 = agent.id, _v$14 = state.selectedKind === "agent" && state.selectedId === agent.id;
              _v$13 !== _p$.e && setAttribute(_el$136, "data-select-id", _p$.e = _v$13);
              _v$14 !== _p$.t && setAttribute(_el$136, "data-selected", _p$.t = _v$14);
              return _p$;
            }, {
              e: void 0,
              t: void 0
    ...
    insert(_el$133, () => tr(locale(), "地点", "Locations"));
    insert(_el$134, createComponent(Show, {
      get when() {
      ...
      get children() {
        return createComponent(For, {
          ...
          children: (location) => (() => {
            ...
            _el$139.$$click = () => applySelection({
              kind: "location",
              id: location.id
            });
            insert(_el$140, () => location.name || location.id);
            insert(_el$141, () => `id=${location.id} · ${tr(locale(), "半径", "radius")}=${formatPhysicalDistanceCm(location.profile?.radius_cm, locale()) || "-"} · ${tr(locale(), "资源", "resources")}=${renderResourceSummary(location.resources)}`);
            createRenderEffect((_p$) => {
              var _v$15 = location.id, _v$16 = state.selectedKind === "location" && state.selectedId === location.id;
              _v$15 !== _p$.e && setAttribute(_el$139, "data-select-id", _p$.e = _v$15);
              _v$16 !== _p$.t && setAttribute(_el$139, "data-selected", _p$.t = _v$16);
              return _p$;
            }, {
              e: void 0,
              t: void 0
    ...
    createRenderEffect(() => setAttribute(_el$128, "placeholder", tr(locale(), "搜索行动体或地点", "Search agents or locations")));
    createRenderEffect(() => _el$128.value = getSelectedSearch());
    return _el$125;
  })();
}
function WorldSummaryPanel() {
  ...
  return (() => {
    var _el$142 = _tmpl$37(), _el$146 = _el$142.firstChild, _el$147 = _el$146.firstChild, _el$148 = _el$147.firstChild, _el$149 = _el$148.firstChild, _el$150 = _el$149.nextSibling, _el$151 = _el$148.nextSibling, _el$152 = _el$147.nextSibling, _el$153 = _el$152.firstChild, _el$154 = _el$153.nextSibling, _el$155 = _el$154.nextSibling, _el$163 = _el$155.nextSibling, _el$164 = _el$163.nextSibling, _el$165 = _el$164.firstChild, _el$166 = _el$165.nextSibling;
    insert(_el$142, createComponent(PanelSection, {
      get title() {
        ...
        return createComponent(Show, {
          ...
          children: (gameplay) => [(() => {
            ...
            get children() {
              return [(() => {
                var _el$168 = _tmpl$7();
                insert(_el$168, () => gameplay().acceptedIntentSummary);
                return _el$168;
              })(), (() => {
                var _el$169 = _tmpl$4();
                insert(_el$169, () => gameplay().acceptedIntentDetail);
                return _el$169;
              })(), createComponent(Show, {
                get when() {
                ...
                get children() {
                  return [(() => {
                    ...
                    var _el$171 = _tmpl$4();
                    insert(_el$171, () => gameplay().resumeAnchor);
                    return _el$171;
                  })()];
                }
              })];
            ...
            get children() {
              return [(() => {
                ...
                var _el$173 = _tmpl$7();
                insert(_el$173, () => gameplay().executionSummary || tr(locale(), "等待目标执行状态更新。", "Waiting for goal execution state updates."));
                return _el$173;
              })(), createComponent(Show, {
                get when() {
                ...
                get children() {
                  var _el$175 = _tmpl$4();
                  insert(_el$175, () => gameplay().executionCauseDetail);
                  return _el$175;
                }
              })];
            }
            ...
            get children() {
              return [createComponent(Show, {
                ...
                get children() {
                  var _el$176 = _tmpl$4();
                  insert(_el$176, () => gameplay().progressDetail);
                  return _el$176;
                }
              }), createComponent(Show, {
                get when() {
                ...
                get children() {
                  return [(() => {
                    ...
                    var _el$178 = _tmpl$4();
                    insert(_el$178, () => gameplay().narrativeBlockerDetail || tr(locale(), "当前玩法被阻塞，需要显式恢复。", "Gameplay is blocked and needs explicit recovery."));
                    return _el$178;
                  })()];
                }
              }), createComponent(Show, {
                ...
                get children() {
                  var _el$179 = _tmpl$4();
                  insert(_el$179, () => gameplay().blockerSupplementalDetail);
                  return _el$179;
                }
              }), (() => {
                var _el$180 = _tmpl$38();
                ...
                var _el$181 = _tmpl$7();
                insert(_el$181, () => gameplay().narrativeNextStep || tr(locale(), "等待下一次运行时指引更新。", "Wait for the next runtime guidance update."));
                return _el$181;
              })(), createComponent(Show, {
                get when() {
                ...
                get children() {
                  var _el$182 = _tmpl$4();
                  insert(_el$182, () => gameplay().branchHint);
                  return _el$182;
                }
              }), createComponent(Show, {
                get when() {
            ...
            get children() {
              var _el$184 = _tmpl$8();
              insert(_el$184, createComponent(MetricCard, {
                get label() {
            ...
            children: (feedback) => createComponent(EventCard, {
              ...
              get children() {
                return [(() => {
                  var _el$190 = _tmpl$7();
                  insert(_el$190, () => feedback().effect || feedback().reason || tr(locale(), "最新回执已更新，但还没有新的世界级后果。", "The latest feedback is in, but there is no new world-level consequence yet."));
                  return _el$190;
                })(), createComponent(Show, {
                  get when() {
                  ...
                  get children() {
                    var _el$191 = _tmpl$4();
                    insert(_el$191, () => feedback().reason);
                    return _el$191;
                  }
                }), createComponent(Show, {
                  get when() {
            ...
            children: (action) => createComponent(CalloutCard, {
              ...
              get children() {
                return [(() => {
                  var _el$193 = _tmpl$7();
                  insert(_el$193, () => action().label || action().actionId || tr(locale(), "当前存在一条更合适的推进动作。", "One action is currently the best next move."));
                  return _el$193;
                })(), (() => {
                  var _el$194 = _tmpl$4();
                  insert(_el$194, () => gameplayActionDetail(action(), gameplay(), locale()));
                  return _el$194;
                })(), (() => {
                  var _el$195 = _tmpl$28(), _el$196 = _el$195.firstChild;
                  _el$196.$$click = () => renderGameplayAction(action());
                  insert(_el$196, () => gameplayActionButtonLabel(action(), locale()));
                  createRenderEffect(() => _el$196.disabled = Boolean(action().disabledReason));
                  return _el$195;
                })()];
              }
            })
            ...
            var _el$185 = _tmpl$39(), _el$186 = _el$185.firstChild, _el$187 = _el$186.nextSibling;
            insert(_el$186, () => tr(locale(), "可用玩法动作", "Available Gameplay Actions"));
                ...
                return createComponent(For, {
                  ...
                  children: (action) => createComponent(EventCard, {
                    ...
                    get children() {
                      return [(() => {
                        var _el$197 = _tmpl$4();
                        insert(_el$197, () => gameplayActionDetail(action, gameplay(), locale()));
                        return _el$197;
                      })(), createComponent(Show, {
                        get when() {
                        ...
                        get children() {
                          var _el$200 = _tmpl$28(), _el$201 = _el$200.firstChild;
            ...
            get children() {
              return [(() => {
                var _el$188 = _tmpl$7();
                insert(_el$188, () => gameplay().assetGovernanceHandoff);
                return _el$188;
              })(), (() => {
                var _el$189 = _tmpl$4();
                insert(_el$189, () => tr(locale(), "资产 / 治理相关能力请走单独 lane；这张主入口页面只保留正式玩法所需的最小动作面。", "Asset and governance actions stay on their dedicated lane; this primary entry only keeps the minimum surface needed for formal gameplay."));
                return _el$189;
              })()];
            }
          })]
        ...
        return createComponent(PanelSection, {
          ...
          get children() {
            return [(() => {
              ...
              get children() {
                var _el$144 = _tmpl$35(), _el$145 = _el$144.firstChild;
                _el$145.$$click = () => {
                  void logoutHostedPlayerSession();
                };
                insert(_el$145, () => tr(locale(), "释放玩家会话", "Release Player Session"));
                return _el$144;
              }
            })];
          }
    ...
    insert(_el$149, () => tr(locale(), "运行诊断", "Runtime Diagnostics"));
    insert(_el$150, () => tr(locale(), "执行通道、认证/会话、托管矩阵与最近事件都收在这里，避免它们继续抢占主玩法首屏。", "Execution lanes, auth/session truth, hosted matrix, and recent events live here so they no longer dominate the primary gameplay viewport."));
    ...
    insert(_el$155, createComponent(Show, {
      ...
      get children() {
        ...
        insert(_el$156, () => tr(locale(), "释放玩家会话", "Release Player Session"));
        return _el$156;
      }
    }));
    ...
    insert(_el$165, () => tr(locale(), "最近事件", "Recent Events"));
...
function InteractionPanel() {
  ...
  return (() => {
    var _el$207 = _tmpl$50(), _el$208 = _el$207.firstChild, _el$210 = _el$208.nextSibling;
    ...
    insert(_el$207, createComponent(EmptyState, {
      get children() {
        return assetLaneDetail();
      }
    }), null);
    insert(_el$207, createComponent(PanelSection, {
      get title() {
      ...
      get children() {
        return [(() => {
          var _el$211 = _tmpl$40(), _el$212 = _el$211.firstChild, _el$213 = _el$212.nextSibling;
          insert(_el$212, () => tr(locale(), "消息", "Message"));
          _el$213.$$input = (event) => {
            state.chatDraft.message = String(event.currentTarget.value || "");
            state.chatDraft.dirty = true;
          };
          createRenderEffect((_p$) => {
            ...
            _v$17 !== _p$.e && setAttribute(_el$213, "placeholder", _p$.e = _v$17);
            _v$18 !== _p$.t && (_el$213.disabled = _p$.t = _v$18);
            return _p$;
          }, {
            e: void 0,
            t: void 0
          });
          createRenderEffect(() => _el$213.value = state.chatDraft.message);
          return _el$211;
        })(), (() => {
          var _el$214 = _tmpl$41(), _el$215 = _el$214.firstChild;
          _el$215.$$click = () => sendAgentChat(agentId(), state.chatDraft.message);
          insert(_el$215, () => tr(locale(), "发送聊天", "Send Chat"));
          createRenderEffect(() => _el$215.disabled = !chatCapability().enabled);
          return _el$214;
        })(), createComponent(Show, {
          get when() {
            return chatFeedback();
          ...
          var _el$216 = _tmpl$9(), _el$217 = _el$216.firstChild, _el$218 = _el$217.nextSibling;
          insert(_el$217, () => tr(locale(), "消息流", "Message Flow"));
              ...
              return createComponent(For, {
                ...
                children: (entry) => createComponent(EventCard, {
                  ...
                  get children() {
                    return [(() => {
                      var _el$247 = _tmpl$7();
                      insert(_el$247, () => chatEntryMessage(entry, locale()));
                      return _el$247;
    ...
    insert(_el$207, createComponent(PanelSection, {
      ...
      get children() {
        return [(() => {
          ...
          var _el$220 = _tmpl$42(), _el$221 = _el$220.firstChild;
          _el$221.$$click = () => togglePromptOverridesVisible();
          insert(_el$221, promptSettingsButtonLabel);
          return _el$220;
        })()];
      }
    }), null);
      ...
      get children() {
        return createComponent(PanelSection, {
          ...
          get children() {
            return [(() => {
              var _el$222 = _tmpl$4();
              insert(_el$222, () => promptVersionState().summary);
              return _el$222;
            })(), (() => {
              var _el$223 = _tmpl$4();
              insert(_el$223, () => promptVersionState().detail);
              return _el$223;
            })(), createComponent(Show, {
              get when() {
              ...
              get children() {
                var _el$224 = _tmpl$43(), _el$225 = _el$224.firstChild, _el$226 = _el$225.nextSibling;
                insert(_el$225, () => tr(locale(), "后端审批码", "Backend Approval Code"));
                _el$226.$$input = (event) => {
                  state.strongAuth.approvalCode = String(event.currentTarget.value || "");
                };
                createRenderEffect(() => _el$226.value = state.strongAuth.approvalCode || "");
                return _el$224;
              }
            }), (() => {
              var _el$227 = _tmpl$44(), _el$228 = _el$227.firstChild, _el$229 = _el$228.nextSibling;
              insert(_el$228, () => tr(locale(), "系统提示词覆盖", "System Prompt Override"));
              _el$229.$$input = (event) => {
                state.promptDraft.systemPrompt = String(event.currentTarget.value || "");
                state.promptDraft.dirty = true;
              };
              createRenderEffect(() => _el$229.disabled = !promptCapability().enabled);
              createRenderEffect(() => _el$229.value = state.promptDraft.systemPrompt);
              return _el$227;
            })(), (() => {
              var _el$230 = _tmpl$45(), _el$231 = _el$230.firstChild, _el$232 = _el$231.nextSibling;
              insert(_el$231, () => tr(locale(), "短期目标覆盖", "Short-Term Goal Override"));
              _el$232.$$input = (event) => {
                state.promptDraft.shortTermGoal = String(event.currentTarget.value || "");
                state.promptDraft.dirty = true;
              };
              createRenderEffect(() => _el$232.disabled = !promptCapability().enabled);
              createRenderEffect(() => _el$232.value = state.promptDraft.shortTermGoal);
              return _el$230;
            })(), (() => {
              var _el$233 = _tmpl$46(), _el$234 = _el$233.firstChild, _el$235 = _el$234.nextSibling;
              insert(_el$234, () => tr(locale(), "长期目标覆盖", "Long-Term Goal Override"));
              _el$235.$$input = (event) => {
                state.promptDraft.longTermGoal = String(event.currentTarget.value || "");
                state.promptDraft.dirty = true;
              };
              createRenderEffect(() => _el$235.disabled = !promptCapability().enabled);
              createRenderEffect(() => _el$235.value = state.promptDraft.longTermGoal);
              return _el$233;
            })(), (() => {
              var _el$236 = _tmpl$47(), _el$237 = _el$236.firstChild, _el$238 = _el$237.nextSibling;
              _el$237.$$click = () => sendPromptControl("preview", null);
              insert(_el$237, () => tr(locale(), "预览提示词", "Preview Prompt"));
              _el$238.$$click = () => sendPromptControl("apply", null);
              insert(_el$238, () => tr(locale(), "应用提示词", "Apply Prompt"));
              createRenderEffect((_p$) => {
                var _v$19 = !promptCapability().enabled, _v$20 = !promptCapability().enabled;
                _v$19 !== _p$.e && (_el$237.disabled = _p$.e = _v$19);
                _v$20 !== _p$.t && (_el$238.disabled = _p$.t = _v$20);
                return _p$;
              }, {
                e: void 0,
                t: void 0
              ...
              var _el$239 = _tmpl$48(), _el$240 = _el$239.firstChild, _el$241 = _el$240.firstChild, _el$242 = _el$241.nextSibling, _el$243 = _el$240.nextSibling;
              insert(_el$241, () => tr(locale(), "下一次回滚目标版本", "Next Rollback Target Version"));
              _el$242.$$input = (event) => {
              ...
              insert(_el$243, () => tr(locale(), "回滚提示词", "Rollback Prompt"));
              createRenderEffect((_p$) => {
                var _v$21 = !promptCapability().enabled, _v$22 = !promptCapability().enabled;
                _v$21 !== _p$.e && (_el$242.disabled = _p$.e = _v$21);
                _v$22 !== _p$.t && (_el$243.disabled = _p$.t = _v$22);
                return _p$;
              }, {
                e: void 0,
                t: void 0
              });
              createRenderEffect(() => _el$242.value = Number(state.promptDraft.rollbackTargetVersion || 0));
              return _el$239;
            })(), createComponent(Show, {
              get when() {
    ...
    insert(_el$207, createComponent(PanelSection, {
      ...
      get children() {
        return [(() => {
          ...
          var _el$245 = _tmpl$49(), _el$246 = _el$245.firstChild;
          insert(_el$246, () => tr(locale(), "主代币转账（这里暂未开放）", "Main Token Transfer (Not Exposed Here Yet)"));
          return _el$245;
        })()];
      }
    }), null);
...
function DetailsPanel() {
  ...
  return (() => {
    var _el$248 = _tmpl$52(), _el$249 = _el$248.firstChild, _el$250 = _el$249.nextSibling, _el$251 = _el$250.firstChild, _el$252 = _el$251.nextSibling, _el$253 = _el$252.nextSibling;
    ...
    insert(_el$248, createComponent(InteractionPanel, {}), _el$250);
    ...
    insert(_el$251, () => tr(locale(), "世界规模", "World Scale"));
    ...
    insert(_el$253, worldMetaSummary);
    ...
    insert(_el$248, createComponent(Show, {
      ...
      get children() {
        var _el$254 = _tmpl$51(), _el$255 = _el$254.firstChild, _el$256 = _el$255.nextSibling;
        insert(_el$255, () => tr(locale(), "最近错误", "Last Error"));
        insert(_el$256, () => state.lastError);
        return _el$254;
      }
    }), null);
    return _el$248;
...
function AppShell() {
  ...
  return [createComponent(MobileJumpRail, {}), createComponent(HostedLoginGate, {}), (() => {
    var _el$257 = _tmpl$53(), _el$258 = _el$257.firstChild, _el$259 = _el$258.firstChild, _el$260 = _el$259.nextSibling, _el$261 = _el$260.nextSibling, _el$262 = _el$258.nextSibling;
    insert(_el$259, () => tr(locale(), "导航", "Navigate"));
    insert(_el$260, () => tr(locale(), "目标", "Targets"));
    insert(_el$261, () => tr(locale(), "先锁定对象，再进入世界舞台或右侧指挥面板。", "Lock onto a target first, then move into the stage or command surface."));
    insert(_el$262, createComponent(TargetsPanel, {}));
    return _el$257;
  })(), (() => {
    var _el$263 = _tmpl$54(), _el$264 = _el$263.firstChild, _el$265 = _el$264.firstChild;
    insert(_el$265, createComponent(WorldStageHero, {}), null);
    insert(_el$265, createComponent(PixelWorldHost, {
      get locale() {
        return locale();
      }
    }), null);
    insert(_el$265, createComponent(WorldSummaryPanel, {}), null);
    return _el$263;
  })(), (() => {
    var _el$266 = _tmpl$55(), _el$267 = _el$266.firstChild, _el$268 = _el$267.firstChild, _el$269 = _el$268.nextSibling, _el$270 = _el$269.nextSibling, _el$271 = _el$267.nextSibling;
    insert(_el$268, () => tr(locale(), "指挥与核查", "Command and Inspect"));
    insert(_el$269, () => tr(locale(), "交互与明细", "Interact and Inspect"));
    insert(_el$270, () => tr(locale(), "只有锁定目标后才进入这里。聊天优先，提示词与对象核查继续后置。", "Enter this column only after locking a target. Chat comes first; prompt controls and raw inspection stay behind it."));
    insert(_el$271, createComponent(DetailsPanel, {}));
    return _el$266;
  })()];
}
