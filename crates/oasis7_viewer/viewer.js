...
function createViewerAuthSurfaceModule({
  ...
  function resolveHostedAccessHint2() {
    const raw = getSearchParams2().get("hosted_access");
    if (!raw) {
      return null;
    }
    try {
  ...
  function isLoopbackHostname2(raw) {
  ...
  function buildAuthSurfaceModel2() {
    ...
    const source = state2.hostedAccess ? state2.auth.available ? state2.auth.source === "legacy_viewer_auth_bootstrap" ? "legacy_viewer_auth_bootstrap+hosted_access_hint" : "hosted_player_issue+browser_local_device_session" : "hosted_access_hint" : state2.auth.available ? state2.auth.source : "guest_only";
    return {
      deploymentHint,
      source,
      currentTier,
      ...
      tiers: [
        ...
        },
        {
          ...
          status: state2.auth.available ? state2.auth.source === "legacy_viewer_auth_bootstrap" ? "active_legacy_preview" : state2.auth.registrationStatus === "registered" ? "active_hosted_session" : "issued_pending_register" : "not_issued",
...
var _tmpl$$1 = /* @__PURE__ */ template(`<div class=pixel-world-canvas__grid>`), _tmpl$2$1 = /* @__PURE__ */ template(`<div class="pixel-world-canvas__terrain-band pixel-world-canvas__terrain-band--one">`), _tmpl$3$1 = /* @__PURE__ */ template(`<div class="pixel-world-canvas__terrain-band pixel-world-canvas__terrain-band--two">`), _tmpl$4$1 = /* @__PURE__ */ template(`<div class=pixel-world-fragment-terrain>`), _tmpl$5$1 = /* @__PURE__ */ template(`<div class=pixel-world-route>`), _tmpl$6$1 = /* @__PURE__ */ template(`<div class="pixel-world-route-waypoint pixel-world-route-waypoint--mid">`), _tmpl$7$1 = /* @__PURE__ */ template(`<div class="pixel-world-route-waypoint pixel-world-route-waypoint--target">`), _tmpl$8$1 = /* @__PURE__ */ template(`<div class=pixel-world-hotspot><span>`), _tmpl$9$1 = /* @__PURE__ */ template(`<button class="pixel-world-entity pixel-world-entity--location"><span>`), _tmpl$0$1 = /* @__PURE__ */ template(`<button class="pixel-world-entity pixel-world-entity--agent"data-pixel-world-agent-marker=true><span>`), _tmpl$1$1 = /* @__PURE__ */ template(`<button type=button class="pixel-world-entity pixel-world-entity--agent pixel-world-entity--canvas-hit-target"data-pixel-world-agent-marker=true><span>`), _tmpl$10$1 = /* @__PURE__ */ template(`<div class="pixel-world-canvas__callout pixel-world-canvas__callout--goal">`), _tmpl$11$1 = /* @__PURE__ */ template(`<div class="pixel-world-canvas__callout pixel-world-canvas__callout--blocker">`), _tmpl$12$1 = /* @__PURE__ */ template(`<div class=pixel-world-canvas__selection>`), _tmpl$13$1 = /* @__PURE__ */ template(`<div class="pixel-world-canvas pixel-world-canvas--rendered"data-renderer-ready=true><canvas id=pixel-world-embedded-runtime-canvas class=pixel-world-canvas__surface tabindex=0 role=img aria-describedby=pixel-world-canvas-accessible-summary width=960 height=540></canvas><div id=pixel-world-canvas-accessible-summary class=sr-only></div><div class=pixel-world-canvas__overlay>`), _tmpl$14$1 = /* @__PURE__ */ template(`<div class=pixel-world-action-receipt__detail>`), _tmpl$15$1 = /* @__PURE__ */ template(`<span>`), _tmpl$16$1 = /* @__PURE__ */ template(`<div><div class=pixel-world-action-receipt__label></div><div class=pixel-world-action-receipt__body><div class=pixel-world-action-receipt__title></div><div class=pixel-world-action-receipt__summary></div></div><div class=pixel-world-action-receipt__meta><span>`), _tmpl$17$1 = /* @__PURE__ */ template(`<div class=pixel-world-command-cell__detail>`), _tmpl$18$1 = /* @__PURE__ */ template(`<div class=pixel-world-command-strip><div class="pixel-world-command-cell pixel-world-command-cell--objective"><div class=pixel-world-command-cell__label></div><div class=pixel-world-command-cell__value></div><div class=pixel-world-command-cell__detail></div></div><div class="pixel-world-command-cell pixel-world-command-cell--next"role=button tabindex=0><div class=pixel-world-command-cell__label></div><div class=pixel-world-command-cell__value></div><a class=pixel-world-command-cell__action></a></div><div class="pixel-world-command-cell pixel-world-command-cell--leverage"><div class=pixel-world-command-cell__label></div><div class=pixel-world-command-cell__value></div><div class=pixel-world-command-cell__detail>`), _tmpl$19$1 = /* @__PURE__ */ template(`<span class="badge badge--accent">`), _tmpl$20$1 = /* @__PURE__ */ template(`<span class="badge badge--warn">`), _tmpl$21$1 = /* @__PURE__ */ template(`<div class="pixel-world-readout badge-row"><span class="badge badge--accent"></span><span class=badge></span><span class=badge></span><span class=badge>`), _tmpl$22$1 = /* @__PURE__ */ template(`<div class="pixel-world-focus-hud__cell pixel-world-focus-hud__cell--tick"data-hud-priority=telemetry><span></span><strong></strong><em>`), _tmpl$23$1 = /* @__PURE__ */ template(`<div class=pixel-world-focus-hud data-focus-hud=true><div class=pixel-world-focus-hud__identity><div class=pixel-world-focus-hud__eyebrow></div><div class=pixel-world-focus-hud__title></div></div><div class="pixel-world-focus-hud__cell pixel-world-focus-hud__cell--prompt"><span></span><strong></strong><em></em></div><div class="pixel-world-focus-hud__cell pixel-world-focus-hud__cell--mission"><span></span><strong></strong><em></em></div><div class="pixel-world-focus-hud__cell pixel-world-focus-hud__cell--blocker"><span></span><strong></strong></div><div class="pixel-world-focus-hud__cell pixel-world-focus-hud__cell--receipt"><span></span><strong></strong><em></em></div><div class=pixel-world-focus-controls><button type=button class="pixel-world-focus-control pixel-world-focus-control--primary"></button><button type=button class="pixel-world-focus-control pixel-world-focus-control--secondary"></button><button type=button class="pixel-world-focus-control pixel-world-focus-control--secondary"></button><button type=button class="pixel-world-focus-control pixel-world-focus-control--quiet">`), _tmpl$24$1 = /* @__PURE__ */ template(`<div class=pixel-world-focus-cinematic data-focus-cinematic=true><div class=pixel-world-focus-cinematic__eyebrow></div><div class=pixel-world-focus-cinematic__title></div><div class=pixel-world-focus-cinematic__body></div><div class=badge-row><span class="badge badge--accent">`), _tmpl$25$1 = /* @__PURE__ */ template(`<div class=pixel-world-focus-rail__item><span></span><strong>`), _tmpl$26$1 = /* @__PURE__ */ template(`<div class=pixel-world-focus-rail data-focus-rail=true><div class=pixel-world-focus-rail__label>`), _tmpl$27$1 = /* @__PURE__ */ template(`<span class=sr-only>`), _tmpl$28$1 = /* @__PURE__ */ template(`<div class="pixel-world-focus-minimap__node pixel-world-focus-minimap__node--selected"data-selected=true><span></span><strong>`), _tmpl$29$1 = /* @__PURE__ */ template(`<div class=pixel-world-focus-minimap data-focus-minimap=true><div class=pixel-world-focus-minimap__label></div><div class=pixel-world-focus-minimap__grid></div><div class=pixel-world-focus-minimap__route></div><div class="pixel-world-focus-minimap__node pixel-world-focus-minimap__node--target"><span></span><strong></strong></div><div class="pixel-world-focus-minimap__node pixel-world-focus-minimap__node--agent"><span></span><strong></strong></div><div class=pixel-world-focus-minimap__meta><span></span><span></span><span></span><span>`), _tmpl$30$1 = /* @__PURE__ */ template(`<pre class=json>`), _tmpl$31$1 = /* @__PURE__ */ template(`<details class=diagnostic><summary>`), _tmpl$32$1 = /* @__PURE__ */ template(`<span class=badge>`), _tmpl$33$1 = /* @__PURE__ */ template(`<div class=badge-row><span class="badge badge--accent"></span><span class=badge></span><span>`), _tmpl$34$1 = /* @__PURE__ */ template(`<div class=pixel-world-focus-command-tray><div class="pixel-world-focus-command-chip pixel-world-focus-command-chip--target"><span></span><strong></strong></div><div class="pixel-world-focus-command-chip pixel-world-focus-command-chip--blocker"><span></span><strong></strong></div><div class="pixel-world-focus-command-chip pixel-world-focus-command-chip--receipt"><span></span><strong></strong></div><button type=button class="pixel-world-focus-command-chip pixel-world-focus-command-chip--primary"data-chat-send=1>`), _tmpl$35$1 = /* @__PURE__ */ template(`<div class=empty>`), _tmpl$36$1 = /* @__PURE__ */ template(`<div class="panel panel--nested"><div class=panel__header><div class="stack stack--compact"><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></div></div><div class="panel__body stack"><div class=field><label for=agent-chat-message></label><textarea id=agent-chat-message rows=2></textarea></div><div class=toolbar><button type=button data-chat-send=1></button></div><div><div class="panel__title panel__title--spaced"></div><div class=event-list>`), _tmpl$37$1 = /* @__PURE__ */ template(`<div class="pixel-world-focus-command-surface stack">`), _tmpl$38$1 = /* @__PURE__ */ template(`<div class=feedback-detail>`), _tmpl$39$1 = /* @__PURE__ */ template(`<div class=feedback-card><div class=badge-row><span></span></div><div class=feedback-summary>`), _tmpl$40$1 = /* @__PURE__ */ template(`<div class=event-card><div class=event-card__title><span></span></div><div class=event-card__meta></div><div class=feedback-summary>`), _tmpl$41$1 = /* @__PURE__ */ template(`<div class=pixel-world-host__summary><div class=pixel-world-host__summary-copy><div class=pixel-world-host__headline></div><div class=feedback-detail></div></div><div class=pixel-world-focus-entry><button type=button class=pixel-world-focus-entry__button>`), _tmpl$42$1 = /* @__PURE__ */ template(`<div class="empty pixel-world-render-unavailable"data-renderer-state=unavailable>`), _tmpl$43$1 = /* @__PURE__ */ template(`<details class="diagnostic pixel-world-render-unavailable"data-renderer-state=unavailable><summary></summary><div class="stack flow-top"><div class=feedback-summary>`), _tmpl$44$1 = /* @__PURE__ */ template(`<div class=pixel-world-focus-receipt>`), _tmpl$45$1 = /* @__PURE__ */ template(`<details class="pixel-world-focus-drawer pixel-world-focus-drawer--command"><summary></summary><div class=pixel-world-focus-drawer__body>`), _tmpl$46$1 = /* @__PURE__ */ template(`<details class="diagnostic pixel-world-render-diagnostics"><summary></summary><div class="pixel-world-host__toolbar badge-row"><span class="badge badge--accent"></span><span class="badge badge--accent"></span><span class="badge badge--accent"></span><span class=badge></span><span class=badge></span><span class=badge></span><span class=badge></span><span class=badge></span><span class=badge></span><button type=button></button><button type=button></button><div class=feedback-detail>`), _tmpl$47$1 = /* @__PURE__ */ template(`<details class="pixel-world-focus-drawer pixel-world-focus-drawer--diagnostics"><summary></summary><div class=pixel-world-focus-drawer__body><div class=badge-row><span class=badge></span><span class=badge></span><span class=badge></span></div><div class="toolbar toolbar--spaced"><button type=button>`), _tmpl$48$1 = /* @__PURE__ */ template(`<div class="stack flow-top"><pre class=json>`), _tmpl$49$1 = /* @__PURE__ */ template(`<div><details class=diagnostic><summary>`);
...
function PixelWorldHostVisualLayer(props) {
  ...
  return [_tmpl$$1(), _tmpl$2$1(), _tmpl$3$1(), createComponent(For, {
    get each() {
    ...
    children: (location, index) => (() => {
      ...
      createRenderEffect((_p$) => {
        var _v$14 = location.marker_role, _v$15 = {
          ...toWorldPercentStyle(location.pos, visualState().worldBounds, {
            left: `${12 + index() % 4 * 21}%`,
            top: `${18 + Math.floor(index() / 4) * 26}%`
          }),
          opacity: location.marker_alpha
        }, _v$16 = location.label;
        _v$14 !== _p$.e && setAttribute(_el$0, "data-marker-role", _p$.e = _v$14);
        _p$.t = style(_el$0, _v$15, _p$.t);
        _v$16 !== _p$.a && setAttribute(_el$0, "title", _p$.a = _v$16);
        return _p$;
      }, {
        e: void 0,
        t: void 0,
    ...
    children: (agent, index) => (() => {
      ...
      createRenderEffect((_p$) => {
        var _v$17 = agent.id, _v$18 = visualState().selection?.kind === "agent" && visualState().selection?.id === agent.id ? "true" : "false", _v$19 = agent.position_source, _v$20 = `${tr$1(props.locale(), "选择 Agent", "Select Agent")} ${agent.id}`, _v$21 = agentMarkerStyle(agent, index(), visualState().worldBounds), _v$22 = agent.label;
        _v$17 !== _p$.e && setAttribute(_el$10, "data-agent-id", _p$.e = _v$17);
        _v$18 !== _p$.t && setAttribute(_el$10, "data-selected", _p$.t = _v$18);
        _v$19 !== _p$.a && setAttribute(_el$10, "data-position-source", _p$.a = _v$19);
        _v$20 !== _p$.o && setAttribute(_el$10, "aria-label", _p$.o = _v$20);
        _p$.i = style(_el$10, _v$21, _p$.i);
        _v$22 !== _p$.n && setAttribute(_el$10, "title", _p$.n = _v$22);
        return _p$;
      }, {
        e: void 0,
        t: void 0,
...
function PixelWorldCanvasAgentHitTargets(props) {
  ...
  return createComponent(For, {
    ...
    children: (agent, index) => (() => {
      ...
      createRenderEffect((_p$) => {
        var _v$23 = agent.id, _v$24 = agent.position_source, _v$25 = `${tr$1(props.locale(), "选择 Agent", "Select Agent")} ${agent.id}`, _v$26 = agentMarkerStyle(agent, index(), visualState().worldBounds), _v$27 = agent.label;
        _v$23 !== _p$.e && setAttribute(_el$12, "data-agent-id", _p$.e = _v$23);
        _v$24 !== _p$.t && setAttribute(_el$12, "data-position-source", _p$.t = _v$24);
        _v$25 !== _p$.a && setAttribute(_el$12, "aria-label", _p$.a = _v$25);
        _p$.o = style(_el$12, _v$26, _p$.o);
        _v$27 !== _p$.i && setAttribute(_el$12, "title", _p$.i = _v$27);
        return _p$;
      }, {
        e: void 0,
        t: void 0,
...
function PixelWorldActionReceipt(props) {
  ...
  return (() => {
    var _el$21 = _tmpl$16$1(), _el$22 = _el$21.firstChild, _el$23 = _el$22.nextSibling, _el$24 = _el$23.firstChild, _el$25 = _el$24.nextSibling, _el$27 = _el$23.nextSibling, _el$28 = _el$27.firstChild;
    ...
    createRenderEffect((_p$) => {
      var _v$28 = `pixel-world-action-receipt ${props.class ?? ""}`, _v$29 = receipt().present ? "true" : "false", _v$30 = receipt().state, _v$31 = receipt().confidence;
      _v$28 !== _p$.e && className(_el$21, _p$.e = _v$28);
      _v$29 !== _p$.t && setAttribute(_el$21, "data-receipt-present", _p$.t = _v$29);
      _v$30 !== _p$.a && setAttribute(_el$21, "data-receipt-state", _p$.a = _v$30);
      _v$31 !== _p$.o && setAttribute(_el$21, "data-receipt-confidence", _p$.o = _v$31);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
function PixelWorldCommercialHud(props) {
  ...
  return createComponent(Show, {
    ...
    get children() {
      return [(() => {
        var _el$30 = _tmpl$18$1(), _el$31 = _el$30.firstChild, _el$32 = _el$31.firstChild, _el$33 = _el$32.nextSibling, _el$34 = _el$33.nextSibling, _el$35 = _el$31.nextSibling, _el$36 = _el$35.firstChild, _el$37 = _el$36.nextSibling, _el$39 = _el$37.nextSibling, _el$40 = _el$35.nextSibling, _el$41 = _el$40.firstChild, _el$42 = _el$41.nextSibling, _el$43 = _el$42.nextSibling;
        ...
        insert(_el$36, () => tr$1(props.locale(), "下一步", "Next Move"));
        insert(_el$37, () => surface().next_action.label);
        insert(_el$35, createComponent(Show, {
          get when() {
            return surface().next_action.detail;
          },
          get children() {
            var _el$38 = _tmpl$17$1();
            insert(_el$38, () => surface().next_action.detail);
            return _el$38;
          }
        }), _el$39);
        _el$39.$$click = activateNextMove;
        insert(_el$39, (() => {
        ...
        insert(_el$41, () => tr$1(props.locale(), "玩家杠杆", "Player Leverage"));
        insert(_el$42, () => surface().player_leverage.summary);
        insert(_el$43, (() => {
        ...
        createRenderEffect((_p$) => {
          var _v$32 = surface().active_agent_id || "", _v$33 = surface().player_leverage.state, _v$34 = nextMoveRoute(), _v$35 = surface().next_action.execute_kind || "none", _v$36 = nextMoveHref();
          _v$32 !== _p$.e && setAttribute(_el$30, "data-active-agent", _p$.e = _v$32);
          _v$33 !== _p$.t && setAttribute(_el$30, "data-leverage-state", _p$.t = _v$33);
          _v$34 !== _p$.a && setAttribute(_el$35, "data-next-move-route", _p$.a = _v$34);
          _v$35 !== _p$.o && setAttribute(_el$35, "data-execute-kind", _p$.o = _v$35);
          _v$36 !== _p$.i && setAttribute(_el$39, "href", _p$.i = _v$36);
          return _p$;
        }, {
          e: void 0,
          t: void 0,
        ...
        var _el$44 = _tmpl$21$1(), _el$46 = _el$44.firstChild, _el$47 = _el$46.nextSibling, _el$48 = _el$47.nextSibling, _el$49 = _el$48.nextSibling;
        insert(_el$44, createComponent(Show, {
          get when() {
            return memo(() => surface().world_read.tick !== null)() && surface().world_read.tick !== void 0;
          },
          get children() {
            var _el$45 = _tmpl$19$1();
            insert(_el$45, () => `tick=${surface().world_read.tick}`);
            createRenderEffect(() => setAttribute(_el$45, "data-world-tick", String(surface().world_read.tick)));
            return _el$45;
          }
        }), _el$46);
        insert(_el$46, () => `agents=${surface().world_read.agents}`);
        insert(_el$47, () => `routes=${surface().world_read.routes}`);
        insert(_el$48, () => `fragments=${surface().world_read.fragments}`);
        insert(_el$49, () => `hotspots=${surface().world_read.hotspots}`);
        insert(_el$44, createComponent(Show, {
          get when() {
          ...
          get children() {
            ...
            insert(_el$50, () => `blocker=${surface().blocker.label}`);
            return _el$50;
          }
        }), null);
        return _el$44;
  ...
  return createComponent(Show, {
    ...
    get children() {
      ...
      insert(_el$51, createComponent(Show, {
        ...
        get children() {
          var _el$63 = _tmpl$22$1(), _el$64 = _el$63.firstChild, _el$65 = _el$64.nextSibling, _el$66 = _el$65.nextSibling;
      ...
      insert(_el$73, () => surface().action_receipt.confidence);
      addEventListener(_el$75, "click", props.onOpenCommand);
      insert(_el$75, () => tr$1(props.locale(), "命令", "Command"));
      addEventListener(_el$76, "click", props.onOpenDiagnostics);
      insert(_el$76, () => tr$1(props.locale(), "诊断", "Diagnostics"));
      ...
      addEventListener(_el$78, "click", props.onExit);
      insert(_el$78, () => tr$1(props.locale(), "退出", "Exit"));
      createRenderEffect((_p$) => {
        var _v$37 = surface().blocker.label ? "true" : "false", _v$38 = surface().blocker.label ? "critical" : "clear", _v$39 = surface().action_receipt.confidence, _v$40 = surface().action_receipt.present ? "receipt" : "waiting", _v$41 = tr$1(props.locale(), "沉浸模式控制", "World focus controls");
        _v$37 !== _p$.e && setAttribute(_el$67, "data-blocker-present", _p$.e = _v$37);
        _v$38 !== _p$.t && setAttribute(_el$67, "data-hud-priority", _p$.t = _v$38);
        _v$39 !== _p$.a && setAttribute(_el$70, "data-receipt-confidence", _p$.a = _v$39);
        _v$40 !== _p$.o && setAttribute(_el$70, "data-hud-priority", _p$.o = _v$40);
        _v$41 !== _p$.i && setAttribute(_el$74, "aria-label", _p$.i = _v$41);
        return _p$;
      }, {
        e: void 0,
        t: void 0,
...
function PixelWorldFocusCinematicBanner(props) {
  ...
  return createComponent(Show, {
    ...
    get children() {
      var _el$79 = _tmpl$24$1(), _el$80 = _el$79.firstChild, _el$81 = _el$80.nextSibling, _el$82 = _el$81.nextSibling, _el$83 = _el$82.nextSibling, _el$84 = _el$83.firstChild;
      insert(_el$80, () => tr$1(props.locale(), "电影化首屏", "Cinematic Opening"));
      insert(_el$81, () => tr$1(props.locale(), "工业世界指挥台", "Industrial World Command Board"));
      insert(_el$82, () => surface().objective.detail);
      insert(_el$84, () => surface().objective.title);
      insert(_el$83, createComponent(Show, {
        get when() {
          return surface().blocker.label;
        },
        get children() {
          var _el$85 = _tmpl$20$1();
          insert(_el$85, () => surface().blocker.label);
          return _el$85;
        }
      }), null);
      return _el$79;
...
function PixelWorldFocusRail(props) {
  ...
  return createComponent(Show, {
    ...
    get children() {
      var _el$86 = _tmpl$26$1(), _el$87 = _el$86.firstChild;
      insert(_el$87, () => tr$1(props.locale(), "焦点", "Focus"));
      insert(_el$86, createComponent(Show, {
        get when() {
          return activeAgent();
        },
        get children() {
          var _el$88 = _tmpl$25$1(), _el$89 = _el$88.firstChild, _el$90 = _el$89.nextSibling;
          insert(_el$89, () => tr$1(props.locale(), "Agent", "Agent"));
          insert(_el$90, activeAgent);
          return _el$88;
        }
      }), null);
      insert(_el$86, createComponent(Show, {
        ...
        get children() {
          var _el$91 = _tmpl$25$1(), _el$92 = _el$91.firstChild, _el$93 = _el$92.nextSibling;
          insert(_el$92, () => tr$1(props.locale(), "选中", "Selected"));
          insert(_el$93, () => `${selected().kind}/${selected().id}`);
          return _el$91;
        }
      }), null);
      insert(_el$86, createComponent(Show, {
        ...
        get children() {
          var _el$94 = _tmpl$25$1(), _el$95 = _el$94.firstChild, _el$96 = _el$95.nextSibling;
          insert(_el$95, () => tr$1(props.locale(), "路线", "Routes"));
          insert(_el$96, routeCount);
          return _el$94;
        }
      }), null);
      insert(_el$86, createComponent(Show, {
        ...
        get children() {
          var _el$97 = _tmpl$25$1(), _el$98 = _el$97.firstChild, _el$99 = _el$98.nextSibling;
          insert(_el$98, () => tr$1(props.locale(), "阻塞", "Blocker"));
          insert(_el$99, () => surface().blocker.label);
          return _el$97;
        }
      }), null);
      return _el$86;
...
function PixelWorldFocusMinimapCard(props) {
  ...
  return createComponent(Show, {
    ...
    get children() {
      var _el$100 = _tmpl$29$1(), _el$101 = _el$100.firstChild, _el$103 = _el$101.nextSibling, _el$104 = _el$103.nextSibling, _el$105 = _el$104.nextSibling, _el$106 = _el$105.firstChild, _el$107 = _el$106.nextSibling, _el$108 = _el$105.nextSibling, _el$109 = _el$108.firstChild, _el$110 = _el$109.nextSibling, _el$114 = _el$108.nextSibling, _el$115 = _el$114.firstChild, _el$116 = _el$115.nextSibling, _el$117 = _el$116.nextSibling, _el$118 = _el$117.nextSibling;
      insert(_el$101, () => tr$1(props.locale(), "任务地图", "Mission Map"));
      insert(_el$100, createComponent(Show, {
        get when() {
          return primaryLocation();
        },
        get children() {
          var _el$102 = _tmpl$27$1();
          insert(_el$102, () => `${tr$1(props.locale(), "参照", "Reference")}: ${primaryLocation().label || primaryLocation().id}`);
          return _el$102;
        }
      }), _el$103);
      insert(_el$106, () => tr$1(props.locale(), "目标", "Target"));
      insert(_el$107, () => surface().next_action.label);
      insert(_el$109, () => tr$1(props.locale(), "Agent", "Agent"));
      insert(_el$110, () => activeAgent() || tr$1(props.locale(), "待分配", "Unassigned"));
      insert(_el$100, createComponent(Show, {
        get when() {
          return selected();
        },
        get children() {
          var _el$111 = _tmpl$28$1(), _el$112 = _el$111.firstChild, _el$113 = _el$112.nextSibling;
          insert(_el$112, () => tr$1(props.locale(), "选中", "Selected"));
          insert(_el$113, () => `${selected().kind}/${selected().id}`);
          return _el$111;
        }
      }), _el$114);
      insert(_el$115, () => `agents=${props.renderState().agents.length}`);
      insert(_el$116, () => `targets=${props.renderState().locations.length}`);
      insert(_el$117, () => `routes=${props.renderState().links.length}`);
      insert(_el$118, () => `fragments=${props.renderState().fragment_terrain.length}`);
      createRenderEffect((_p$) => {
        var _v$42 = props.renderState().links.length, _v$43 = tr$1(props.locale(), "世界摘要", "World summary");
        _v$42 !== _p$.e && setAttribute(_el$104, "data-routes", _p$.e = _v$42);
        _v$43 !== _p$.t && setAttribute(_el$114, "aria-label", _p$.t = _v$43);
        return _p$;
      }, {
        e: void 0,
        t: void 0
...
function PixelRawDiagnostics(props) {
  ...
  return (() => {
    var _el$119 = _tmpl$31$1(), _el$120 = _el$119.firstChild;
    _el$119.addEventListener("toggle", (event) => setOpen(event.currentTarget.open));
    insert(_el$120, () => tr$1(locale(), "原始诊断", "Raw diagnostics"));
    insert(_el$119, createComponent(Show, {
      get when() {
        return open();
      },
      get children() {
        var _el$121 = _tmpl$30$1();
        insert(_el$121, () => JSON.stringify(value(), null, 2));
        return _el$121;
      }
    }), null);
    return _el$119;
...
function PixelWorldFocusCommandSurface(props) {
  ...
  return (() => {
    ...
    insert(_el$122, createComponent(Show, {
      ...
      get fallback() {
        return (() => {
          var _el$155 = _tmpl$35$1();
          insert(_el$155, () => tr$1(locale(), "先选中一个行动体，才能在沉浸模式里直接下指令。", "Select an agent to issue direct commands in World Focus."));
          return _el$155;
        })();
      },
      get children() {
        return [(() => {
          var _el$123 = _tmpl$33$1(), _el$124 = _el$123.firstChild, _el$125 = _el$124.nextSibling, _el$127 = _el$125.nextSibling;
          insert(_el$124, () => tr$1(locale(), "当前交互目标", "Current Target"));
          insert(_el$125, () => `agent=${agentId()}`);
          insert(_el$123, createComponent(Show, {
            get when() {
              return binding()?.playerId;
            },
            get children() {
              var _el$126 = _tmpl$32$1();
              insert(_el$126, () => `boundPlayer=${binding().playerId}`);
              return _el$126;
            }
          }), _el$127);
          insert(_el$127, (() => {
          ...
          createRenderEffect(() => className(_el$127, chatCapability().enabled ? "badge badge--good" : "badge badge--warn"));
          return _el$123;
        })(), (() => {
          var _el$128 = _tmpl$34$1(), _el$129 = _el$128.firstChild, _el$130 = _el$129.firstChild, _el$131 = _el$130.nextSibling, _el$132 = _el$129.nextSibling, _el$133 = _el$132.firstChild, _el$134 = _el$133.nextSibling, _el$135 = _el$132.nextSibling, _el$136 = _el$135.firstChild, _el$137 = _el$136.nextSibling, _el$138 = _el$135.nextSibling;
          insert(_el$130, () => tr$1(locale(), "目标", "Target"));
          ...
          insert(_el$146, createComponent(Show, {
            ...
            get fallback() {
              return (() => {
                var _el$156 = _tmpl$35$1();
                insert(_el$156, () => tr$1(locale(), "还没有聊天反馈。", "No chat feedback yet."));
                return _el$156;
              })();
            },
            children: (feedback) => (() => {
              var _el$157 = _tmpl$39$1(), _el$158 = _el$157.firstChild, _el$159 = _el$158.firstChild, _el$161 = _el$158.nextSibling;
          ...
          insert(_el$154, createComponent(Show, {
            ...
            get children() {
              return createComponent(For, {
                ...
                children: (entry) => (() => {
                  var _el$164 = _tmpl$40$1(), _el$165 = _el$164.firstChild, _el$166 = _el$165.firstChild, _el$167 = _el$165.nextSibling, _el$168 = _el$167.nextSibling;
...
function PixelWorldHost(props) {
  ...
  return (() => {
    var _el$169 = _tmpl$49$1(), _el$216 = _el$169.firstChild, _el$217 = _el$216.firstChild;
    ...
    insert(_el$169, createComponent(Show, {
      ...
      get children() {
        var _el$170 = _tmpl$41$1(), _el$171 = _el$170.firstChild, _el$172 = _el$171.firstChild, _el$173 = _el$172.nextSibling, _el$174 = _el$171.nextSibling, _el$175 = _el$174.firstChild;
        ...
        _el$175.$$click = enterFocusMode;
        insert(_el$175, () => tr$1(locale(), "进入沉浸模式", "Enter World Focus"));
        createRenderEffect((_p$) => {
          var _v$50 = !renderState(), _v$51 = focusMode() ? "true" : "false";
          _v$50 !== _p$.e && (_el$175.disabled = _p$.e = _v$50);
          _v$51 !== _p$.t && setAttribute(_el$175, "aria-pressed", _p$.t = _v$51);
          return _p$;
        }, {
          e: void 0,
          t: void 0
    ...
    insert(_el$169, createComponent(Show, {
      ...
      get children() {
        var _el$177 = _tmpl$43$1(), _el$178 = _el$177.firstChild, _el$179 = _el$178.nextSibling, _el$180 = _el$179.firstChild;
        insert(_el$178, () => tr$1(locale(), "Renderer 不可用", "Renderer Unavailable"));
        insert(_el$180, () => tr$1(locale(), "Rust bridge 未能生成世界显示状态；页面不再保留第二套 JS 世界渲染。", "Rust bridge could not derive the world display state; the page no longer keeps a second JS world renderer."));
        insert(_el$179, createComponent(Show, {
          get when() {
            return rendererFatal();
          },
          get children() {
            var _el$181 = _tmpl$38$1();
            insert(_el$181, () => `${rendererFatal().code}: ${rendererFatal().message}`);
            return _el$181;
          }
        }), null);
        return _el$177;
    ...
    insert(_el$169, createComponent(Show, {
      ...
      get children() {
        var _el$182 = _tmpl$44$1();
        insert(_el$182, createComponent(PixelWorldActionReceipt, {
    ...
    insert(_el$169, createComponent(Show, {
      ...
      get children() {
        var _el$183 = _tmpl$45$1(), _el$184 = _el$183.firstChild, _el$185 = _el$184.nextSibling;
        _el$183.addEventListener("toggle", (event) => setPersistentCommandDrawerOpen(event.currentTarget.open));
        insert(_el$184, () => tr$1(locale(), "命令与目标", "Command and Target"));
        insert(_el$185, createComponent(PixelWorldFocusCommandSurface, {
          locale
        }));
        createRenderEffect(() => _el$183.open = commandDrawerOpen());
        return _el$183;
      }
    }), _el$216);
    insert(_el$169, createComponent(Show, {
      ...
      get children() {
        var _el$186 = _tmpl$46$1(), _el$187 = _el$186.firstChild, _el$188 = _el$187.nextSibling, _el$189 = _el$188.firstChild, _el$190 = _el$189.nextSibling, _el$191 = _el$190.nextSibling, _el$193 = _el$191.nextSibling, _el$194 = _el$193.nextSibling, _el$195 = _el$194.nextSibling, _el$196 = _el$195.nextSibling, _el$197 = _el$196.nextSibling, _el$198 = _el$197.nextSibling, _el$202 = _el$198.nextSibling, _el$203 = _el$202.nextSibling, _el$204 = _el$203.nextSibling;
        insert(_el$187, () => tr$1(locale(), "Renderer 诊断", "Renderer Diagnostics"));
        insert(_el$189, () => `locations=${visualState().locations.length}`);
        insert(_el$190, () => `fragments=${visualState().fragmentTerrain.length}`);
        insert(_el$191, () => `agents=${visualState().agents.length}`);
        insert(_el$188, createComponent(Show, {
          get when() {
            return memo(() => renderState()?.world_tick !== null)() && renderState()?.world_tick !== void 0;
          },
          get children() {
            var _el$192 = _tmpl$19$1();
            insert(_el$192, () => `tick=${renderState()?.world_tick}`);
            createRenderEffect(() => setAttribute(_el$192, "data-world-tick", String(renderState()?.world_tick)));
            return _el$192;
          }
        }), _el$193);
        insert(_el$193, () => `links=${visualState().links.length}`);
        insert(_el$194, () => `hotspots=${arrayField(renderState(), "visual_hotspots", "visualHotspots").length}`);
        insert(_el$195, () => `derived_positions=${visualState().agents.filter((agent) => agent.position_source === "location_derived").length}`);
        insert(_el$196, () => visualState().worldBounds ? "world_bounds=ready" : "world_bounds=missing");
        ...
        insert(_el$188, createComponent(Show, {
          ...
          get children() {
            var _el$199 = _tmpl$32$1();
            insert(_el$199, () => `zoom=${cameraState().zoom.toFixed(2)}`);
            return _el$199;
          }
        }), _el$202);
        insert(_el$188, createComponent(Show, {
          ...
          get children() {
            var _el$200 = _tmpl$32$1();
            insert(_el$200, () => `pan=${cameraState().pan_x_px},${cameraState().pan_y_px}`);
            return _el$200;
          }
        }), _el$202);
        insert(_el$188, createComponent(Show, {
          ...
          get children() {
            var _el$201 = _tmpl$32$1();
            insert(_el$201, () => `hover=${hoverSelection().kind}/${hoverSelection().id}`);
            return _el$201;
          }
        }), _el$202);
        _el$202.$$click = requestReadyMode;
        insert(_el$202, () => tr$1(locale(), "重新挂载嵌入式 Renderer", "Reattach Embedded Renderer"));
        _el$203.$$click = simulateFatal;
        insert(_el$203, () => tr$1(locale(), "模拟 Renderer Fatal", "Simulate Renderer Fatal"));
        insert(_el$204, () => tr$1(locale(), "当前世界舞台只依赖 wasm/Rust bridge、嵌入式 canvas、轻量拖拽缩放和事件回传。", "The world stage depends only on the wasm/Rust bridge, embedded canvas, light pan-zoom interaction, and event callbacks."));
        return _el$186;
      }
    }), _el$216);
    insert(_el$169, createComponent(Show, {
      ...
      get children() {
        var _el$205 = _tmpl$47$1(), _el$206 = _el$205.firstChild, _el$207 = _el$206.nextSibling, _el$208 = _el$207.firstChild, _el$210 = _el$208.firstChild, _el$211 = _el$210.nextSibling, _el$212 = _el$211.nextSibling, _el$214 = _el$208.nextSibling, _el$215 = _el$214.firstChild;
        _el$205.addEventListener("toggle", (event) => setPersistentDiagnosticsDrawerOpen(event.currentTarget.open));
        insert(_el$206, () => tr$1(locale(), "沉浸诊断", "Focus Diagnostics"));
        insert(_el$208, createComponent(Show, {
          get when() {
            return memo(() => renderState().world_tick !== null)() && renderState().world_tick !== void 0;
          },
          get children() {
            var _el$209 = _tmpl$19$1();
    ...
    insert(_el$216, createComponent(Show, {
      ...
      get children() {
        var _el$218 = _tmpl$48$1(), _el$219 = _el$218.firstChild;
        insert(_el$219, () => JSON.stringify(renderState(), null, 2));
        return _el$218;
      }
    }), null);
    createRenderEffect((_p$) => {
      var _v$52 = `pixel-world-host stack ${focusMode() ? "pixel-world-host--focus" : ""} ${focusMode() && maximized() ? "pixel-world-host--focus-maximized" : ""}`, _v$53 = focusMode() ? "true" : "false", _v$54 = focusMode() && maximized() ? "true" : "false", _v$55 = shouldShowFocusCinematic(renderState()) ? "false" : "true";
      _v$52 !== _p$.e && className(_el$169, _p$.e = _v$52);
      _v$53 !== _p$.t && setAttribute(_el$169, "data-world-focus", _p$.t = _v$53);
      _v$54 !== _p$.a && setAttribute(_el$169, "data-world-focus-maximized", _p$.a = _v$54);
      _v$55 !== _p$.o && setAttribute(_el$169, "data-focus-comparable", _p$.o = _v$55);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
var _tmpl$ = /* @__PURE__ */ template(`<span>`), _tmpl$2 = /* @__PURE__ */ template(`<div>`), _tmpl$3 = /* @__PURE__ */ template(`<div class=entity-list-pending aria-live=polite aria-busy=true><div class=entity-list-pending__row><span class=entity-list-pending__spinner aria-hidden=true></span><span></span></div><div class=entity-list-pending__skeleton aria-hidden=true><span></span><span></span><span>`), _tmpl$4 = /* @__PURE__ */ template(`<pre class=json>`), _tmpl$5 = /* @__PURE__ */ template(`<div class=feedback-detail>`), _tmpl$6 = /* @__PURE__ */ template(`<details class=diagnostic><summary></summary><div class="stack flow-top">`), _tmpl$7 = /* @__PURE__ */ template(`<div class=badge-row>`), _tmpl$8 = /* @__PURE__ */ template(`<div class=feedback-summary>`), _tmpl$9 = /* @__PURE__ */ template(`<div class=summary-grid>`), _tmpl$0 = /* @__PURE__ */ template(`<div><div class="panel__title panel__title--spaced"></div><div class=event-list>`), _tmpl$1 = /* @__PURE__ */ template(`<div class=action-grid>`), _tmpl$10 = /* @__PURE__ */ template(`<div class=event-list>`), _tmpl$11 = /* @__PURE__ */ template(`<div class=inline-help-tip><button type=button class=inline-help-tip__button>?</button><div class=inline-help-tip__panel><div class=inline-help-tip__title></div><div class=inline-help-tip__body>`), _tmpl$12 = /* @__PURE__ */ template(`<div class=feedback-card><div class=badge-row></div><div class=feedback-summary>`), _tmpl$13 = /* @__PURE__ */ template(`<div class="feedback-detail flow-top--tight">`), _tmpl$14 = /* @__PURE__ */ template(`<div class="badge-row badge-row--tight">`), _tmpl$15 = /* @__PURE__ */ template(`<div class=metric><div class=metric__label></div><div class=metric__value>`), _tmpl$16 = /* @__PURE__ */ template(`<div class=event-card__meta>`), _tmpl$17 = /* @__PURE__ */ template(`<div><div class=event-card__title><span>`), _tmpl$18 = /* @__PURE__ */ template(`<div class=panel__eyebrow>`), _tmpl$19 = /* @__PURE__ */ template(`<div class=panel__meta-copy>`), _tmpl$20 = /* @__PURE__ */ template(`<div><div class=panel__header><div class="stack stack--compact"><div class=panel__title></div></div></div><div class="panel__body stack">`), _tmpl$21 = /* @__PURE__ */ template(`<div><div class=callout__header><div class=callout__title></div></div><div class=callout__body>`), _tmpl$22 = /* @__PURE__ */ template(`<div class=field><label></label><input type=text autocomplete=off>`), _tmpl$23 = /* @__PURE__ */ template(`<div class=toolbar><button data-auth-action=complete-login>`), _tmpl$24 = /* @__PURE__ */ template(`<div class=stack>`), _tmpl$25 = /* @__PURE__ */ template(`<div class=stack><div class=control-grid><div class=field><label></label><input type=email autocomplete=email></div></div><div class=toolbar><button data-auth-action=start-login>`), _tmpl$26 = /* @__PURE__ */ template(`<div class=auth-gate data-viewer-fixture-state=hosted_login_gate role=dialog aria-modal=true aria-labelledby=hosted-login-gate-title tabindex=-1><div class=auth-gate__dialog><div class=auth-gate__header><div><div class=panel__eyebrow></div><h1 id=hosted-login-gate-title class=auth-gate__title></h1></div></div><div class=feedback-summary>`), _tmpl$27 = /* @__PURE__ */ template(`<div class=toolbar><button>`), _tmpl$28 = /* @__PURE__ */ template(`<details class=entry-menu><summary class=entry-menu__toggle></summary><div class="entry-menu__panel stack"><div><div class="panel__title panel__title--spaced"></div><div class=feedback-detail></div></div><div class=toolbar><button data-locale=zh>中文</button><button data-locale=en>English</button></div><div class=badge-row></div><div class=feedback-detail>`), _tmpl$29 = /* @__PURE__ */ template(`<div class="stack stack--compact"><div class=feedback-summary></div><div class=summary-grid><div class=metric><div class=metric__label></div><div class=metric__value></div></div><div class=metric><div class=metric__label></div><div class=metric__value></div></div><div class=metric><div class=metric__label></div><div class=metric__value>`), _tmpl$30 = /* @__PURE__ */ template(`<button>`), _tmpl$31 = /* @__PURE__ */ template(`<div class=auth-gate role=dialog aria-modal=true aria-labelledby=starter-oc-gate-title data-viewer-fixture-state=starter_oc_required_gate><div class=auth-gate__dialog><div class=auth-gate__header><div><div class=panel__eyebrow></div><h1 id=starter-oc-gate-title class=auth-gate__title></h1></div></div><div class=feedback-detail></div><div class=toolbar>`), _tmpl$32 = /* @__PURE__ */ template(`<div class=control-grid><div class=field><label for=agent-claim-target></label><select id=agent-claim-target>`), _tmpl$33 = /* @__PURE__ */ template(`<option>`), _tmpl$34 = /* @__PURE__ */ template(`<div class="stage-hero stage-hero--compact"><div class=stage-hero__topline><div class="stack stack--hero"><div class=stage-hero__eyebrow-row><div class=stage-hero__eyebrow></div></div><div class=stage-hero__title></div><div class=stage-hero__lede></div></div></div><div class="hero-focus-grid hero-focus-grid--compact"><div class=hero-focus-card><div class=hero-focus-card__label></div><div></div><div class=hero-focus-card__detail></div></div><div class=hero-focus-card><div class=hero-focus-card__label></div><div class="hero-focus-card__value hero-focus-card__value--body"></div><div class=hero-focus-card__detail></div></div><div class=hero-focus-card><div class=hero-focus-card__label></div><div class="hero-focus-card__value hero-focus-card__value--body"></div></div><div class=hero-focus-card data-testid=viewer-identity-card><div class=hero-focus-card__label></div><div class="hero-focus-card__value hero-focus-card__value--body"></div><div class=hero-focus-card__detail></div><div class=hero-focus-card__detail></div></div></div><div class=toolbar><button type=button data-testid=viewer-playthrough-action-request-snapshot></button><button type=button data-testid=viewer-playthrough-action-step></button></div><div class=feedback-detail data-testid=viewer-primary-action-preview></div><div class=stage-hero__mobile-shortcuts><a class=mobile-rail__link href=#viewer-targets-panel></a><a class=mobile-rail__link href=#viewer-details-panel>`), _tmpl$35 = /* @__PURE__ */ template(`<nav class=mobile-rail><a class=mobile-rail__link href=#viewer-stage-panel></a><a class=mobile-rail__link href=#viewer-targets-panel></a><a class=mobile-rail__link href=#viewer-details-panel></a><a class="mobile-rail__link mobile-rail__link--diagnostics"href=#viewer-diagnostics-panel>`), _tmpl$36 = /* @__PURE__ */ template(`<div class=stack><div class=field><label for=entity-search></label><input id=entity-search type=search></div><div><div class="panel__title panel__title--spaced"></div><div class=list></div></div><div><div class="panel__title panel__title--spaced"></div><div class=list>`), _tmpl$37 = /* @__PURE__ */ template(`<button class=list-item data-select-kind=agent><div class=list-item__title></div><div class=badge-row></div><div class=list-item__meta></div><div class=list-item__meta>`), _tmpl$38 = /* @__PURE__ */ template(`<button class=list-item data-select-kind=location><div class=list-item__title></div><div class=list-item__meta>`), _tmpl$39 = /* @__PURE__ */ template(`<div class=toolbar><button data-auth-action=logout>`), _tmpl$40 = /* @__PURE__ */ template(`<button data-auth-action=logout>`), _tmpl$41 = /* @__PURE__ */ template(`<details class=gameplay-details-surface id=viewer-gameplay-details open><summary class=gameplay-details-surface__summary><div class=diagnostic-surface__title><span></span><span class=diagnostic-surface__meta></span></div></summary><div class="stack flow-top"><details id=viewer-diagnostics-panel class="panel diagnostic-surface"data-viewer-surface=diagnostics><summary class="panel__header diagnostic-surface__summary"><div class=diagnostic-surface__title><div class=panel__title></div><div class=diagnostic-surface__meta></div></div><div class=badge-row></div></summary><div class="panel__body stack"><div class=badge-row></div><div class=badge-row></div><div class=toolbar></div><div class=summary-grid></div><div><div class="panel__title panel__title--spaced"></div><div class=event-list>`), _tmpl$42 = /* @__PURE__ */ template(`<div class="badge-row badge-row--spaced">`), _tmpl$43 = /* @__PURE__ */ template(`<div><div class="panel__title panel__title--spaced"></div><div class=action-grid>`), _tmpl$44 = /* @__PURE__ */ template(`<div class="badge-row command-surface__auth-boundary">`), _tmpl$45 = /* @__PURE__ */ template(`<div class=field><label for=agent-chat-message></label><textarea id=agent-chat-message rows=4>`), _tmpl$46 = /* @__PURE__ */ template(`<div class=toolbar><button data-chat-send=1>`), _tmpl$47 = /* @__PURE__ */ template(`<div class=toolbar><button data-prompt-visibility-toggle=1>`), _tmpl$48 = /* @__PURE__ */ template(`<div class=field><label for=strong-auth-approval-code></label><input id=strong-auth-approval-code type=password autocomplete=off>`), _tmpl$49 = /* @__PURE__ */ template(`<div class=field><label for=prompt-system></label><textarea id=prompt-system rows=4>`), _tmpl$50 = /* @__PURE__ */ template(`<div class=field><label for=prompt-short></label><textarea id=prompt-short rows=3>`), _tmpl$51 = /* @__PURE__ */ template(`<div class=field><label for=prompt-long></label><textarea id=prompt-long rows=3>`), _tmpl$52 = /* @__PURE__ */ template(`<div class=toolbar><button data-prompt-action=preview></button><button data-prompt-action=apply>`), _tmpl$53 = /* @__PURE__ */ template(`<div class=toolbar><div class="field field--inline-flex"><label for=prompt-rollback-version></label><input id=prompt-rollback-version type=number min=0 step=1></div><button data-prompt-action=rollback>`), _tmpl$54 = /* @__PURE__ */ template(`<div class=toolbar><button disabled>`), _tmpl$55 = /* @__PURE__ */ template(`<div class="stack command-surface"><div class="badge-row command-surface__target-row"></div><div class="badge-row command-surface__capability-row">`), _tmpl$56 = /* @__PURE__ */ template(`<div><div class="panel__title panel__title--spaced panel__title--danger"></div><pre class=json>`), _tmpl$57 = /* @__PURE__ */ template(`<div class=stack><div class=badge-row></div><div><div class="panel__title panel__title--spaced"></div><div class=badge-row></div><div class="feedback-detail flow-top">`), _tmpl$58 = /* @__PURE__ */ template(`<section class="panel panel--targets"id=viewer-targets-panel data-viewer-surface=targets><div class="panel__header panel__header--stack"><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></div><div class=panel__body>`), _tmpl$59 = /* @__PURE__ */ template(`<section class="panel panel--stage"id=viewer-stage-panel data-viewer-surface=stage><div class="panel__body panel__body--stage"><div class=stack>`), _tmpl$60 = /* @__PURE__ */ template(`<section class="panel panel--details"id=viewer-details-panel data-viewer-surface=command><div class="panel__header panel__header--stack"><div class=panel__eyebrow></div><div class=panel__title></div><div class=panel__meta-copy></div></div><div class=panel__body>`);
...
function EntityListPendingState(props) {
  ...
  return (() => {
    var _el$3 = _tmpl$3(), _el$4 = _el$3.firstChild, _el$5 = _el$4.firstChild, _el$6 = _el$5.nextSibling;
...
function JsonBlock(props) {
  return (() => {
    var _el$7 = _tmpl$4();
    insert(_el$7, () => JSON.stringify(props.value, null, 2));
    return _el$7;
  })();
}
function DiagnosticDetails(props) {
  ...
  return (() => {
    ...
    _el$8.addEventListener("toggle", (event) => setIsOpen(event.currentTarget.open));
    insert(_el$9, () => props.label ?? tr(locale(), "原始诊断", "Raw diagnostics"));
...
function claimQuoteRows(quote) {
  ...
  return [["Slot", claimField(quote, "slot_index", "slot", "slot_id", "slotId", "claim_slot")], ["Reputation tier", claimField(quote, "reputation_tier", "reputationTier", "tier")], ["Owned / cap", [claimField(quote, "owned_claim_count", "owned", "owned_count", "ownedCount"), claimField(quote, "cap", "claim_cap", "claimCap")].filter((part) => part !== null && part !== void 0).join(" / ")], ["Total upfront", claimMoney(claimField(quote, "total_upfront_amount", "total_upfront", "totalUpfront", "upfront_total", "upfrontTotal"))], ["Activation fee", claimMoney(claimField(quote, "activation_fee_amount", "activation_fee", "activationFee"))], ["Bond", claimMoney(claimField(quote, "claim_bond_amount", "bond", "locked_bond", "lockedBond"))], ["Upkeep / epoch", claimMoney(claimField(quote, "upkeep_per_epoch", "upkeepPerEpoch", "upkeep"))], ["Eligible balance", claimMoney(claimField(quote, "eligible_claim_balance", "eligible_balance", "eligibleBalance"))], ["Liquid balance", claimMoney(claimField(quote, "transferable_liquid_balance", "liquid_balance", "liquidBalance"))], ["Restricted starter", claimMoney(claimField(quote, "restricted_starter_claim_balance", "restricted_starter_balance", "restrictedStarterBalance"))], ["Auto starter", claimMoney(claimField(quote, "auto_restricted_starter_claim_amount", "auto_starter_amount", "autoStarterAmount"))], ["Cooldown", claimField(quote, "release_cooldown_epochs", "cooldown_epochs", "cooldownEpochs", "cooldown")], ["Grace", claimField(quote, "grace_epochs", "graceEpochs", "grace")], ["Idle warning", claimField(quote, "idle_warning_epochs", "idleWarningEpochs")], ["Forced reclaim", claimField(quote, "forced_idle_reclaim_epochs", "forcedIdleReclaimEpochs")], ["Penalty bps", claimField(quote, "forced_reclaim_penalty_bps", "forcedReclaimPenaltyBps")], ["Reclaim terms", claimField(quote, "reclaim_terms", "reclaimTerms", "reclaim")]].filter(([, value]) => value !== null && value !== void 0 && value !== "");
}
...
function ClaimAgentChoiceCard(props) {
  ...
  return createComponent(PanelSection, {
    ...
    get children() {
      return [(() => {
        var _el$10 = _tmpl$7();
        insert(_el$10, createComponent(Badge, {
          get ["class"]() {
        ...
        get children() {
          var _el$13 = _tmpl$0(), _el$14 = _el$13.firstChild, _el$15 = _el$14.nextSibling;
          insert(_el$14, () => tr(locale(), "已占用 Agent", "Owned Claims"));
            ...
            children: (owned) => createComponent(EventCard, {
              ...
              get children() {
                return [(() => {
                  ...
                  get children() {
                    var _el$17 = _tmpl$5();
                    insert(_el$17, () => claimOwnedDetail(owned));
                    return _el$17;
                  }
                })];
              }
...
function ExpansionTradeoffCards(props) {
  ...
  return createComponent(PanelSection, {
    ...
    get eyebrow() {
      return tr(locale(), "从已发布动作派生", "Derived From Published Actions");
    },
    get meta() {
    ...
    get children() {
      ...
      insert(_el$18, createComponent(For, {
        ...
        children: (card) => createComponent(EventCard, {
          ...
          get badge() {
            return card.actionable ? "actionable" : "not yet actionable";
          },
          get badgeClass() {
            return card.actionable ? "badge badge--good" : "badge badge--warn";
          },
          get meta() {
          ...
          get children() {
            return [createComponent(Show, {
              ...
              get fallback() {
                return (() => {
                  var _el$21 = _tmpl$8();
                  insert(_el$21, () => tr(locale(), "当前没有匹配的已发布动作；不要把这个分支当成可执行按钮。", "No matching published action yet; do not treat this branch as an executable button."));
                  return _el$21;
                })();
              },
              get children() {
                ...
                insert(_el$19, createComponent(For, {
                  ...
                  children: (action) => (() => {
                    var _el$22 = _tmpl$5();
                    insert(_el$22, (() => {
                      var _c$3 = memo(() => !!action.disabledReason);
                      return () => _c$3() ? `${action.label || action.actionId}: ${action.disabledReason}` : action.label || action.actionId;
                    })());
                    return _el$22;
                  })()
                }));
              ...
              var _el$20 = _tmpl$5();
              insert(_el$20, () => props.gameplay?.nextStepHint || tr(locale(), "选择前先确认对应动作已经正式发布。", "Confirm the matching action is published before committing."));
              return _el$20;
            })()];
          }
        })
...
function InlineHelpTip(props) {
  ...
  return (() => {
    ...
    var _ref$ = rootRef;
    typeof _ref$ === "function" ? use(_ref$, _el$23) : rootRef = _el$23;
    _el$24.$$click = () => setIsOpen((value) => !value);
    insert(_el$26, () => props.title ?? tr(locale(), "比例说明", "Scale Guidance"));
    ...
    createRenderEffect((_p$) => {
      ...
      _v$3 !== _p$.e && setAttribute(_el$23, "data-open", _p$.e = _v$3);
      _v$4 !== _p$.t && setAttribute(_el$24, "aria-label", _p$.t = _v$4);
      _v$5 !== _p$.a && setAttribute(_el$24, "aria-describedby", _p$.a = _v$5);
      _v$6 !== _p$.o && setAttribute(_el$24, "aria-expanded", _p$.o = _v$6);
      _v$7 !== _p$.i && setAttribute(_el$24, "aria-controls", _p$.i = _v$7);
      _v$8 !== _p$.n && setAttribute(_el$25, "id", _p$.n = _v$8);
      _v$9 !== _p$.s && setAttribute(_el$25, "aria-hidden", _p$.s = _v$9);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
function FeedbackCard(props) {
  return (() => {
    var _el$29 = _tmpl$12(), _el$30 = _el$29.firstChild, _el$31 = _el$30.nextSibling;
    insert(_el$30, createComponent(Badge, {
      get ["class"]() {
    ...
    insert(_el$31, () => props.display.summary);
    insert(_el$29, createComponent(Show, {
      ...
      get children() {
        var _el$32 = _tmpl$5();
        insert(_el$32, () => props.display.detail);
        return _el$32;
      }
    }), null);
    insert(_el$29, createComponent(Show, {
...
function MetricCard(props) {
  return (() => {
    var _el$33 = _tmpl$15(), _el$34 = _el$33.firstChild, _el$35 = _el$34.nextSibling;
    insert(_el$34, () => props.label);
    insert(_el$35, () => props.value);
...
function EventCard(props) {
  return (() => {
    var _el$38 = _tmpl$17(), _el$39 = _el$38.firstChild, _el$40 = _el$39.firstChild;
    ...
    insert(_el$39, createComponent(Show, {
      ...
      get children() {
        var _el$41 = _tmpl$();
        insert(_el$41, () => props.badge);
        createRenderEffect(() => className(_el$41, props.badgeClass ?? "badge"));
        return _el$41;
      }
    }), null);
    insert(_el$38, createComponent(Show, {
      ...
      get children() {
        var _el$42 = _tmpl$16();
        insert(_el$42, () => props.meta);
        return _el$42;
      }
    }), null);
    insert(_el$38, () => props.children, null);
    createRenderEffect(() => className(_el$38, props.class ?? "event-card"));
    return _el$38;
  })();
}
function PanelSection(props) {
  return (() => {
    var _el$43 = _tmpl$20(), _el$44 = _el$43.firstChild, _el$45 = _el$44.firstChild, _el$47 = _el$45.firstChild, _el$49 = _el$44.nextSibling;
    ...
    insert(_el$45, createComponent(Show, {
      ...
      get children() {
        var _el$48 = _tmpl$19();
        insert(_el$48, () => props.meta);
        return _el$48;
      }
    }), null);
    insert(_el$49, () => props.children);
    createRenderEffect(() => className(_el$43, `panel panel--nested ${props.class ?? ""}`));
    return _el$43;
  })();
}
function CalloutCard(props) {
  return (() => {
    var _el$50 = _tmpl$21(), _el$51 = _el$50.firstChild, _el$52 = _el$51.firstChild, _el$53 = _el$51.nextSibling;
    ...
    insert(_el$53, () => props.children);
    createRenderEffect((_p$) => {
      var _v$0 = `callout ${props.variant === "warn" ? "callout--warn" : ""} ${props.class ?? ""}`, _v$1 = props.kind ?? "";
      _v$0 !== _p$.e && className(_el$50, _p$.e = _v$0);
      _v$1 !== _p$.t && setAttribute(_el$50, "data-callout-kind", _p$.t = _v$1);
      return _p$;
    }, {
      e: void 0,
      t: void 0
...
function HostedLoginForm(props) {
  ...
  return (() => {
    var _el$54 = _tmpl$25(), _el$55 = _el$54.firstChild, _el$56 = _el$55.firstChild, _el$57 = _el$56.firstChild, _el$58 = _el$57.nextSibling, _el$59 = _el$55.nextSibling, _el$60 = _el$59.firstChild;
    insert(_el$57, () => tr(locale(), "邮箱", "Email"));
    _el$58.$$input = (event) => {
    ...
    insert(_el$60, () => tr(locale(), "请求登录验证码", "Request Login Code"));
    insert(_el$54, createComponent(Show, {
      ...
      get children() {
        return [(() => {
          var _el$61 = _tmpl$7();
          insert(_el$61, createComponent(Badge, {
            get children() {
          ...
          var _el$62 = _tmpl$22(), _el$63 = _el$62.firstChild, _el$64 = _el$63.nextSibling;
          insert(_el$63, () => tr(locale(), "验证码", "Verification Code"));
          _el$64.$$input = (event) => {
          ...
          createRenderEffect((_p$) => {
            ...
            _v$10 !== _p$.e && setAttribute(_el$63, "for", _p$.e = _v$10);
            _v$11 !== _p$.t && setAttribute(_el$64, "id", _p$.t = _v$11);
            return _p$;
          }, {
            e: void 0,
            t: void 0
          });
          createRenderEffect(() => _el$64.value = state.hostedLogin.code);
          return _el$62;
        })(), (() => {
          ...
          insert(_el$66, () => tr(locale(), "登录并领取玩家会话", "Sign In and Acquire Player Session"));
          createRenderEffect(() => _el$66.disabled = state.hostedLogin.completeInFlight || state.auth.issueInFlight);
          return _el$65;
        })()];
      }
    }), null);
    insert(_el$54, createComponent(Show, {
      ...
      get children() {
        var _el$67 = _tmpl$24();
        insert(_el$67, createComponent(EmptyState, {
          get children() {
            return state.hostedLogin.error;
          }
        }), null);
        insert(_el$67, createComponent(Show, {
          ...
          get children() {
            var _el$68 = _tmpl$7();
            insert(_el$68, createComponent(Badge, {
              get children() {
    ...
    createRenderEffect((_p$) => {
      ...
      _v$12 !== _p$.e && setAttribute(_el$57, "for", _p$.e = _v$12);
      _v$13 !== _p$.t && setAttribute(_el$58, "id", _p$.t = _v$13);
      _v$14 !== _p$.a && (_el$60.disabled = _p$.a = _v$14);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
    ...
    createRenderEffect(() => _el$58.value = state.hostedLogin.handle);
    return _el$54;
  })();
}
...
function HostedLoginGate() {
  ...
  return createComponent(Show, {
    ...
    get children() {
      var _el$69 = _tmpl$26(), _el$70 = _el$69.firstChild, _el$71 = _el$70.firstChild, _el$72 = _el$71.firstChild, _el$73 = _el$72.firstChild, _el$74 = _el$73.nextSibling, _el$75 = _el$71.nextSibling;
      _el$69.$$keydown = trapDialogFocus;
      var _ref$2 = dialogRef;
      typeof _ref$2 === "function" ? use(_ref$2, _el$69) : dialogRef = _el$69;
      insert(_el$73, () => tr(locale(), "标准用户流程", "Standard User Flow"));
      insert(_el$74, () => tr(locale(), "登录邮箱后进入游戏", "Sign In With Email"));
      insert(_el$71, createComponent(Badge, {
        "class": "badge badge--warn",
        children: "auth=missing"
      }), null);
      insert(_el$75, () => tr(locale(), "当前是托管公开加入模式。先领取玩家会话，再进入聊天、玩法动作和后续授权。", "This is hosted public join. Acquire a player session first, then continue to chat, gameplay actions, and later authorization."));
      insert(_el$70, createComponent(HostedLoginForm, {
        get locale() {
          return locale();
        },
  ...
  return createComponent(CalloutCard, {
    ...
    get children() {
      return [(() => {
        ...
        get children() {
          var _el$77 = _tmpl$5();
          insert(_el$77, () => gameplay().nextStepHint);
          return _el$77;
        }
      }), createComponent(Show, {
        get when() {
        ...
        children: (action) => (() => {
          var _el$80 = _tmpl$27(), _el$81 = _el$80.firstChild;
          _el$81.$$click = () => renderGameplayAction(action());
          insert(_el$81, () => gameplayActionButtonLabel(action(), locale()));
          createRenderEffect(() => _el$81.disabled = Boolean(gameplayActionDisabledReason(action(), gameplay(), locale())));
          return _el$80;
        })()
      }), (() => {
        var _el$79 = _tmpl$5();
...
function ViewerEntryMenu() {
  ...
  return (() => {
    var _el$82 = _tmpl$28(), _el$83 = _el$82.firstChild, _el$84 = _el$83.nextSibling, _el$85 = _el$84.firstChild, _el$86 = _el$85.firstChild, _el$87 = _el$86.nextSibling, _el$88 = _el$85.nextSibling, _el$89 = _el$88.firstChild, _el$90 = _el$89.nextSibling, _el$91 = _el$88.nextSibling, _el$92 = _el$91.nextSibling;
    insert(_el$83, () => tr(locale(), "入口", "Entry"));
    insert(_el$86, () => tr(locale(), "语言与观察器入口", "Language and Viewer Entry"));
    insert(_el$87, () => tr(locale(), "主玩法继续留在当前页面；这里只保留语言切换。", "Primary gameplay stays on this page. This menu only keeps locale switching."));
    _el$89.$$click = () => setViewerLocale("zh");
    _el$90.$$click = () => setViewerLocale("en");
    insert(_el$91, createComponent(Badge, {
      get children() {
        return `locale=${localeCode(locale())}`;
      }
    }));
    insert(_el$92, () => viewerEntryUrls().softwareSafeUrl);
    createRenderEffect((_p$) => {
      var _v$15 = locale() === "zh", _v$16 = locale() === "en";
      _v$15 !== _p$.e && (_el$89.disabled = _p$.e = _v$15);
      _v$16 !== _p$.t && (_el$90.disabled = _p$.t = _v$16);
      return _p$;
    }, {
      e: void 0,
      t: void 0
...
function StarterOcOnboardingPanel(props) {
  ...
  return (() => {
    var _el$93 = _tmpl$29(), _el$94 = _el$93.firstChild, _el$95 = _el$94.nextSibling, _el$96 = _el$95.firstChild, _el$97 = _el$96.firstChild, _el$98 = _el$97.nextSibling, _el$99 = _el$96.nextSibling, _el$100 = _el$99.firstChild, _el$101 = _el$100.nextSibling, _el$102 = _el$99.nextSibling, _el$103 = _el$102.firstChild, _el$104 = _el$103.nextSibling;
    insert(_el$94, () => tr(locale(), "等待同步时不用空等：先了解下一步。Agent 出现后，先领取第一笔 OC，再用它开启第一次 Agent 聊天和早期玩法操作。", "Do not idle through sync: learn the next step now. Once the Agent appears, claim the first OC, then use it to unlock the first Agent chat and early gameplay actions."));
    insert(_el$97, () => tr(locale(), "第一笔 OC", "First OC"));
    insert(_el$98, () => tr(locale(), "新手启动资金", "Starter budget"));
    insert(_el$100, () => tr(locale(), "用途", "Use"));
    insert(_el$101, () => tr(locale(), "解锁 Agent 聊天", "Unlock Agent chat"));
    insert(_el$103, () => tr(locale(), "玩法目标", "Play Goal"));
    insert(_el$104, () => tr(locale(), "指挥 Agent 恢复产线", "Guide the Agent"));
      ...
      get children() {
        return createComponent(Show, {
          ...
          children: (starterAction) => (() => {
            var _el$107 = _tmpl$27(), _el$108 = _el$107.firstChild;
            _el$108.$$click = () => renderGameplayAction(starterAction());
            insert(_el$108, () => gameplayActionButtonLabel(starterAction(), locale()));
            createRenderEffect(() => _el$108.disabled = Boolean(gameplayActionDisabledReason(starterAction(), gameplay(), locale())));
            return _el$107;
          })()
        });
      }
...
function StarterOcRequiredGate() {
  ...
  return createComponent(Show, {
    ...
    children: () => (() => {
      var _el$109 = _tmpl$31(), _el$110 = _el$109.firstChild, _el$111 = _el$110.firstChild, _el$112 = _el$111.firstChild, _el$113 = _el$112.firstChild, _el$114 = _el$113.nextSibling, _el$115 = _el$111.nextSibling, _el$116 = _el$115.nextSibling;
      insert(_el$113, () => tr(locale(), "新手必经步骤", "Required Onboarding Step"));
      insert(_el$114, (() => {
      ...
      insert(_el$110, createComponent(Show, {
        ...
        get fallback() {
          return (() => {
            var _el$118 = _tmpl$29(), _el$119 = _el$118.firstChild, _el$120 = _el$119.nextSibling, _el$121 = _el$120.firstChild, _el$122 = _el$121.firstChild, _el$123 = _el$122.nextSibling, _el$124 = _el$121.nextSibling, _el$125 = _el$124.firstChild, _el$126 = _el$125.nextSibling, _el$127 = _el$124.nextSibling, _el$128 = _el$127.firstChild, _el$129 = _el$128.nextSibling;
            insert(_el$119, (() => {
              var _c$0 = memo(() => !!creditConfirmed());
              return () => _c$0() ? tr(locale(), "第一笔 OC 已经写入本地 testnet 快照。现在可以开始第一次 Agent 聊天，后续早期玩法动作也会解锁。", "The first OC is now visible in the local testnet snapshot. You can start the first Agent chat and continue early gameplay actions.") : tr(locale(), "领取请求已经提交。系统正在自动推进并刷新本地 testnet，确认这笔初始 OC 写入可见快照。", "The claim was submitted. The system is automatically advancing and refreshing the local testnet to confirm the starter OC in the visible snapshot.");
            })());
            insert(_el$122, () => tr(locale(), "状态", "Status"));
            insert(_el$123, (() => {
              var _c$1 = memo(() => !!creditConfirmed());
              return () => _c$1() ? tr(locale(), "已入账", "Credited") : tr(locale(), "自动确认中", "Auto-confirming");
            })());
            insert(_el$125, () => tr(locale(), "进度", "Progress"));
            insert(_el$126, (() => {
            ...
            insert(_el$128, () => tr(locale(), "你可以做什么", "What To Do"));
            insert(_el$129, (() => {
      ...
      insert(_el$115, (() => {
        ...
        return () => _c$9() ? tr(locale(), "OC 会作为第一次 LLM/Agent chat 的启动预算；用它向 Agent 发第一条指令，推动产线恢复。", "OC is the starter budget for the first LLM/Agent chat. Use it to send the first command and move production forward.") : memo(() => !!pendingCredit())() ? tr(locale(), "不用空等：系统会自动推进确认。若本地 testnet 暂时没有回执，下面的按钮可以手动补一次确认。", "No need to idle: confirmation runs automatically. If the local testnet has not responded yet, the button below can retry one confirmation.") : tr(locale(), "这是进入 Agent 聊天和早期玩法动作前必须完成的一步。领取后会进入入账确认。", "This step is required before Agent chat and early gameplay actions. Claiming it moves you to credit confirmation.");
      })());
      insert(_el$116, createComponent(Show, {
        ...
        children: (nextAction) => (() => {
          ...
          typeof _ref$4 === "function" ? use(_ref$4, _el$130) : primaryButtonRef = _el$130;
          insert(_el$130, (() => {
          ...
          createRenderEffect(() => _el$130.disabled = Boolean(gameplayActionDisabledReason(nextAction(), gameplay(), locale())));
          return _el$130;
        })()
      }), null);
      insert(_el$116, createComponent(Show, {
        ...
        get children() {
          ...
          typeof _ref$3 === "function" ? use(_ref$3, _el$117) : primaryButtonRef = _el$117;
          insert(_el$117, () => tr(locale(), "继续", "Continue"));
          return _el$117;
        }
      }), null);
      return _el$109;
...
function AgentClaimSessionBoundaryCard(props) {
  ...
  return createComponent(CalloutCard, {
    ...
    get children() {
      return [(() => {
        var _el$131 = _tmpl$8();
        insert(_el$131, () => tr(locale(), "这个世界已经有 Agent，但当前账号还没有可作为 claimer 的绑定 Agent。", "This world already has Agents, but the current account has no bound Agent that can act as the claimer."));
        return _el$131;
      })(), (() => {
        var _el$132 = _tmpl$5();
        insert(_el$132, () => tr(locale(), "可以先观察世界对象；认领入口必须来自当前会话绑定和 canonical slot-1 quote，不能从世界里的第一个 Agent 推断。", "You can observe world objects first; claim entry must come from the current session binding and canonical slot-1 quote, not from the first Agent in the world."));
        return _el$132;
      })(), (() => {
        var _el$133 = _tmpl$7();
...
function AgentClaimPanel(props) {
  ...
  return createComponent(CalloutCard, {
    ...
    get badge() {
      return memo(() => !!quote())() ? `slot=${quote().slot_index}` : "claim";
    },
    get badgeClass() {
    ...
    get children() {
      return [(() => {
        var _el$134 = _tmpl$8();
        insert(_el$134, () => agentClaim()?.objective || tr(locale(), "选择一个未被占用的 Agent，并用当前玩家会话提交认领。", "Pick an unclaimed agent and submit the claim with the current player session."));
        return _el$134;
      })(), (() => {
        var _el$135 = _tmpl$5();
        insert(_el$135, () => agentClaim()?.progress_detail || tr(locale(), "首次 slot-1 认领可以使用专用 starter claim 额度补足前置费用。", "The first slot-1 claim can use the dedicated starter claim allowance for upfront costs."));
        return _el$135;
      })(), (() => {
        var _el$136 = _tmpl$7();
        ...
        insert(_el$136, createComponent(Badge, {
          get children() {
            return `eligible=${quote()?.eligible_claim_balance ?? agentClaim()?.slot_1_eligible_claim_balance ?? "-"}`;
          }
        }), null);
        insert(_el$136, createComponent(Badge, {
          get children() {
            return `upfront=${quote()?.total_upfront_amount ?? "-"}`;
          }
        }), null);
        return _el$136;
      })(), (() => {
        var _el$137 = _tmpl$32(), _el$138 = _el$137.firstChild, _el$139 = _el$138.firstChild, _el$140 = _el$139.nextSibling;
        insert(_el$139, () => tr(locale(), "目标 Agent", "Target Agent"));
        _el$140.$$input = (event) => setSelectedTargetId(event.currentTarget.value);
        insert(_el$140, createComponent(For, {
          get each() {
            return targets();
          },
          children: (target) => (() => {
            var _el$143 = _tmpl$33();
            insert(_el$143, () => `${target.name}${target.isClaimer ? ` (${tr(locale(), "当前绑定", "current binding")})` : ""}`);
            createRenderEffect(() => _el$143.value = target.id);
            return _el$143;
          })()
        }));
        createRenderEffect(() => _el$140.value = selectedTarget());
        return _el$137;
      })(), (() => {
        var _el$141 = _tmpl$27(), _el$142 = _el$141.firstChild;
        _el$142.$$click = () => {
        ...
        insert(_el$142, () => tr(locale(), "认领 Agent", "Claim Agent"));
        createRenderEffect(() => _el$142.disabled = Boolean(disabledReason()));
        return _el$141;
      })()];
    }
  });
...
function WorldStageHero() {
  ...
  return (() => {
    var _el$144 = _tmpl$34(), _el$145 = _el$144.firstChild, _el$146 = _el$145.firstChild, _el$147 = _el$146.firstChild, _el$148 = _el$147.firstChild, _el$149 = _el$147.nextSibling, _el$150 = _el$149.nextSibling, _el$151 = _el$145.nextSibling, _el$152 = _el$151.firstChild, _el$153 = _el$152.firstChild, _el$154 = _el$153.nextSibling, _el$155 = _el$154.nextSibling, _el$156 = _el$152.nextSibling, _el$157 = _el$156.firstChild, _el$158 = _el$157.nextSibling, _el$159 = _el$158.nextSibling, _el$160 = _el$156.nextSibling, _el$161 = _el$160.firstChild, _el$162 = _el$161.nextSibling, _el$163 = _el$160.nextSibling, _el$164 = _el$163.firstChild, _el$165 = _el$164.nextSibling, _el$166 = _el$165.nextSibling, _el$167 = _el$166.nextSibling, _el$168 = _el$151.nextSibling, _el$169 = _el$168.firstChild, _el$170 = _el$169.nextSibling, _el$171 = _el$168.nextSibling, _el$172 = _el$171.nextSibling, _el$173 = _el$172.firstChild, _el$174 = _el$173.nextSibling;
    insert(_el$148, () => tr(locale(), "工业世界指挥桌", "Industrial World Command Desk"));
    insert(_el$147, createComponent(InlineHelpTip, {
      get locale() {
        return locale();
      },
    ...
    insert(_el$149, () => gameplaySummary()?.goalTitle || tr(locale(), "进入世界，先看局势，再做动作", "Read the world first, then act."));
    insert(_el$150, () => gameplaySummary()?.nextStepHint || gameplaySummary()?.objective || tr(locale(), "这张入口页优先保留世界、目标和关键动作；高级诊断与治理能力按需展开。", "This entry keeps the world, objective, and primary actions in front. Advanced diagnostics and governance stay on demand."));
    insert(_el$145, createComponent(ViewerEntryMenu, {}), null);
    ...
    insert(_el$153, () => tr(locale(), "局势", "Situation"));
    insert(_el$154, stageLabel);
    insert(_el$155, () => gameplayProgressLabel(gameplaySummary()?.progressPercent, locale()));
    insert(_el$157, () => tr(locale(), "已接受意图", "Accepted Intent"));
    insert(_el$158, acceptedIntentTitle);
    insert(_el$159, acceptedIntentDetail);
    insert(_el$161, () => tr(locale(), "下一步", "Next Step"));
    insert(_el$162, nextStepCopy);
    insert(_el$164, () => tr(locale(), "当前身份", "Current Identity"));
    insert(_el$165, identityKindLabel);
    insert(_el$166, identityDetail);
    insert(_el$167, identityMeta);
    _el$169.$$click = () => renderGameplayAction(refreshSnapshotAction());
    insert(_el$169, () => tr(locale(), "刷新快照", "Refresh Snapshot"));
    _el$170.$$click = () => sendControl("step", {
      count: 1
    });
    insert(_el$170, () => tr(locale(), "推进一步", "Advance One Step"));
    insert(_el$171, (() => {
    ...
    insert(_el$173, () => tr(locale(), "选择目标", "Select Target"));
    insert(_el$174, () => tr(locale(), "进入指挥", "Command"));
    insert(_el$144, createComponent(Show, {
      get when() {
      ...
      get children() {
        return createComponent(CalloutCard, {
          ...
          get children() {
            var _el$175 = _tmpl$8();
            insert(_el$175, () => tr(locale(), "首屏优先展示世界与目标；只有连接异常时，才把连接状态抬到这里提示你。", "This entry keeps the world and target first, and only elevates connection status when it needs attention."));
            return _el$175;
          }
        });
      }
    ...
    createRenderEffect((_p$) => {
      ...
      _v$17 !== _p$.e && setAttribute(_el$144, "data-stage-state", _p$.e = _v$17);
      _v$18 !== _p$.t && className(_el$154, _p$.t = _v$18);
      _v$19 !== _p$.a && setAttribute(_el$168, "aria-label", _p$.a = _v$19);
      _v$20 !== _p$.o && setAttribute(_el$169, "aria-label", _p$.o = _v$20);
      _v$21 !== _p$.i && setAttribute(_el$170, "aria-label", _p$.i = _v$21);
      _v$22 !== _p$.n && setAttribute(_el$172, "aria-label", _p$.n = _v$22);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
function MobileJumpRail() {
  const locale = () => uiLocale();
  return (() => {
    var _el$177 = _tmpl$35(), _el$178 = _el$177.firstChild, _el$179 = _el$178.nextSibling, _el$180 = _el$179.nextSibling, _el$181 = _el$180.nextSibling;
    insert(_el$178, () => tr(locale(), "世界", "World"));
    insert(_el$179, () => tr(locale(), "目标", "Targets"));
    insert(_el$180, () => tr(locale(), "指挥", "Command"));
    insert(_el$181, () => tr(locale(), "诊断", "Diagnostics"));
    createRenderEffect(() => setAttribute(_el$177, "aria-label", tr(locale(), "主入口分区导航", "Primary entry section navigation")));
    return _el$177;
  })();
}
function TargetsPanel() {
  ...
  return (() => {
    var _el$182 = _tmpl$36(), _el$183 = _el$182.firstChild, _el$184 = _el$183.firstChild, _el$185 = _el$184.nextSibling, _el$186 = _el$183.nextSibling, _el$187 = _el$186.firstChild, _el$188 = _el$187.nextSibling, _el$189 = _el$186.nextSibling, _el$190 = _el$189.firstChild, _el$191 = _el$190.nextSibling;
    insert(_el$182, createComponent(Show, {
      ...
      children: (selected) => (() => {
        var _el$192 = _tmpl$7();
        insert(_el$192, createComponent(Badge, {
          "class": "badge badge--accent",
          get children() {
    ...
    insert(_el$182, createComponent(EmptyState, {
      get children() {
    ...
    insert(_el$182, createComponent(Show, {
      ...
      children: (action) => createComponent(CalloutCard, {
        ...
        get children() {
          return [(() => {
            var _el$193 = _tmpl$8();
            insert(_el$193, () => gameplayActionDisabledReason(action(), gameplaySummary(), locale()) || tr(locale(), "当前是新用户空世界：先认领第一个 Agent，它会在链上提交并同步后出现在行动体列表。", "This is a new-user empty world: claim the first Agent first, then it will appear in the agent list after chain submission and sync."));
            return _el$193;
          })(), createComponent(Show, {
            get when() {
            ...
            var _el$194 = _tmpl$27(), _el$195 = _el$194.firstChild;
            _el$195.$$click = () => renderGameplayAction(action());
            insert(_el$195, () => gameplayActionButtonLabel(action(), locale()));
            createRenderEffect(() => _el$195.disabled = Boolean(gameplayActionDisabledReason(action(), gameplaySummary(), locale())));
            return _el$194;
          })()];
        }
      })
    }), _el$183);
    insert(_el$184, () => tr(locale(), "筛选目标", "Filter targets"));
    _el$185.$$input = (event) => setSelectedSearch(event.currentTarget.value);
    insert(_el$187, () => tr(locale(), "行动体", "Agents"));
    insert(_el$188, createComponent(Show, {
      get when() {
      ...
      get children() {
        return createComponent(For, {
          ...
          children: (agent, index) => {
            ...
            return (() => {
              var _el$196 = _tmpl$37(), _el$197 = _el$196.firstChild, _el$198 = _el$197.nextSibling, _el$199 = _el$198.nextSibling, _el$200 = _el$199.nextSibling;
              _el$196.$$click = () => applySelection({
                kind: "agent",
                id: agent.id
              });
              insert(_el$197, () => agent.id);
              ...
              insert(_el$199, () => `${tr(locale(), "地点", "location")}=${agent.location_id} · ${tr(locale(), "资源", "resources")}=${renderResourceSummary(agent.resources)}`);
              insert(_el$200, () => status().detail);
              createRenderEffect((_p$) => {
                ...
                _v$23 !== _p$.e && setAttribute(_el$196, "data-testid", _p$.e = _v$23);
                _v$24 !== _p$.t && setAttribute(_el$196, "data-select-id", _p$.t = _v$24);
                _v$25 !== _p$.a && setAttribute(_el$196, "data-agent-session-status", _p$.a = _v$25);
                _v$26 !== _p$.o && setAttribute(_el$196, "data-selected", _p$.o = _v$26);
                return _p$;
              }, {
                e: void 0,
                t: void 0,
    ...
    insert(_el$190, () => tr(locale(), "地点", "Locations"));
    insert(_el$191, createComponent(Show, {
      ...
      get children() {
        return createComponent(For, {
          ...
          children: (location) => (() => {
            var _el$201 = _tmpl$38(), _el$202 = _el$201.firstChild, _el$203 = _el$202.nextSibling;
            _el$201.$$click = () => applySelection({
              kind: "location",
              id: location.id
            });
            insert(_el$202, () => location.name || location.id);
            insert(_el$203, () => `id=${location.id} · ${tr(locale(), "半径", "radius")}=${formatPhysicalDistanceCm(location.profile?.radius_cm, locale()) || "-"} · ${tr(locale(), "资源", "resources")}=${renderResourceSummary(location.resources)}`);
            createRenderEffect((_p$) => {
              ...
              _v$27 !== _p$.e && setAttribute(_el$201, "data-testid", _p$.e = _v$27);
              _v$28 !== _p$.t && setAttribute(_el$201, "data-select-id", _p$.t = _v$28);
              _v$29 !== _p$.a && setAttribute(_el$201, "data-selected", _p$.a = _v$29);
              return _p$;
            }, {
              e: void 0,
              t: void 0,
    ...
    createRenderEffect(() => setAttribute(_el$185, "placeholder", tr(locale(), "搜索行动体或地点", "Search agents or locations")));
    createRenderEffect(() => _el$185.value = getSelectedSearch());
    return _el$182;
  })();
}
function WorldSummaryPanel() {
  ...
  return [createComponent(Show, {
    ...
    var _el$204 = _tmpl$41(), _el$205 = _el$204.firstChild, _el$206 = _el$205.firstChild, _el$207 = _el$206.firstChild, _el$208 = _el$207.nextSibling, _el$209 = _el$205.nextSibling, _el$213 = _el$209.firstChild, _el$214 = _el$213.firstChild, _el$215 = _el$214.firstChild, _el$216 = _el$215.firstChild, _el$217 = _el$216.nextSibling, _el$218 = _el$215.nextSibling, _el$219 = _el$214.nextSibling, _el$220 = _el$219.firstChild, _el$221 = _el$220.nextSibling, _el$222 = _el$221.nextSibling, _el$230 = _el$222.nextSibling, _el$231 = _el$230.nextSibling, _el$232 = _el$231.firstChild, _el$233 = _el$232.nextSibling;
    insert(_el$207, () => tr(locale(), "玩法明细", "Gameplay Details"));
    insert(_el$208, () => tr(locale(), "世界棋盘上方已保留目标、下一步和回执；这里展开看完整状态机与经济明细。", "The world board already carries objective, next move, and receipt; expand here for the full state machine and economy details."));
    insert(_el$205, createComponent(Badge, {
      get children() {
        return diagnosticsSummaryBadges().join(" · ");
      }
    }), null);
    insert(_el$209, createComponent(PanelSection, {
      get title() {
        ...
        return createComponent(Show, {
          ...
          children: (gameplay) => [(() => {
            ...
            get children() {
              return [(() => {
                var _el$235 = _tmpl$8();
                insert(_el$235, () => gameplay().controlProof?.summary || tr(locale(), "等待控制证明链路发布。", "Waiting for the control proof chain."));
                return _el$235;
              })(), (() => {
                var _el$236 = _tmpl$9();
                insert(_el$236, createComponent(MetricCard, {
                  get label() {
            ...
            get children() {
              return [(() => {
                ...
                var _el$238 = _tmpl$8();
                insert(_el$238, () => gameplay().attractionProof?.summary || tr(locale(), "等待吸引力证据发布。", "Waiting for attraction proof."));
                return _el$238;
              })(), (() => {
                var _el$239 = _tmpl$9();
                insert(_el$239, createComponent(MetricCard, {
                  get label() {
            ...
            get children() {
              return [(() => {
                var _el$240 = _tmpl$8();
                insert(_el$240, () => gameplay().agencyMoves?.summary || tr(locale(), "等待玩家能动性动词发布。", "Waiting for player agency moves."));
                return _el$240;
              })(), (() => {
                var _el$241 = _tmpl$9();
                insert(_el$241, createComponent(MetricCard, {
                  get label() {
            ...
            get children() {
              return [(() => {
                var _el$242 = _tmpl$8();
                insert(_el$242, () => gameplay().progressionProof?.summary || tr(locale(), "等待首胜与反刷证据发布。", "Waiting for first-win and anti-grind evidence."));
                return _el$242;
              })(), (() => {
                var _el$243 = _tmpl$9();
            ...
            get children() {
              return [(() => {
                var _el$244 = _tmpl$8();
                insert(_el$244, () => gameplay().matureWorldContinuation?.summary || tr(locale(), "等待成熟世界承接证据发布。", "Waiting for mature-world continuation evidence."));
                return _el$244;
              })(), (() => {
                var _el$245 = _tmpl$9();
                insert(_el$245, createComponent(MetricCard, {
                  get label() {
                ...
                insert(_el$245, createComponent(MetricCard, {
                  get label() {
                    return tr(locale(), "恢复选项", "Recovery Options");
                  },
                  get value() {
                    return gameplay().matureWorldContinuation?.recoveryOptions || tr(locale(), "待发布", "not published");
                  }
                }), null);
                insert(_el$245, createComponent(MetricCard, {
                  get label() {
            ...
            get children() {
              return [(() => {
                var _el$246 = _tmpl$8();
                insert(_el$246, () => gameplay().acceptedIntentSummary);
                return _el$246;
              })(), (() => {
                var _el$247 = _tmpl$5();
                insert(_el$247, () => gameplay().acceptedIntentDetail);
                return _el$247;
              })(), createComponent(Show, {
                get when() {
                ...
                get children() {
                  return [(() => {
                    ...
                    var _el$249 = _tmpl$5();
                    insert(_el$249, () => gameplay().resumeAnchor);
                    return _el$249;
                  })()];
                }
              })];
            ...
            get children() {
              return [(() => {
                var _el$250 = _tmpl$7();
                insert(_el$250, createComponent(For, {
                  get each() {
                ...
                var _el$251 = _tmpl$8();
                insert(_el$251, () => gameplay().executionSummary || tr(locale(), "等待目标执行状态更新。", "Waiting for goal execution state updates."));
                return _el$251;
              })(), createComponent(Show, {
                get when() {
                ...
                get children() {
                  var _el$252 = _tmpl$7();
                  insert(_el$252, createComponent(Badge, {
                    get children() {
                      return gameplay().executionCauseLabel;
                    }
                  }));
                ...
                get children() {
                  var _el$253 = _tmpl$5();
                  insert(_el$253, () => gameplay().executionCauseDetail);
                  return _el$253;
                }
              })];
            }
            ...
            get children() {
              return [createComponent(Show, {
                ...
                get children() {
                  var _el$254 = _tmpl$5();
                  insert(_el$254, () => gameplay().progressDetail);
                  return _el$254;
                }
              }), createComponent(Show, {
                get when() {
                ...
                get children() {
                  return [(() => {
                    var _el$255 = _tmpl$42();
                    insert(_el$255, createComponent(Badge, {
                      "class": "badge badge--warn",
                      get children() {
                    ...
                    var _el$256 = _tmpl$5();
                    insert(_el$256, () => gameplay().narrativeBlockerDetail || tr(locale(), "当前玩法被阻塞，需要显式恢复。", "Gameplay is blocked and needs explicit recovery."));
                    return _el$256;
                  })()];
                }
              }), createComponent(Show, {
                ...
                get children() {
                  var _el$257 = _tmpl$5();
                  insert(_el$257, () => gameplay().blockerSupplementalDetail);
                  return _el$257;
                }
              }), (() => {
                var _el$258 = _tmpl$42();
                insert(_el$258, createComponent(Badge, {
                  "class": "badge badge--accent",
                  get children() {
                ...
                var _el$259 = _tmpl$8();
                insert(_el$259, () => gameplay().narrativeNextStep || tr(locale(), "等待下一次运行时指引更新。", "Wait for the next runtime guidance update."));
                return _el$259;
              })(), createComponent(Show, {
                get when() {
                ...
                get children() {
                  var _el$260 = _tmpl$5();
                  insert(_el$260, () => gameplay().branchHint);
                  return _el$260;
                }
              }), createComponent(Show, {
                get when() {
            ...
            get children() {
              var _el$262 = _tmpl$9();
              insert(_el$262, createComponent(MetricCard, {
                get label() {
            ...
            children: (feedback) => createComponent(EventCard, {
              ...
              get children() {
                return [(() => {
                  var _el$268 = _tmpl$8();
                  insert(_el$268, () => feedback().effect || feedback().reason || tr(locale(), "最新回执已更新，但还没有新的世界级后果。", "The latest feedback is in, but there is no new world-level consequence yet."));
                  return _el$268;
                })(), createComponent(Show, {
                  get when() {
                  ...
                  get children() {
                    var _el$269 = _tmpl$5();
                    insert(_el$269, () => feedback().reason);
                    return _el$269;
                  }
                }), createComponent(Show, {
                  get when() {
            ...
            children: (action) => createComponent(CalloutCard, {
              ...
              get children() {
                return [(() => {
                  var _el$271 = _tmpl$8();
                  insert(_el$271, () => action().label || action().actionId || tr(locale(), "当前存在一条更合适的推进动作。", "One action is currently the best next move."));
                  return _el$271;
                })(), (() => {
                  var _el$272 = _tmpl$5();
                  insert(_el$272, () => gameplayActionDisabledReason(action(), gameplay(), locale()) || gameplayActionDetail(action(), gameplay(), locale()));
                  return _el$272;
                })(), (() => {
                  var _el$273 = _tmpl$27(), _el$274 = _el$273.firstChild;
                  _el$274.$$click = () => renderGameplayAction(action());
                  insert(_el$274, () => gameplayActionButtonLabel(action(), locale()));
                  createRenderEffect((_p$) => {
                    var _v$30 = gameplayActionTestId(action(), "recommended"), _v$31 = Boolean(gameplayActionDisabledReason(action(), gameplay(), locale()));
                    _v$30 !== _p$.e && setAttribute(_el$274, "data-testid", _p$.e = _v$30);
                    _v$31 !== _p$.t && (_el$274.disabled = _p$.t = _v$31);
                    return _p$;
                  }, {
                    e: void 0,
                    t: void 0
            ...
            var _el$263 = _tmpl$43(), _el$264 = _el$263.firstChild, _el$265 = _el$264.nextSibling;
            insert(_el$264, () => tr(locale(), "可用玩法动作", "Available Gameplay Actions"));
            insert(_el$265, createComponent(Show, {
              get when() {
              ...
              get children() {
                return createComponent(For, {
                  ...
                  children: (action) => createComponent(EventCard, {
                    ...
                    get badge() {
                      return memo(() => gameplay().recommendedAction?.actionId === action.actionId)() ? tr(locale(), "recommended", "recommended") : action.disabledReason ? "handoff" : "ready";
                    },
                    get badgeClass() {
                      return memo(() => gameplay().recommendedAction?.actionId === action.actionId)() ? "badge badge--accent" : action.disabledReason ? "badge badge--warn" : "badge badge--good";
                    },
                    get meta() {
                    ...
                    get children() {
                      return [(() => {
                        var _el$275 = _tmpl$5();
                        insert(_el$275, () => gameplayActionDisabledReason(action, gameplay(), locale()) || gameplayActionDetail(action, gameplay(), locale()));
                        return _el$275;
                      })(), createComponent(Show, {
                        get when() {
                        ...
                        get children() {
                          var _el$276 = _tmpl$27(), _el$277 = _el$276.firstChild;
                          _el$277.$$click = () => renderGameplayAction(action);
                          insert(_el$277, () => gameplayActionButtonLabel(action, locale()));
                          createRenderEffect((_p$) => {
                            var _v$32 = gameplayActionTestId(action), _v$33 = Boolean(gameplayActionDisabledReason(action, gameplay(), locale()));
                            _v$32 !== _p$.e && setAttribute(_el$277, "data-testid", _p$.e = _v$32);
                            _v$33 !== _p$.t && (_el$277.disabled = _p$.t = _v$33);
                            return _p$;
                          }, {
                            e: void 0,
                            t: void 0
                        ...
                        get children() {
                          var _el$278 = _tmpl$27(), _el$279 = _el$278.firstChild;
                          _el$279.$$click = () => renderGameplayAction(action);
                          insert(_el$279, () => gameplayActionButtonLabel(action, locale()));
                          createRenderEffect((_p$) => {
                            var _v$34 = gameplayActionTestId(action), _v$35 = Boolean(gameplayActionDisabledReason(action, gameplay(), locale()));
                            _v$34 !== _p$.e && setAttribute(_el$279, "data-testid", _p$.e = _v$34);
                            _v$35 !== _p$.t && (_el$279.disabled = _p$.t = _v$35);
                            return _p$;
                          }, {
                            e: void 0,
                            t: void 0
            ...
            get children() {
              return [(() => {
                var _el$266 = _tmpl$8();
                insert(_el$266, () => gameplay().assetGovernanceHandoff);
                return _el$266;
              })(), (() => {
                var _el$267 = _tmpl$5();
                insert(_el$267, () => tr(locale(), "资产 / 治理相关能力请走单独 lane；这张主入口页面只保留正式玩法所需的最小动作面。", "Asset and governance actions stay on their dedicated lane; this primary entry only keeps the minimum surface needed for formal gameplay."));
                return _el$267;
              })()];
            }
          })]
        ...
        return createComponent(PanelSection, {
          ...
          get children() {
            return [(() => {
              ...
              get children() {
                var _el$211 = _tmpl$39(), _el$212 = _el$211.firstChild;
                _el$212.$$click = () => {
                  void logoutHostedPlayerSession();
                };
                insert(_el$212, () => tr(locale(), "释放玩家会话", "Release Player Session"));
                return _el$211;
              }
            })];
          }
    ...
    insert(_el$216, () => tr(locale(), "运行诊断", "Runtime Diagnostics"));
    insert(_el$217, () => tr(locale(), "执行通道、认证/会话、托管矩阵与最近事件都收在这里，避免它们继续抢占主玩法首屏。", "Execution lanes, auth/session truth, hosted matrix, and recent events live here so they no longer dominate the primary gameplay viewport."));
    ...
    insert(_el$219, createComponent(PanelSection, {
      get title() {
      ...
      get children() {
        return createComponent(Show, {
          ...
          children: (debug) => [(() => {
            var _el$280 = _tmpl$7();
            insert(_el$280, createComponent(Badge, {
              "class": "badge badge--accent",
            ...
            var _el$281 = _tmpl$7();
            insert(_el$281, createComponent(Badge, {
              get children() {
            ...
            var _el$282 = _tmpl$7();
            insert(_el$282, createComponent(Badge, {
              "class": "badge badge--accent",
            ...
            get children() {
              var _el$283 = _tmpl$7();
              insert(_el$283, createComponent(Badge, {
                get children() {
    ...
    insert(_el$222, createComponent(Show, {
      ...
      get children() {
        var _el$223 = _tmpl$40();
        _el$223.$$click = () => {
          void logoutHostedPlayerSession();
        };
        insert(_el$223, () => tr(locale(), "释放玩家会话", "Release Player Session"));
        return _el$223;
      }
    }));
    ...
    insert(_el$219, createComponent(Show, {
      ...
      get children() {
        return [(() => {
          var _el$225 = _tmpl$7();
          insert(_el$225, createComponent(Badge, {
            "class": "badge badge--accent",
            children: "rebind"
          }), null);
          insert(_el$225, createComponent(Badge, {
    ...
    insert(_el$219, createComponent(Show, {
      ...
      children: (admission) => (() => {
        var _el$284 = _tmpl$7();
        insert(_el$284, createComponent(Badge, {
          get children() {
    ...
    insert(_el$219, createComponent(PanelSection, {
      ...
      get children() {
        return [createComponent(EmptyState, {
          ...
          var _el$228 = _tmpl$7();
          insert(_el$228, createComponent(Badge, {
            get ["class"]() {
    ...
    insert(_el$230, createComponent(MetricCard, {
      get label() {
    ...
    insert(_el$232, () => tr(locale(), "最近事件", "Recent Events"));
...
function InteractionPanel() {
  const locale = () => uiLocale();
  const selectedAgentId$1 = () => selectedAgentId();
  const agentId = () => {
  ...
  return (() => {
    var _el$285 = _tmpl$55(), _el$286 = _el$285.firstChild, _el$288 = _el$286.nextSibling;
    insert(_el$286, createComponent(Badge, {
      "class": "badge badge--accent",
      get children() {
    ...
    insert(_el$285, createComponent(Show, {
      get when() {
      ...
      get children() {
        return [(() => {
          var _el$287 = _tmpl$44();
          insert(_el$287, createComponent(Badge, {
    ...
    insert(_el$288, createComponent(Badge, {
      get children() {
    ...
    insert(_el$285, createComponent(EmptyState, {
    ...
    insert(_el$285, createComponent(Show, {
      ...
      children: (action) => (() => {
        var _el$325 = _tmpl$27(), _el$326 = _el$325.firstChild;
        _el$326.$$click = () => renderGameplayAction(action());
        insert(_el$326, () => gameplayActionButtonLabel(action(), locale()));
        createRenderEffect(() => _el$326.disabled = Boolean(gameplayActionDisabledReason(action(), gameplaySummary(), locale())));
        return _el$325;
      })()
    }), null);
    insert(_el$285, createComponent(PanelSection, {
      ...
      get children() {
        return [(() => {
          var _el$289 = _tmpl$45(), _el$290 = _el$289.firstChild, _el$291 = _el$290.nextSibling;
          insert(_el$290, () => tr(locale(), "消息", "Message"));
          _el$291.$$input = (event) => {
            state.chatDraft.message = String(event.currentTarget.value || "");
            state.chatDraft.dirty = true;
          };
          createRenderEffect((_p$) => {
            ...
            _v$36 !== _p$.e && setAttribute(_el$291, "placeholder", _p$.e = _v$36);
            _v$37 !== _p$.t && (_el$291.disabled = _p$.t = _v$37);
            return _p$;
          }, {
            e: void 0,
            t: void 0
          });
          createRenderEffect(() => _el$291.value = state.chatDraft.message);
          return _el$289;
        })(), (() => {
          var _el$292 = _tmpl$46(), _el$293 = _el$292.firstChild;
          _el$293.$$click = () => sendAgentChat(agentId(), state.chatDraft.message);
          insert(_el$293, () => tr(locale(), "发送聊天", "Send Chat"));
          createRenderEffect(() => _el$293.disabled = !chatControlsEnabled());
          return _el$292;
        })(), createComponent(Show, {
          get when() {
            return chatFeedback();
          ...
          var _el$294 = _tmpl$0(), _el$295 = _el$294.firstChild, _el$296 = _el$295.nextSibling;
          insert(_el$295, () => tr(locale(), "消息流", "Message Flow"));
          insert(_el$296, createComponent(Show, {
            get when() {
              return chatHistory().length > 0;
            },
            get fallback() {
              ...
              return createComponent(For, {
                ...
                children: (entry) => createComponent(EventCard, {
                  ...
                  get children() {
                    return [(() => {
                      var _el$327 = _tmpl$8();
                      insert(_el$327, () => chatEntryMessage(entry, locale()));
                      return _el$327;
    ...
    insert(_el$285, createComponent(PanelSection, {
      ...
      get children() {
        return [(() => {
          ...
          var _el$298 = _tmpl$47(), _el$299 = _el$298.firstChild;
          _el$299.$$click = () => togglePromptOverridesVisible();
          insert(_el$299, promptSettingsButtonLabel);
          createRenderEffect(() => _el$299.disabled = !canControlSelectedAgent());
          return _el$298;
        })()];
      }
    }), null);
      ...
      get children() {
        return createComponent(PanelSection, {
          ...
          get children() {
            return [(() => {
              var _el$300 = _tmpl$5();
              insert(_el$300, () => promptVersionState().summary);
              return _el$300;
            })(), (() => {
              var _el$301 = _tmpl$5();
              insert(_el$301, () => promptVersionState().detail);
              return _el$301;
            })(), createComponent(Show, {
              get when() {
              ...
              get children() {
                var _el$302 = _tmpl$48(), _el$303 = _el$302.firstChild, _el$304 = _el$303.nextSibling;
                insert(_el$303, () => tr(locale(), "后端审批码", "Backend Approval Code"));
                _el$304.$$input = (event) => {
                  state.strongAuth.approvalCode = String(event.currentTarget.value || "");
                };
                createRenderEffect(() => _el$304.value = state.strongAuth.approvalCode || "");
                return _el$302;
              }
            }), (() => {
              var _el$305 = _tmpl$49(), _el$306 = _el$305.firstChild, _el$307 = _el$306.nextSibling;
              insert(_el$306, () => tr(locale(), "系统提示词覆盖", "System Prompt Override"));
              _el$307.$$input = (event) => {
                state.promptDraft.systemPrompt = String(event.currentTarget.value || "");
                state.promptDraft.dirty = true;
              };
              createRenderEffect(() => _el$307.disabled = !promptControlsEnabled());
              createRenderEffect(() => _el$307.value = state.promptDraft.systemPrompt);
              return _el$305;
            })(), (() => {
              var _el$308 = _tmpl$50(), _el$309 = _el$308.firstChild, _el$310 = _el$309.nextSibling;
              insert(_el$309, () => tr(locale(), "短期目标覆盖", "Short-Term Goal Override"));
              _el$310.$$input = (event) => {
                state.promptDraft.shortTermGoal = String(event.currentTarget.value || "");
                state.promptDraft.dirty = true;
              };
              createRenderEffect(() => _el$310.disabled = !promptControlsEnabled());
              createRenderEffect(() => _el$310.value = state.promptDraft.shortTermGoal);
              return _el$308;
            })(), (() => {
              var _el$311 = _tmpl$51(), _el$312 = _el$311.firstChild, _el$313 = _el$312.nextSibling;
              insert(_el$312, () => tr(locale(), "长期目标覆盖", "Long-Term Goal Override"));
              _el$313.$$input = (event) => {
                state.promptDraft.longTermGoal = String(event.currentTarget.value || "");
                state.promptDraft.dirty = true;
              };
              createRenderEffect(() => _el$313.disabled = !promptControlsEnabled());
              createRenderEffect(() => _el$313.value = state.promptDraft.longTermGoal);
              return _el$311;
            })(), (() => {
              var _el$314 = _tmpl$52(), _el$315 = _el$314.firstChild, _el$316 = _el$315.nextSibling;
              _el$315.$$click = () => sendPromptControl("preview", null);
              insert(_el$315, () => tr(locale(), "预览提示词", "Preview Prompt"));
              _el$316.$$click = () => sendPromptControl("apply", null);
              insert(_el$316, () => tr(locale(), "应用提示词", "Apply Prompt"));
              createRenderEffect((_p$) => {
                var _v$38 = !promptControlsEnabled(), _v$39 = !promptControlsEnabled();
                _v$38 !== _p$.e && (_el$315.disabled = _p$.e = _v$38);
                _v$39 !== _p$.t && (_el$316.disabled = _p$.t = _v$39);
                return _p$;
              }, {
                e: void 0,
                t: void 0
              ...
              var _el$317 = _tmpl$53(), _el$318 = _el$317.firstChild, _el$319 = _el$318.firstChild, _el$320 = _el$319.nextSibling, _el$321 = _el$318.nextSibling;
              insert(_el$319, () => tr(locale(), "下一次回滚目标版本", "Next Rollback Target Version"));
              _el$320.$$input = (event) => {
              ...
              insert(_el$321, () => tr(locale(), "回滚提示词", "Rollback Prompt"));
              createRenderEffect((_p$) => {
                var _v$40 = !promptControlsEnabled(), _v$41 = !promptControlsEnabled();
                _v$40 !== _p$.e && (_el$320.disabled = _p$.e = _v$40);
                _v$41 !== _p$.t && (_el$321.disabled = _p$.t = _v$41);
                return _p$;
              }, {
                e: void 0,
                t: void 0
              });
              createRenderEffect(() => _el$320.value = Number(state.promptDraft.rollbackTargetVersion || 0));
              return _el$317;
            })(), createComponent(Show, {
              get when() {
    ...
    insert(_el$285, createComponent(PanelSection, {
      ...
      get children() {
        return [(() => {
          var _el$322 = _tmpl$7();
          insert(_el$322, createComponent(Badge, {
            get ["class"]() {
              return mainTokenTransferCapability().enabled ? "badge badge--good" : "badge badge--warn";
            },
            get children() {
          ...
          var _el$323 = _tmpl$54(), _el$324 = _el$323.firstChild;
          insert(_el$324, () => tr(locale(), "主代币转账（这里暂未开放）", "Main Token Transfer (Not Exposed Here Yet)"));
          return _el$323;
        })()];
      }
    }), null);
    createRenderEffect((_p$) => {
      ...
      _v$42 !== _p$.e && setAttribute(_el$285, "data-command-agent", _p$.e = _v$42);
      _v$43 !== _p$.t && setAttribute(_el$285, "data-command-chat-history", _p$.t = _v$43);
      return _p$;
    }, {
      e: void 0,
      t: void 0
...
function DetailsPanel() {
  ...
  return (() => {
    var _el$328 = _tmpl$57(), _el$329 = _el$328.firstChild, _el$330 = _el$329.nextSibling, _el$331 = _el$330.firstChild, _el$332 = _el$331.nextSibling, _el$333 = _el$332.nextSibling;
    insert(_el$329, createComponent(Badge, {
      "class": "badge badge--accent",
      get children() {
    ...
    insert(_el$331, () => tr(locale(), "世界规模", "World Scale"));
    insert(_el$332, createComponent(Badge, {
      get children() {
    ...
    insert(_el$333, worldMetaSummary);
    ...
    insert(_el$328, createComponent(Show, {
      ...
      get children() {
        var _el$334 = _tmpl$56(), _el$335 = _el$334.firstChild, _el$336 = _el$335.nextSibling;
        insert(_el$335, () => tr(locale(), "最近错误", "Last Error"));
        insert(_el$336, () => state.lastError);
        return _el$334;
      }
    }), null);
    return _el$328;
...
function AppShell() {
  ...
  return [createComponent(MobileJumpRail, {}), createComponent(HostedLoginGate, {}), createComponent(StarterOcRequiredGate, {}), (() => {
    var _el$337 = _tmpl$58(), _el$338 = _el$337.firstChild, _el$339 = _el$338.firstChild, _el$340 = _el$339.nextSibling, _el$341 = _el$340.nextSibling, _el$342 = _el$338.nextSibling;
    insert(_el$339, () => tr(locale(), "导航", "Navigate"));
    insert(_el$340, () => tr(locale(), "目标", "Targets"));
    insert(_el$341, () => tr(locale(), "先锁定对象，再进入世界舞台或右侧指挥面板。", "Lock onto a target first, then move into the stage or command surface."));
    insert(_el$342, createComponent(TargetsPanel, {}));
    createRenderEffect((_p$) => {
      var _v$44 = starterOcGateOpen() ? "true" : void 0, _v$45 = starterOcGateOpen() ? true : void 0;
      _v$44 !== _p$.e && setAttribute(_el$337, "aria-hidden", _p$.e = _v$44);
      _v$45 !== _p$.t && (_el$337.inert = _p$.t = _v$45);
      return _p$;
    }, {
      e: void 0,
      t: void 0
    ...
    var _el$343 = _tmpl$59(), _el$344 = _el$343.firstChild, _el$345 = _el$344.firstChild;
    insert(_el$345, createComponent(Show, {
      get when() {
    ...
    insert(_el$345, createComponent(WorldStageHero, {}), null);
    insert(_el$345, createComponent(PixelWorldHost, {
      get locale() {
        return locale();
      }
    }), null);
    ...
    createRenderEffect((_p$) => {
      ...
      _v$46 !== _p$.e && setAttribute(_el$343, "aria-hidden", _p$.e = _v$46);
      _v$47 !== _p$.t && (_el$343.inert = _p$.t = _v$47);
      return _p$;
    }, {
      e: void 0,
      t: void 0
    ...
    var _el$346 = _tmpl$60(), _el$347 = _el$346.firstChild, _el$348 = _el$347.firstChild, _el$349 = _el$348.nextSibling, _el$350 = _el$349.nextSibling, _el$351 = _el$347.nextSibling;
    insert(_el$348, () => tr(locale(), "指挥与核查", "Command and Inspect"));
    insert(_el$349, () => tr(locale(), "交互与明细", "Interact and Inspect"));
    insert(_el$350, () => tr(locale(), "只有锁定目标后才进入这里。聊天优先，提示词与对象核查继续后置。", "Enter this column only after locking a target. Chat comes first; prompt controls and raw inspection stay behind it."));
    insert(_el$351, createComponent(DetailsPanel, {}));
    createRenderEffect((_p$) => {
      var _v$48 = starterOcGateOpen() ? "true" : void 0, _v$49 = starterOcGateOpen() ? true : void 0;
      _v$48 !== _p$.e && setAttribute(_el$346, "aria-hidden", _p$.e = _v$48);
      _v$49 !== _p$.t && (_el$346.inert = _p$.t = _v$49);
      return _p$;
    }, {
      e: void 0,
      t: void 0
