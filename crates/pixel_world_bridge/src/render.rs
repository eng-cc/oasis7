...
#[derive(Component)]
struct PixelWorldAgentSilhouetteVisual {
    id: String,
}
...
fn agent_silhouette_size_px(agent: &Agent) -> Option<f32> {
...
fn agent_silhouette_offset(agent_id: &str, body_size: f64) -> Vec2 {
...
fn reconcile_agent_silhouettes(
    commands: &mut Commands,
    runtime: &BevyRuntimeState,
