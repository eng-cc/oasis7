...
/// The bounded decisions available when settling a challenged social fact.
...
/// A signed, read-only request for the impact of adjudicating a challenged social fact.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct AdjudicateSocialFactQuoteRequest {
    pub fact_id: u64,
    pub decision: SocialAdjudicationDecision,
    pub notes: String,
    pub player_id: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub public_key: Option<String>,
...
/// The non-mutating, authoritative consequences a player needs before settling a social fact.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct AdjudicateSocialFactQuotePreflight {
    pub actor_id: String,
    pub action_kind: String,
    pub schema_id: String,
    pub subject_id: Option<String>,
...
/// A signed, read-only request for the impact of revoking a social fact.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RevokeSocialFactQuoteRequest {
    pub fact_id: u64,
    pub reason: String,
    pub player_id: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// The non-mutating, authoritative consequences a player needs before revoking a social fact.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RevokeSocialFactQuotePreflight {
    pub actor_id: String,
    pub action_kind: String,
    pub schema_id: String,
    pub subject_id: Option<String>,
