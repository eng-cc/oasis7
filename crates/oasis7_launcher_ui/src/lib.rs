...
const LAUNCHER_UI_FIELDS: &[LauncherUiField] = &[
    ...
    LauncherUiField {
        id: "agent_decision_source",
        section: "agent_provider",
        kind: LauncherUiFieldKind::Text,
        label_zh: "Agent 决策来源",
        label_en: "Agent Decision Source",
        web_visible: true,
        native_visible: true,
    },
    LauncherUiField {
        id: "agent_provider_backend",
        section: "agent_provider",
        kind: LauncherUiFieldKind::Text,
        label_zh: "Provider Backend",
        label_en: "Provider Backend",
        web_visible: true,
        native_visible: true,
    },
    LauncherUiField {
        id: "agent_provider_contract",
        section: "agent_provider",
        kind: LauncherUiFieldKind::Text,
        label_zh: "Provider Contract",
        label_en: "Provider Contract",
        web_visible: true,
        native_visible: true,
    },
    LauncherUiField {
        id: "agent_provider_transport",
        section: "agent_provider",
        kind: LauncherUiFieldKind::Text,
        label_zh: "Provider Transport",
        label_en: "Provider Transport",
        web_visible: true,
        native_visible: true,
    },
    LauncherUiField {
        id: "agent_provider_url",
        section: "agent_provider",
        kind: LauncherUiFieldKind::Text,
        label_zh: "Provider URL",
        label_en: "Provider URL",
        web_visible: true,
        native_visible: true,
    },
    LauncherUiField {
        id: "agent_provider_auth_token",
        section: "agent_provider",
        kind: LauncherUiFieldKind::Text,
        label_zh: "Provider Auth Token",
        label_en: "Provider Auth Token",
        web_visible: true,
        native_visible: true,
    },
    LauncherUiField {
        id: "provider_auto_discover",
        section: "agent_provider",
        kind: LauncherUiFieldKind::Checkbox,
        label_zh: "自动探测 Provider",
        label_en: "Auto-Discover Provider",
        web_visible: true,
        native_visible: true,
    },
    LauncherUiField {
        id: "agent_provider_connect_timeout_ms",
        section: "agent_provider",
        kind: LauncherUiFieldKind::Text,
        label_zh: "Provider 连接超时毫秒",
        label_en: "Provider Connect Timeout Ms",
        web_visible: true,
        native_visible: true,
    },
    LauncherUiField {
        id: "agent_execution_lane",
        section: "agent_provider",
        kind: LauncherUiFieldKind::Text,
        label_zh: "Agent 执行 Lane",
        label_en: "Agent Execution Lane",
        web_visible: true,
        native_visible: true,
    },
    LauncherUiField {
        id: "agent_provider_profile",
        section: "agent_provider",
        kind: LauncherUiFieldKind::Text,
        label_zh: "Provider Profile",
        label_en: "Provider Profile",
        web_visible: true,
        native_visible: true,
    },
    LauncherUiField {
