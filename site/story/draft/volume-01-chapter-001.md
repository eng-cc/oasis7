# 《绿洲 2076》第一卷第一章阅读版 v1.1-line-edit

阅读版范围：`CH-001` 到 `CH-012`。源版本：完整 line edit v1.1；本文件仍按第一卷稳定基线作为阅读版展示，不等同最终出版定稿。
...
原来的流程是她昨晚写的。那些旧习惯还在手里：开头、欢迎、介绍规则、轮流发言、确认目标。写到第三遍，她自己先停了笔。

绿洲的第一次晨会不该从一张会议表开始。

她删掉“自我介绍”和“每人一句期待”，最后把“请大家简单说说自己的背景”移到可选项。
...
他说得很慢，声音有些硬。宋清岚注意到，他把“谁拖慢了谁”压到最底下，像那不是临时措辞，而是一条早就不想让人带进绿洲的旧习惯。
...
许映舟看见那一格让采样臂多绕了四十七秒。路线中段正切过岩脊的阴影，阳面外壳和阴面关节的温差还没有抹平；真空里没有空气帮他们把带电矿尘吹开，采样臂每次转向都可能把细尘带进关节缝。数字在她视野边缘跳了一下，她差点开口。砾光已经把采样夹具抬起来，等她确认。

这四十七秒还会让样本错过第一轮冷炉交接，最早要在下一轮把盒子送进去。戚云梁没有把这个代价藏在路线图后面。
...
第一条采样路线很短。短到许映舟一开始以为是不是系统又用了保守参数。矿场边缘的碎石并不密，机械足踏过以后，尘层没有被风带走，只靠惯性在低重力里漂了片刻，几粒细灰还因静电贴在脚踝的护片上。远处那片没接上灯的空地仍然暗着，只剩几根标杆露在地图边缘。
...
于是她在三张卡下面写下三条边界：旧臂手感另行重建；现场缺口暂不写回；维修完成不等于全部恢复。
...
石听雨把公共状态改成三行，先写能做的，再把限制放在同一面墙上：
...
排练表最后只剩三项：进来，看见出口，约下次。

周砚屏读完，才终于把手从面板上放下。

她没有写“全部准备好了”。应声也没有。

最后只留下两行：入口预演安全条件满足。出口灯仍然亮着。
...
宋清岚把活动名从“第一次进场”改成“第一次亮灯”。小穹只开放门口入口：门口、旁听、稍后、安静退出。公共客厅深处仍在暗处，座席只放出入口线附近的一小排，扶手也只到门边。
