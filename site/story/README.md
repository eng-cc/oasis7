...
世界背景、总纲、人物、调研、审稿意见、时间线、章节卡和正文已重建到第三卷后续。第一至第三卷现存 19 章正文（`CH-001` 到 `CH-158`）已于 2026-08-26 完成逐章文学 line edit，并同步卷内定位稿、章节卡和第一卷发布台账；完整覆盖清单见 `draft/full-line-edit-ledger.md`。第一卷公开标签仍为阅读版 v1.0-rc，内部正文标记为 v1.1-line-edit；第二卷 Agent 归零与修宪路线保持未完成规则边界；第三卷温室 / 生活循环及后续路线保持播种前与早期生活边界。第四卷公共节律路线仍只处于 scaffold，暂定覆盖 `TL-159` 到 `TL-198` / `CH-159` 到 `CH-198`。
