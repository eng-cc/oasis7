...
env -u RUSTC_WRAPPER cargo test -p oasis7 --bin oasis7_rollback_strict_audit_evidence -- --nocapture
...
run_test complete_receipt_requires_governance_auth_and_replay_stays_rejected_after_restart
