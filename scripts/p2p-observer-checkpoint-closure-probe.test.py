...
def main():
    ...
    receipt={"schema_version":"oasis7.checkpoint_closure_verification_receipt.v1","world_id":"fixture-world","probe_nonce":"x"*32,"height":4242,"execution_block_hash":"fixture-checkpoint-v2","execution_state_root":"fixture-state-root","manifest_hash":"0123456789abcdef"*4,"objects":[obj],"fetch_observations":[observed]}
