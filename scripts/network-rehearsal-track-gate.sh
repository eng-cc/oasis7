...
Purpose:
  Build one machine-readable QA gate summary for network rehearsal / release train
...
Examples:
  ./scripts/network-rehearsal-track-gate.sh \
    ...
    --candidate-bundle output/release-candidates/public-testnet-rehearsal-01.json \
...
candidate_bundle=""
lanes_tsv=""
out_dir="output/network-rehearsal-gates"
...
summary = {
    "schema_version": "oasis7.network_rehearsal_track_gate.v1",
    "track": track,
...
lines = [
    "# Network Rehearsal Track Gate Summary",
    "",
    f"- Track: `{track}`",
...
echo "network rehearsal track gate summary: $summary_md"
echo "network rehearsal track gate summary json: $summary_json"
