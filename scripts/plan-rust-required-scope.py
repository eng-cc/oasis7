...
CAPABILITIES=("oasis7_required","consensus","distfs","node","net","viewer_js_required","viewer_performance_report","pixel_world_bridge","launcher_web","workspace_support","scenario_regression","operational_contracts","codex_agent_config_validation","compile_metrics","required_gate_baseline")
...
def main():
 ...
 requires_rust=full or bool(capabilities-{"codex_agent_config_validation","compile_metrics"})
