...
checks = [
    (
        ...
        [
            ...
            "release_full",
            "Mocks, fixtures, and fake services can prove module contract handling",
        ],
    ),
    (
        ...
        [
            ...
            "Do not collapse a multi-track initiative into one mixed-domain implementation task",
        ],
    ),
    (
        root / "AGENTS.md",
    ...
    (
        root / ".agents/roles/templates/parent-initiative.md",
        [
            "# Parent Initiative Packet",
            "## Child Tracks",
    ...
    (
        root / ".agents/roles/templates/domain-child-task.md",
        [
            "# Domain Child Task Packet",
            "Parent Initiative Task UID",
            "## Dependency Inputs",
            "## Dependency Outputs",
            "## Module-Local Verification",
            "module_required command / evidence",
            "module_full trigger",
            "## Integration / Release Escalation",
        ],
    ),
    (
        root / ".agents/roles/templates/mock-fixture-contract.md",
        [
            "# Mock / Fixture Contract",
            "Type: `mock | fixture | fake-service | local-simulation`",
            "## Covered Contract",
            "## Proof Boundary",
            "This proves:",
            "This does not prove:",
    ...
    (
        ...
        [
            ...
            "Do not use a parent initiative to weaken child task truth",
    ...
    (
        ...
        [
            ...
            "module_required",
            "module_full",
            "integration/release escalation condition",
        ],
    ),
    (
        root / ".agents/skills/verification-before-completion/SKILL.md",
        [
            "For parent initiative or domain child task claims",
            "`module_required`: module-local fast-loop evidence",
            "`module_full`: risk-triggered broader module evidence",
            "`integration_required`: cross-module evidence",
            "`release_full`: release confidence evidence",
            "Parent/child workflow readiness",
        ],
    ),
    (
...
scenarios = [
    ...
    {
        "id": "multi_track_initiative_uses_parent_child_pattern",
        "expected_route": "parent initiative coordination task -> independently mergeable domain child tasks",
        "surface": ".agents/skills/repo-owned-workflow-router/SKILL.md",
        "required_markers": [
