...
def build_parser(
    *,
    ...
    add_task_uid_argument(role_report)
    ...
    append_execution_log = subparsers.add_parser("append-execution-log")
    append_execution_log.add_argument("root", type=pathlib.Path)
    add_task_uid_argument(append_execution_log, required=True)
    append_execution_log.add_argument("--role", required=True)
    append_execution_log.add_argument("--completed", required=True)
    append_execution_log.add_argument("--pending", required=True)
    append_execution_log.add_argument("--action", required=True)
    append_execution_log.add_argument("--validation-command", required=True)
    append_execution_log.add_argument("--expected-result", required=True)
    append_execution_log.add_argument("--actual-result", required=True)
    append_execution_log.add_argument("--blocker-next-action", required=True)
    append_execution_log.add_argument("--json", action="store_true")
    append_execution_log.set_defaults(func=handlers["cmd_append_execution_log"])
