...
require_file ".agents/roles/templates/parent-initiative.md"
require_file ".agents/roles/templates/domain-child-task.md"
require_file ".agents/roles/templates/mock-fixture-contract.md"
...
require_file "scripts/pm/compact-task-group.sh"
require_file "scripts/pm/append-execution-log.sh"
require_file "scripts/pm/capture-todo.sh"
require_file "scripts/pm/capture-todo-smoke.sh"
