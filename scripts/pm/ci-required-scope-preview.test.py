...
{"clauses":["{\"id\":\"required-gate-scope-policy\",\"revision\":\"required-domain-split/v1\"}","{\"id\":\"required-gate-versioned-preview\",\"revision\":\"v1\"}"],"contract_digest":"sha256:c65c8cdf66bf0dfe1654c8cf431a2b8c6796632829d0e1a5a92a1097e0eb62b5","projection_digest":"sha256:5ec0706acd029e64d0dd6703d639236eea778082043fa468296e86ddc74cad21","revision":3,"schema":"oasis7-ci-impact-publication/v2","scope_base_oid":"aad4952584023cf3c739d0034a7d76036fea733a","source_head_oid":"cb0ed9e96a69b8383c58fc87a54e449eac381c55","task_uid":"task_1a2856fa0014493896906b9e906f5f26"}"""
    ...
    def test_dispatch_environment_uses_canonical_workspace_support_selector(self):
        fields = {"run_oasis7_workspace_support_crate_tests": "true"}
        old_values = {
            name: os.environ.get(name)
            for name in (
                "PREVIEW_PYTHON",
                "OASIS7_CI_RUN_WORKSPACE_SUPPORT_CRATE_TESTS",
                "OASIS7_CI_RUN_OASIS7_WORKSPACE_SUPPORT_CRATE_TESTS",
            )
        }
        try:
            os.environ["PREVIEW_PYTHON"] = "/tmp/preview-venv/bin/python"
            os.environ["OASIS7_CI_RUN_WORKSPACE_SUPPORT_CRATE_TESTS"] = "false"
            os.environ["OASIS7_CI_RUN_OASIS7_WORKSPACE_SUPPORT_CRATE_TESTS"] = "false"
            env = PREVIEW.dispatcher_environment(fields, self.context(), "f" * 40)
        finally:
            for name, value in old_values.items():
                if value is None:
                    os.environ.pop(name, None)
                    ...
                    os.environ[name] = value
        self.assertEqual(env["OASIS7_CI_RUN_WORKSPACE_SUPPORT_CRATE_TESTS"], "true")
        self.assertNotIn("OASIS7_CI_RUN_OASIS7_WORKSPACE_SUPPORT_CRATE_TESTS", env)
