...
usage() {
  cat <<'USAGE'
Usage:
  ./scripts/public-testnet-rehearsal-blocker-packet.sh \
    --window-id <id> \
...
Purpose:
  Generate concrete markdown drafts for the current public-testnet-rehearsal blockers:
...
Examples:
  ./scripts/public-testnet-rehearsal-blocker-packet.sh \
    ...
    --candidate-bundle output/release-candidates/public-testnet-rehearsal-20260324-05.json \
    --candidate-gate-summary output/network-rehearsal/public-testnet-rehearsal-20260324-06/gate/public_testnet_rehearsal-20260324-175501/summary.md \
    --access-out doc/testing/evidence/network-rehearsal-public-testnet-rehearsal-shared-access-2026-05-23.md \
    --mixed-topology-out doc/testing/evidence/network-rehearsal-public-testnet-rehearsal-mixed-topology-2026-05-23.md \
    --rollback-out doc/testing/evidence/network-rehearsal-public-testnet-rehearsal-rollback-contract-2026-05-23.md \
    ...
    --fallback-candidate-bundle output/release-candidates/public-testnet-rehearsal-20260324-05.json \
    --fallback-class bootstrap_restore_ready \
    --fallback-gate-summary output/network-rehearsal/public-testnet-rehearsal-20260324-06/gate/public_testnet_rehearsal-20260324-175501/summary.md \
    --fallback-owner-ref doc/testing/evidence/network-rehearsal-public-testnet-rehearsal-short-window-promotion-record-2026-03-24.md
USAGE
}
...
rollback_reason="no audited formal fallback is pinned yet; for the first public-testnet-rehearsal pass, provide a bootstrap_restore_ready fallback with restore steps, owner ref, and restoration scope"
...
cat >"$access_out" <<EOF
# Public Testnet Rehearsal Access Check
...
# Public Testnet Rehearsal Mixed-Topology Gate Check
...
- \`validation_expectations\`:
  - \`baseline candidate_id and role boundary still match current public-testnet-rehearsal bundle truth\`
...
# Public Testnet Rehearsal Rollback Target
...
- \`fallback_gate_ref\`:
  - \`${fallback_gate_summary:-<output/network-rehearsal/.../gate/.../summary.md>}\`
...
## Notes
- \`pass\` if:
  - \`fallback_class=formal_pass_candidate\` and fallback candidate is a formal previous public-testnet-rehearsal \`pass\` candidate; or
  - \`fallback_class=bootstrap_restore_ready\`, current track is still pursuing the first public-testnet-rehearsal \`pass\`, and \`restore_steps_ref\` + \`fallback_owner_ref\` + \`restoration_scope\` are all pinned and audited.
