...
- 完成内容: 已同步回写 `doc/testing/evidence/gameplay-ten-minute-retention-gate-2026-04-09.md`、`doc/game/project.md`、`doc/game/gameplay/gameplay-ten-minute-retention-recovery-2026-04-09.project.md` 与 `doc/game/gameplay/gameplay-top-level-design.project.md`，把 `software_safe` formal floor 结论更新为 `pass`，并将 retention gate 从 `hold` 调整为 `watch`，明确下一步是继续补 3 条 active-LLM 10 分钟样本，而不是直接宣称 `continue_playing`。
