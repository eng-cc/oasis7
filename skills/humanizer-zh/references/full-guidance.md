...
This file preserves the detailed guidance that used to live in `humanizer-zh/SKILL.md`. The entrypoint now uses progressive disclosure: read this file only when the task needs the detailed patterns, examples, or command catalogue.
