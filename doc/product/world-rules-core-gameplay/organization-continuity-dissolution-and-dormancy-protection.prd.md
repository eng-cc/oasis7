...
| 受限持续（estate / 可撤销 delegation） | 保护后仍存在明确的维护、风险隔离或价值保全需要，且其范围、授权来源、可撤销性和未决义务已可读记录。 | 在授权范围内提出有限维护、风险隔离或有限重启；相关主体可查看并质疑范围，提交 reclaim 或申诉。 | 不能把受限授权扩张为永久所有权、绕过合同/托管/责任处理，或处置范围外的资产、Agent 与业务。 | 授权撤销或处置前提失败时回到保护；reclaim/申诉待决只叠加在本阶段，成功后按确认结果更正到适用基础阶段或进入已解决。已经确认的最小安全动作及其 receipt 不被抹除。 |
