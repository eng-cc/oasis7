...
| 获取/精炼原料 | 进入下方的“原材料准备子循环”，沿来源评估、获取/补充决策、采集/精炼结算到 `ready_for_logistics` 批次的顺序推进；只有真实结果已经形成、且可交给物流环节时才算准备完成。 | 原料不足、来源不可达、精炼未完成或结果不满足适用性时，分别指出供给、可达性、能源还是规格问题；玩家只能使用该专业合同当前支持的等待、改源、减量、补电、改配方或延期，不能静默裁剪投入。 |
...
walkthrough 中的“获取/精炼原料”不是一个点击动作，而是一条受边界约束的准备链。它必须在同一选定配方/首个工业目标上下文中收敛为：

`source assessment -> acquire/replenish decision -> extraction/refinement settlement -> ready_for_logistics material batch`

本子循环复用产品根 PRD 的 source/deposit 与 handoff 语义、[`M4 工业资源流转合同`](../../world-simulator/m4/industrial-resource-flow-contract.prd.md) 的材料账本/适用性边界，以及 [`gameplay` 工业引导合同](../../game/gameplay/gameplay-top-level-design.prd.md) 的精炼和资源恢复选择；它只补齐首局玩家如何判断“原料准备完成”，不新增资源类型、动作 ABI、字段 schema、产率或数值公式。

| 子步骤 | 玩家可比较的决策与完成边界 | 必须反馈的阻塞与恢复 |
| --- | --- | --- |
| 来源评估（`source_assessment`） | 读取当前来源身份、作用域、可见/可分配状态、材料/质量提示、与首个工业目标的关联及下一次复查边界；只比较当前专业合同真实支持的 `mine_now`、`reduce_batch`、`move_to_other_frag`、`wait_for_replenish`、`restore_power_first` 或合法的替代来源/材料路径。评估和比较本身不创建 claim、hold、材料批次或补充资格。 | 来源未知、过期、耗尽、不可达、无权限或存在争用时，必须说明是证据、供给、访问还是竞争问题。来源 profile 不支持补充时不得展示等待补充；没有安全来源时转为改源、减量、改配方或延期。 |
| 获取/补充决策 | 玩家确认一个仍真实可用的获取、等待补充、换源或减量路径；提交前的预览只说明预计可满足量、成本、风险和复查点，不扣资源、不占采集顺位，也不把推荐变成已取得的批次。 | 提交前后来源数量、权限、质量、路线或电力发生变化时，按新鲜权威状态重新报价/评估；争用只按专业合同的有界分配结果处理，不能靠重试、拆小批或改变到达顺序取得隐含优先级。 |
...
该子循环的 `test_tier_required` 至少覆盖：一条“来源评估 → 获取/精炼 → settled receipt → `ready_for_logistics` 批次 → transfer submit/in-transit → destination arrival 重验 → applicable batch → join 候选”的正向链；耗尽且不支持补充、同一来源争用、低电力、规格未知及到达后适用性失败各一个可恢复或安全停止样例；preview 无副作用、获取/精炼与物流提交分别 fresh submit 重验、source/refinement、ready_for_logistics、arrived/applicable 分层，以及重复/重连/replay 不复制材料或进度。`test_tier_full` 再覆盖多来源/多批次、补充后重评、跨账本损耗、到达顺序变化、持久化恢复及 Viewer/pure API/Agent 的状态和下一动作同义性。
...
| --- | --- | --- | --- | --- |
| [REQ-FIRST-INDUSTRIAL-001](#req-first-industrial-001) / [AC-FIRST-INDUSTRIAL-001](#ac-first-industrial-001) | `producer_system_designer` | [`doc/game/prd.md`](../../game/prd.md)、[`gameplay-top-level-design.prd.md`](../../game/gameplay/gameplay-top-level-design.prd.md) | 本专题对应要求、验收与专业 authority 的可导航追踪证据 | `test_tier_required` |
| [REQ-FIRST-INDUSTRIAL-001](#req-first-industrial-001) / [AC-FIRST-INDUSTRIAL-002](#ac-first-industrial-002) | `producer_system_designer` | [`doc/game/prd.md`](../../game/prd.md)、[`gameplay-top-level-design.prd.md`](../../game/gameplay/gameplay-top-level-design.prd.md) | 本专题对应要求、验收与专业 authority 的可导航追踪证据 | `test_tier_required` |
| [REQ-FIRST-INDUSTRIAL-002](#req-first-industrial-002) / [AC-FIRST-INDUSTRIAL-001](#ac-first-industrial-001) | `producer_system_designer` | [`doc/game/prd.md`](../../game/prd.md)、[`gameplay-top-level-design.prd.md`](../../game/gameplay/gameplay-top-level-design.prd.md) | 本专题对应要求、验收与专业 authority 的可导航追踪证据 | `test_tier_required` |
| [REQ-FIRST-INDUSTRIAL-003](#req-first-industrial-003) / [AC-FIRST-INDUSTRIAL-001](#ac-first-industrial-001) | `producer_system_designer` | [`doc/game/prd.md`](../../game/prd.md)、[`gameplay-top-level-design.prd.md`](../../game/gameplay/gameplay-top-level-design.prd.md) | 本专题对应要求、验收与专业 authority 的可导航追踪证据 | `test_tier_required` |
| [REQ-FIRST-INDUSTRIAL-003](#req-first-industrial-003) / [AC-FIRST-INDUSTRIAL-002](#ac-first-industrial-002) | `producer_system_designer` | [`doc/game/prd.md`](../../game/prd.md)、[`gameplay-top-level-design.prd.md`](../../game/gameplay/gameplay-top-level-design.prd.md) | 本专题对应要求、验收与专业 authority 的可导航追踪证据 | `test_tier_required` |
| [REQ-FIRST-INDUSTRIAL-004](#req-first-industrial-004) / [AC-FIRST-INDUSTRIAL-001](#ac-first-industrial-001) | `producer_system_designer` | [`doc/game/prd.md`](../../game/prd.md)、[`gameplay-top-level-design.prd.md`](../../game/gameplay/gameplay-top-level-design.prd.md) | 本专题对应要求、验收与专业 authority 的可导航追踪证据 | `test_tier_required` |
| [REQ-FIRST-INDUSTRIAL-004](#req-first-industrial-004) / [AC-FIRST-INDUSTRIAL-005](#ac-first-industrial-005) | `producer_system_designer` | [`doc/game/prd.md`](../../game/prd.md)、[`gameplay-top-level-design.prd.md`](../../game/gameplay/gameplay-top-level-design.prd.md) | 本专题对应要求、验收与专业 authority 的可导航追踪证据 | `test_tier_required` |
| [REQ-FIRST-INDUSTRIAL-005](#req-first-industrial-005) / [AC-FIRST-INDUSTRIAL-003](#ac-first-industrial-003) | `producer_system_designer` | [`doc/game/prd.md`](../../game/prd.md)、[`gameplay-top-level-design.prd.md`](../../game/gameplay/gameplay-top-level-design.prd.md) | 本专题对应要求、验收与专业 authority 的可导航追踪证据 | `test_tier_required` |
| [REQ-FIRST-INDUSTRIAL-006](#req-first-industrial-006) / [AC-FIRST-INDUSTRIAL-002](#ac-first-industrial-002) | `producer_system_designer` | [`doc/game/prd.md`](../../game/prd.md)、[`gameplay-top-level-design.prd.md`](../../game/gameplay/gameplay-top-level-design.prd.md) | 本专题对应要求、验收与专业 authority 的可导航追踪证据 | `test_tier_required` |
| [REQ-FIRST-INDUSTRIAL-007](#req-first-industrial-007) / [AC-FIRST-INDUSTRIAL-004](#ac-first-industrial-004) | `producer_system_designer` | [`doc/game/prd.md`](../../game/prd.md)、[`gameplay-top-level-design.prd.md`](../../game/gameplay/gameplay-top-level-design.prd.md) | 本专题对应要求、验收与专业 authority 的可导航追踪证据 | `test_tier_required` |
| [REQ-FIRST-INDUSTRIAL-008](#req-first-industrial-008) / [AC-FIRST-INDUSTRIAL-004](#ac-first-industrial-004) | `producer_system_designer` | [`doc/game/prd.md`](../../game/prd.md)、[`gameplay-top-level-design.prd.md`](../../game/gameplay/gameplay-top-level-design.prd.md) | 本专题对应要求、验收与专业 authority 的可导航追踪证据 | `test_tier_required` |
