...
| `settled` | 采集/补充或精炼的 source effect 已由一次 receipt 结算，实际产物与 provenance 可追溯，仍待交接 | 下游账本已有可消费库存、规格已适用或已产生下游进度 |
