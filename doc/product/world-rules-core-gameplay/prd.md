...
<a id="sc-34"></a>
- SC-34：代表性连续性治理产品样例把 CR-3 的授权治理（GCB-001/002/003）、CR-4 的高影响保护与复核边界（GCB-006，并与紧急保供/危机恢复的既有产品语义相交但不重复）以及 CR-5 的长期经济审计与同候选发行证据（MW-10、PE-002/003、AR-4、[`REQ-ENTRY-CANDIDATE-001`](../player-entry-distribution/access-modes-and-release-readiness.prd.md#req-entry-candidate-001) / [`AC-ENTRY-CANDIDATE-001`](../player-entry-distribution/access-modes-and-release-readiness.prd.md#ac-entry-candidate-001)、[`ENTRY-CLAIM-001/003`](../player-entry-distribution/release-communications-and-public-claims.prd.md#req-entry-claim-001)）分别绑定到稳定产品 REQ/AC。runtime、P2P、恢复、经济审计、QA 与公开 claim 必须来自同一候选证据窗口；单节点、局部或历史 green 不得代签，本文不保存当前 readiness 结论。
