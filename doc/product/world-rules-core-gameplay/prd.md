...
| `产出待交付` | production receipt 的实际主/副产物、损耗、目的账本/终端、owner/recipient/资格与剩余交付前置 | delivery/settlement、需求减少、交付奖励或终端里程碑 | 等待/取得终端容量、交付、持有、改道/重报价或延期；没有 delivery receipt 就不能宣称当前目标完成 |
