...
覆盖可用空间、信息密度、语言、关键文本、连接中断与恢复的跨 surface 产品连续性。不定义具体 panel/module、fullscreen 控件、布局宽度、hit boundary、字体/资产、local JSON/cache、WebSocket 时序、Test API、测试命令或发布/readiness claim。
