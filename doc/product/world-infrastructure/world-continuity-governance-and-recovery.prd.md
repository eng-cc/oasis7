...
| CR-5 长期经济审计与同候选发行证据 | 根 [`SC-34`](../world-rules-core-gameplay/prd.md#sc-34)、[`REQ-WR-MW-003`](../world-rules-core-gameplay/mature-world-progression.prd.md#req-wr-mw-003) / [`AC-WR-MW-003`](../world-rules-core-gameplay/mature-world-progression.prd.md#ac-wr-mw-003)、[`REQ-WR-MW-005`](../world-rules-core-gameplay/mature-world-progression.prd.md#req-wr-mw-005) / [`AC-WR-MW-005`](../world-rules-core-gameplay/mature-world-progression.prd.md#ac-wr-mw-005)、[`REQ-WR-PE-002`](../world-rules-core-gameplay/playability-evidence-and-claim-boundaries.prd.md#req-wr-pe-002) / [`AC-WR-PE-002`](../world-rules-core-gameplay/playability-evidence-and-claim-boundaries.prd.md#ac-wr-pe-002)、[`REQ-WR-PE-003`](../world-rules-core-gameplay/playability-evidence-and-claim-boundaries.prd.md#req-wr-pe-003) / [`AC-WR-PE-003`](../world-rules-core-gameplay/playability-evidence-and-claim-boundaries.prd.md#ac-wr-pe-003)、[`AR-4`](../player-entry-distribution/access-modes-and-release-readiness.prd.md)、[`REQ-ENTRY-CANDIDATE-001`](../player-entry-distribution/access-modes-and-release-readiness.prd.md#req-entry-candidate-001) / [`AC-ENTRY-CANDIDATE-001`](../player-entry-distribution/access-modes-and-release-readiness.prd.md#ac-entry-candidate-001)、[`REQ-ENTRY-CLAIM-001`](../player-entry-distribution/release-communications-and-public-claims.prd.md#req-entry-claim-001) / [`AC-ENTRY-CLAIM-001`](../player-entry-distribution/release-communications-and-public-claims.prd.md#ac-entry-claim-001)、[`REQ-ENTRY-CLAIM-003`](../player-entry-distribution/release-communications-and-public-claims.prd.md#req-entry-claim-003) / [`AC-ENTRY-CLAIM-003`](../player-entry-distribution/release-communications-and-public-claims.prd.md#ac-entry-claim-003) | 产品要求 levy 与非 levy 资源 source/sink、关键经济变化和治理影响可审计；缺证、冲突或异常不能被单节点、单专题或短时 green 掩盖；runtime/P2P/恢复/QA/公开 claim 必须绑定同一候选证据窗口；不生成当前 release verdict。 |
