...
- `mainnet`, `public_testnet`, `shared-network`, incident, release, proof, playability, and hosted-world filenames describe the target schema only. They do not establish network health, readiness, public availability, incident closure, player validation, settlement, or release approval.
