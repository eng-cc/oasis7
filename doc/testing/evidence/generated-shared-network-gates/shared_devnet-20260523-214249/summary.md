...
| `shared_access` | `qa_engineer` | `partial` | `doc/testing/evidence/shared-network-shared-devnet-shared-access-2026-05-23.md` | cloud public shared endpoint now exists on 39.104.204.172, but same-window independent proof for the player-facing 4173 surface is still incomplete |
