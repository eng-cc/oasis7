...
| `multi_entry_closure` | `qa_engineer` | `partial` | `doc/testing/evidence/shared-network-shared-devnet-live-window-gap-audit-2026-05-23.md` | fresh post-reset candidate has not yet re-run same-window headed web plus no-ui plus pure-api closure |
| `mixed_topology_baseline` | `qa_engineer` | `partial` | `doc/testing/evidence/shared-network-shared-devnet-mixed-topology-2026-05-23.md` | only audited partial mixed-topology baseline exists; no current same-window uplift decision is pinned |
...
| `rollback_target_ready` | `liveops_community` | `partial` | `doc/testing/evidence/shared-network-shared-devnet-rollback-contract-2026-05-23.md` | restore contract is now real and audited, but still lacks formal current candidate bundle and gate reconciliation |
