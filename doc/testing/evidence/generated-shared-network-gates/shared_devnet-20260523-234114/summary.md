...
| `mixed_topology_baseline` | `qa_engineer` | `partial` | `doc/testing/evidence/shared-network-shared-devnet-mixed-topology-2026-05-23.md` | current same-window mixed deployment evidence is pinned, but the local validator is still behind the cloud live head and no producer/QA uplift decision is pinned |
