...
- 测试门禁、required/full 分层口径或证据模板变化时，优先更新 `doc/testing/prd.md`、`testing-manual.md` 与对应 evidence 文档；高频入口变化时，再同步回写 `doc/testing/prd.index.md` 与相关热点子域入口（例如 `doc/testing/evidence/README.md`）。
