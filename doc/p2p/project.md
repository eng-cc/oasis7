...
- [x] testnet-storage-challenge-degraded-readiness (PRD-P2P-001/003/028) [test_tier_required]: 修复 public testnet storage challenge 在 provider/DHT/fetch route retryable 不可用时误 hard-block sequencer 的问题；storage challenge 现在只走 provider-scoped route，保留 malformed/hash mismatch 硬失败，并把网络退化暴露到 readiness / preflight / package upgrade gate。 Trace: .pm/tasks/task_8d92c7fdfbc742e3866ef1162faedd66.yaml
