...
- [x] p2p-shared-world-doc-boundary-cleanup (PRD-P2P-028) [test_tier_required]: 精简 shared-network / benchmark / testing manual 重复叙事，明确 `shared_devnet` 仅是 legacy rehearsal evidence，不等同 `public_testnet`、mainnet、public launch 或 public large shared world。 Trace: .pm/tasks/task_d3129d0dff0f4111bcd87b1d2658179c.yaml
