...
| TASK-GAME-076 | PRD-GAME-012 | `gameplay_designer` | required pass / live-boundary retained | 自动化、诊断框架和 content-volume supplement 已补齐：required summary 为 `attraction_pass` / `content_volume_pass`，覆盖诊断、路线取舍、微型委托、事故修复、机会扫描、回访封装和本地订单贡献。 | `doc/game/gameplay/gameplay-ten-minute-retention-recovery-2026-04-09.prd.md`, `doc/game/gameplay/gameplay-ten-minute-retention-recovery-2026-04-09.project.md` |
