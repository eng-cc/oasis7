...
- 想确认访问模式、limited preview 或 release readiness：先读 `../../product/player-entry-distribution/access-modes-and-release-readiness.prd.md`，再按需读 `gameplay-limited-preview-execution-2026-03-22.prd.md`
...
- 首读入口:
  ...
  - `../../product/player-entry-distribution/access-modes-and-release-readiness.prd.md`
- 适合问题:
