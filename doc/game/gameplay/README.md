...
- 想确认普通治理主体如何聚合、委托、纠错，以及 OC 转让为什么不能旁路事项权利：先读 `../../product/world-rules-core-gameplay/governed-common-decisions-and-constitutional-boundaries.prd.md` 的 `GCB-004/005`，再读 `gameplay-ordinary-governance-subject-and-oc-rights-contract.prd.md`
- 想确认工业能力如何从可审计提案走到确定性模拟、受限试点、治理准入与有期限开放，以及跨区市场如何从新鲜情报走到物理交付、escrow 里程碑和争议恢复：先读 [`GR-009..011`](../../product/world-rules-core-gameplay/governed-regional-capabilities-and-extensions.prd.md#req-wr-gr-009)、[`SC31-009/AC-SC31-010/011`](../../product/world-rules-core-gameplay/industrial-demand-goals-and-settlement.prd.md#req-sc31-009)、[`ES-004`](../../product/world-rules-core-gameplay/market-normal-state-and-emergency-supply.prd.md#req-wr-es-004) 与 [`GCB-005`](../../product/world-rules-core-gameplay/governed-common-decisions-and-constitutional-boundaries.prd.md#req-wr-gcb-005)，再读 `gameplay-industrial-creation-and-cross-region-market-contract.prd.md`；产品正文仍由对应 active authority 拥有
...
- `gameplay-ordinary-governance-subject-and-oc-rights-contract.prd.md` 拥有 `PRD-GAME-019` 的普通治理主体聚合、资格/委托、公开审计、重复主体纠错/申诉、事项快照、OC 外部转让与单向非治理额度桥玩家动作和验收；产品 `GCB-004/005` 仍由 `governed-common-decisions-and-constitutional-boundaries.prd.md` 拥有，runtime/P2P/QA 保留各自执行与验证 authority。
- `gameplay-industrial-creation-and-cross-region-market-contract.prd.md` 拥有 `PRD-GAME-018` 的工业创建、许可/开放、OC/世界资格分离、跨区发现/物理交付/escrow 里程碑与争议恢复玩家合同；当前消费 active `GR-009..011`、`SC31-009/AC-SC31-010/011`、`ES-004` 与 `GCB-005` 产品 authority，常态/危机保供不在本合同重新定义。
