...
- `PRD-ID`：`PRD-GAME-018`
- 上层产品映射：工业能力提案/扩展消费当前 [`受治理的区域能力与扩展`](../../product/world-rules-core-gameplay/governed-regional-capabilities-and-extensions.prd.md#req-wr-gr-002) 的 `GR-002` 发布/激活重验与 [`GR-003`](../../product/world-rules-core-gameplay/governed-regional-capabilities-and-extensions.prd.md#req-wr-gr-003) 生效后限制/退出；需求、报价与生产/交付结算消费 [`工业需求目标与生产交付结算`](../../product/world-rules-core-gameplay/industrial-demand-goals-and-settlement.prd.md)；常态市场与危机边界消费 [`常态市场与有界紧急保供`](../../product/world-rules-core-gameplay/market-normal-state-and-emergency-supply.prd.md)。已标记为 `superseded` 的 [`受治理工业、市场结算与危机保供`](../../product/world-infrastructure/governed-industry-market-and-emergency-supply.prd.md) 仍是 AC-1 至 AC-4 的迁移 provenance，不再是 active authority。
...
产品旧源的 [`AC-1`](../../product/world-infrastructure/governed-industry-market-and-emergency-supply.prd.md#ac-1) 至 [`AC-4`](../../product/world-infrastructure/governed-industry-market-and-emergency-supply.prd.md#ac-4) 是迁移追踪来源；当前产品语义以 `GR-002/003`、工业需求/交付专题和常态市场专题为准。产品层的“工业规则、市场边界和不作实现/合规承诺”仍优先于本合同，本合同不把紧急保供扩展为新玩法系统。

OC 与世界资格分离的产品接收仍是未决依赖：旧源 AC-3 已被识别，但当前没有可由本专题代替的 active 产品验收锚点。本合同只定义目标玩法隔离和失败可读性，不把该依赖写成产品迁移完成、当前可用或 release 证据；后续必须由 `producer_system_designer` 联同 `blockchain_ops_engineer` / `runtime_engineer` 收口产品与执行 authority 后，才能关闭该残余。
