...
- 想确认当前试玩放行与发行口径：先读 `doc/product/player-entry-distribution/access-modes-and-release-readiness.prd.md`，再按需进入 `doc/game/gameplay/gameplay-limited-preview-execution-2026-03-22.prd.md`；当前公开状态只看根 `README.md`。
