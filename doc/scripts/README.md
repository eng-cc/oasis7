...
| 查看脚本模块任务映射与完成记录 | `doc/scripts/project.md` |
| 按文件名查找专题 PRD/design/project 三件套 | `doc/scripts/prd.index.md` |
| 选择当前脚本治理规范 | `doc/scripts/governance/README.md` |
...
- `doc/scripts/project.md` 记录 PRD-ID 到任务和验证证据的映射，不重复规范正文。
- `doc/scripts/governance/README.md` 是治理专题的唯一问题路由；专题正文拥有各自的参数、失败语义和兼容边界。
...
- 新增、移动或退役专题时，同步更新对应专题 README 与 `doc/scripts/prd.index.md`。
