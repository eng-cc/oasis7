...
- GitHub task issue evidence comments preserves completed implementation history.
...
| What was completed for this topic? | GitHub task issue evidence comments |
...
- Completed project history stays in GitHub task issue evidence comments; current behavior and operator actions stay in `pre-commit.prd.md`.
