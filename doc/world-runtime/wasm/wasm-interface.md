...
| [E1](wasm-executor.prd.md#sr2-obligation-e1) | ### 实现要点（E10） | [本域合同](wasm-interface.md#sr2-execution-contract) | paired专业owner与runtime/QA；具体跨域依赖见本域合同 | 下方原文限定范围不扩张，未执行能力不升级 |
