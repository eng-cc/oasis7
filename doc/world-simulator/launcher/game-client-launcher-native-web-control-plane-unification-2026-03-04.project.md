...
- [x] launcher-p2p-peer-list-ui (PRD-WORLD_SIMULATOR-015) [test_tier_required]: 透传 `/api/state` 的 `chain_replication_status`，并在启动器 `节点观测` 卡展示本地 peer id 与已连接 peer 明细。 Trace: .pm/tasks/task_ee3cc0c5d2d741658b404100843f93d8.yaml
