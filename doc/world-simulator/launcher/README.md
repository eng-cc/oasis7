...
- 想确认 launcher 的引导配置、可诊断状态，以及 chain runtime / execution world / stale-world 恢复边界：先读 `game-client-launcher-guided-configuration-and-usability.prd.md`；当前实现事实仍须按当期代码与任务证据核验
