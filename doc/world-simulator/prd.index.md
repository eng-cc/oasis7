...
| `doc/world-simulator/viewer/viewer-frontend-structure-standard.prd.md` | `doc/world-simulator/viewer/viewer-frontend-structure-standard.design.md` | `doc/world-simulator/viewer/viewer-frontend-structure-standard.project.md` |
| `doc/world-simulator/viewer/viewer-web-build-truth.prd.md` | `doc/world-simulator/viewer/viewer-web-build-truth.design.md` | active debt: `doc/world-simulator/viewer/viewer-frontend-structure-standard.project.md` |
