...
- [ ] viewer-pixel-world-commercial-rendering-loop (PRD-WORLD_SIMULATOR-046) [test_tier_required]: 将 pixel-world 主舞台从 renderer/debug 状态面板收口为商业化游戏棋盘，首屏优先展示目标、下一步、玩家杠杆与 agent-route 关系，并默认折叠 renderer diagnostics。 Trace: .pm/tasks/task_b399bf37eff94c44a300c55f5db739d3.yaml
