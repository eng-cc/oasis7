...
- [x] first-agent-claim-approval-closure (PRD-WORLD_SIMULATOR-045) [test_tier_required]: 补齐首个 agent claim 的产品闭环，并同步落地 `PRD-WORLD_RUNTIME-040` 对应 runtime 治理接口、viewer snapshot 回流与 `software_safe` 正式摘要状态卡。 Trace: .pm/tasks/task_95128237584e403bbaa24b24b5c024b9.yaml
