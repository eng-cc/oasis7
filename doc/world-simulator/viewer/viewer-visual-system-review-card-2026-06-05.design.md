...
- Expected visual contract: Viewer remains an industrial world command table:
  world and command path first, diagnostics demoted, unavailable states honest, action
...
- Screenshots:
  ...
  - `output/playwright/pixel-world-fragment-visual/2026-06-05T13-43-42-359Z/fragment-rendered-visual.png`
...
- Automated evidence:
  ...
  - `output/playwright/viewer-visual-system/2026-06-05T13-26-33Z/renderer-unavailable-hook-probe.json`
...
| UI state is honest against supplied state / DTO evidence | pass | Empty/sync state is presented as waiting; unavailable and derived state hooks are explicit. |
