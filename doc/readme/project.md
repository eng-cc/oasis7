...
- [x] xiaohongshu-loop-engineering-post-pack (PRD-README-050) [test_tier_required]: 为小红书新增 `Loop Engineering在游戏开发中的实践` 素材包，收口正文、短版 caption、评论区引导、发布边界、运营复盘观察点，并补齐两张发布图（封面 + 内容提要）与预览拼图。 Trace: .pm/tasks/task_a9ab9b9760c24e1fac5a31a157404408.yaml
  - 产物文件:
    ...
    - `.pm/tasks/task_a9ab9b9760c24e1fac5a31a157404408.yaml`
    - `.pm/tasks/task_a9ab9b9760c24e1fac5a31a157404408.execution.md`
  - 验收命令 (`test_tier_required`):
    - `rg -n "Loop Engineering在游戏开发中的实践|我给 agent|接力系统|不是全自动|xiaohongshu-loop-engineering" doc/readme/governance/readme-xiaohongshu-loop-engineering-game-dev-post-pack-2026-06-15.md doc/readme/governance/readme-xiaohongshu-liveops-runbook-2026-03-23.md site/social/xiaohongshu-loop-engineering-carousel.html .pm/tasks/task_a9ab9b9760c24e1fac5a31a157404408.yaml .pm/tasks/task_a9ab9b9760c24e1fac5a31a157404408.execution.md`
    - `file site/social/xiaohongshu-loop-engineering-carousel-slide1.png site/social/xiaohongshu-loop-engineering-carousel-slide2.png site/social/xiaohongshu-loop-engineering-cover.png`
    - `git diff --check`
