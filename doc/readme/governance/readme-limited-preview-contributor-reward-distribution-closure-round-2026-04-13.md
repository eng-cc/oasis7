...
- Source Ledger: `doc/readme/governance/readme-limited-preview-contributor-reward-ledger-round-2026-04-13.md`
...
- Fill `Execution Owner` once the operator is known.
- After both rows are distributed, update the source ledger closure rows from `pending` to `distributed`.
