...
| `RC-03` | 术语与边界 | README 中世界规则、玩家权能、WASM / runtime / viewer 边界与权威文档一致 | `doc/product/world-rules-core-gameplay/prd.md`、`doc/game/*`、`doc/world-runtime/*` | 将细节下沉到权威源，README 只保留导航级摘要 |
| `RC-04` | 入口链接 | README / `doc/README.md` 中指向 `doc/product/world-rules-core-gameplay/prd.md`、`testing-manual.md`、模块主 PRD 的链接可用 | `README.md`、`doc/README.md` | 修复链接并重跑文档治理 / 后续自动检查 |
