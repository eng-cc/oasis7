# oasis7: 公告 / Changelog 模板（2026-03-11）（项目管理）
...
## 任务拆解（含 PRD-ID 映射）
- [x] ANN-T1 (PRD-README-ANN-TEMPLATE-001/002) [test_tier_required]: 从首份公告底稿抽象模板结构。
- [x] ANN-T2 (PRD-README-ANN-TEMPLATE-002/003) [test_tier_required]: 生成模板文件并补齐 source-link / review status 字段。
