# Repository Health Scheduled Inspection Runbook

## Purpose
This runbook defines the recurring repository-health inspection used by engineering governance owners.
...
## Cadence
- Weekly light inspection: Monday 10:00 Asia/Shanghai.
...
- `pm lint` failure: classify current-task failures separately from known historical execution-log evidence debt. Do not make historical debt a weekly hard alarm unless a follow-up task has scoped it.
...
## Quarterly Review
Use the quarterly review to compare weekly trends:
...
- whether any weekly reflection signals should become committed `.pm` tasks
