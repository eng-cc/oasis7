...
- [x] TASK-ENGINEERING-014-D2 (PRD-ENGINEERING-006): Owner-D 完成 3 份根入口 redirect project 文档收口（root game-test project shell 后续已删除；`doc/world-runtime.project.md`、`doc/world-simulator.project.md` 仍保留兼容跳转）。
