...
## 复核范围
- 迁移协作入口：旧协作三件套已退役；当前完成态入口为 `doc/engineering/doc-migration/task-engineering-009-active-legacy-migration-closure-2026-03-11.md`
- 迁移项目文档：旧协作三件套已退役；当前收口复核入口为本文件。
...
| 引用可达 | `pass` | 工程主项目、迁移 closure evidence 与根入口 redirect 仍保持可达；本次抽查未发现新增断链。 |
