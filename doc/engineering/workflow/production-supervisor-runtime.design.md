...
```json
{
  ...
  "recovery": {"restart_count": 0, "takeover_count": 0, "readback_queries": [], "signature": "...", "rule": "new_epoch", "attempts": 1, "elapsed_s": 0, "new_epoch": true, "same_idempotency_key": false, "final_status": {"kind": "canonical", "value": "capability_blocked"}},
  "expected": {"status_rule": {"kind": "canonical", "value": "capability_blocked"}, "phase_rule": {"kind": "same_as_input"}, "expected_outcome_code": "producer_missing",
    ...
    "recovery": {"rule": "new_epoch", "max_attempts": 1, "max_elapsed_s": 60, "new_epoch": true, "same_idempotency_key": false}},
