...
| --- | --- | --- |
| `.agents/roles/*.md` and existing templates | Retain all IDs and the existing card structure; reference the common contract and encode professional differences | Executable instruction assets are code, even when Markdown; no extra authority registry |
