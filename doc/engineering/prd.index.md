...
## 历史审计留痕
- `doc/engineering/prd-review/prd-full-system-audit-2026-03-03.prd.md` / `doc/engineering/prd-review/prd-full-system-audit-2026-03-03.design.md` / `doc/engineering/prd-review/prd-full-system-audit-2026-03-03.project.md`：2026-03 全量 PRD 审读历史机制说明；当前不作为旧清单机制入口。
