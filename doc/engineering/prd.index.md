...
- 2026-03 self-evolution file-based PM project 面已退役删除；`file-based-self-evolution-management-2026-03-30.prd.md` 只保留 `PRD-ENGINEERING-021` 历史锚点，当前 task truth / evidence / reflection intake / PR-readiness 规则以 `doc/engineering/workflow/source-of-truth.md` 为准。
