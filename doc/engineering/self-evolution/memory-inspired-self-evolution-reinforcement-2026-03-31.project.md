...
- [ ] TASK-ENGINEERING-089 (PRD-ENGINEERING-MIR-002/003/004/006) [test_tier_required] + [test_tier_full]: 建立 `~/.codex/session_index.jsonl + ~/.codex/history.jsonl (+ sessions rollout fallback) + devlog/evidence -> working_memory -> source_type=reflection` 的 canonical 契约、去重规则、`source_ref` 规范化与 owner review 入口。
