...
- [x] repo-health-scheduled-inspection (PRD-ENGINEERING-021/025) [test_tier_required]: 新增 repository health 定期巡检 runbook，固定 weekly reminder、task/worktree + `repository_health_engineer` slice、doc inventory/doc governance/skill lint/worktree GC/PM lint 摘要、`.pm` evidence sink 与 escalation 口径；该流程是人工分级巡检，不新增 GitHub Actions 硬门禁。 Trace: .pm/tasks/task_2d354c73f1d04e25a328ad4c25c2a1a9.yaml
- [x] messaging-bridge-cleanup (PRD-ENGINEERING-021/025) [test_tier_required]: 删除历史 messaging bridge 残留的活跃仓库指导，移除 AGENTS 调度/发送说明、退役 stale root PR evidence，并将 repository health 巡检 runbook 改为 scheduler-neutral reminder；历史 `.pm` 证据保留为 audit truth。 Trace: .pm/tasks/task_198cdd132d3e4fda9f5fc9b4f46f412e.yaml
