...
- [x] agents-main-worktree-guard (PRD-ENGINEERING-021) [test_tier_required]: 在 workflow source-of-truth 与根 `AGENTS.md` 中明确禁止从 `main` 分支 / 主 worktree 直接修改 `AGENTS.md`，要求先创建或进入 task worktree。 Trace: .pm/tasks/task_d15fb6ffed634592bd8a0af8c1559cc1.yaml
