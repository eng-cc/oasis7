...
- 最新完成: `launcher-inventory-snapshot-sync`（已把 `doc/world-simulator/launcher` 热点入口父级库存快照同步到 2026-06-23 inventory truth，保留后续按 action_required 热点做 bounded 分类巡检的口径。）
