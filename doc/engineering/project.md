...
- [x] oasis7-node-types-burn-down (PRD-ENGINEERING-R1200-002/004/005) [test_tier_required]: 抽离 `crates/oasis7_node/src/types.rs` 的 main-token controller binding 子模块到 `types/controller_binding.rs`，将根文件从 1277 行压到 1069 行，并退役该 frozen oversized baseline 项。 Trace: .pm/tasks/task_b46f0ea2302d4b289fe2b6977a0d3041.yaml
