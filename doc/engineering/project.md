...
- [x] workflow-eval-scenario-coverage (PRD-ENGINEERING-031/PRD-ENGINEERING-021) [test_tier_required]: 扩展 `scripts/pm/workflow-behavior-eval.sh` 的 routing scenario contract，覆盖 trivial 直办、non-trivial task truth、brainstorming/TDD/subagent 可选门、fresh verification 与 GitHub PR review 边界，防止可选流程退化成必经流程。 Trace: .pm/tasks/task_ae1c12cfc37342d2a886c0829193e6da.yaml
...
- [ ] standard-worktree-flow (PRD-ENGINEERING-021/031/PRD-ENGINEERING-AWB-009A) [test_tier_required]: 将默认 workflow 从 trivial/non-trivial 分流改为“所有仓库变更任务先走标准 task worktree + `.pm` task + owner role 真值”，并同步 source-of-truth、root AGENTS、workflow skills 与 behavior eval 契约。 Trace: .pm/tasks/task_2f8fdc0b447244a4b4b7923ab0496da5.yaml
- [ ] tpm-orchestrator-role (PRD-ENGINEERING-021/031/PRD-ENGINEERING-AWB-006) [test_tier_required]: 新增 `tpm` 作为默认主 Agent / orchestrator / canonical integrator，并将 `producer_system_designer` 与其他专业角色收口为 TPM 派生的 bounded subagent slice。 Trace: .pm/tasks/task_be2454e6bc47441d9383f7509e381b96.yaml
