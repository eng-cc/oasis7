...
- [x] repo-health-manual-inspection-trigger (PRD-ENGINEERING-021/025) [test_tier_required]: cc-connect 删除后，将 repository health 巡检 runbook 从 weekly cron / 自动提醒改为工程治理 owner 手动触发，并同步工程入口路径到 `repository-health-manual-inspection.runbook.md`。 Trace: .pm/tasks/task_ef87a7a54b764b13ae8be86dd6f54a77.yaml
