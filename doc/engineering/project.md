...
- [x] visual-interaction-design-skills [test_tier_required]: 新增 repo-owned `game-interaction-design` 与 `game-visual-design` skills，绑定 `game_visual_interaction_designer` 的可视化/玩家可见交互方法面，并保留外部资料 source-map 与 runtime/QA 边界。 Trace: .pm/tasks/task_aa75e054f104413bac6454b912591744.yaml
