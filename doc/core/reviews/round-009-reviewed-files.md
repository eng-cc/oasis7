...
| `doc/world-simulator/viewer/viewer-manual.manual.md` | Viewer 高频手册 | 是否保留 legacy 命名或迁移为 `*.manual.md` | migrate | P0 | `viewer_engineer` | aligned | I9-002 | 已新增 `viewer-manual.manual.md` 作为 canonical 手册，旧路径已删除 |
