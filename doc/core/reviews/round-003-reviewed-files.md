...
- historical engineering full-PRD review triplet（后续已删除）
...
- nonviewer design-alignment closure project (retired/deleted)
- nonviewer design-alignment review PRD (retired/deleted)
- nonviewer design-alignment review project (retired/deleted)
...
- `doc/p2p/distfs/distfs-distributed-resilience.prd.md`
- `doc/p2p/distfs/distfs-distributed-resilience.project.md`
- `doc/p2p/distfs/distfs-distributed-resilience.prd.md`
- `doc/p2p/distfs/distfs-distributed-resilience.project.md`
...
- retired frag-resource-balance-onboarding PRD（后续已删除；现行产品语义进入首局与持续游玩分册，生成语义进入 chunked fragment generation 分册）
...
- historical removed standard_3d viewer doc set: early 2D/3D clarity and rendering polish topics
...
- historical removed standard_3d viewer doc set: capture automation and bevy-web runtime topics
...
- retired viewer-control-feedback-iteration-checklist-2026-02-27 PRD (archive: `Git history / current control-feedback canonical docs`)
- retired viewer-control-feedback-iteration-checklist-2026-02-27 project (archive: `Git history / current control-feedback canonical docs`)
- retired viewer-control-feedback-step-recovery-p0-2026-02-27 PRD (archive: `Git history / current control-feedback canonical docs`)
- retired viewer-control-feedback-step-recovery-p0-2026-02-27 project (archive: `Git history / current control-feedback canonical docs`)
...
- retired viewer-control-predictability-tasklist-2026-02-28 PRD (archive: `Git history / current control-feedback canonical docs`)
- retired viewer-control-predictability-tasklist-2026-02-28 project (archive: `Git history / current control-feedback canonical docs`)
...
- historical removed standard_3d viewer doc set: industrial visual closure topics
...
- historical removed standard_3d viewer doc set: observability visual optimization and open-world sandbox readiness topics
...
- historical removed standard_3d viewer doc set: release coverage, release QA, and rendering physical-accuracy topics
...
- historical removed standard_3d viewer doc set: texture inspector, visual upgrade, visualization, camera, and old web-closure topics
