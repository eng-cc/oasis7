...
Use the above table to log every closed beta candidate signal before moving it into the corresponding GitHub task issue evidence comments and any formal QA / LiveOps evidence bundle required by the release gate.
